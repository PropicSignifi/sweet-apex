...
var QYsPF = function (_Component) {
  _inherits(QYsPF, _Component);

  function QYsPF() {
    _classCallCheck(this, QYsPF);

    return _possibleConstructorReturn(this, (QYsPF.__proto__ || Object.getPrototypeOf(QYsPF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QYsPF, _step_3Soy2.default);

exports.default = QYsPF;
...
exports.templates = exports.QYsPF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QYsPF.
   * @public
   */

  goog.module('QYsPF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QYsPF.render';
  }
...
_metalSoy2.default.register(QYsPF, templates);
exports.QYsPF = QYsPF;
