...
var yOvCO = function (_Component) {
  _inherits(yOvCO, _Component);

  function yOvCO() {
    _classCallCheck(this, yOvCO);

    return _possibleConstructorReturn(this, (yOvCO.__proto__ || Object.getPrototypeOf(yOvCO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yOvCO, _commandSoy2.default);

exports.default = yOvCO;
...
exports.templates = exports.yOvCO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yOvCO.
   * @public
   */

  goog.module('yOvCO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yOvCO.render';
  }
...
_metalSoy2.default.register(yOvCO, templates);
exports.yOvCO = yOvCO;
