...
var dCjEh = function (_Component) {
  _inherits(dCjEh, _Component);

  function dCjEh() {
    _classCallCheck(this, dCjEh);

    return _possibleConstructorReturn(this, (dCjEh.__proto__ || Object.getPrototypeOf(dCjEh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dCjEh, _step_4Soy2.default);

exports.default = dCjEh;
...
exports.templates = exports.dCjEh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dCjEh.
   * @public
   */

  goog.module('dCjEh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dCjEh.render';
  }
...
_metalSoy2.default.register(dCjEh, templates);
exports.dCjEh = dCjEh;
