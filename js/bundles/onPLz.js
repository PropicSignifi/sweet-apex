...
var onPLz = function (_Component) {
  _inherits(onPLz, _Component);

  function onPLz() {
    _classCallCheck(this, onPLz);

    return _possibleConstructorReturn(this, (onPLz.__proto__ || Object.getPrototypeOf(onPLz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(onPLz, _templateSoy2.default);

exports.default = onPLz;
...
exports.templates = exports.onPLz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace onPLz.
   * @public
   */

  goog.module('onPLz.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param899 = function param899() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'onPLz.render';
  }
...
_metalSoy2.default.register(onPLz, templates);
exports.onPLz = onPLz;
