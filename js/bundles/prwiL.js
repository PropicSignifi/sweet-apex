...
var prwiL = function (_Component) {
  _inherits(prwiL, _Component);

  function prwiL() {
    _classCallCheck(this, prwiL);

    return _possibleConstructorReturn(this, (prwiL.__proto__ || Object.getPrototypeOf(prwiL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(prwiL, _grammarSoy2.default);

exports.default = prwiL;
...
exports.templates = exports.prwiL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace prwiL.
   * @public
   */

  goog.module('prwiL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'prwiL.render';
  }
...
_metalSoy2.default.register(prwiL, templates);
exports.prwiL = prwiL;
