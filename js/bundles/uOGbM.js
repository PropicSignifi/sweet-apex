...
var uOGbM = function (_Component) {
  _inherits(uOGbM, _Component);

  function uOGbM() {
    _classCallCheck(this, uOGbM);

    return _possibleConstructorReturn(this, (uOGbM.__proto__ || Object.getPrototypeOf(uOGbM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uOGbM, _commandSoy2.default);

exports.default = uOGbM;
...
exports.templates = exports.uOGbM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uOGbM.
   * @public
   */

  goog.module('uOGbM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uOGbM.render';
  }
...
_metalSoy2.default.register(uOGbM, templates);
exports.uOGbM = uOGbM;
