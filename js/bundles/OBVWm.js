...
var OBVWm = function (_Component) {
  _inherits(OBVWm, _Component);

  function OBVWm() {
    _classCallCheck(this, OBVWm);

    return _possibleConstructorReturn(this, (OBVWm.__proto__ || Object.getPrototypeOf(OBVWm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OBVWm, _step_2Soy2.default);

exports.default = OBVWm;
...
exports.templates = exports.OBVWm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OBVWm.
   * @public
   */

  goog.module('OBVWm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OBVWm.render';
  }
...
_metalSoy2.default.register(OBVWm, templates);
exports.OBVWm = OBVWm;
