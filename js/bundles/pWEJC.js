...
var pWEJC = function (_Component) {
  _inherits(pWEJC, _Component);

  function pWEJC() {
    _classCallCheck(this, pWEJC);

    return _possibleConstructorReturn(this, (pWEJC.__proto__ || Object.getPrototypeOf(pWEJC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pWEJC, _reflectSoy2.default);

exports.default = pWEJC;
...
exports.templates = exports.pWEJC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pWEJC.
   * @public
   */

  goog.module('pWEJC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pWEJC.render';
  }
...
_metalSoy2.default.register(pWEJC, templates);
exports.pWEJC = pWEJC;
