...
var LMDYc = function (_Component) {
  _inherits(LMDYc, _Component);

  function LMDYc() {
    _classCallCheck(this, LMDYc);

    return _possibleConstructorReturn(this, (LMDYc.__proto__ || Object.getPrototypeOf(LMDYc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LMDYc, _reflectSoy2.default);

exports.default = LMDYc;
...
exports.templates = exports.LMDYc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LMDYc.
   * @public
   */

  goog.module('LMDYc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LMDYc.render';
  }
...
_metalSoy2.default.register(LMDYc, templates);
exports.LMDYc = LMDYc;
