...
var tPaIA = function (_Component) {
  _inherits(tPaIA, _Component);

  function tPaIA() {
    _classCallCheck(this, tPaIA);

    return _possibleConstructorReturn(this, (tPaIA.__proto__ || Object.getPrototypeOf(tPaIA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tPaIA, _varSoy2.default);

exports.default = tPaIA;
...
exports.templates = exports.tPaIA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tPaIA.
   * @public
   */

  goog.module('tPaIA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tPaIA.render';
  }
...
_metalSoy2.default.register(tPaIA, templates);
exports.tPaIA = tPaIA;
