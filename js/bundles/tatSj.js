...
var tatSj = function (_Component) {
  _inherits(tatSj, _Component);

  function tatSj() {
    _classCallCheck(this, tatSj);

    return _possibleConstructorReturn(this, (tatSj.__proto__ || Object.getPrototypeOf(tatSj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tatSj, _step_1Soy2.default);

exports.default = tatSj;
...
exports.templates = exports.tatSj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tatSj.
   * @public
   */

  goog.module('tatSj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tatSj.render';
  }
...
_metalSoy2.default.register(tatSj, templates);
exports.tatSj = tatSj;
