...
var uMGhi = function (_Component) {
  _inherits(uMGhi, _Component);

  function uMGhi() {
    _classCallCheck(this, uMGhi);

    return _possibleConstructorReturn(this, (uMGhi.__proto__ || Object.getPrototypeOf(uMGhi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uMGhi, _scriptSoy2.default);

exports.default = uMGhi;
...
exports.templates = exports.uMGhi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uMGhi.
   * @public
   */

  goog.module('uMGhi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uMGhi.render';
  }
...
_metalSoy2.default.register(uMGhi, templates);
exports.uMGhi = uMGhi;
