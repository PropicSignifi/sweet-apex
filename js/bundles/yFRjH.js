...
var yFRjH = function (_Component) {
  _inherits(yFRjH, _Component);

  function yFRjH() {
    _classCallCheck(this, yFRjH);

    return _possibleConstructorReturn(this, (yFRjH.__proto__ || Object.getPrototypeOf(yFRjH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yFRjH, _aspectSoy2.default);

exports.default = yFRjH;
...
exports.templates = exports.yFRjH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yFRjH.
   * @public
   */

  goog.module('yFRjH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yFRjH.render';
  }
...
_metalSoy2.default.register(yFRjH, templates);
exports.yFRjH = yFRjH;
