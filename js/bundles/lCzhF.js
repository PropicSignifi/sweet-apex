...
var lCzhF = function (_Component) {
  _inherits(lCzhF, _Component);

  function lCzhF() {
    _classCallCheck(this, lCzhF);

    return _possibleConstructorReturn(this, (lCzhF.__proto__ || Object.getPrototypeOf(lCzhF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lCzhF, _configSoy2.default);

exports.default = lCzhF;
...
exports.templates = exports.lCzhF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lCzhF.
   * @public
   */

  goog.module('lCzhF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lCzhF.render';
  }
...
_metalSoy2.default.register(lCzhF, templates);
exports.lCzhF = lCzhF;
