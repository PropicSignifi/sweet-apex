...
var UWbwy = function (_Component) {
  _inherits(UWbwy, _Component);

  function UWbwy() {
    _classCallCheck(this, UWbwy);

    return _possibleConstructorReturn(this, (UWbwy.__proto__ || Object.getPrototypeOf(UWbwy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UWbwy, _functionSoy2.default);

exports.default = UWbwy;
...
exports.templates = exports.UWbwy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UWbwy.
   * @public
   */

  goog.module('UWbwy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UWbwy.render';
  }
...
_metalSoy2.default.register(UWbwy, templates);
exports.UWbwy = UWbwy;
