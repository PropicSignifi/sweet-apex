...
var utVND = function (_Component) {
  _inherits(utVND, _Component);

  function utVND() {
    _classCallCheck(this, utVND);

    return _possibleConstructorReturn(this, (utVND.__proto__ || Object.getPrototypeOf(utVND)).apply(this, arguments));
  }
...
_metalSoy2.default.register(utVND, _indexSoy2.default);

exports.default = utVND;
...
exports.templates = exports.utVND = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace utVND.
   * @public
   */

  goog.module('utVND.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'utVND.render';
  }
...
_metalSoy2.default.register(utVND, templates);
exports.utVND = utVND;
