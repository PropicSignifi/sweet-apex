...
var XfwcR = function (_Component) {
  _inherits(XfwcR, _Component);

  function XfwcR() {
    _classCallCheck(this, XfwcR);

    return _possibleConstructorReturn(this, (XfwcR.__proto__ || Object.getPrototypeOf(XfwcR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XfwcR, _grammarSoy2.default);

exports.default = XfwcR;
...
exports.templates = exports.XfwcR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XfwcR.
   * @public
   */

  goog.module('XfwcR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XfwcR.render';
  }
...
_metalSoy2.default.register(XfwcR, templates);
exports.XfwcR = XfwcR;
