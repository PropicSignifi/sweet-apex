...
var uHFEu = function (_Component) {
  _inherits(uHFEu, _Component);

  function uHFEu() {
    _classCallCheck(this, uHFEu);

    return _possibleConstructorReturn(this, (uHFEu.__proto__ || Object.getPrototypeOf(uHFEu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uHFEu, _injectSoy2.default);

exports.default = uHFEu;
...
exports.templates = exports.uHFEu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uHFEu.
   * @public
   */

  goog.module('uHFEu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uHFEu.render';
  }
...
_metalSoy2.default.register(uHFEu, templates);
exports.uHFEu = uHFEu;
