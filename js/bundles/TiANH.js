...
var TiANH = function (_Component) {
  _inherits(TiANH, _Component);

  function TiANH() {
    _classCallCheck(this, TiANH);

    return _possibleConstructorReturn(this, (TiANH.__proto__ || Object.getPrototypeOf(TiANH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TiANH, _indexSoy2.default);

exports.default = TiANH;
...
exports.templates = exports.TiANH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TiANH.
   * @public
   */

  goog.module('TiANH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TiANH.render';
  }
...
_metalSoy2.default.register(TiANH, templates);
exports.TiANH = TiANH;
