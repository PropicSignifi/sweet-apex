...
var zhzne = function (_Component) {
  _inherits(zhzne, _Component);

  function zhzne() {
    _classCallCheck(this, zhzne);

    return _possibleConstructorReturn(this, (zhzne.__proto__ || Object.getPrototypeOf(zhzne)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zhzne, _testcaseSoy2.default);

exports.default = zhzne;
...
exports.templates = exports.zhzne = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zhzne.
   * @public
   */

  goog.module('zhzne.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zhzne.render';
  }
...
_metalSoy2.default.register(zhzne, templates);
exports.zhzne = zhzne;
