...
var uURKU = function (_Component) {
  _inherits(uURKU, _Component);

  function uURKU() {
    _classCallCheck(this, uURKU);

    return _possibleConstructorReturn(this, (uURKU.__proto__ || Object.getPrototypeOf(uURKU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uURKU, _actionSoy2.default);

exports.default = uURKU;
...
exports.templates = exports.uURKU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uURKU.
   * @public
   */

  goog.module('uURKU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uURKU.render';
  }
...
_metalSoy2.default.register(uURKU, templates);
exports.uURKU = uURKU;
