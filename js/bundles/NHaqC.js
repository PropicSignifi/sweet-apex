...
var NHaqC = function (_Component) {
  _inherits(NHaqC, _Component);

  function NHaqC() {
    _classCallCheck(this, NHaqC);

    return _possibleConstructorReturn(this, (NHaqC.__proto__ || Object.getPrototypeOf(NHaqC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NHaqC, _enumSoy2.default);

exports.default = NHaqC;
...
exports.templates = exports.NHaqC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NHaqC.
   * @public
   */

  goog.module('NHaqC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NHaqC.render';
  }
...
_metalSoy2.default.register(NHaqC, templates);
exports.NHaqC = NHaqC;
