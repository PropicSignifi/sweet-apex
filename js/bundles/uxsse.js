...
var uxsse = function (_Component) {
  _inherits(uxsse, _Component);

  function uxsse() {
    _classCallCheck(this, uxsse);

    return _possibleConstructorReturn(this, (uxsse.__proto__ || Object.getPrototypeOf(uxsse)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uxsse, _default_valueSoy2.default);

exports.default = uxsse;
...
exports.templates = exports.uxsse = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uxsse.
   * @public
   */

  goog.module('uxsse.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uxsse.render';
  }
...
_metalSoy2.default.register(uxsse, templates);
exports.uxsse = uxsse;
