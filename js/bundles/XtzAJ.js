...
var XtzAJ = function (_Component) {
  _inherits(XtzAJ, _Component);

  function XtzAJ() {
    _classCallCheck(this, XtzAJ);

    return _possibleConstructorReturn(this, (XtzAJ.__proto__ || Object.getPrototypeOf(XtzAJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XtzAJ, _testcaseSoy2.default);

exports.default = XtzAJ;
...
exports.templates = exports.XtzAJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XtzAJ.
   * @public
   */

  goog.module('XtzAJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XtzAJ.render';
  }
...
_metalSoy2.default.register(XtzAJ, templates);
exports.XtzAJ = XtzAJ;
