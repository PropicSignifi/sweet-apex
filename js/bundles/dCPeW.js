...
var dCPeW = function (_Component) {
  _inherits(dCPeW, _Component);

  function dCPeW() {
    _classCallCheck(this, dCPeW);

    return _possibleConstructorReturn(this, (dCPeW.__proto__ || Object.getPrototypeOf(dCPeW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dCPeW, _configSoy2.default);

exports.default = dCPeW;
...
exports.templates = exports.dCPeW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dCPeW.
   * @public
   */

  goog.module('dCPeW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dCPeW.render';
  }
...
_metalSoy2.default.register(dCPeW, templates);
exports.dCPeW = dCPeW;
