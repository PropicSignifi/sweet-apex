...
var TjepS = function (_Component) {
  _inherits(TjepS, _Component);

  function TjepS() {
    _classCallCheck(this, TjepS);

    return _possibleConstructorReturn(this, (TjepS.__proto__ || Object.getPrototypeOf(TjepS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TjepS, _testcaseSoy2.default);

exports.default = TjepS;
...
exports.templates = exports.TjepS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TjepS.
   * @public
   */

  goog.module('TjepS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TjepS.render';
  }
...
_metalSoy2.default.register(TjepS, templates);
exports.TjepS = TjepS;
