...
var LRZNT = function (_Component) {
  _inherits(LRZNT, _Component);

  function LRZNT() {
    _classCallCheck(this, LRZNT);

    return _possibleConstructorReturn(this, (LRZNT.__proto__ || Object.getPrototypeOf(LRZNT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LRZNT, _transpilationSoy2.default);

exports.default = LRZNT;
...
exports.templates = exports.LRZNT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LRZNT.
   * @public
   */

  goog.module('LRZNT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LRZNT.render';
  }
...
_metalSoy2.default.register(LRZNT, templates);
exports.LRZNT = LRZNT;
