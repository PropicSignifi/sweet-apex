...
var JJBsJ = function (_Component) {
  _inherits(JJBsJ, _Component);

  function JJBsJ() {
    _classCallCheck(this, JJBsJ);

    return _possibleConstructorReturn(this, (JJBsJ.__proto__ || Object.getPrototypeOf(JJBsJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JJBsJ, _functionSoy2.default);

exports.default = JJBsJ;
...
exports.templates = exports.JJBsJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JJBsJ.
   * @public
   */

  goog.module('JJBsJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JJBsJ.render';
  }
...
_metalSoy2.default.register(JJBsJ, templates);
exports.JJBsJ = JJBsJ;
