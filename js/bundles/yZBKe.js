...
var yZBKe = function (_Component) {
  _inherits(yZBKe, _Component);

  function yZBKe() {
    _classCallCheck(this, yZBKe);

    return _possibleConstructorReturn(this, (yZBKe.__proto__ || Object.getPrototypeOf(yZBKe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yZBKe, _indexSoy2.default);

exports.default = yZBKe;
...
exports.templates = exports.yZBKe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yZBKe.
   * @public
   */

  goog.module('yZBKe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yZBKe.render';
  }
...
_metalSoy2.default.register(yZBKe, templates);
exports.yZBKe = yZBKe;
