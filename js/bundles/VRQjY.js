...
var _transpilationSoy = __webpack_require__(283);
...
var VRQjY = function (_Component) {
  _inherits(VRQjY, _Component);

  function VRQjY() {
    _classCallCheck(this, VRQjY);

    return _possibleConstructorReturn(this, (VRQjY.__proto__ || Object.getPrototypeOf(VRQjY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VRQjY, _transpilationSoy2.default);

exports.default = VRQjY;
...
exports.templates = exports.VRQjY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VRQjY.
   * @public
   */

  goog.module('VRQjY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VRQjY.render';
  }
...
_metalSoy2.default.register(VRQjY, templates);
exports.VRQjY = VRQjY;
