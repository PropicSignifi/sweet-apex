...
var MyGDc = function (_Component) {
  _inherits(MyGDc, _Component);

  function MyGDc() {
    _classCallCheck(this, MyGDc);

    return _possibleConstructorReturn(this, (MyGDc.__proto__ || Object.getPrototypeOf(MyGDc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MyGDc, _scriptSoy2.default);

exports.default = MyGDc;
...
exports.templates = exports.MyGDc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MyGDc.
   * @public
   */

  goog.module('MyGDc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MyGDc.render';
  }
...
_metalSoy2.default.register(MyGDc, templates);
exports.MyGDc = MyGDc;
