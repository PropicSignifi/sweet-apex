...
var WgefZ = function (_Component) {
  _inherits(WgefZ, _Component);

  function WgefZ() {
    _classCallCheck(this, WgefZ);

    return _possibleConstructorReturn(this, (WgefZ.__proto__ || Object.getPrototypeOf(WgefZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WgefZ, _enumSoy2.default);

exports.default = WgefZ;
...
exports.templates = exports.WgefZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WgefZ.
   * @public
   */

  goog.module('WgefZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WgefZ.render';
  }
...
_metalSoy2.default.register(WgefZ, templates);
exports.WgefZ = WgefZ;
