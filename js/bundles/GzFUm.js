...
var GzFUm = function (_Component) {
  _inherits(GzFUm, _Component);

  function GzFUm() {
    _classCallCheck(this, GzFUm);

    return _possibleConstructorReturn(this, (GzFUm.__proto__ || Object.getPrototypeOf(GzFUm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GzFUm, _fileSoy2.default);

exports.default = GzFUm;
...
exports.templates = exports.GzFUm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GzFUm.
   * @public
   */

  goog.module('GzFUm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GzFUm.render';
  }
...
_metalSoy2.default.register(GzFUm, templates);
exports.GzFUm = GzFUm;
