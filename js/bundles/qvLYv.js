...
var qvLYv = function (_Component) {
  _inherits(qvLYv, _Component);

  function qvLYv() {
    _classCallCheck(this, qvLYv);

    return _possibleConstructorReturn(this, (qvLYv.__proto__ || Object.getPrototypeOf(qvLYv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qvLYv, _apexdocSoy2.default);

exports.default = qvLYv;
...
exports.templates = exports.qvLYv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qvLYv.
   * @public
   */

  goog.module('qvLYv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qvLYv.render';
  }
...
_metalSoy2.default.register(qvLYv, templates);
exports.qvLYv = qvLYv;
