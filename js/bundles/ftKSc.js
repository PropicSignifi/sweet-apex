...
var ftKSc = function (_Component) {
  _inherits(ftKSc, _Component);

  function ftKSc() {
    _classCallCheck(this, ftKSc);

    return _possibleConstructorReturn(this, (ftKSc.__proto__ || Object.getPrototypeOf(ftKSc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ftKSc, _featureSoy2.default);

exports.default = ftKSc;
...
exports.templates = exports.ftKSc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ftKSc.
   * @public
   */

  goog.module('ftKSc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ftKSc.render';
  }
...
_metalSoy2.default.register(ftKSc, templates);
exports.ftKSc = ftKSc;
