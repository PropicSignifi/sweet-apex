...
var _injectSoy = __webpack_require__(309);
...
var yctll = function (_Component) {
  _inherits(yctll, _Component);

  function yctll() {
    _classCallCheck(this, yctll);

    return _possibleConstructorReturn(this, (yctll.__proto__ || Object.getPrototypeOf(yctll)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yctll, _injectSoy2.default);

exports.default = yctll;
...
exports.templates = exports.yctll = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yctll.
   * @public
   */

  goog.module('yctll.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yctll.render';
  }
...
_metalSoy2.default.register(yctll, templates);
exports.yctll = yctll;
