...
var myFuJ = function (_Component) {
  _inherits(myFuJ, _Component);

  function myFuJ() {
    _classCallCheck(this, myFuJ);

    return _possibleConstructorReturn(this, (myFuJ.__proto__ || Object.getPrototypeOf(myFuJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(myFuJ, _annotationSoy2.default);

exports.default = myFuJ;
...
exports.templates = exports.myFuJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace myFuJ.
   * @public
   */

  goog.module('myFuJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'myFuJ.render';
  }
...
_metalSoy2.default.register(myFuJ, templates);
exports.myFuJ = myFuJ;
