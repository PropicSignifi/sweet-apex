...
var MtPfR = function (_Component) {
  _inherits(MtPfR, _Component);

  function MtPfR() {
    _classCallCheck(this, MtPfR);

    return _possibleConstructorReturn(this, (MtPfR.__proto__ || Object.getPrototypeOf(MtPfR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MtPfR, _testcaseSoy2.default);

exports.default = MtPfR;
...
exports.templates = exports.MtPfR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MtPfR.
   * @public
   */

  goog.module('MtPfR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MtPfR.render';
  }
...
_metalSoy2.default.register(MtPfR, templates);
exports.MtPfR = MtPfR;
