...
var qQBcH = function (_Component) {
  _inherits(qQBcH, _Component);

  function qQBcH() {
    _classCallCheck(this, qQBcH);

    return _possibleConstructorReturn(this, (qQBcH.__proto__ || Object.getPrototypeOf(qQBcH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qQBcH, _reflectSoy2.default);

exports.default = qQBcH;
...
exports.templates = exports.qQBcH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qQBcH.
   * @public
   */

  goog.module('qQBcH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qQBcH.render';
  }
...
_metalSoy2.default.register(qQBcH, templates);
exports.qQBcH = qQBcH;
