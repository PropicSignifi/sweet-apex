...
var nKAQr = function (_Component) {
  _inherits(nKAQr, _Component);

  function nKAQr() {
    _classCallCheck(this, nKAQr);

    return _possibleConstructorReturn(this, (nKAQr.__proto__ || Object.getPrototypeOf(nKAQr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nKAQr, _destructureSoy2.default);

exports.default = nKAQr;
...
exports.templates = exports.nKAQr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nKAQr.
   * @public
   */

  goog.module('nKAQr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nKAQr.render';
  }
...
_metalSoy2.default.register(nKAQr, templates);
exports.nKAQr = nKAQr;
