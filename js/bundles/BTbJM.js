...
var BTbJM = function (_Component) {
  _inherits(BTbJM, _Component);

  function BTbJM() {
    _classCallCheck(this, BTbJM);

    return _possibleConstructorReturn(this, (BTbJM.__proto__ || Object.getPrototypeOf(BTbJM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BTbJM, _identitySoy2.default);

exports.default = BTbJM;
...
exports.templates = exports.BTbJM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BTbJM.
   * @public
   */

  goog.module('BTbJM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BTbJM.render';
  }
...
_metalSoy2.default.register(BTbJM, templates);
exports.BTbJM = BTbJM;
