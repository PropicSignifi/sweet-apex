...
var EiGRj = function (_Component) {
  _inherits(EiGRj, _Component);

  function EiGRj() {
    _classCallCheck(this, EiGRj);

    return _possibleConstructorReturn(this, (EiGRj.__proto__ || Object.getPrototypeOf(EiGRj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EiGRj, _fileSoy2.default);

exports.default = EiGRj;
...
exports.templates = exports.EiGRj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EiGRj.
   * @public
   */

  goog.module('EiGRj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EiGRj.render';
  }
...
_metalSoy2.default.register(EiGRj, templates);
exports.EiGRj = EiGRj;
