...
var _scriptSoy = __webpack_require__(333);
...
var gdxgs = function (_Component) {
  _inherits(gdxgs, _Component);

  function gdxgs() {
    _classCallCheck(this, gdxgs);

    return _possibleConstructorReturn(this, (gdxgs.__proto__ || Object.getPrototypeOf(gdxgs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gdxgs, _scriptSoy2.default);

exports.default = gdxgs;
...
exports.templates = exports.gdxgs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gdxgs.
   * @public
   */

  goog.module('gdxgs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gdxgs.render';
  }
...
_metalSoy2.default.register(gdxgs, templates);
exports.gdxgs = gdxgs;
