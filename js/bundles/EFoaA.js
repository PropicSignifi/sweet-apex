...
var EFoaA = function (_Component) {
  _inherits(EFoaA, _Component);

  function EFoaA() {
    _classCallCheck(this, EFoaA);

    return _possibleConstructorReturn(this, (EFoaA.__proto__ || Object.getPrototypeOf(EFoaA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EFoaA, _indexSoy2.default);

exports.default = EFoaA;
...
exports.templates = exports.EFoaA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EFoaA.
   * @public
   */

  goog.module('EFoaA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EFoaA.render';
  }
...
_metalSoy2.default.register(EFoaA, templates);
exports.EFoaA = EFoaA;
