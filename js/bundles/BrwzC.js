...
var _step_2Soy = __webpack_require__(351);
...
var BrwzC = function (_Component) {
  _inherits(BrwzC, _Component);

  function BrwzC() {
    _classCallCheck(this, BrwzC);

    return _possibleConstructorReturn(this, (BrwzC.__proto__ || Object.getPrototypeOf(BrwzC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BrwzC, _step_2Soy2.default);

exports.default = BrwzC;
...
exports.templates = exports.BrwzC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BrwzC.
   * @public
   */

  goog.module('BrwzC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BrwzC.render';
  }
...
_metalSoy2.default.register(BrwzC, templates);
exports.BrwzC = BrwzC;
