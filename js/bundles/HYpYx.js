...
var _reflectSoy = __webpack_require__(339);
...
var HYpYx = function (_Component) {
  _inherits(HYpYx, _Component);

  function HYpYx() {
    _classCallCheck(this, HYpYx);

    return _possibleConstructorReturn(this, (HYpYx.__proto__ || Object.getPrototypeOf(HYpYx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HYpYx, _reflectSoy2.default);

exports.default = HYpYx;
...
exports.templates = exports.HYpYx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HYpYx.
   * @public
   */

  goog.module('HYpYx.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1045 = function param1045() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1045 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HYpYx.render';
  }
...
_metalSoy2.default.register(HYpYx, templates);
exports.HYpYx = HYpYx;
