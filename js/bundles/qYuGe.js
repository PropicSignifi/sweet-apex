...
var qYuGe = function (_Component) {
  _inherits(qYuGe, _Component);

  function qYuGe() {
    _classCallCheck(this, qYuGe);

    return _possibleConstructorReturn(this, (qYuGe.__proto__ || Object.getPrototypeOf(qYuGe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qYuGe, _operatorSoy2.default);

exports.default = qYuGe;
...
exports.templates = exports.qYuGe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qYuGe.
   * @public
   */

  goog.module('qYuGe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qYuGe.render';
  }
...
_metalSoy2.default.register(qYuGe, templates);
exports.qYuGe = qYuGe;
