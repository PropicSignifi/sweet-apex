...
var cTgVc = function (_Component) {
  _inherits(cTgVc, _Component);

  function cTgVc() {
    _classCallCheck(this, cTgVc);

    return _possibleConstructorReturn(this, (cTgVc.__proto__ || Object.getPrototypeOf(cTgVc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cTgVc, _indexSoy2.default);

exports.default = cTgVc;
...
exports.templates = exports.cTgVc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cTgVc.
   * @public
   */

  goog.module('cTgVc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cTgVc.render';
  }
...
_metalSoy2.default.register(cTgVc, templates);
exports.cTgVc = cTgVc;
