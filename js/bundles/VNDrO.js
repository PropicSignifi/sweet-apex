...
var VNDrO = function (_Component) {
  _inherits(VNDrO, _Component);

  function VNDrO() {
    _classCallCheck(this, VNDrO);

    return _possibleConstructorReturn(this, (VNDrO.__proto__ || Object.getPrototypeOf(VNDrO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VNDrO, _testcaseSoy2.default);

exports.default = VNDrO;
...
exports.templates = exports.VNDrO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VNDrO.
   * @public
   */

  goog.module('VNDrO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VNDrO.render';
  }
...
_metalSoy2.default.register(VNDrO, templates);
exports.VNDrO = VNDrO;
