...
var BLxjc = function (_Component) {
  _inherits(BLxjc, _Component);

  function BLxjc() {
    _classCallCheck(this, BLxjc);

    return _possibleConstructorReturn(this, (BLxjc.__proto__ || Object.getPrototypeOf(BLxjc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BLxjc, _array_creationSoy2.default);

exports.default = BLxjc;
...
exports.templates = exports.BLxjc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BLxjc.
   * @public
   */

  goog.module('BLxjc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BLxjc.render';
  }
...
_metalSoy2.default.register(BLxjc, templates);
exports.BLxjc = BLxjc;
