...
var Bqhef = function (_Component) {
  _inherits(Bqhef, _Component);

  function Bqhef() {
    _classCallCheck(this, Bqhef);

    return _possibleConstructorReturn(this, (Bqhef.__proto__ || Object.getPrototypeOf(Bqhef)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Bqhef, _aspectSoy2.default);

exports.default = Bqhef;
...
exports.templates = exports.Bqhef = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Bqhef.
   * @public
   */

  goog.module('Bqhef.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Bqhef.render';
  }
...
_metalSoy2.default.register(Bqhef, templates);
exports.Bqhef = Bqhef;
