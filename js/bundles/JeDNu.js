...
var JeDNu = function (_Component) {
  _inherits(JeDNu, _Component);

  function JeDNu() {
    _classCallCheck(this, JeDNu);

    return _possibleConstructorReturn(this, (JeDNu.__proto__ || Object.getPrototypeOf(JeDNu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JeDNu, _annotationSoy2.default);

exports.default = JeDNu;
...
exports.templates = exports.JeDNu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JeDNu.
   * @public
   */

  goog.module('JeDNu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JeDNu.render';
  }
...
_metalSoy2.default.register(JeDNu, templates);
exports.JeDNu = JeDNu;
