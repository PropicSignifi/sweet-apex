...
var svPnI = function (_Component) {
  _inherits(svPnI, _Component);

  function svPnI() {
    _classCallCheck(this, svPnI);

    return _possibleConstructorReturn(this, (svPnI.__proto__ || Object.getPrototypeOf(svPnI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(svPnI, _annotationSoy2.default);

exports.default = svPnI;
...
exports.templates = exports.svPnI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace svPnI.
   * @public
   */

  goog.module('svPnI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'svPnI.render';
  }
...
_metalSoy2.default.register(svPnI, templates);
exports.svPnI = svPnI;
