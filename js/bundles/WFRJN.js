...
var WFRJN = function (_Component) {
  _inherits(WFRJN, _Component);

  function WFRJN() {
    _classCallCheck(this, WFRJN);

    return _possibleConstructorReturn(this, (WFRJN.__proto__ || Object.getPrototypeOf(WFRJN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WFRJN, _varSoy2.default);

exports.default = WFRJN;
...
exports.templates = exports.WFRJN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WFRJN.
   * @public
   */

  goog.module('WFRJN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WFRJN.render';
  }
...
_metalSoy2.default.register(WFRJN, templates);
exports.WFRJN = WFRJN;
