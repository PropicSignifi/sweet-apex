...
var RtqQa = function (_Component) {
  _inherits(RtqQa, _Component);

  function RtqQa() {
    _classCallCheck(this, RtqQa);

    return _possibleConstructorReturn(this, (RtqQa.__proto__ || Object.getPrototypeOf(RtqQa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RtqQa, _lambdaSoy2.default);

exports.default = RtqQa;
...
exports.templates = exports.RtqQa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RtqQa.
   * @public
   */

  goog.module('RtqQa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RtqQa.render';
  }
...
_metalSoy2.default.register(RtqQa, templates);
exports.RtqQa = RtqQa;
