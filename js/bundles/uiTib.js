...
var uiTib = function (_Component) {
  _inherits(uiTib, _Component);

  function uiTib() {
    _classCallCheck(this, uiTib);

    return _possibleConstructorReturn(this, (uiTib.__proto__ || Object.getPrototypeOf(uiTib)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uiTib, _default_valueSoy2.default);

exports.default = uiTib;
...
exports.templates = exports.uiTib = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uiTib.
   * @public
   */

  goog.module('uiTib.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uiTib.render';
  }
...
_metalSoy2.default.register(uiTib, templates);
exports.uiTib = uiTib;
