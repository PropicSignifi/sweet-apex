...
var LSFLU = function (_Component) {
  _inherits(LSFLU, _Component);

  function LSFLU() {
    _classCallCheck(this, LSFLU);

    return _possibleConstructorReturn(this, (LSFLU.__proto__ || Object.getPrototypeOf(LSFLU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LSFLU, _injectSoy2.default);

exports.default = LSFLU;
...
exports.templates = exports.LSFLU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LSFLU.
   * @public
   */

  goog.module('LSFLU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LSFLU.render';
  }
...
_metalSoy2.default.register(LSFLU, templates);
exports.LSFLU = LSFLU;
