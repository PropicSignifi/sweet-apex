...
var NoOCY = function (_Component) {
  _inherits(NoOCY, _Component);

  function NoOCY() {
    _classCallCheck(this, NoOCY);

    return _possibleConstructorReturn(this, (NoOCY.__proto__ || Object.getPrototypeOf(NoOCY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NoOCY, _actionSoy2.default);

exports.default = NoOCY;
...
exports.templates = exports.NoOCY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NoOCY.
   * @public
   */

  goog.module('NoOCY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NoOCY.render';
  }
...
_metalSoy2.default.register(NoOCY, templates);
exports.NoOCY = NoOCY;
