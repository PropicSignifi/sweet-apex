...
var ZjekS = function (_Component) {
  _inherits(ZjekS, _Component);

  function ZjekS() {
    _classCallCheck(this, ZjekS);

    return _possibleConstructorReturn(this, (ZjekS.__proto__ || Object.getPrototypeOf(ZjekS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZjekS, _operatorSoy2.default);

exports.default = ZjekS;
...
exports.templates = exports.ZjekS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZjekS.
   * @public
   */

  goog.module('ZjekS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZjekS.render';
  }
...
_metalSoy2.default.register(ZjekS, templates);
exports.ZjekS = ZjekS;
