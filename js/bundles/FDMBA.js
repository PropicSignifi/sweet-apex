...
var FDMBA = function (_Component) {
  _inherits(FDMBA, _Component);

  function FDMBA() {
    _classCallCheck(this, FDMBA);

    return _possibleConstructorReturn(this, (FDMBA.__proto__ || Object.getPrototypeOf(FDMBA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FDMBA, _aspectSoy2.default);

exports.default = FDMBA;
...
exports.templates = exports.FDMBA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FDMBA.
   * @public
   */

  goog.module('FDMBA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FDMBA.render';
  }
...
_metalSoy2.default.register(FDMBA, templates);
exports.FDMBA = FDMBA;
