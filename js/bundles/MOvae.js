...
var MOvae = function (_Component) {
  _inherits(MOvae, _Component);

  function MOvae() {
    _classCallCheck(this, MOvae);

    return _possibleConstructorReturn(this, (MOvae.__proto__ || Object.getPrototypeOf(MOvae)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MOvae, _enumSoy2.default);

exports.default = MOvae;
...
exports.templates = exports.MOvae = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MOvae.
   * @public
   */

  goog.module('MOvae.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MOvae.render';
  }
...
_metalSoy2.default.register(MOvae, templates);
exports.MOvae = MOvae;
