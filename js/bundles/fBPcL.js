...
var fBPcL = function (_Component) {
  _inherits(fBPcL, _Component);

  function fBPcL() {
    _classCallCheck(this, fBPcL);

    return _possibleConstructorReturn(this, (fBPcL.__proto__ || Object.getPrototypeOf(fBPcL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fBPcL, _featureSoy2.default);

exports.default = fBPcL;
...
exports.templates = exports.fBPcL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fBPcL.
   * @public
   */

  goog.module('fBPcL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fBPcL.render';
  }
...
_metalSoy2.default.register(fBPcL, templates);
exports.fBPcL = fBPcL;
