...
var PyKhw = function (_Component) {
  _inherits(PyKhw, _Component);

  function PyKhw() {
    _classCallCheck(this, PyKhw);

    return _possibleConstructorReturn(this, (PyKhw.__proto__ || Object.getPrototypeOf(PyKhw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PyKhw, _identitySoy2.default);

exports.default = PyKhw;
...
exports.templates = exports.PyKhw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PyKhw.
   * @public
   */

  goog.module('PyKhw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PyKhw.render';
  }
...
_metalSoy2.default.register(PyKhw, templates);
exports.PyKhw = PyKhw;
