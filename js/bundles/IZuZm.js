...
var IZuZm = function (_Component) {
  _inherits(IZuZm, _Component);

  function IZuZm() {
    _classCallCheck(this, IZuZm);

    return _possibleConstructorReturn(this, (IZuZm.__proto__ || Object.getPrototypeOf(IZuZm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IZuZm, _featureSoy2.default);

exports.default = IZuZm;
...
exports.templates = exports.IZuZm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IZuZm.
   * @public
   */

  goog.module('IZuZm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IZuZm.render';
  }
...
_metalSoy2.default.register(IZuZm, templates);
exports.IZuZm = IZuZm;
