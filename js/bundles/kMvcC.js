...
var kMvcC = function (_Component) {
  _inherits(kMvcC, _Component);

  function kMvcC() {
    _classCallCheck(this, kMvcC);

    return _possibleConstructorReturn(this, (kMvcC.__proto__ || Object.getPrototypeOf(kMvcC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kMvcC, _step_1Soy2.default);

exports.default = kMvcC;
...
exports.templates = exports.kMvcC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kMvcC.
   * @public
   */

  goog.module('kMvcC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kMvcC.render';
  }
...
_metalSoy2.default.register(kMvcC, templates);
exports.kMvcC = kMvcC;
