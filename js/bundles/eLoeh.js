...
var eLoeh = function (_Component) {
  _inherits(eLoeh, _Component);

  function eLoeh() {
    _classCallCheck(this, eLoeh);

    return _possibleConstructorReturn(this, (eLoeh.__proto__ || Object.getPrototypeOf(eLoeh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eLoeh, _indexSoy2.default);

exports.default = eLoeh;
...
exports.templates = exports.eLoeh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eLoeh.
   * @public
   */

  goog.module('eLoeh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eLoeh.render';
  }
...
_metalSoy2.default.register(eLoeh, templates);
exports.eLoeh = eLoeh;
