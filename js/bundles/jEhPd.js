...
var jEhPd = function (_Component) {
  _inherits(jEhPd, _Component);

  function jEhPd() {
    _classCallCheck(this, jEhPd);

    return _possibleConstructorReturn(this, (jEhPd.__proto__ || Object.getPrototypeOf(jEhPd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jEhPd, _aspectSoy2.default);

exports.default = jEhPd;
...
exports.templates = exports.jEhPd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jEhPd.
   * @public
   */

  goog.module('jEhPd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jEhPd.render';
  }
...
_metalSoy2.default.register(jEhPd, templates);
exports.jEhPd = jEhPd;
