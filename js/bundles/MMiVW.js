...
var _enumSoy = __webpack_require__(309);
...
var MMiVW = function (_Component) {
  _inherits(MMiVW, _Component);

  function MMiVW() {
    _classCallCheck(this, MMiVW);

    return _possibleConstructorReturn(this, (MMiVW.__proto__ || Object.getPrototypeOf(MMiVW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MMiVW, _enumSoy2.default);

exports.default = MMiVW;
...
exports.templates = exports.MMiVW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MMiVW.
   * @public
   */

  goog.module('MMiVW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MMiVW.render';
  }
...
_metalSoy2.default.register(MMiVW, templates);
exports.MMiVW = MMiVW;
