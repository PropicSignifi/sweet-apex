...
var qKEuo = function (_Component) {
  _inherits(qKEuo, _Component);

  function qKEuo() {
    _classCallCheck(this, qKEuo);

    return _possibleConstructorReturn(this, (qKEuo.__proto__ || Object.getPrototypeOf(qKEuo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qKEuo, _templateSoy2.default);

exports.default = qKEuo;
...
exports.templates = exports.qKEuo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qKEuo.
   * @public
   */

  goog.module('qKEuo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qKEuo.render';
  }
...
_metalSoy2.default.register(qKEuo, templates);
exports.qKEuo = qKEuo;
