...
var rzgeg = function (_Component) {
  _inherits(rzgeg, _Component);

  function rzgeg() {
    _classCallCheck(this, rzgeg);

    return _possibleConstructorReturn(this, (rzgeg.__proto__ || Object.getPrototypeOf(rzgeg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rzgeg, _scriptSoy2.default);

exports.default = rzgeg;
...
exports.templates = exports.rzgeg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rzgeg.
   * @public
   */

  goog.module('rzgeg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rzgeg.render';
  }
...
_metalSoy2.default.register(rzgeg, templates);
exports.rzgeg = rzgeg;
