...
var IDCiw = function (_Component) {
  _inherits(IDCiw, _Component);

  function IDCiw() {
    _classCallCheck(this, IDCiw);

    return _possibleConstructorReturn(this, (IDCiw.__proto__ || Object.getPrototypeOf(IDCiw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IDCiw, _functionSoy2.default);

exports.default = IDCiw;
...
exports.templates = exports.IDCiw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IDCiw.
   * @public
   */

  goog.module('IDCiw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IDCiw.render';
  }
...
_metalSoy2.default.register(IDCiw, templates);
exports.IDCiw = IDCiw;
