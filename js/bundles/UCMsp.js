...
var UCMsp = function (_Component) {
  _inherits(UCMsp, _Component);

  function UCMsp() {
    _classCallCheck(this, UCMsp);

    return _possibleConstructorReturn(this, (UCMsp.__proto__ || Object.getPrototypeOf(UCMsp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UCMsp, _templateSoy2.default);

exports.default = UCMsp;
...
exports.templates = exports.UCMsp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UCMsp.
   * @public
   */

  goog.module('UCMsp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UCMsp.render';
  }
...
_metalSoy2.default.register(UCMsp, templates);
exports.UCMsp = UCMsp;
