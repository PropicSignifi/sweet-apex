...
var BGgsd = function (_Component) {
  _inherits(BGgsd, _Component);

  function BGgsd() {
    _classCallCheck(this, BGgsd);

    return _possibleConstructorReturn(this, (BGgsd.__proto__ || Object.getPrototypeOf(BGgsd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BGgsd, _identitySoy2.default);

exports.default = BGgsd;
...
exports.templates = exports.BGgsd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BGgsd.
   * @public
   */

  goog.module('BGgsd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BGgsd.render';
  }
...
_metalSoy2.default.register(BGgsd, templates);
exports.BGgsd = BGgsd;
