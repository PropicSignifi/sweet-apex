...
var MZmOb = function (_Component) {
  _inherits(MZmOb, _Component);

  function MZmOb() {
    _classCallCheck(this, MZmOb);

    return _possibleConstructorReturn(this, (MZmOb.__proto__ || Object.getPrototypeOf(MZmOb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MZmOb, _transpilationSoy2.default);

exports.default = MZmOb;
...
exports.templates = exports.MZmOb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MZmOb.
   * @public
   */

  goog.module('MZmOb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MZmOb.render';
  }
...
_metalSoy2.default.register(MZmOb, templates);
exports.MZmOb = MZmOb;
