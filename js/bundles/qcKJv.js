...
var qcKJv = function (_Component) {
  _inherits(qcKJv, _Component);

  function qcKJv() {
    _classCallCheck(this, qcKJv);

    return _possibleConstructorReturn(this, (qcKJv.__proto__ || Object.getPrototypeOf(qcKJv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qcKJv, _functionSoy2.default);

exports.default = qcKJv;
...
exports.templates = exports.qcKJv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qcKJv.
   * @public
   */

  goog.module('qcKJv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qcKJv.render';
  }
...
_metalSoy2.default.register(qcKJv, templates);
exports.qcKJv = qcKJv;
