...
var LzMrI = function (_Component) {
  _inherits(LzMrI, _Component);

  function LzMrI() {
    _classCallCheck(this, LzMrI);

    return _possibleConstructorReturn(this, (LzMrI.__proto__ || Object.getPrototypeOf(LzMrI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LzMrI, _indexSoy2.default);

exports.default = LzMrI;
...
exports.templates = exports.LzMrI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LzMrI.
   * @public
   */

  goog.module('LzMrI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LzMrI.render';
  }
...
_metalSoy2.default.register(LzMrI, templates);
exports.LzMrI = LzMrI;
