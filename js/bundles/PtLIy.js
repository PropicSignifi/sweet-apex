...
var PtLIy = function (_Component) {
  _inherits(PtLIy, _Component);

  function PtLIy() {
    _classCallCheck(this, PtLIy);

    return _possibleConstructorReturn(this, (PtLIy.__proto__ || Object.getPrototypeOf(PtLIy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PtLIy, _modSoy2.default);

exports.default = PtLIy;
...
exports.templates = exports.PtLIy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PtLIy.
   * @public
   */

  goog.module('PtLIy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PtLIy.render';
  }
...
_metalSoy2.default.register(PtLIy, templates);
exports.PtLIy = PtLIy;
