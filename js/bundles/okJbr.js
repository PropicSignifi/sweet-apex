...
var okJbr = function (_Component) {
  _inherits(okJbr, _Component);

  function okJbr() {
    _classCallCheck(this, okJbr);

    return _possibleConstructorReturn(this, (okJbr.__proto__ || Object.getPrototypeOf(okJbr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(okJbr, _indexSoy2.default);

exports.default = okJbr;
...
exports.templates = exports.okJbr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace okJbr.
   * @public
   */

  goog.module('okJbr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'okJbr.render';
  }
...
_metalSoy2.default.register(okJbr, templates);
exports.okJbr = okJbr;
