...
var tUHzc = function (_Component) {
  _inherits(tUHzc, _Component);

  function tUHzc() {
    _classCallCheck(this, tUHzc);

    return _possibleConstructorReturn(this, (tUHzc.__proto__ || Object.getPrototypeOf(tUHzc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tUHzc, _default_valueSoy2.default);

exports.default = tUHzc;
...
exports.templates = exports.tUHzc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tUHzc.
   * @public
   */

  goog.module('tUHzc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tUHzc.render';
  }
...
_metalSoy2.default.register(tUHzc, templates);
exports.tUHzc = tUHzc;
