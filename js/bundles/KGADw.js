...
var KGADw = function (_Component) {
  _inherits(KGADw, _Component);

  function KGADw() {
    _classCallCheck(this, KGADw);

    return _possibleConstructorReturn(this, (KGADw.__proto__ || Object.getPrototypeOf(KGADw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KGADw, _destructureSoy2.default);

exports.default = KGADw;
...
exports.templates = exports.KGADw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KGADw.
   * @public
   */

  goog.module('KGADw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KGADw.render';
  }
...
_metalSoy2.default.register(KGADw, templates);
exports.KGADw = KGADw;
