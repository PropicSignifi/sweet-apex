...
var aaFdK = function (_Component) {
  _inherits(aaFdK, _Component);

  function aaFdK() {
    _classCallCheck(this, aaFdK);

    return _possibleConstructorReturn(this, (aaFdK.__proto__ || Object.getPrototypeOf(aaFdK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aaFdK, _grammarSoy2.default);

exports.default = aaFdK;
...
exports.templates = exports.aaFdK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aaFdK.
   * @public
   */

  goog.module('aaFdK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aaFdK.render';
  }
...
_metalSoy2.default.register(aaFdK, templates);
exports.aaFdK = aaFdK;
