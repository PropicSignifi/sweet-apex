...
var ucFKy = function (_Component) {
  _inherits(ucFKy, _Component);

  function ucFKy() {
    _classCallCheck(this, ucFKy);

    return _possibleConstructorReturn(this, (ucFKy.__proto__ || Object.getPrototypeOf(ucFKy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ucFKy, _identitySoy2.default);

exports.default = ucFKy;
...
exports.templates = exports.ucFKy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ucFKy.
   * @public
   */

  goog.module('ucFKy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ucFKy.render';
  }
...
_metalSoy2.default.register(ucFKy, templates);
exports.ucFKy = ucFKy;
