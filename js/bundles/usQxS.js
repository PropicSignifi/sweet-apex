...
var usQxS = function (_Component) {
  _inherits(usQxS, _Component);

  function usQxS() {
    _classCallCheck(this, usQxS);

    return _possibleConstructorReturn(this, (usQxS.__proto__ || Object.getPrototypeOf(usQxS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(usQxS, _indexSoy2.default);

exports.default = usQxS;
...
exports.templates = exports.usQxS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace usQxS.
   * @public
   */

  goog.module('usQxS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'usQxS.render';
  }
...
_metalSoy2.default.register(usQxS, templates);
exports.usQxS = usQxS;
