...
var SuGja = function (_Component) {
  _inherits(SuGja, _Component);

  function SuGja() {
    _classCallCheck(this, SuGja);

    return _possibleConstructorReturn(this, (SuGja.__proto__ || Object.getPrototypeOf(SuGja)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SuGja, _indexSoy2.default);

exports.default = SuGja;
...
exports.templates = exports.SuGja = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SuGja.
   * @public
   */

  goog.module('SuGja.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SuGja.render';
  }
...
_metalSoy2.default.register(SuGja, templates);
exports.SuGja = SuGja;
