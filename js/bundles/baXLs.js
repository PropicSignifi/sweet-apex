...
var baXLs = function (_Component) {
  _inherits(baXLs, _Component);

  function baXLs() {
    _classCallCheck(this, baXLs);

    return _possibleConstructorReturn(this, (baXLs.__proto__ || Object.getPrototypeOf(baXLs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(baXLs, _castSoy2.default);

exports.default = baXLs;
...
exports.templates = exports.baXLs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace baXLs.
   * @public
   */

  goog.module('baXLs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'baXLs.render';
  }
...
_metalSoy2.default.register(baXLs, templates);
exports.baXLs = baXLs;
