...
var tyfsk = function (_Component) {
  _inherits(tyfsk, _Component);

  function tyfsk() {
    _classCallCheck(this, tyfsk);

    return _possibleConstructorReturn(this, (tyfsk.__proto__ || Object.getPrototypeOf(tyfsk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tyfsk, _actionSoy2.default);

exports.default = tyfsk;
...
exports.templates = exports.tyfsk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tyfsk.
   * @public
   */

  goog.module('tyfsk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tyfsk.render';
  }
...
_metalSoy2.default.register(tyfsk, templates);
exports.tyfsk = tyfsk;
