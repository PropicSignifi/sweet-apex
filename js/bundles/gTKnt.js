...
var gTKnt = function (_Component) {
  _inherits(gTKnt, _Component);

  function gTKnt() {
    _classCallCheck(this, gTKnt);

    return _possibleConstructorReturn(this, (gTKnt.__proto__ || Object.getPrototypeOf(gTKnt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gTKnt, _array_creationSoy2.default);

exports.default = gTKnt;
...
exports.templates = exports.gTKnt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gTKnt.
   * @public
   */

  goog.module('gTKnt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gTKnt.render';
  }
...
_metalSoy2.default.register(gTKnt, templates);
exports.gTKnt = gTKnt;
