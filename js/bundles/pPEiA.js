...
var pPEiA = function (_Component) {
  _inherits(pPEiA, _Component);

  function pPEiA() {
    _classCallCheck(this, pPEiA);

    return _possibleConstructorReturn(this, (pPEiA.__proto__ || Object.getPrototypeOf(pPEiA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pPEiA, _configSoy2.default);

exports.default = pPEiA;
...
exports.templates = exports.pPEiA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pPEiA.
   * @public
   */

  goog.module('pPEiA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pPEiA.render';
  }
...
_metalSoy2.default.register(pPEiA, templates);
exports.pPEiA = pPEiA;
