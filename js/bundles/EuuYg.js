...
var EuuYg = function (_Component) {
  _inherits(EuuYg, _Component);

  function EuuYg() {
    _classCallCheck(this, EuuYg);

    return _possibleConstructorReturn(this, (EuuYg.__proto__ || Object.getPrototypeOf(EuuYg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EuuYg, _array_creationSoy2.default);

exports.default = EuuYg;
...
exports.templates = exports.EuuYg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EuuYg.
   * @public
   */

  goog.module('EuuYg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EuuYg.render';
  }
...
_metalSoy2.default.register(EuuYg, templates);
exports.EuuYg = EuuYg;
