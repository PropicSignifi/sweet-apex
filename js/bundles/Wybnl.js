...
var Wybnl = function (_Component) {
  _inherits(Wybnl, _Component);

  function Wybnl() {
    _classCallCheck(this, Wybnl);

    return _possibleConstructorReturn(this, (Wybnl.__proto__ || Object.getPrototypeOf(Wybnl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Wybnl, _actionSoy2.default);

exports.default = Wybnl;
...
exports.templates = exports.Wybnl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Wybnl.
   * @public
   */

  goog.module('Wybnl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Wybnl.render';
  }
...
_metalSoy2.default.register(Wybnl, templates);
exports.Wybnl = Wybnl;
