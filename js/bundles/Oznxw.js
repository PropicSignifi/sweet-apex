...
var Oznxw = function (_Component) {
  _inherits(Oznxw, _Component);

  function Oznxw() {
    _classCallCheck(this, Oznxw);

    return _possibleConstructorReturn(this, (Oznxw.__proto__ || Object.getPrototypeOf(Oznxw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Oznxw, _functionSoy2.default);

exports.default = Oznxw;
...
exports.templates = exports.Oznxw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Oznxw.
   * @public
   */

  goog.module('Oznxw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Oznxw.render';
  }
...
_metalSoy2.default.register(Oznxw, templates);
exports.Oznxw = Oznxw;
