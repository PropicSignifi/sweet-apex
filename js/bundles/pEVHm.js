...
var pEVHm = function (_Component) {
  _inherits(pEVHm, _Component);

  function pEVHm() {
    _classCallCheck(this, pEVHm);

    return _possibleConstructorReturn(this, (pEVHm.__proto__ || Object.getPrototypeOf(pEVHm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pEVHm, _injectSoy2.default);

exports.default = pEVHm;
...
exports.templates = exports.pEVHm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pEVHm.
   * @public
   */

  goog.module('pEVHm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pEVHm.render';
  }
...
_metalSoy2.default.register(pEVHm, templates);
exports.pEVHm = pEVHm;
