...
var RvJvb = function (_Component) {
  _inherits(RvJvb, _Component);

  function RvJvb() {
    _classCallCheck(this, RvJvb);

    return _possibleConstructorReturn(this, (RvJvb.__proto__ || Object.getPrototypeOf(RvJvb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RvJvb, _step_4Soy2.default);

exports.default = RvJvb;
...
exports.templates = exports.RvJvb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RvJvb.
   * @public
   */

  goog.module('RvJvb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RvJvb.render';
  }
...
_metalSoy2.default.register(RvJvb, templates);
exports.RvJvb = RvJvb;
