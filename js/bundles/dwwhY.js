...
var dwwhY = function (_Component) {
  _inherits(dwwhY, _Component);

  function dwwhY() {
    _classCallCheck(this, dwwhY);

    return _possibleConstructorReturn(this, (dwwhY.__proto__ || Object.getPrototypeOf(dwwhY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dwwhY, _apexdocSoy2.default);

exports.default = dwwhY;
...
exports.templates = exports.dwwhY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dwwhY.
   * @public
   */

  goog.module('dwwhY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dwwhY.render';
  }
...
_metalSoy2.default.register(dwwhY, templates);
exports.dwwhY = dwwhY;
