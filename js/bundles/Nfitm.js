...
var Nfitm = function (_Component) {
  _inherits(Nfitm, _Component);

  function Nfitm() {
    _classCallCheck(this, Nfitm);

    return _possibleConstructorReturn(this, (Nfitm.__proto__ || Object.getPrototypeOf(Nfitm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Nfitm, _lambdaSoy2.default);

exports.default = Nfitm;
...
exports.templates = exports.Nfitm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Nfitm.
   * @public
   */

  goog.module('Nfitm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Nfitm.render';
  }
...
_metalSoy2.default.register(Nfitm, templates);
exports.Nfitm = Nfitm;
