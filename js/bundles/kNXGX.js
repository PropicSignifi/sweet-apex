...
var kNXGX = function (_Component) {
  _inherits(kNXGX, _Component);

  function kNXGX() {
    _classCallCheck(this, kNXGX);

    return _possibleConstructorReturn(this, (kNXGX.__proto__ || Object.getPrototypeOf(kNXGX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kNXGX, _commandSoy2.default);

exports.default = kNXGX;
...
exports.templates = exports.kNXGX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kNXGX.
   * @public
   */

  goog.module('kNXGX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kNXGX.render';
  }
...
_metalSoy2.default.register(kNXGX, templates);
exports.kNXGX = kNXGX;
