...
var _indexSoy = __webpack_require__(319);
...
var HoPGh = function (_Component) {
  _inherits(HoPGh, _Component);

  function HoPGh() {
    _classCallCheck(this, HoPGh);

    return _possibleConstructorReturn(this, (HoPGh.__proto__ || Object.getPrototypeOf(HoPGh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HoPGh, _indexSoy2.default);

exports.default = HoPGh;
...
exports.templates = exports.HoPGh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HoPGh.
   * @public
   */

  goog.module('HoPGh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HoPGh.render';
  }
...
_metalSoy2.default.register(HoPGh, templates);
exports.HoPGh = HoPGh;
