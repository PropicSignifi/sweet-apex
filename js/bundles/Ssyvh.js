...
var _operatorSoy = __webpack_require__(329);
...
var Ssyvh = function (_Component) {
  _inherits(Ssyvh, _Component);

  function Ssyvh() {
    _classCallCheck(this, Ssyvh);

    return _possibleConstructorReturn(this, (Ssyvh.__proto__ || Object.getPrototypeOf(Ssyvh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Ssyvh, _operatorSoy2.default);

exports.default = Ssyvh;
...
exports.templates = exports.Ssyvh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Ssyvh.
   * @public
   */

  goog.module('Ssyvh.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param940 = function param940() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param940 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Ssyvh.render';
  }
...
_metalSoy2.default.register(Ssyvh, templates);
exports.Ssyvh = Ssyvh;
