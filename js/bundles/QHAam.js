...
var QHAam = function (_Component) {
  _inherits(QHAam, _Component);

  function QHAam() {
    _classCallCheck(this, QHAam);

    return _possibleConstructorReturn(this, (QHAam.__proto__ || Object.getPrototypeOf(QHAam)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QHAam, _castSoy2.default);

exports.default = QHAam;
...
exports.templates = exports.QHAam = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QHAam.
   * @public
   */

  goog.module('QHAam.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QHAam.render';
  }
...
_metalSoy2.default.register(QHAam, templates);
exports.QHAam = QHAam;
