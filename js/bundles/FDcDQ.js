...
var FDcDQ = function (_Component) {
  _inherits(FDcDQ, _Component);

  function FDcDQ() {
    _classCallCheck(this, FDcDQ);

    return _possibleConstructorReturn(this, (FDcDQ.__proto__ || Object.getPrototypeOf(FDcDQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FDcDQ, _commandSoy2.default);

exports.default = FDcDQ;
...
exports.templates = exports.FDcDQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FDcDQ.
   * @public
   */

  goog.module('FDcDQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FDcDQ.render';
  }
...
_metalSoy2.default.register(FDcDQ, templates);
exports.FDcDQ = FDcDQ;
