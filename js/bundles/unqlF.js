...
var unqlF = function (_Component) {
  _inherits(unqlF, _Component);

  function unqlF() {
    _classCallCheck(this, unqlF);

    return _possibleConstructorReturn(this, (unqlF.__proto__ || Object.getPrototypeOf(unqlF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(unqlF, _reflectSoy2.default);

exports.default = unqlF;
...
exports.templates = exports.unqlF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace unqlF.
   * @public
   */

  goog.module('unqlF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'unqlF.render';
  }
...
_metalSoy2.default.register(unqlF, templates);
exports.unqlF = unqlF;
