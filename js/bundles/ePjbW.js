...
var ePjbW = function (_Component) {
  _inherits(ePjbW, _Component);

  function ePjbW() {
    _classCallCheck(this, ePjbW);

    return _possibleConstructorReturn(this, (ePjbW.__proto__ || Object.getPrototypeOf(ePjbW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ePjbW, _map_accessSoy2.default);

exports.default = ePjbW;
...
exports.templates = exports.ePjbW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ePjbW.
   * @public
   */

  goog.module('ePjbW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ePjbW.render';
  }
...
_metalSoy2.default.register(ePjbW, templates);
exports.ePjbW = ePjbW;
