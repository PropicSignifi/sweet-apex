...
var _functionSoy = __webpack_require__(313);
...
var vWTsn = function (_Component) {
  _inherits(vWTsn, _Component);

  function vWTsn() {
    _classCallCheck(this, vWTsn);

    return _possibleConstructorReturn(this, (vWTsn.__proto__ || Object.getPrototypeOf(vWTsn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vWTsn, _functionSoy2.default);

exports.default = vWTsn;
...
exports.templates = exports.vWTsn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vWTsn.
   * @public
   */

  goog.module('vWTsn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vWTsn.render';
  }
...
_metalSoy2.default.register(vWTsn, templates);
exports.vWTsn = vWTsn;
