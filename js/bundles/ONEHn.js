...
var ONEHn = function (_Component) {
  _inherits(ONEHn, _Component);

  function ONEHn() {
    _classCallCheck(this, ONEHn);

    return _possibleConstructorReturn(this, (ONEHn.__proto__ || Object.getPrototypeOf(ONEHn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ONEHn, _destructureSoy2.default);

exports.default = ONEHn;
...
exports.templates = exports.ONEHn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ONEHn.
   * @public
   */

  goog.module('ONEHn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ONEHn.render';
  }
...
_metalSoy2.default.register(ONEHn, templates);
exports.ONEHn = ONEHn;
