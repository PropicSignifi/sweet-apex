...
var sCwZN = function (_Component) {
  _inherits(sCwZN, _Component);

  function sCwZN() {
    _classCallCheck(this, sCwZN);

    return _possibleConstructorReturn(this, (sCwZN.__proto__ || Object.getPrototypeOf(sCwZN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sCwZN, _actionSoy2.default);

exports.default = sCwZN;
...
exports.templates = exports.sCwZN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sCwZN.
   * @public
   */

  goog.module('sCwZN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sCwZN.render';
  }
...
_metalSoy2.default.register(sCwZN, templates);
exports.sCwZN = sCwZN;
