...
var _rethrowSoy = __webpack_require__(333);
...
var hLSCI = function (_Component) {
  _inherits(hLSCI, _Component);

  function hLSCI() {
    _classCallCheck(this, hLSCI);

    return _possibleConstructorReturn(this, (hLSCI.__proto__ || Object.getPrototypeOf(hLSCI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hLSCI, _rethrowSoy2.default);

exports.default = hLSCI;
...
exports.templates = exports.hLSCI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hLSCI.
   * @public
   */

  goog.module('hLSCI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hLSCI.render';
  }
...
_metalSoy2.default.register(hLSCI, templates);
exports.hLSCI = hLSCI;
