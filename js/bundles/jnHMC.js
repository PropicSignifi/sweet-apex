...
var jnHMC = function (_Component) {
  _inherits(jnHMC, _Component);

  function jnHMC() {
    _classCallCheck(this, jnHMC);

    return _possibleConstructorReturn(this, (jnHMC.__proto__ || Object.getPrototypeOf(jnHMC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jnHMC, _modSoy2.default);

exports.default = jnHMC;
...
exports.templates = exports.jnHMC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jnHMC.
   * @public
   */

  goog.module('jnHMC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jnHMC.render';
  }
...
_metalSoy2.default.register(jnHMC, templates);
exports.jnHMC = jnHMC;
