...
var yPqif = function (_Component) {
  _inherits(yPqif, _Component);

  function yPqif() {
    _classCallCheck(this, yPqif);

    return _possibleConstructorReturn(this, (yPqif.__proto__ || Object.getPrototypeOf(yPqif)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yPqif, _indexSoy2.default);

exports.default = yPqif;
...
exports.templates = exports.yPqif = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yPqif.
   * @public
   */

  goog.module('yPqif.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yPqif.render';
  }
...
_metalSoy2.default.register(yPqif, templates);
exports.yPqif = yPqif;
