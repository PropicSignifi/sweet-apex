...
var iRiXV = function (_Component) {
  _inherits(iRiXV, _Component);

  function iRiXV() {
    _classCallCheck(this, iRiXV);

    return _possibleConstructorReturn(this, (iRiXV.__proto__ || Object.getPrototypeOf(iRiXV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iRiXV, _lambdaSoy2.default);

exports.default = iRiXV;
...
exports.templates = exports.iRiXV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iRiXV.
   * @public
   */

  goog.module('iRiXV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iRiXV.render';
  }
...
_metalSoy2.default.register(iRiXV, templates);
exports.iRiXV = iRiXV;
