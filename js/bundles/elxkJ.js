...
var elxkJ = function (_Component) {
  _inherits(elxkJ, _Component);

  function elxkJ() {
    _classCallCheck(this, elxkJ);

    return _possibleConstructorReturn(this, (elxkJ.__proto__ || Object.getPrototypeOf(elxkJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(elxkJ, _scriptSoy2.default);

exports.default = elxkJ;
...
exports.templates = exports.elxkJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace elxkJ.
   * @public
   */

  goog.module('elxkJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'elxkJ.render';
  }
...
_metalSoy2.default.register(elxkJ, templates);
exports.elxkJ = elxkJ;
