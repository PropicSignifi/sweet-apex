...
var hKqHD = function (_Component) {
  _inherits(hKqHD, _Component);

  function hKqHD() {
    _classCallCheck(this, hKqHD);

    return _possibleConstructorReturn(this, (hKqHD.__proto__ || Object.getPrototypeOf(hKqHD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hKqHD, _testcaseSoy2.default);

exports.default = hKqHD;
...
exports.templates = exports.hKqHD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hKqHD.
   * @public
   */

  goog.module('hKqHD.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param432 = function param432() {
      ...
      ie_open('h2');
      itext('Run Integration Test');
      ie_close('h2');
      ie_open('p');
      itext('Integration test cases are listed under ');
      ie_open('code');
      itext('integration');
      ie_close('code');
      itext(' directory.');
      ie_close('p');
      ie_open('p');
      itext('Run the below code to start the integration test.');
      ie_close('p');
      $templateAlias2({ code: './run_integration_test.sh', mode: 'bash' }, null, opt_ijData);
      ie_close('article');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hKqHD.render';
  }
...
_metalSoy2.default.register(hKqHD, templates);
exports.hKqHD = hKqHD;
