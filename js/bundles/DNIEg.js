...
var DNIEg = function (_Component) {
  _inherits(DNIEg, _Component);

  function DNIEg() {
    _classCallCheck(this, DNIEg);

    return _possibleConstructorReturn(this, (DNIEg.__proto__ || Object.getPrototypeOf(DNIEg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DNIEg, _default_valueSoy2.default);

exports.default = DNIEg;
...
exports.templates = exports.DNIEg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DNIEg.
   * @public
   */

  goog.module('DNIEg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DNIEg.render';
  }
...
_metalSoy2.default.register(DNIEg, templates);
exports.DNIEg = DNIEg;
