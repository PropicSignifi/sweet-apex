...
var OPQYe = function (_Component) {
  _inherits(OPQYe, _Component);

  function OPQYe() {
    _classCallCheck(this, OPQYe);

    return _possibleConstructorReturn(this, (OPQYe.__proto__ || Object.getPrototypeOf(OPQYe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OPQYe, _fileSoy2.default);

exports.default = OPQYe;
...
exports.templates = exports.OPQYe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OPQYe.
   * @public
   */

  goog.module('OPQYe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OPQYe.render';
  }
...
_metalSoy2.default.register(OPQYe, templates);
exports.OPQYe = OPQYe;
