...
var sbtDU = function (_Component) {
  _inherits(sbtDU, _Component);

  function sbtDU() {
    _classCallCheck(this, sbtDU);

    return _possibleConstructorReturn(this, (sbtDU.__proto__ || Object.getPrototypeOf(sbtDU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sbtDU, _functionSoy2.default);

exports.default = sbtDU;
...
exports.templates = exports.sbtDU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sbtDU.
   * @public
   */

  goog.module('sbtDU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sbtDU.render';
  }
...
_metalSoy2.default.register(sbtDU, templates);
exports.sbtDU = sbtDU;
