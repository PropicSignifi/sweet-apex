...
var zwvhC = function (_Component) {
  _inherits(zwvhC, _Component);

  function zwvhC() {
    _classCallCheck(this, zwvhC);

    return _possibleConstructorReturn(this, (zwvhC.__proto__ || Object.getPrototypeOf(zwvhC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zwvhC, _injectSoy2.default);

exports.default = zwvhC;
...
exports.templates = exports.zwvhC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zwvhC.
   * @public
   */

  goog.module('zwvhC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zwvhC.render';
  }
...
_metalSoy2.default.register(zwvhC, templates);
exports.zwvhC = zwvhC;
