...
var EGVRg = function (_Component) {
  _inherits(EGVRg, _Component);

  function EGVRg() {
    _classCallCheck(this, EGVRg);

    return _possibleConstructorReturn(this, (EGVRg.__proto__ || Object.getPrototypeOf(EGVRg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EGVRg, _lambdaSoy2.default);

exports.default = EGVRg;
...
exports.templates = exports.EGVRg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EGVRg.
   * @public
   */

  goog.module('EGVRg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EGVRg.render';
  }
...
_metalSoy2.default.register(EGVRg, templates);
exports.EGVRg = EGVRg;
