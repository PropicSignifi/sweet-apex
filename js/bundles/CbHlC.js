...
var CbHlC = function (_Component) {
  _inherits(CbHlC, _Component);

  function CbHlC() {
    _classCallCheck(this, CbHlC);

    return _possibleConstructorReturn(this, (CbHlC.__proto__ || Object.getPrototypeOf(CbHlC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CbHlC, _reflectSoy2.default);

exports.default = CbHlC;
...
exports.templates = exports.CbHlC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CbHlC.
   * @public
   */

  goog.module('CbHlC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CbHlC.render';
  }
...
_metalSoy2.default.register(CbHlC, templates);
exports.CbHlC = CbHlC;
