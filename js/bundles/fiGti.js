...
var fiGti = function (_Component) {
  _inherits(fiGti, _Component);

  function fiGti() {
    _classCallCheck(this, fiGti);

    return _possibleConstructorReturn(this, (fiGti.__proto__ || Object.getPrototypeOf(fiGti)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fiGti, _fileSoy2.default);

exports.default = fiGti;
...
exports.templates = exports.fiGti = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fiGti.
   * @public
   */

  goog.module('fiGti.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fiGti.render';
  }
...
_metalSoy2.default.register(fiGti, templates);
exports.fiGti = fiGti;
