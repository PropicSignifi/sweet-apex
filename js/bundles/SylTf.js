...
var _template_stringSoy = __webpack_require__(345);
...
var SylTf = function (_Component) {
  _inherits(SylTf, _Component);

  function SylTf() {
    _classCallCheck(this, SylTf);

    return _possibleConstructorReturn(this, (SylTf.__proto__ || Object.getPrototypeOf(SylTf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SylTf, _template_stringSoy2.default);

exports.default = SylTf;
...
exports.templates = exports.SylTf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SylTf.
   * @public
   */

  goog.module('SylTf.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1133 = function param1133() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SylTf.render';
  }
...
_metalSoy2.default.register(SylTf, templates);
exports.SylTf = SylTf;
