...
var _tagged_stringSoy = __webpack_require__(345);
...
var egDcZ = function (_Component) {
  _inherits(egDcZ, _Component);

  function egDcZ() {
    _classCallCheck(this, egDcZ);

    return _possibleConstructorReturn(this, (egDcZ.__proto__ || Object.getPrototypeOf(egDcZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(egDcZ, _tagged_stringSoy2.default);

exports.default = egDcZ;
...
exports.templates = exports.egDcZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace egDcZ.
   * @public
   */

  goog.module('egDcZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'egDcZ.render';
  }
...
_metalSoy2.default.register(egDcZ, templates);
exports.egDcZ = egDcZ;
