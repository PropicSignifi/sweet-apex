...
var dVqYb = function (_Component) {
  _inherits(dVqYb, _Component);

  function dVqYb() {
    _classCallCheck(this, dVqYb);

    return _possibleConstructorReturn(this, (dVqYb.__proto__ || Object.getPrototypeOf(dVqYb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dVqYb, _step_4Soy2.default);

exports.default = dVqYb;
...
exports.templates = exports.dVqYb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dVqYb.
   * @public
   */

  goog.module('dVqYb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dVqYb.render';
  }
...
_metalSoy2.default.register(dVqYb, templates);
exports.dVqYb = dVqYb;
