...
var JPDnP = function (_Component) {
  _inherits(JPDnP, _Component);

  function JPDnP() {
    _classCallCheck(this, JPDnP);

    return _possibleConstructorReturn(this, (JPDnP.__proto__ || Object.getPrototypeOf(JPDnP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JPDnP, _grammarSoy2.default);

exports.default = JPDnP;
...
exports.templates = exports.JPDnP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JPDnP.
   * @public
   */

  goog.module('JPDnP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JPDnP.render';
  }
...
_metalSoy2.default.register(JPDnP, templates);
exports.JPDnP = JPDnP;
