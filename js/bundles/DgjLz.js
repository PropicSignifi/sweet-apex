...
var DgjLz = function (_Component) {
  _inherits(DgjLz, _Component);

  function DgjLz() {
    _classCallCheck(this, DgjLz);

    return _possibleConstructorReturn(this, (DgjLz.__proto__ || Object.getPrototypeOf(DgjLz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DgjLz, _commandSoy2.default);

exports.default = DgjLz;
...
exports.templates = exports.DgjLz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DgjLz.
   * @public
   */

  goog.module('DgjLz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DgjLz.render';
  }
...
_metalSoy2.default.register(DgjLz, templates);
exports.DgjLz = DgjLz;
