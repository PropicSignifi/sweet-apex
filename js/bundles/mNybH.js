...
var mNybH = function (_Component) {
  _inherits(mNybH, _Component);

  function mNybH() {
    _classCallCheck(this, mNybH);

    return _possibleConstructorReturn(this, (mNybH.__proto__ || Object.getPrototypeOf(mNybH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mNybH, _tagged_stringSoy2.default);

exports.default = mNybH;
...
exports.templates = exports.mNybH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mNybH.
   * @public
   */

  goog.module('mNybH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mNybH.render';
  }
...
_metalSoy2.default.register(mNybH, templates);
exports.mNybH = mNybH;
