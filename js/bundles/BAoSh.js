...
var BAoSh = function (_Component) {
  _inherits(BAoSh, _Component);

  function BAoSh() {
    _classCallCheck(this, BAoSh);

    return _possibleConstructorReturn(this, (BAoSh.__proto__ || Object.getPrototypeOf(BAoSh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BAoSh, _step_1Soy2.default);

exports.default = BAoSh;
...
exports.templates = exports.BAoSh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BAoSh.
   * @public
   */

  goog.module('BAoSh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BAoSh.render';
  }
...
_metalSoy2.default.register(BAoSh, templates);
exports.BAoSh = BAoSh;
