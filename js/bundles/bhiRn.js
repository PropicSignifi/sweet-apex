...
var bhiRn = function (_Component) {
  _inherits(bhiRn, _Component);

  function bhiRn() {
    _classCallCheck(this, bhiRn);

    return _possibleConstructorReturn(this, (bhiRn.__proto__ || Object.getPrototypeOf(bhiRn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bhiRn, _functionSoy2.default);

exports.default = bhiRn;
...
exports.templates = exports.bhiRn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bhiRn.
   * @public
   */

  goog.module('bhiRn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bhiRn.render';
  }
...
_metalSoy2.default.register(bhiRn, templates);
exports.bhiRn = bhiRn;
