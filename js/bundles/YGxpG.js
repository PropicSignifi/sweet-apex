...
var YGxpG = function (_Component) {
  _inherits(YGxpG, _Component);

  function YGxpG() {
    _classCallCheck(this, YGxpG);

    return _possibleConstructorReturn(this, (YGxpG.__proto__ || Object.getPrototypeOf(YGxpG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YGxpG, _featureSoy2.default);

exports.default = YGxpG;
...
exports.templates = exports.YGxpG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YGxpG.
   * @public
   */

  goog.module('YGxpG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YGxpG.render';
  }
...
_metalSoy2.default.register(YGxpG, templates);
exports.YGxpG = YGxpG;
