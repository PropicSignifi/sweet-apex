...
var BYHND = function (_Component) {
  _inherits(BYHND, _Component);

  function BYHND() {
    _classCallCheck(this, BYHND);

    return _possibleConstructorReturn(this, (BYHND.__proto__ || Object.getPrototypeOf(BYHND)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BYHND, _indexSoy2.default);

exports.default = BYHND;
...
exports.templates = exports.BYHND = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BYHND.
   * @public
   */

  goog.module('BYHND.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BYHND.render';
  }
...
_metalSoy2.default.register(BYHND, templates);
exports.BYHND = BYHND;
