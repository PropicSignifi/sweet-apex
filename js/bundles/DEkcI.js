...
var DEkcI = function (_Component) {
  _inherits(DEkcI, _Component);

  function DEkcI() {
    _classCallCheck(this, DEkcI);

    return _possibleConstructorReturn(this, (DEkcI.__proto__ || Object.getPrototypeOf(DEkcI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DEkcI, _grammarSoy2.default);

exports.default = DEkcI;
...
exports.templates = exports.DEkcI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DEkcI.
   * @public
   */

  goog.module('DEkcI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DEkcI.render';
  }
...
_metalSoy2.default.register(DEkcI, templates);
exports.DEkcI = DEkcI;
