...
var sJNrb = function (_Component) {
  _inherits(sJNrb, _Component);

  function sJNrb() {
    _classCallCheck(this, sJNrb);

    return _possibleConstructorReturn(this, (sJNrb.__proto__ || Object.getPrototypeOf(sJNrb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sJNrb, _functionSoy2.default);

exports.default = sJNrb;
...
exports.templates = exports.sJNrb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sJNrb.
   * @public
   */

  goog.module('sJNrb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sJNrb.render';
  }
...
_metalSoy2.default.register(sJNrb, templates);
exports.sJNrb = sJNrb;
