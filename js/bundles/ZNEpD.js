...
var ZNEpD = function (_Component) {
  _inherits(ZNEpD, _Component);

  function ZNEpD() {
    _classCallCheck(this, ZNEpD);

    return _possibleConstructorReturn(this, (ZNEpD.__proto__ || Object.getPrototypeOf(ZNEpD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZNEpD, _indexSoy2.default);

exports.default = ZNEpD;
...
exports.templates = exports.ZNEpD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZNEpD.
   * @public
   */

  goog.module('ZNEpD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZNEpD.render';
  }
...
_metalSoy2.default.register(ZNEpD, templates);
exports.ZNEpD = ZNEpD;
