...
var LEbWH = function (_Component) {
  _inherits(LEbWH, _Component);

  function LEbWH() {
    _classCallCheck(this, LEbWH);

    return _possibleConstructorReturn(this, (LEbWH.__proto__ || Object.getPrototypeOf(LEbWH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LEbWH, _step_4Soy2.default);

exports.default = LEbWH;
...
exports.templates = exports.LEbWH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LEbWH.
   * @public
   */

  goog.module('LEbWH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LEbWH.render';
  }
...
_metalSoy2.default.register(LEbWH, templates);
exports.LEbWH = LEbWH;
