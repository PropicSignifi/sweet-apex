...
var AeabX = function (_Component) {
  _inherits(AeabX, _Component);

  function AeabX() {
    _classCallCheck(this, AeabX);

    return _possibleConstructorReturn(this, (AeabX.__proto__ || Object.getPrototypeOf(AeabX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AeabX, _transpilationSoy2.default);

exports.default = AeabX;
...
exports.templates = exports.AeabX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AeabX.
   * @public
   */

  goog.module('AeabX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AeabX.render';
  }
...
_metalSoy2.default.register(AeabX, templates);
exports.AeabX = AeabX;
