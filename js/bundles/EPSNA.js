...
var EPSNA = function (_Component) {
  _inherits(EPSNA, _Component);

  function EPSNA() {
    _classCallCheck(this, EPSNA);

    return _possibleConstructorReturn(this, (EPSNA.__proto__ || Object.getPrototypeOf(EPSNA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EPSNA, _castSoy2.default);

exports.default = EPSNA;
...
exports.templates = exports.EPSNA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EPSNA.
   * @public
   */

  goog.module('EPSNA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EPSNA.render';
  }
...
_metalSoy2.default.register(EPSNA, templates);
exports.EPSNA = EPSNA;
