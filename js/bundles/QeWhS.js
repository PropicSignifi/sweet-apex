...
var QeWhS = function (_Component) {
  _inherits(QeWhS, _Component);

  function QeWhS() {
    _classCallCheck(this, QeWhS);

    return _possibleConstructorReturn(this, (QeWhS.__proto__ || Object.getPrototypeOf(QeWhS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QeWhS, _apexdocSoy2.default);

exports.default = QeWhS;
...
exports.templates = exports.QeWhS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QeWhS.
   * @public
   */

  goog.module('QeWhS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QeWhS.render';
  }
...
_metalSoy2.default.register(QeWhS, templates);
exports.QeWhS = QeWhS;
