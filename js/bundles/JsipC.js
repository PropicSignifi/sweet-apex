...
var JsipC = function (_Component) {
  _inherits(JsipC, _Component);

  function JsipC() {
    _classCallCheck(this, JsipC);

    return _possibleConstructorReturn(this, (JsipC.__proto__ || Object.getPrototypeOf(JsipC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JsipC, _default_valueSoy2.default);

exports.default = JsipC;
...
exports.templates = exports.JsipC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JsipC.
   * @public
   */

  goog.module('JsipC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JsipC.render';
  }
...
_metalSoy2.default.register(JsipC, templates);
exports.JsipC = JsipC;
