...
var uzbJN = function (_Component) {
  _inherits(uzbJN, _Component);

  function uzbJN() {
    _classCallCheck(this, uzbJN);

    return _possibleConstructorReturn(this, (uzbJN.__proto__ || Object.getPrototypeOf(uzbJN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uzbJN, _indexSoy2.default);

exports.default = uzbJN;
...
exports.templates = exports.uzbJN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uzbJN.
   * @public
   */

  goog.module('uzbJN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uzbJN.render';
  }
...
_metalSoy2.default.register(uzbJN, templates);
exports.uzbJN = uzbJN;
