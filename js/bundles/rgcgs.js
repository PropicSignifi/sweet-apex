...
var rgcgs = function (_Component) {
  _inherits(rgcgs, _Component);

  function rgcgs() {
    _classCallCheck(this, rgcgs);

    return _possibleConstructorReturn(this, (rgcgs.__proto__ || Object.getPrototypeOf(rgcgs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rgcgs, _configSoy2.default);

exports.default = rgcgs;
...
exports.templates = exports.rgcgs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rgcgs.
   * @public
   */

  goog.module('rgcgs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rgcgs.render';
  }
...
_metalSoy2.default.register(rgcgs, templates);
exports.rgcgs = rgcgs;
