...
var nynOn = function (_Component) {
  _inherits(nynOn, _Component);

  function nynOn() {
    _classCallCheck(this, nynOn);

    return _possibleConstructorReturn(this, (nynOn.__proto__ || Object.getPrototypeOf(nynOn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nynOn, _testcaseSoy2.default);

exports.default = nynOn;
...
exports.templates = exports.nynOn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nynOn.
   * @public
   */

  goog.module('nynOn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nynOn.render';
  }
...
_metalSoy2.default.register(nynOn, templates);
exports.nynOn = nynOn;
