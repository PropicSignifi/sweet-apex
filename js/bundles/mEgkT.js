...
var mEgkT = function (_Component) {
  _inherits(mEgkT, _Component);

  function mEgkT() {
    _classCallCheck(this, mEgkT);

    return _possibleConstructorReturn(this, (mEgkT.__proto__ || Object.getPrototypeOf(mEgkT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mEgkT, _grammarSoy2.default);

exports.default = mEgkT;
...
exports.templates = exports.mEgkT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mEgkT.
   * @public
   */

  goog.module('mEgkT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mEgkT.render';
  }
...
_metalSoy2.default.register(mEgkT, templates);
exports.mEgkT = mEgkT;
