...
var SgIYD = function (_Component) {
  _inherits(SgIYD, _Component);

  function SgIYD() {
    _classCallCheck(this, SgIYD);

    return _possibleConstructorReturn(this, (SgIYD.__proto__ || Object.getPrototypeOf(SgIYD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SgIYD, _indexSoy2.default);

exports.default = SgIYD;
...
exports.templates = exports.SgIYD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SgIYD.
   * @public
   */

  goog.module('SgIYD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SgIYD.render';
  }
...
_metalSoy2.default.register(SgIYD, templates);
exports.SgIYD = SgIYD;
