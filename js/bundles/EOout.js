...
var EOout = function (_Component) {
  _inherits(EOout, _Component);

  function EOout() {
    _classCallCheck(this, EOout);

    return _possibleConstructorReturn(this, (EOout.__proto__ || Object.getPrototypeOf(EOout)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EOout, _testcaseSoy2.default);

exports.default = EOout;
...
exports.templates = exports.EOout = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EOout.
   * @public
   */

  goog.module('EOout.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EOout.render';
  }
...
_metalSoy2.default.register(EOout, templates);
exports.EOout = EOout;
