...
var cfeJD = function (_Component) {
  _inherits(cfeJD, _Component);

  function cfeJD() {
    _classCallCheck(this, cfeJD);

    return _possibleConstructorReturn(this, (cfeJD.__proto__ || Object.getPrototypeOf(cfeJD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cfeJD, _indexSoy2.default);

exports.default = cfeJD;
...
exports.templates = exports.cfeJD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cfeJD.
   * @public
   */

  goog.module('cfeJD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cfeJD.render';
  }
...
_metalSoy2.default.register(cfeJD, templates);
exports.cfeJD = cfeJD;
