...
var WxDYt = function (_Component) {
  _inherits(WxDYt, _Component);

  function WxDYt() {
    _classCallCheck(this, WxDYt);

    return _possibleConstructorReturn(this, (WxDYt.__proto__ || Object.getPrototypeOf(WxDYt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WxDYt, _map_accessSoy2.default);

exports.default = WxDYt;
...
exports.templates = exports.WxDYt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WxDYt.
   * @public
   */

  goog.module('WxDYt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WxDYt.render';
  }
...
_metalSoy2.default.register(WxDYt, templates);
exports.WxDYt = WxDYt;
