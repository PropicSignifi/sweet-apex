...
var gdGwD = function (_Component) {
  _inherits(gdGwD, _Component);

  function gdGwD() {
    _classCallCheck(this, gdGwD);

    return _possibleConstructorReturn(this, (gdGwD.__proto__ || Object.getPrototypeOf(gdGwD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gdGwD, _template_stringSoy2.default);

exports.default = gdGwD;
...
exports.templates = exports.gdGwD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gdGwD.
   * @public
   */

  goog.module('gdGwD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gdGwD.render';
  }
...
_metalSoy2.default.register(gdGwD, templates);
exports.gdGwD = gdGwD;
