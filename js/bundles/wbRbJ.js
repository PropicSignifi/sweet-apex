...
var wbRbJ = function (_Component) {
  _inherits(wbRbJ, _Component);

  function wbRbJ() {
    _classCallCheck(this, wbRbJ);

    return _possibleConstructorReturn(this, (wbRbJ.__proto__ || Object.getPrototypeOf(wbRbJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wbRbJ, _testcaseSoy2.default);

exports.default = wbRbJ;
...
exports.templates = exports.wbRbJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wbRbJ.
   * @public
   */

  goog.module('wbRbJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wbRbJ.render';
  }
...
_metalSoy2.default.register(wbRbJ, templates);
exports.wbRbJ = wbRbJ;
