...
var nsbHV = function (_Component) {
  _inherits(nsbHV, _Component);

  function nsbHV() {
    _classCallCheck(this, nsbHV);

    return _possibleConstructorReturn(this, (nsbHV.__proto__ || Object.getPrototypeOf(nsbHV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nsbHV, _enumSoy2.default);

exports.default = nsbHV;
...
exports.templates = exports.nsbHV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nsbHV.
   * @public
   */

  goog.module('nsbHV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nsbHV.render';
  }
...
_metalSoy2.default.register(nsbHV, templates);
exports.nsbHV = nsbHV;
