...
var rKQNY = function (_Component) {
  _inherits(rKQNY, _Component);

  function rKQNY() {
    _classCallCheck(this, rKQNY);

    return _possibleConstructorReturn(this, (rKQNY.__proto__ || Object.getPrototypeOf(rKQNY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rKQNY, _grammarSoy2.default);

exports.default = rKQNY;
...
exports.templates = exports.rKQNY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rKQNY.
   * @public
   */

  goog.module('rKQNY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rKQNY.render';
  }
...
_metalSoy2.default.register(rKQNY, templates);
exports.rKQNY = rKQNY;
