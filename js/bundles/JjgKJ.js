...
var JjgKJ = function (_Component) {
  _inherits(JjgKJ, _Component);

  function JjgKJ() {
    _classCallCheck(this, JjgKJ);

    return _possibleConstructorReturn(this, (JjgKJ.__proto__ || Object.getPrototypeOf(JjgKJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JjgKJ, _transpilationSoy2.default);

exports.default = JjgKJ;
...
exports.templates = exports.JjgKJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JjgKJ.
   * @public
   */

  goog.module('JjgKJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JjgKJ.render';
  }
...
_metalSoy2.default.register(JjgKJ, templates);
exports.JjgKJ = JjgKJ;
