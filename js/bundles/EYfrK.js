...
var EYfrK = function (_Component) {
  _inherits(EYfrK, _Component);

  function EYfrK() {
    _classCallCheck(this, EYfrK);

    return _possibleConstructorReturn(this, (EYfrK.__proto__ || Object.getPrototypeOf(EYfrK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EYfrK, _indexSoy2.default);

exports.default = EYfrK;
...
exports.templates = exports.EYfrK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EYfrK.
   * @public
   */

  goog.module('EYfrK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EYfrK.render';
  }
...
_metalSoy2.default.register(EYfrK, templates);
exports.EYfrK = EYfrK;
