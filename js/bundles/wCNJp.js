...
var wCNJp = function (_Component) {
  _inherits(wCNJp, _Component);

  function wCNJp() {
    _classCallCheck(this, wCNJp);

    return _possibleConstructorReturn(this, (wCNJp.__proto__ || Object.getPrototypeOf(wCNJp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wCNJp, _injectSoy2.default);

exports.default = wCNJp;
...
exports.templates = exports.wCNJp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wCNJp.
   * @public
   */

  goog.module('wCNJp.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param778 = function param778() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wCNJp.render';
  }
...
_metalSoy2.default.register(wCNJp, templates);
exports.wCNJp = wCNJp;
