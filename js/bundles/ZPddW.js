...
var _array_creationSoy = __webpack_require__(301);
...
var ZPddW = function (_Component) {
  _inherits(ZPddW, _Component);

  function ZPddW() {
    _classCallCheck(this, ZPddW);

    return _possibleConstructorReturn(this, (ZPddW.__proto__ || Object.getPrototypeOf(ZPddW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZPddW, _array_creationSoy2.default);

exports.default = ZPddW;
...
exports.templates = exports.ZPddW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZPddW.
   * @public
   */

  goog.module('ZPddW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZPddW.render';
  }
...
_metalSoy2.default.register(ZPddW, templates);
exports.ZPddW = ZPddW;
