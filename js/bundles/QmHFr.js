...
var QmHFr = function (_Component) {
  _inherits(QmHFr, _Component);

  function QmHFr() {
    _classCallCheck(this, QmHFr);

    return _possibleConstructorReturn(this, (QmHFr.__proto__ || Object.getPrototypeOf(QmHFr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QmHFr, _injectSoy2.default);

exports.default = QmHFr;
...
exports.templates = exports.QmHFr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QmHFr.
   * @public
   */

  goog.module('QmHFr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QmHFr.render';
  }
...
_metalSoy2.default.register(QmHFr, templates);
exports.QmHFr = QmHFr;
