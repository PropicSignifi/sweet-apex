...
var dzhpq = function (_Component) {
  _inherits(dzhpq, _Component);

  function dzhpq() {
    _classCallCheck(this, dzhpq);

    return _possibleConstructorReturn(this, (dzhpq.__proto__ || Object.getPrototypeOf(dzhpq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dzhpq, _apexdocSoy2.default);

exports.default = dzhpq;
...
exports.templates = exports.dzhpq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dzhpq.
   * @public
   */

  goog.module('dzhpq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dzhpq.render';
  }
...
_metalSoy2.default.register(dzhpq, templates);
exports.dzhpq = dzhpq;
