...
var IJiuO = function (_Component) {
  _inherits(IJiuO, _Component);

  function IJiuO() {
    _classCallCheck(this, IJiuO);

    return _possibleConstructorReturn(this, (IJiuO.__proto__ || Object.getPrototypeOf(IJiuO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IJiuO, _templateSoy2.default);

exports.default = IJiuO;
...
exports.templates = exports.IJiuO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IJiuO.
   * @public
   */

  goog.module('IJiuO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IJiuO.render';
  }
...
_metalSoy2.default.register(IJiuO, templates);
exports.IJiuO = IJiuO;
