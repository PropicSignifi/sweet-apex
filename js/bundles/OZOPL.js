...
var OZOPL = function (_Component) {
  _inherits(OZOPL, _Component);

  function OZOPL() {
    _classCallCheck(this, OZOPL);

    return _possibleConstructorReturn(this, (OZOPL.__proto__ || Object.getPrototypeOf(OZOPL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OZOPL, _identitySoy2.default);

exports.default = OZOPL;
...
exports.templates = exports.OZOPL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OZOPL.
   * @public
   */

  goog.module('OZOPL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OZOPL.render';
  }
...
_metalSoy2.default.register(OZOPL, templates);
exports.OZOPL = OZOPL;
