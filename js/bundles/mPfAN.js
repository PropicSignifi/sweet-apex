...
var _scriptSoy = __webpack_require__(325);
...
var mPfAN = function (_Component) {
  _inherits(mPfAN, _Component);

  function mPfAN() {
    _classCallCheck(this, mPfAN);

    return _possibleConstructorReturn(this, (mPfAN.__proto__ || Object.getPrototypeOf(mPfAN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mPfAN, _scriptSoy2.default);

exports.default = mPfAN;
...
exports.templates = exports.mPfAN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mPfAN.
   * @public
   */

  goog.module('mPfAN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mPfAN.render';
  }
...
_metalSoy2.default.register(mPfAN, templates);
exports.mPfAN = mPfAN;
