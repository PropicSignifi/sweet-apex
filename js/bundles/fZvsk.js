...
var fZvsk = function (_Component) {
  _inherits(fZvsk, _Component);

  function fZvsk() {
    _classCallCheck(this, fZvsk);

    return _possibleConstructorReturn(this, (fZvsk.__proto__ || Object.getPrototypeOf(fZvsk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fZvsk, _transpilationSoy2.default);

exports.default = fZvsk;
...
exports.templates = exports.fZvsk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fZvsk.
   * @public
   */

  goog.module('fZvsk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fZvsk.render';
  }
...
_metalSoy2.default.register(fZvsk, templates);
exports.fZvsk = fZvsk;
