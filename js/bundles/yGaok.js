...
var yGaok = function (_Component) {
  _inherits(yGaok, _Component);

  function yGaok() {
    _classCallCheck(this, yGaok);

    return _possibleConstructorReturn(this, (yGaok.__proto__ || Object.getPrototypeOf(yGaok)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yGaok, _commandSoy2.default);

exports.default = yGaok;
...
exports.templates = exports.yGaok = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yGaok.
   * @public
   */

  goog.module('yGaok.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yGaok.render';
  }
...
_metalSoy2.default.register(yGaok, templates);
exports.yGaok = yGaok;
