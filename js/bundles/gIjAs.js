...
var gIjAs = function (_Component) {
  _inherits(gIjAs, _Component);

  function gIjAs() {
    _classCallCheck(this, gIjAs);

    return _possibleConstructorReturn(this, (gIjAs.__proto__ || Object.getPrototypeOf(gIjAs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gIjAs, _step_1Soy2.default);

exports.default = gIjAs;
...
exports.templates = exports.gIjAs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gIjAs.
   * @public
   */

  goog.module('gIjAs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gIjAs.render';
  }
...
_metalSoy2.default.register(gIjAs, templates);
exports.gIjAs = gIjAs;
