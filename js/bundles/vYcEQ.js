...
var vYcEQ = function (_Component) {
  _inherits(vYcEQ, _Component);

  function vYcEQ() {
    _classCallCheck(this, vYcEQ);

    return _possibleConstructorReturn(this, (vYcEQ.__proto__ || Object.getPrototypeOf(vYcEQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vYcEQ, _fileSoy2.default);

exports.default = vYcEQ;
...
exports.templates = exports.vYcEQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vYcEQ.
   * @public
   */

  goog.module('vYcEQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vYcEQ.render';
  }
...
_metalSoy2.default.register(vYcEQ, templates);
exports.vYcEQ = vYcEQ;
