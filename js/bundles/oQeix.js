...
var oQeix = function (_Component) {
  _inherits(oQeix, _Component);

  function oQeix() {
    _classCallCheck(this, oQeix);

    return _possibleConstructorReturn(this, (oQeix.__proto__ || Object.getPrototypeOf(oQeix)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oQeix, _featureSoy2.default);

exports.default = oQeix;
...
exports.templates = exports.oQeix = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oQeix.
   * @public
   */

  goog.module('oQeix.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oQeix.render';
  }
...
_metalSoy2.default.register(oQeix, templates);
exports.oQeix = oQeix;
