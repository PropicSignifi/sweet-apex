...
var Sweqr = function (_Component) {
  _inherits(Sweqr, _Component);

  function Sweqr() {
    _classCallCheck(this, Sweqr);

    return _possibleConstructorReturn(this, (Sweqr.__proto__ || Object.getPrototypeOf(Sweqr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Sweqr, _castSoy2.default);

exports.default = Sweqr;
...
exports.templates = exports.Sweqr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Sweqr.
   * @public
   */

  goog.module('Sweqr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Sweqr.render';
  }
...
_metalSoy2.default.register(Sweqr, templates);
exports.Sweqr = Sweqr;
