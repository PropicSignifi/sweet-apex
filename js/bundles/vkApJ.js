...
var vkApJ = function (_Component) {
  _inherits(vkApJ, _Component);

  function vkApJ() {
    _classCallCheck(this, vkApJ);

    return _possibleConstructorReturn(this, (vkApJ.__proto__ || Object.getPrototypeOf(vkApJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vkApJ, _fileSoy2.default);

exports.default = vkApJ;
...
exports.templates = exports.vkApJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vkApJ.
   * @public
   */

  goog.module('vkApJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vkApJ.render';
  }
...
_metalSoy2.default.register(vkApJ, templates);
exports.vkApJ = vkApJ;
