...
var _map_accessSoy = __webpack_require__(315);
...
var pIGfx = function (_Component) {
  _inherits(pIGfx, _Component);

  function pIGfx() {
    _classCallCheck(this, pIGfx);

    return _possibleConstructorReturn(this, (pIGfx.__proto__ || Object.getPrototypeOf(pIGfx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pIGfx, _map_accessSoy2.default);

exports.default = pIGfx;
...
exports.templates = exports.pIGfx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pIGfx.
   * @public
   */

  goog.module('pIGfx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pIGfx.render';
  }
...
_metalSoy2.default.register(pIGfx, templates);
exports.pIGfx = pIGfx;
