...
var EDSJP = function (_Component) {
  _inherits(EDSJP, _Component);

  function EDSJP() {
    _classCallCheck(this, EDSJP);

    return _possibleConstructorReturn(this, (EDSJP.__proto__ || Object.getPrototypeOf(EDSJP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EDSJP, _transpilationSoy2.default);

exports.default = EDSJP;
...
exports.templates = exports.EDSJP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EDSJP.
   * @public
   */

  goog.module('EDSJP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EDSJP.render';
  }
...
_metalSoy2.default.register(EDSJP, templates);
exports.EDSJP = EDSJP;
