...
var yxbXE = function (_Component) {
  _inherits(yxbXE, _Component);

  function yxbXE() {
    _classCallCheck(this, yxbXE);

    return _possibleConstructorReturn(this, (yxbXE.__proto__ || Object.getPrototypeOf(yxbXE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yxbXE, _map_accessSoy2.default);

exports.default = yxbXE;
...
exports.templates = exports.yxbXE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yxbXE.
   * @public
   */

  goog.module('yxbXE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yxbXE.render';
  }
...
_metalSoy2.default.register(yxbXE, templates);
exports.yxbXE = yxbXE;
