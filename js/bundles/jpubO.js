...
var jpubO = function (_Component) {
  _inherits(jpubO, _Component);

  function jpubO() {
    _classCallCheck(this, jpubO);

    return _possibleConstructorReturn(this, (jpubO.__proto__ || Object.getPrototypeOf(jpubO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jpubO, _identitySoy2.default);

exports.default = jpubO;
...
exports.templates = exports.jpubO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jpubO.
   * @public
   */

  goog.module('jpubO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jpubO.render';
  }
...
_metalSoy2.default.register(jpubO, templates);
exports.jpubO = jpubO;
