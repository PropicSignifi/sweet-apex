...
var DLXVa = function (_Component) {
  _inherits(DLXVa, _Component);

  function DLXVa() {
    _classCallCheck(this, DLXVa);

    return _possibleConstructorReturn(this, (DLXVa.__proto__ || Object.getPrototypeOf(DLXVa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DLXVa, _lambdaSoy2.default);

exports.default = DLXVa;
...
exports.templates = exports.DLXVa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DLXVa.
   * @public
   */

  goog.module('DLXVa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DLXVa.render';
  }
...
_metalSoy2.default.register(DLXVa, templates);
exports.DLXVa = DLXVa;
