...
var subRx = function (_Component) {
  _inherits(subRx, _Component);

  function subRx() {
    _classCallCheck(this, subRx);

    return _possibleConstructorReturn(this, (subRx.__proto__ || Object.getPrototypeOf(subRx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(subRx, _array_creationSoy2.default);

exports.default = subRx;
...
exports.templates = exports.subRx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace subRx.
   * @public
   */

  goog.module('subRx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'subRx.render';
  }
...
_metalSoy2.default.register(subRx, templates);
exports.subRx = subRx;
