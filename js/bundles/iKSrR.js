...
var iKSrR = function (_Component) {
  _inherits(iKSrR, _Component);

  function iKSrR() {
    _classCallCheck(this, iKSrR);

    return _possibleConstructorReturn(this, (iKSrR.__proto__ || Object.getPrototypeOf(iKSrR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iKSrR, _step_3Soy2.default);

exports.default = iKSrR;
...
exports.templates = exports.iKSrR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iKSrR.
   * @public
   */

  goog.module('iKSrR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iKSrR.render';
  }
...
_metalSoy2.default.register(iKSrR, templates);
exports.iKSrR = iKSrR;
