...
var Mmyvg = function (_Component) {
  _inherits(Mmyvg, _Component);

  function Mmyvg() {
    _classCallCheck(this, Mmyvg);

    return _possibleConstructorReturn(this, (Mmyvg.__proto__ || Object.getPrototypeOf(Mmyvg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Mmyvg, _default_valueSoy2.default);

exports.default = Mmyvg;
...
exports.templates = exports.Mmyvg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Mmyvg.
   * @public
   */

  goog.module('Mmyvg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Mmyvg.render';
  }
...
_metalSoy2.default.register(Mmyvg, templates);
exports.Mmyvg = Mmyvg;
