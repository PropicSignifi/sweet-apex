...
var bxpEm = function (_Component) {
  _inherits(bxpEm, _Component);

  function bxpEm() {
    _classCallCheck(this, bxpEm);

    return _possibleConstructorReturn(this, (bxpEm.__proto__ || Object.getPrototypeOf(bxpEm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bxpEm, _transpilationSoy2.default);

exports.default = bxpEm;
...
exports.templates = exports.bxpEm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bxpEm.
   * @public
   */

  goog.module('bxpEm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bxpEm.render';
  }
...
_metalSoy2.default.register(bxpEm, templates);
exports.bxpEm = bxpEm;
