...
var TqiaA = function (_Component) {
  _inherits(TqiaA, _Component);

  function TqiaA() {
    _classCallCheck(this, TqiaA);

    return _possibleConstructorReturn(this, (TqiaA.__proto__ || Object.getPrototypeOf(TqiaA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TqiaA, _annotationSoy2.default);

exports.default = TqiaA;
...
exports.templates = exports.TqiaA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TqiaA.
   * @public
   */

  goog.module('TqiaA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TqiaA.render';
  }
...
_metalSoy2.default.register(TqiaA, templates);
exports.TqiaA = TqiaA;
