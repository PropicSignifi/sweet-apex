...
var NrOSj = function (_Component) {
  _inherits(NrOSj, _Component);

  function NrOSj() {
    _classCallCheck(this, NrOSj);

    return _possibleConstructorReturn(this, (NrOSj.__proto__ || Object.getPrototypeOf(NrOSj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NrOSj, _indexSoy2.default);

exports.default = NrOSj;
...
exports.templates = exports.NrOSj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NrOSj.
   * @public
   */

  goog.module('NrOSj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NrOSj.render';
  }
...
_metalSoy2.default.register(NrOSj, templates);
exports.NrOSj = NrOSj;
