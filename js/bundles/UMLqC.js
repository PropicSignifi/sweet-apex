...
var UMLqC = function (_Component) {
  _inherits(UMLqC, _Component);

  function UMLqC() {
    _classCallCheck(this, UMLqC);

    return _possibleConstructorReturn(this, (UMLqC.__proto__ || Object.getPrototypeOf(UMLqC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UMLqC, _templateSoy2.default);

exports.default = UMLqC;
...
exports.templates = exports.UMLqC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UMLqC.
   * @public
   */

  goog.module('UMLqC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UMLqC.render';
  }
...
_metalSoy2.default.register(UMLqC, templates);
exports.UMLqC = UMLqC;
