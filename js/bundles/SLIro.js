...
var SLIro = function (_Component) {
  _inherits(SLIro, _Component);

  function SLIro() {
    _classCallCheck(this, SLIro);

    return _possibleConstructorReturn(this, (SLIro.__proto__ || Object.getPrototypeOf(SLIro)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SLIro, _rethrowSoy2.default);

exports.default = SLIro;
...
exports.templates = exports.SLIro = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SLIro.
   * @public
   */

  goog.module('SLIro.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SLIro.render';
  }
...
_metalSoy2.default.register(SLIro, templates);
exports.SLIro = SLIro;
