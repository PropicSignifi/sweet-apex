...
var LvPQW = function (_Component) {
  _inherits(LvPQW, _Component);

  function LvPQW() {
    _classCallCheck(this, LvPQW);

    return _possibleConstructorReturn(this, (LvPQW.__proto__ || Object.getPrototypeOf(LvPQW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LvPQW, _step_3Soy2.default);

exports.default = LvPQW;
...
exports.templates = exports.LvPQW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LvPQW.
   * @public
   */

  goog.module('LvPQW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LvPQW.render';
  }
...
_metalSoy2.default.register(LvPQW, templates);
exports.LvPQW = LvPQW;
