...
var FpIiN = function (_Component) {
  _inherits(FpIiN, _Component);

  function FpIiN() {
    _classCallCheck(this, FpIiN);

    return _possibleConstructorReturn(this, (FpIiN.__proto__ || Object.getPrototypeOf(FpIiN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FpIiN, _destructureSoy2.default);

exports.default = FpIiN;
...
exports.templates = exports.FpIiN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FpIiN.
   * @public
   */

  goog.module('FpIiN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FpIiN.render';
  }
...
_metalSoy2.default.register(FpIiN, templates);
exports.FpIiN = FpIiN;
