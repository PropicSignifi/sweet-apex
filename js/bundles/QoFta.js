...
var QoFta = function (_Component) {
  _inherits(QoFta, _Component);

  function QoFta() {
    _classCallCheck(this, QoFta);

    return _possibleConstructorReturn(this, (QoFta.__proto__ || Object.getPrototypeOf(QoFta)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QoFta, _indexSoy2.default);

exports.default = QoFta;
...
exports.templates = exports.QoFta = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QoFta.
   * @public
   */

  goog.module('QoFta.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QoFta.render';
  }
...
_metalSoy2.default.register(QoFta, templates);
exports.QoFta = QoFta;
