...
var _varSoy = __webpack_require__(353);
...
var WAljG = function (_Component) {
  _inherits(WAljG, _Component);

  function WAljG() {
    _classCallCheck(this, WAljG);

    return _possibleConstructorReturn(this, (WAljG.__proto__ || Object.getPrototypeOf(WAljG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WAljG, _varSoy2.default);

exports.default = WAljG;
...
exports.templates = exports.WAljG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WAljG.
   * @public
   */

  goog.module('WAljG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WAljG.render';
  }
...
_metalSoy2.default.register(WAljG, templates);
exports.WAljG = WAljG;
