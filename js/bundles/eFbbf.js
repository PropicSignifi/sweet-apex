...
var _enumSoy = __webpack_require__(301);
...
var eFbbf = function (_Component) {
  _inherits(eFbbf, _Component);

  function eFbbf() {
    _classCallCheck(this, eFbbf);

    return _possibleConstructorReturn(this, (eFbbf.__proto__ || Object.getPrototypeOf(eFbbf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eFbbf, _enumSoy2.default);

exports.default = eFbbf;
...
exports.templates = exports.eFbbf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eFbbf.
   * @public
   */

  goog.module('eFbbf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eFbbf.render';
  }
...
_metalSoy2.default.register(eFbbf, templates);
exports.eFbbf = eFbbf;
