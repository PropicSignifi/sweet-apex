...
var owymf = function (_Component) {
  _inherits(owymf, _Component);

  function owymf() {
    _classCallCheck(this, owymf);

    return _possibleConstructorReturn(this, (owymf.__proto__ || Object.getPrototypeOf(owymf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(owymf, _configSoy2.default);

exports.default = owymf;
...
exports.templates = exports.owymf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace owymf.
   * @public
   */

  goog.module('owymf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'owymf.render';
  }
...
_metalSoy2.default.register(owymf, templates);
exports.owymf = owymf;
