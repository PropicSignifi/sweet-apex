...
var xPrro = function (_Component) {
  _inherits(xPrro, _Component);

  function xPrro() {
    _classCallCheck(this, xPrro);

    return _possibleConstructorReturn(this, (xPrro.__proto__ || Object.getPrototypeOf(xPrro)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xPrro, _configSoy2.default);

exports.default = xPrro;
...
exports.templates = exports.xPrro = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xPrro.
   * @public
   */

  goog.module('xPrro.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xPrro.render';
  }
...
_metalSoy2.default.register(xPrro, templates);
exports.xPrro = xPrro;
