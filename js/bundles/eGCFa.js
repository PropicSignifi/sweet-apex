...
var _identitySoy = __webpack_require__(307);
...
var eGCFa = function (_Component) {
  _inherits(eGCFa, _Component);

  function eGCFa() {
    _classCallCheck(this, eGCFa);

    return _possibleConstructorReturn(this, (eGCFa.__proto__ || Object.getPrototypeOf(eGCFa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eGCFa, _identitySoy2.default);

exports.default = eGCFa;
...
exports.templates = exports.eGCFa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eGCFa.
   * @public
   */

  goog.module('eGCFa.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param704 = function param704() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param704 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eGCFa.render';
  }
...
_metalSoy2.default.register(eGCFa, templates);
exports.eGCFa = eGCFa;
