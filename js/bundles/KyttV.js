...
var KyttV = function (_Component) {
  _inherits(KyttV, _Component);

  function KyttV() {
    _classCallCheck(this, KyttV);

    return _possibleConstructorReturn(this, (KyttV.__proto__ || Object.getPrototypeOf(KyttV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KyttV, _tagged_stringSoy2.default);

exports.default = KyttV;
...
exports.templates = exports.KyttV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KyttV.
   * @public
   */

  goog.module('KyttV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KyttV.render';
  }
...
_metalSoy2.default.register(KyttV, templates);
exports.KyttV = KyttV;
