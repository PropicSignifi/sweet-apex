...
var IoWle = function (_Component) {
  _inherits(IoWle, _Component);

  function IoWle() {
    _classCallCheck(this, IoWle);

    return _possibleConstructorReturn(this, (IoWle.__proto__ || Object.getPrototypeOf(IoWle)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IoWle, _reflectSoy2.default);

exports.default = IoWle;
...
exports.templates = exports.IoWle = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IoWle.
   * @public
   */

  goog.module('IoWle.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IoWle.render';
  }
...
_metalSoy2.default.register(IoWle, templates);
exports.IoWle = IoWle;
