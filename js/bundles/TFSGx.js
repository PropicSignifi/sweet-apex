...
var TFSGx = function (_Component) {
  _inherits(TFSGx, _Component);

  function TFSGx() {
    _classCallCheck(this, TFSGx);

    return _possibleConstructorReturn(this, (TFSGx.__proto__ || Object.getPrototypeOf(TFSGx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TFSGx, _indexSoy2.default);

exports.default = TFSGx;
...
exports.templates = exports.TFSGx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TFSGx.
   * @public
   */

  goog.module('TFSGx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TFSGx.render';
  }
...
_metalSoy2.default.register(TFSGx, templates);
exports.TFSGx = TFSGx;
