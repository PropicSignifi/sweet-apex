...
var UnzDo = function (_Component) {
  _inherits(UnzDo, _Component);

  function UnzDo() {
    _classCallCheck(this, UnzDo);

    return _possibleConstructorReturn(this, (UnzDo.__proto__ || Object.getPrototypeOf(UnzDo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UnzDo, _indexSoy2.default);

exports.default = UnzDo;
...
exports.templates = exports.UnzDo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UnzDo.
   * @public
   */

  goog.module('UnzDo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UnzDo.render';
  }
...
_metalSoy2.default.register(UnzDo, templates);
exports.UnzDo = UnzDo;
