...
var RQUIA = function (_Component) {
  _inherits(RQUIA, _Component);

  function RQUIA() {
    _classCallCheck(this, RQUIA);

    return _possibleConstructorReturn(this, (RQUIA.__proto__ || Object.getPrototypeOf(RQUIA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RQUIA, _grammarSoy2.default);

exports.default = RQUIA;
...
exports.templates = exports.RQUIA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RQUIA.
   * @public
   */

  goog.module('RQUIA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RQUIA.render';
  }
...
_metalSoy2.default.register(RQUIA, templates);
exports.RQUIA = RQUIA;
