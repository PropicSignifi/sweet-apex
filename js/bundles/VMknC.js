...
var VMknC = function (_Component) {
  _inherits(VMknC, _Component);

  function VMknC() {
    _classCallCheck(this, VMknC);

    return _possibleConstructorReturn(this, (VMknC.__proto__ || Object.getPrototypeOf(VMknC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VMknC, _transpilationSoy2.default);

exports.default = VMknC;
...
exports.templates = exports.VMknC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VMknC.
   * @public
   */

  goog.module('VMknC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VMknC.render';
  }
...
_metalSoy2.default.register(VMknC, templates);
exports.VMknC = VMknC;
