...
var BYTUE = function (_Component) {
  _inherits(BYTUE, _Component);

  function BYTUE() {
    _classCallCheck(this, BYTUE);

    return _possibleConstructorReturn(this, (BYTUE.__proto__ || Object.getPrototypeOf(BYTUE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BYTUE, _scriptSoy2.default);

exports.default = BYTUE;
...
exports.templates = exports.BYTUE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BYTUE.
   * @public
   */

  goog.module('BYTUE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BYTUE.render';
  }
...
_metalSoy2.default.register(BYTUE, templates);
exports.BYTUE = BYTUE;
