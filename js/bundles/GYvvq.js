...
var GYvvq = function (_Component) {
  _inherits(GYvvq, _Component);

  function GYvvq() {
    _classCallCheck(this, GYvvq);

    return _possibleConstructorReturn(this, (GYvvq.__proto__ || Object.getPrototypeOf(GYvvq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GYvvq, _operatorSoy2.default);

exports.default = GYvvq;
...
exports.templates = exports.GYvvq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GYvvq.
   * @public
   */

  goog.module('GYvvq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GYvvq.render';
  }
...
_metalSoy2.default.register(GYvvq, templates);
exports.GYvvq = GYvvq;
