...
var CDazW = function (_Component) {
  _inherits(CDazW, _Component);

  function CDazW() {
    _classCallCheck(this, CDazW);

    return _possibleConstructorReturn(this, (CDazW.__proto__ || Object.getPrototypeOf(CDazW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CDazW, _annotationSoy2.default);

exports.default = CDazW;
...
exports.templates = exports.CDazW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CDazW.
   * @public
   */

  goog.module('CDazW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CDazW.render';
  }
...
_metalSoy2.default.register(CDazW, templates);
exports.CDazW = CDazW;
