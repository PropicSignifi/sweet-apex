...
var qnNFY = function (_Component) {
  _inherits(qnNFY, _Component);

  function qnNFY() {
    _classCallCheck(this, qnNFY);

    return _possibleConstructorReturn(this, (qnNFY.__proto__ || Object.getPrototypeOf(qnNFY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qnNFY, _default_valueSoy2.default);

exports.default = qnNFY;
...
exports.templates = exports.qnNFY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qnNFY.
   * @public
   */

  goog.module('qnNFY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qnNFY.render';
  }
...
_metalSoy2.default.register(qnNFY, templates);
exports.qnNFY = qnNFY;
