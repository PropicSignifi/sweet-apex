...
var bXQyb = function (_Component) {
  _inherits(bXQyb, _Component);

  function bXQyb() {
    _classCallCheck(this, bXQyb);

    return _possibleConstructorReturn(this, (bXQyb.__proto__ || Object.getPrototypeOf(bXQyb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bXQyb, _indexSoy2.default);

exports.default = bXQyb;
...
exports.templates = exports.bXQyb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bXQyb.
   * @public
   */

  goog.module('bXQyb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bXQyb.render';
  }
...
_metalSoy2.default.register(bXQyb, templates);
exports.bXQyb = bXQyb;
