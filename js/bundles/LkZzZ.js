...
var LkZzZ = function (_Component) {
  _inherits(LkZzZ, _Component);

  function LkZzZ() {
    _classCallCheck(this, LkZzZ);

    return _possibleConstructorReturn(this, (LkZzZ.__proto__ || Object.getPrototypeOf(LkZzZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LkZzZ, _fileSoy2.default);

exports.default = LkZzZ;
...
exports.templates = exports.LkZzZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LkZzZ.
   * @public
   */

  goog.module('LkZzZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LkZzZ.render';
  }
...
_metalSoy2.default.register(LkZzZ, templates);
exports.LkZzZ = LkZzZ;
