...
var EZtTb = function (_Component) {
  _inherits(EZtTb, _Component);

  function EZtTb() {
    _classCallCheck(this, EZtTb);

    return _possibleConstructorReturn(this, (EZtTb.__proto__ || Object.getPrototypeOf(EZtTb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EZtTb, _nullableSoy2.default);

exports.default = EZtTb;
...
exports.templates = exports.EZtTb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EZtTb.
   * @public
   */

  goog.module('EZtTb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EZtTb.render';
  }
...
_metalSoy2.default.register(EZtTb, templates);
exports.EZtTb = EZtTb;
