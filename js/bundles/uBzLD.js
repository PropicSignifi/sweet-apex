...
var uBzLD = function (_Component) {
  _inherits(uBzLD, _Component);

  function uBzLD() {
    _classCallCheck(this, uBzLD);

    return _possibleConstructorReturn(this, (uBzLD.__proto__ || Object.getPrototypeOf(uBzLD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uBzLD, _default_valueSoy2.default);

exports.default = uBzLD;
...
exports.templates = exports.uBzLD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uBzLD.
   * @public
   */

  goog.module('uBzLD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uBzLD.render';
  }
...
_metalSoy2.default.register(uBzLD, templates);
exports.uBzLD = uBzLD;
