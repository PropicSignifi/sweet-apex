...
var DZXZc = function (_Component) {
  _inherits(DZXZc, _Component);

  function DZXZc() {
    _classCallCheck(this, DZXZc);

    return _possibleConstructorReturn(this, (DZXZc.__proto__ || Object.getPrototypeOf(DZXZc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DZXZc, _featureSoy2.default);

exports.default = DZXZc;
...
exports.templates = exports.DZXZc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DZXZc.
   * @public
   */

  goog.module('DZXZc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DZXZc.render';
  }
...
_metalSoy2.default.register(DZXZc, templates);
exports.DZXZc = DZXZc;
