...
var sOLve = function (_Component) {
  _inherits(sOLve, _Component);

  function sOLve() {
    _classCallCheck(this, sOLve);

    return _possibleConstructorReturn(this, (sOLve.__proto__ || Object.getPrototypeOf(sOLve)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sOLve, _aspectSoy2.default);
...
exports.templates = exports.sOLve = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sOLve.
   * @public
   */

  goog.module('sOLve.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sOLve.render';
  }
...
_metalSoy2.default.register(sOLve, templates);
exports.sOLve = sOLve;
