...
var hGuKQ = function (_Component) {
  _inherits(hGuKQ, _Component);

  function hGuKQ() {
    _classCallCheck(this, hGuKQ);

    return _possibleConstructorReturn(this, (hGuKQ.__proto__ || Object.getPrototypeOf(hGuKQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hGuKQ, _functionSoy2.default);

exports.default = hGuKQ;
...
exports.templates = exports.hGuKQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hGuKQ.
   * @public
   */

  goog.module('hGuKQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hGuKQ.render';
  }
...
_metalSoy2.default.register(hGuKQ, templates);
exports.hGuKQ = hGuKQ;
