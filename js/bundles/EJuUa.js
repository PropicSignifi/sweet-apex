...
var EJuUa = function (_Component) {
  _inherits(EJuUa, _Component);

  function EJuUa() {
    _classCallCheck(this, EJuUa);

    return _possibleConstructorReturn(this, (EJuUa.__proto__ || Object.getPrototypeOf(EJuUa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EJuUa, _testcaseSoy2.default);

exports.default = EJuUa;
...
exports.templates = exports.EJuUa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EJuUa.
   * @public
   */

  goog.module('EJuUa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EJuUa.render';
  }
...
_metalSoy2.default.register(EJuUa, templates);
exports.EJuUa = EJuUa;
