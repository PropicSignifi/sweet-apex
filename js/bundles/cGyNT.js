...
var cGyNT = function (_Component) {
  _inherits(cGyNT, _Component);

  function cGyNT() {
    _classCallCheck(this, cGyNT);

    return _possibleConstructorReturn(this, (cGyNT.__proto__ || Object.getPrototypeOf(cGyNT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cGyNT, _lambdaSoy2.default);

exports.default = cGyNT;
...
exports.templates = exports.cGyNT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cGyNT.
   * @public
   */

  goog.module('cGyNT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cGyNT.render';
  }
...
_metalSoy2.default.register(cGyNT, templates);
exports.cGyNT = cGyNT;
