...
var YieGQ = function (_Component) {
  _inherits(YieGQ, _Component);

  function YieGQ() {
    _classCallCheck(this, YieGQ);

    return _possibleConstructorReturn(this, (YieGQ.__proto__ || Object.getPrototypeOf(YieGQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YieGQ, _rethrowSoy2.default);

exports.default = YieGQ;
...
exports.templates = exports.YieGQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YieGQ.
   * @public
   */

  goog.module('YieGQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YieGQ.render';
  }
...
_metalSoy2.default.register(YieGQ, templates);
exports.YieGQ = YieGQ;
