...
var RLOiz = function (_Component) {
  _inherits(RLOiz, _Component);

  function RLOiz() {
    _classCallCheck(this, RLOiz);

    return _possibleConstructorReturn(this, (RLOiz.__proto__ || Object.getPrototypeOf(RLOiz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RLOiz, _transpilationSoy2.default);

exports.default = RLOiz;
...
exports.templates = exports.RLOiz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RLOiz.
   * @public
   */

  goog.module('RLOiz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RLOiz.render';
  }
...
_metalSoy2.default.register(RLOiz, templates);
exports.RLOiz = RLOiz;
