...
var noZbB = function (_Component) {
  _inherits(noZbB, _Component);

  function noZbB() {
    _classCallCheck(this, noZbB);

    return _possibleConstructorReturn(this, (noZbB.__proto__ || Object.getPrototypeOf(noZbB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(noZbB, _commandSoy2.default);

exports.default = noZbB;
...
exports.templates = exports.noZbB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace noZbB.
   * @public
   */

  goog.module('noZbB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'noZbB.render';
  }
...
_metalSoy2.default.register(noZbB, templates);
exports.noZbB = noZbB;
