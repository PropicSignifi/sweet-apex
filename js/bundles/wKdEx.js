...
var wKdEx = function (_Component) {
  _inherits(wKdEx, _Component);

  function wKdEx() {
    _classCallCheck(this, wKdEx);

    return _possibleConstructorReturn(this, (wKdEx.__proto__ || Object.getPrototypeOf(wKdEx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wKdEx, _reflectSoy2.default);

exports.default = wKdEx;
...
exports.templates = exports.wKdEx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wKdEx.
   * @public
   */

  goog.module('wKdEx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wKdEx.render';
  }
...
_metalSoy2.default.register(wKdEx, templates);
exports.wKdEx = wKdEx;
