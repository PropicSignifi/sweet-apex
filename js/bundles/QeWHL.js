...
var _tagged_stringSoy = __webpack_require__(343);
...
var QeWHL = function (_Component) {
  _inherits(QeWHL, _Component);

  function QeWHL() {
    _classCallCheck(this, QeWHL);

    return _possibleConstructorReturn(this, (QeWHL.__proto__ || Object.getPrototypeOf(QeWHL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QeWHL, _tagged_stringSoy2.default);

exports.default = QeWHL;
...
exports.templates = exports.QeWHL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QeWHL.
   * @public
   */

  goog.module('QeWHL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QeWHL.render';
  }
...
_metalSoy2.default.register(QeWHL, templates);
exports.QeWHL = QeWHL;
