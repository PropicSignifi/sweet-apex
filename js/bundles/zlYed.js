...
var zlYed = function (_Component) {
  _inherits(zlYed, _Component);

  function zlYed() {
    _classCallCheck(this, zlYed);

    return _possibleConstructorReturn(this, (zlYed.__proto__ || Object.getPrototypeOf(zlYed)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zlYed, _apexdocSoy2.default);

exports.default = zlYed;
...
exports.templates = exports.zlYed = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zlYed.
   * @public
   */

  goog.module('zlYed.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zlYed.render';
  }
...
_metalSoy2.default.register(zlYed, templates);
exports.zlYed = zlYed;
