...
var gHKpC = function (_Component) {
  _inherits(gHKpC, _Component);

  function gHKpC() {
    _classCallCheck(this, gHKpC);

    return _possibleConstructorReturn(this, (gHKpC.__proto__ || Object.getPrototypeOf(gHKpC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gHKpC, _default_valueSoy2.default);

exports.default = gHKpC;
...
exports.templates = exports.gHKpC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gHKpC.
   * @public
   */

  goog.module('gHKpC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gHKpC.render';
  }
...
_metalSoy2.default.register(gHKpC, templates);
exports.gHKpC = gHKpC;
