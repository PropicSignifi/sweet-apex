...
var sPjBa = function (_Component) {
  _inherits(sPjBa, _Component);

  function sPjBa() {
    _classCallCheck(this, sPjBa);

    return _possibleConstructorReturn(this, (sPjBa.__proto__ || Object.getPrototypeOf(sPjBa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sPjBa, _actionSoy2.default);

exports.default = sPjBa;
...
exports.templates = exports.sPjBa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sPjBa.
   * @public
   */

  goog.module('sPjBa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sPjBa.render';
  }
...
_metalSoy2.default.register(sPjBa, templates);
exports.sPjBa = sPjBa;
