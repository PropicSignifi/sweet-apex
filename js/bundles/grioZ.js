...
var grioZ = function (_Component) {
  _inherits(grioZ, _Component);

  function grioZ() {
    _classCallCheck(this, grioZ);

    return _possibleConstructorReturn(this, (grioZ.__proto__ || Object.getPrototypeOf(grioZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(grioZ, _commandSoy2.default);

exports.default = grioZ;
...
exports.templates = exports.grioZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace grioZ.
   * @public
   */

  goog.module('grioZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'grioZ.render';
  }
...
_metalSoy2.default.register(grioZ, templates);
exports.grioZ = grioZ;
