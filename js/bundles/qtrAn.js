...
var qtrAn = function (_Component) {
  _inherits(qtrAn, _Component);

  function qtrAn() {
    _classCallCheck(this, qtrAn);

    return _possibleConstructorReturn(this, (qtrAn.__proto__ || Object.getPrototypeOf(qtrAn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qtrAn, _enumSoy2.default);

exports.default = qtrAn;
...
exports.templates = exports.qtrAn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qtrAn.
   * @public
   */

  goog.module('qtrAn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qtrAn.render';
  }
...
_metalSoy2.default.register(qtrAn, templates);
exports.qtrAn = qtrAn;
