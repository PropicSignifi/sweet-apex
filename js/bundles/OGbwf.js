...
var OGbwf = function (_Component) {
  _inherits(OGbwf, _Component);

  function OGbwf() {
    _classCallCheck(this, OGbwf);

    return _possibleConstructorReturn(this, (OGbwf.__proto__ || Object.getPrototypeOf(OGbwf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OGbwf, _apexdocSoy2.default);

exports.default = OGbwf;
...
exports.templates = exports.OGbwf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OGbwf.
   * @public
   */

  goog.module('OGbwf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OGbwf.render';
  }
...
_metalSoy2.default.register(OGbwf, templates);
exports.OGbwf = OGbwf;
