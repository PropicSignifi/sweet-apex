...
var hXHLs = function (_Component) {
  _inherits(hXHLs, _Component);

  function hXHLs() {
    _classCallCheck(this, hXHLs);

    return _possibleConstructorReturn(this, (hXHLs.__proto__ || Object.getPrototypeOf(hXHLs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hXHLs, _array_creationSoy2.default);

exports.default = hXHLs;
...
exports.templates = exports.hXHLs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hXHLs.
   * @public
   */

  goog.module('hXHLs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hXHLs.render';
  }
...
_metalSoy2.default.register(hXHLs, templates);
exports.hXHLs = hXHLs;
