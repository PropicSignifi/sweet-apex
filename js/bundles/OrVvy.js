...
var OrVvy = function (_Component) {
  _inherits(OrVvy, _Component);

  function OrVvy() {
    _classCallCheck(this, OrVvy);

    return _possibleConstructorReturn(this, (OrVvy.__proto__ || Object.getPrototypeOf(OrVvy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OrVvy, _grammarSoy2.default);

exports.default = OrVvy;
...
exports.templates = exports.OrVvy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OrVvy.
   * @public
   */

  goog.module('OrVvy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OrVvy.render';
  }
...
_metalSoy2.default.register(OrVvy, templates);
exports.OrVvy = OrVvy;
