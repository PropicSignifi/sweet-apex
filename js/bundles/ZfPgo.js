...
var ZfPgo = function (_Component) {
  _inherits(ZfPgo, _Component);

  function ZfPgo() {
    _classCallCheck(this, ZfPgo);

    return _possibleConstructorReturn(this, (ZfPgo.__proto__ || Object.getPrototypeOf(ZfPgo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZfPgo, _indexSoy2.default);

exports.default = ZfPgo;
...
exports.templates = exports.ZfPgo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZfPgo.
   * @public
   */

  goog.module('ZfPgo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZfPgo.render';
  }
...
_metalSoy2.default.register(ZfPgo, templates);
exports.ZfPgo = ZfPgo;
