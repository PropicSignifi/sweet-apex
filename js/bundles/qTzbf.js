...
var qTzbf = function (_Component) {
  _inherits(qTzbf, _Component);

  function qTzbf() {
    _classCallCheck(this, qTzbf);

    return _possibleConstructorReturn(this, (qTzbf.__proto__ || Object.getPrototypeOf(qTzbf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qTzbf, _featureSoy2.default);

exports.default = qTzbf;
...
exports.templates = exports.qTzbf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qTzbf.
   * @public
   */

  goog.module('qTzbf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qTzbf.render';
  }
...
_metalSoy2.default.register(qTzbf, templates);
exports.qTzbf = qTzbf;
