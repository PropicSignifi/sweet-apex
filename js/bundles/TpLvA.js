...
var TpLvA = function (_Component) {
  _inherits(TpLvA, _Component);

  function TpLvA() {
    _classCallCheck(this, TpLvA);

    return _possibleConstructorReturn(this, (TpLvA.__proto__ || Object.getPrototypeOf(TpLvA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TpLvA, _indexSoy2.default);

exports.default = TpLvA;
...
exports.templates = exports.TpLvA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TpLvA.
   * @public
   */

  goog.module('TpLvA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TpLvA.render';
  }
...
_metalSoy2.default.register(TpLvA, templates);
exports.TpLvA = TpLvA;
