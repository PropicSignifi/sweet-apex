...
var YzMJB = function (_Component) {
  _inherits(YzMJB, _Component);

  function YzMJB() {
    _classCallCheck(this, YzMJB);

    return _possibleConstructorReturn(this, (YzMJB.__proto__ || Object.getPrototypeOf(YzMJB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YzMJB, _constructor_annotationSoy2.default);

exports.default = YzMJB;
...
exports.templates = exports.YzMJB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YzMJB.
   * @public
   */

  goog.module('YzMJB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YzMJB.render';
  }
...
_metalSoy2.default.register(YzMJB, templates);
exports.YzMJB = YzMJB;
