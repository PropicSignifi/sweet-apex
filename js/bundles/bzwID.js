...
var bzwID = function (_Component) {
  _inherits(bzwID, _Component);

  function bzwID() {
    _classCallCheck(this, bzwID);

    return _possibleConstructorReturn(this, (bzwID.__proto__ || Object.getPrototypeOf(bzwID)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bzwID, _aspectSoy2.default);

exports.default = bzwID;
...
exports.templates = exports.bzwID = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bzwID.
   * @public
   */

  goog.module('bzwID.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bzwID.render';
  }
...
_metalSoy2.default.register(bzwID, templates);
exports.bzwID = bzwID;
