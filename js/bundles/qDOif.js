...
var qDOif = function (_Component) {
  _inherits(qDOif, _Component);

  function qDOif() {
    _classCallCheck(this, qDOif);

    return _possibleConstructorReturn(this, (qDOif.__proto__ || Object.getPrototypeOf(qDOif)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qDOif, _map_accessSoy2.default);

exports.default = qDOif;
...
exports.templates = exports.qDOif = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qDOif.
   * @public
   */

  goog.module('qDOif.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qDOif.render';
  }
...
_metalSoy2.default.register(qDOif, templates);
exports.qDOif = qDOif;
