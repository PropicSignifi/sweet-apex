...
var Skqjq = function (_Component) {
  _inherits(Skqjq, _Component);

  function Skqjq() {
    _classCallCheck(this, Skqjq);

    return _possibleConstructorReturn(this, (Skqjq.__proto__ || Object.getPrototypeOf(Skqjq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Skqjq, _indexSoy2.default);

exports.default = Skqjq;
...
exports.templates = exports.Skqjq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Skqjq.
   * @public
   */

  goog.module('Skqjq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Skqjq.render';
  }
...
_metalSoy2.default.register(Skqjq, templates);
exports.Skqjq = Skqjq;
