...
var rILJo = function (_Component) {
  _inherits(rILJo, _Component);

  function rILJo() {
    _classCallCheck(this, rILJo);

    return _possibleConstructorReturn(this, (rILJo.__proto__ || Object.getPrototypeOf(rILJo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rILJo, _castSoy2.default);

exports.default = rILJo;
...
exports.templates = exports.rILJo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rILJo.
   * @public
   */

  goog.module('rILJo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rILJo.render';
  }
...
_metalSoy2.default.register(rILJo, templates);
exports.rILJo = rILJo;
