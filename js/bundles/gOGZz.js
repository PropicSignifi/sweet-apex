...
var gOGZz = function (_Component) {
  _inherits(gOGZz, _Component);

  function gOGZz() {
    _classCallCheck(this, gOGZz);

    return _possibleConstructorReturn(this, (gOGZz.__proto__ || Object.getPrototypeOf(gOGZz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gOGZz, _testcaseSoy2.default);

exports.default = gOGZz;
...
exports.templates = exports.gOGZz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gOGZz.
   * @public
   */

  goog.module('gOGZz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gOGZz.render';
  }
...
_metalSoy2.default.register(gOGZz, templates);
exports.gOGZz = gOGZz;
