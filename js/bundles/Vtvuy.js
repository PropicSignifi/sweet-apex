...
var Vtvuy = function (_Component) {
  _inherits(Vtvuy, _Component);

  function Vtvuy() {
    _classCallCheck(this, Vtvuy);

    return _possibleConstructorReturn(this, (Vtvuy.__proto__ || Object.getPrototypeOf(Vtvuy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Vtvuy, _identitySoy2.default);

exports.default = Vtvuy;
...
exports.templates = exports.Vtvuy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Vtvuy.
   * @public
   */

  goog.module('Vtvuy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Vtvuy.render';
  }
...
_metalSoy2.default.register(Vtvuy, templates);
exports.Vtvuy = Vtvuy;
