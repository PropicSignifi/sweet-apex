...
var _templateSoy = __webpack_require__(347);
...
var lSbIj = function (_Component) {
  _inherits(lSbIj, _Component);

  function lSbIj() {
    _classCallCheck(this, lSbIj);

    return _possibleConstructorReturn(this, (lSbIj.__proto__ || Object.getPrototypeOf(lSbIj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lSbIj, _templateSoy2.default);

exports.default = lSbIj;
...
exports.templates = exports.lSbIj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lSbIj.
   * @public
   */

  goog.module('lSbIj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lSbIj.render';
  }
...
_metalSoy2.default.register(lSbIj, templates);
exports.lSbIj = lSbIj;
