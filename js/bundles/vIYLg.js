...
var vIYLg = function (_Component) {
  _inherits(vIYLg, _Component);

  function vIYLg() {
    _classCallCheck(this, vIYLg);

    return _possibleConstructorReturn(this, (vIYLg.__proto__ || Object.getPrototypeOf(vIYLg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vIYLg, _default_valueSoy2.default);

exports.default = vIYLg;
...
exports.templates = exports.vIYLg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vIYLg.
   * @public
   */

  goog.module('vIYLg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vIYLg.render';
  }
...
_metalSoy2.default.register(vIYLg, templates);
exports.vIYLg = vIYLg;
