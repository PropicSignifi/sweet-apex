...
var FBqix = function (_Component) {
  _inherits(FBqix, _Component);

  function FBqix() {
    _classCallCheck(this, FBqix);

    return _possibleConstructorReturn(this, (FBqix.__proto__ || Object.getPrototypeOf(FBqix)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FBqix, _nullableSoy2.default);

exports.default = FBqix;
...
exports.templates = exports.FBqix = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FBqix.
   * @public
   */

  goog.module('FBqix.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FBqix.render';
  }
...
_metalSoy2.default.register(FBqix, templates);
exports.FBqix = FBqix;
