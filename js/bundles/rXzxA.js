...
var rXzxA = function (_Component) {
  _inherits(rXzxA, _Component);

  function rXzxA() {
    _classCallCheck(this, rXzxA);

    return _possibleConstructorReturn(this, (rXzxA.__proto__ || Object.getPrototypeOf(rXzxA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rXzxA, _tagged_stringSoy2.default);

exports.default = rXzxA;
...
exports.templates = exports.rXzxA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rXzxA.
   * @public
   */

  goog.module('rXzxA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rXzxA.render';
  }
...
_metalSoy2.default.register(rXzxA, templates);
exports.rXzxA = rXzxA;
