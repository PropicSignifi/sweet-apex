...
var XMmQk = function (_Component) {
  _inherits(XMmQk, _Component);

  function XMmQk() {
    _classCallCheck(this, XMmQk);

    return _possibleConstructorReturn(this, (XMmQk.__proto__ || Object.getPrototypeOf(XMmQk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XMmQk, _transpilationSoy2.default);

exports.default = XMmQk;
...
exports.templates = exports.XMmQk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XMmQk.
   * @public
   */

  goog.module('XMmQk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XMmQk.render';
  }
...
_metalSoy2.default.register(XMmQk, templates);
exports.XMmQk = XMmQk;
