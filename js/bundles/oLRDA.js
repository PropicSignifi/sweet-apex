...
var oLRDA = function (_Component) {
  _inherits(oLRDA, _Component);

  function oLRDA() {
    _classCallCheck(this, oLRDA);

    return _possibleConstructorReturn(this, (oLRDA.__proto__ || Object.getPrototypeOf(oLRDA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oLRDA, _apexdocSoy2.default);

exports.default = oLRDA;
...
exports.templates = exports.oLRDA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oLRDA.
   * @public
   */

  goog.module('oLRDA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oLRDA.render';
  }
...
_metalSoy2.default.register(oLRDA, templates);
exports.oLRDA = oLRDA;
