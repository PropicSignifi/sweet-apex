...
var ySopV = function (_Component) {
  _inherits(ySopV, _Component);

  function ySopV() {
    _classCallCheck(this, ySopV);

    return _possibleConstructorReturn(this, (ySopV.__proto__ || Object.getPrototypeOf(ySopV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ySopV, _castSoy2.default);

exports.default = ySopV;
...
exports.templates = exports.ySopV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ySopV.
   * @public
   */

  goog.module('ySopV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ySopV.render';
  }
...
_metalSoy2.default.register(ySopV, templates);
exports.ySopV = ySopV;
