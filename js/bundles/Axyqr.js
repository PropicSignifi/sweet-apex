...
var Axyqr = function (_Component) {
  _inherits(Axyqr, _Component);

  function Axyqr() {
    _classCallCheck(this, Axyqr);

    return _possibleConstructorReturn(this, (Axyqr.__proto__ || Object.getPrototypeOf(Axyqr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Axyqr, _commandSoy2.default);

exports.default = Axyqr;
...
exports.templates = exports.Axyqr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Axyqr.
   * @public
   */

  goog.module('Axyqr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Axyqr.render';
  }
...
_metalSoy2.default.register(Axyqr, templates);
exports.Axyqr = Axyqr;
