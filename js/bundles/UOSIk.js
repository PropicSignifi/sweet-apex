...
var UOSIk = function (_Component) {
  _inherits(UOSIk, _Component);

  function UOSIk() {
    _classCallCheck(this, UOSIk);

    return _possibleConstructorReturn(this, (UOSIk.__proto__ || Object.getPrototypeOf(UOSIk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UOSIk, _default_valueSoy2.default);

exports.default = UOSIk;
...
exports.templates = exports.UOSIk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UOSIk.
   * @public
   */

  goog.module('UOSIk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UOSIk.render';
  }
...
_metalSoy2.default.register(UOSIk, templates);
exports.UOSIk = UOSIk;
