...
var luRHc = function (_Component) {
  _inherits(luRHc, _Component);

  function luRHc() {
    _classCallCheck(this, luRHc);

    return _possibleConstructorReturn(this, (luRHc.__proto__ || Object.getPrototypeOf(luRHc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(luRHc, _indexSoy2.default);

exports.default = luRHc;
...
exports.templates = exports.luRHc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace luRHc.
   * @public
   */

  goog.module('luRHc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'luRHc.render';
  }
...
_metalSoy2.default.register(luRHc, templates);
exports.luRHc = luRHc;
