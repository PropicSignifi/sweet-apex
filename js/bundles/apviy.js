...
var apviy = function (_Component) {
  _inherits(apviy, _Component);

  function apviy() {
    _classCallCheck(this, apviy);

    return _possibleConstructorReturn(this, (apviy.__proto__ || Object.getPrototypeOf(apviy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(apviy, _functionSoy2.default);

exports.default = apviy;
...
exports.templates = exports.apviy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace apviy.
   * @public
   */

  goog.module('apviy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'apviy.render';
  }
...
_metalSoy2.default.register(apviy, templates);
exports.apviy = apviy;
