...
var RtSRB = function (_Component) {
  _inherits(RtSRB, _Component);

  function RtSRB() {
    _classCallCheck(this, RtSRB);

    return _possibleConstructorReturn(this, (RtSRB.__proto__ || Object.getPrototypeOf(RtSRB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RtSRB, _testcaseSoy2.default);

exports.default = RtSRB;
...
exports.templates = exports.RtSRB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RtSRB.
   * @public
   */

  goog.module('RtSRB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RtSRB.render';
  }
...
_metalSoy2.default.register(RtSRB, templates);
exports.RtSRB = RtSRB;
