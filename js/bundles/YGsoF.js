...
var YGsoF = function (_Component) {
  _inherits(YGsoF, _Component);

  function YGsoF() {
    _classCallCheck(this, YGsoF);

    return _possibleConstructorReturn(this, (YGsoF.__proto__ || Object.getPrototypeOf(YGsoF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YGsoF, _fileSoy2.default);

exports.default = YGsoF;
...
exports.templates = exports.YGsoF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YGsoF.
   * @public
   */

  goog.module('YGsoF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YGsoF.render';
  }
...
_metalSoy2.default.register(YGsoF, templates);
exports.YGsoF = YGsoF;
