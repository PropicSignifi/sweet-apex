...
var jctsS = function (_Component) {
  _inherits(jctsS, _Component);

  function jctsS() {
    _classCallCheck(this, jctsS);

    return _possibleConstructorReturn(this, (jctsS.__proto__ || Object.getPrototypeOf(jctsS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jctsS, _injectSoy2.default);

exports.default = jctsS;
...
exports.templates = exports.jctsS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jctsS.
   * @public
   */

  goog.module('jctsS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jctsS.render';
  }
...
_metalSoy2.default.register(jctsS, templates);
exports.jctsS = jctsS;
