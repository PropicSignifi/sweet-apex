...
var UMGWP = function (_Component) {
  _inherits(UMGWP, _Component);

  function UMGWP() {
    _classCallCheck(this, UMGWP);

    return _possibleConstructorReturn(this, (UMGWP.__proto__ || Object.getPrototypeOf(UMGWP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UMGWP, _castSoy2.default);

exports.default = UMGWP;
...
exports.templates = exports.UMGWP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UMGWP.
   * @public
   */

  goog.module('UMGWP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UMGWP.render';
  }
...
_metalSoy2.default.register(UMGWP, templates);
exports.UMGWP = UMGWP;
