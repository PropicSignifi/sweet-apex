...
var eXQcR = function (_Component) {
  _inherits(eXQcR, _Component);

  function eXQcR() {
    _classCallCheck(this, eXQcR);

    return _possibleConstructorReturn(this, (eXQcR.__proto__ || Object.getPrototypeOf(eXQcR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eXQcR, _testcaseSoy2.default);

exports.default = eXQcR;
...
exports.templates = exports.eXQcR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eXQcR.
   * @public
   */

  goog.module('eXQcR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eXQcR.render';
  }
...
_metalSoy2.default.register(eXQcR, templates);
exports.eXQcR = eXQcR;
