...
var GsBLB = function (_Component) {
  _inherits(GsBLB, _Component);

  function GsBLB() {
    _classCallCheck(this, GsBLB);

    return _possibleConstructorReturn(this, (GsBLB.__proto__ || Object.getPrototypeOf(GsBLB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GsBLB, _scriptSoy2.default);

exports.default = GsBLB;
...
exports.templates = exports.GsBLB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GsBLB.
   * @public
   */

  goog.module('GsBLB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GsBLB.render';
  }
...
_metalSoy2.default.register(GsBLB, templates);
exports.GsBLB = GsBLB;
