...
var kGeYR = function (_Component) {
  _inherits(kGeYR, _Component);

  function kGeYR() {
    _classCallCheck(this, kGeYR);

    return _possibleConstructorReturn(this, (kGeYR.__proto__ || Object.getPrototypeOf(kGeYR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kGeYR, _destructureSoy2.default);

exports.default = kGeYR;
...
exports.templates = exports.kGeYR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kGeYR.
   * @public
   */

  goog.module('kGeYR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kGeYR.render';
  }
...
_metalSoy2.default.register(kGeYR, templates);
exports.kGeYR = kGeYR;
