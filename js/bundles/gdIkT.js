...
var gdIkT = function (_Component) {
  _inherits(gdIkT, _Component);

  function gdIkT() {
    _classCallCheck(this, gdIkT);

    return _possibleConstructorReturn(this, (gdIkT.__proto__ || Object.getPrototypeOf(gdIkT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gdIkT, _castSoy2.default);

exports.default = gdIkT;
...
exports.templates = exports.gdIkT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gdIkT.
   * @public
   */

  goog.module('gdIkT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gdIkT.render';
  }
...
_metalSoy2.default.register(gdIkT, templates);
exports.gdIkT = gdIkT;
