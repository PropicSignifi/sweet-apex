...
var hCund = function (_Component) {
  _inherits(hCund, _Component);

  function hCund() {
    _classCallCheck(this, hCund);

    return _possibleConstructorReturn(this, (hCund.__proto__ || Object.getPrototypeOf(hCund)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hCund, _apexdocSoy2.default);

exports.default = hCund;
...
exports.templates = exports.hCund = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hCund.
   * @public
   */

  goog.module('hCund.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hCund.render';
  }
...
_metalSoy2.default.register(hCund, templates);
exports.hCund = hCund;
