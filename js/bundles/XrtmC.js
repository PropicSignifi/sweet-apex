...
var XrtmC = function (_Component) {
  _inherits(XrtmC, _Component);

  function XrtmC() {
    _classCallCheck(this, XrtmC);

    return _possibleConstructorReturn(this, (XrtmC.__proto__ || Object.getPrototypeOf(XrtmC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XrtmC, _featureSoy2.default);

exports.default = XrtmC;
...
exports.templates = exports.XrtmC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XrtmC.
   * @public
   */

  goog.module('XrtmC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XrtmC.render';
  }
...
_metalSoy2.default.register(XrtmC, templates);
exports.XrtmC = XrtmC;
