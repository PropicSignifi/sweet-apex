...
var RPyfv = function (_Component) {
  _inherits(RPyfv, _Component);

  function RPyfv() {
    _classCallCheck(this, RPyfv);

    return _possibleConstructorReturn(this, (RPyfv.__proto__ || Object.getPrototypeOf(RPyfv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RPyfv, _nullableSoy2.default);

exports.default = RPyfv;
...
exports.templates = exports.RPyfv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RPyfv.
   * @public
   */

  goog.module('RPyfv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RPyfv.render';
  }
...
_metalSoy2.default.register(RPyfv, templates);
exports.RPyfv = RPyfv;
