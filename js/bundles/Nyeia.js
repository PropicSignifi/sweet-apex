...
var Nyeia = function (_Component) {
  _inherits(Nyeia, _Component);

  function Nyeia() {
    _classCallCheck(this, Nyeia);

    return _possibleConstructorReturn(this, (Nyeia.__proto__ || Object.getPrototypeOf(Nyeia)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Nyeia, _functionSoy2.default);

exports.default = Nyeia;
...
exports.templates = exports.Nyeia = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Nyeia.
   * @public
   */

  goog.module('Nyeia.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Nyeia.render';
  }
...
_metalSoy2.default.register(Nyeia, templates);
exports.Nyeia = Nyeia;
