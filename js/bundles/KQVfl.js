...
var KQVfl = function (_Component) {
  _inherits(KQVfl, _Component);

  function KQVfl() {
    _classCallCheck(this, KQVfl);

    return _possibleConstructorReturn(this, (KQVfl.__proto__ || Object.getPrototypeOf(KQVfl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KQVfl, _identitySoy2.default);

exports.default = KQVfl;
...
exports.templates = exports.KQVfl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KQVfl.
   * @public
   */

  goog.module('KQVfl.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param730 = function param730() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KQVfl.render';
  }
...
_metalSoy2.default.register(KQVfl, templates);
exports.KQVfl = KQVfl;
