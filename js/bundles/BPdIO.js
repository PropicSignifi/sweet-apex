...
var BPdIO = function (_Component) {
  _inherits(BPdIO, _Component);

  function BPdIO() {
    _classCallCheck(this, BPdIO);

    return _possibleConstructorReturn(this, (BPdIO.__proto__ || Object.getPrototypeOf(BPdIO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BPdIO, _tagged_stringSoy2.default);

exports.default = BPdIO;
...
exports.templates = exports.BPdIO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BPdIO.
   * @public
   */

  goog.module('BPdIO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BPdIO.render';
  }
...
_metalSoy2.default.register(BPdIO, templates);
exports.BPdIO = BPdIO;
