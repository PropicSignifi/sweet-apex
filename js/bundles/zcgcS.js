...
var zcgcS = function (_Component) {
  _inherits(zcgcS, _Component);

  function zcgcS() {
    _classCallCheck(this, zcgcS);

    return _possibleConstructorReturn(this, (zcgcS.__proto__ || Object.getPrototypeOf(zcgcS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zcgcS, _grammarSoy2.default);

exports.default = zcgcS;
...
exports.templates = exports.zcgcS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zcgcS.
   * @public
   */

  goog.module('zcgcS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zcgcS.render';
  }
...
_metalSoy2.default.register(zcgcS, templates);
exports.zcgcS = zcgcS;
