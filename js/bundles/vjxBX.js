...
var vjxBX = function (_Component) {
  _inherits(vjxBX, _Component);

  function vjxBX() {
    _classCallCheck(this, vjxBX);

    return _possibleConstructorReturn(this, (vjxBX.__proto__ || Object.getPrototypeOf(vjxBX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vjxBX, _aspectSoy2.default);

exports.default = vjxBX;
...
exports.templates = exports.vjxBX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vjxBX.
   * @public
   */

  goog.module('vjxBX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vjxBX.render';
  }
...
_metalSoy2.default.register(vjxBX, templates);
exports.vjxBX = vjxBX;
