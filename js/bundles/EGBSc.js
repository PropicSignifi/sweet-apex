...
var EGBSc = function (_Component) {
  _inherits(EGBSc, _Component);

  function EGBSc() {
    _classCallCheck(this, EGBSc);

    return _possibleConstructorReturn(this, (EGBSc.__proto__ || Object.getPrototypeOf(EGBSc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EGBSc, _castSoy2.default);

exports.default = EGBSc;
...
exports.templates = exports.EGBSc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EGBSc.
   * @public
   */

  goog.module('EGBSc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EGBSc.render';
  }
...
_metalSoy2.default.register(EGBSc, templates);
exports.EGBSc = EGBSc;
