...
var vzIdV = function (_Component) {
  _inherits(vzIdV, _Component);

  function vzIdV() {
    _classCallCheck(this, vzIdV);

    return _possibleConstructorReturn(this, (vzIdV.__proto__ || Object.getPrototypeOf(vzIdV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vzIdV, _featureSoy2.default);

exports.default = vzIdV;
...
exports.templates = exports.vzIdV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vzIdV.
   * @public
   */

  goog.module('vzIdV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vzIdV.render';
  }
...
_metalSoy2.default.register(vzIdV, templates);
exports.vzIdV = vzIdV;
