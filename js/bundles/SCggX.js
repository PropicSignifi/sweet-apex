...
var SCggX = function (_Component) {
  _inherits(SCggX, _Component);

  function SCggX() {
    _classCallCheck(this, SCggX);

    return _possibleConstructorReturn(this, (SCggX.__proto__ || Object.getPrototypeOf(SCggX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SCggX, _grammarSoy2.default);

exports.default = SCggX;
...
exports.templates = exports.SCggX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SCggX.
   * @public
   */

  goog.module('SCggX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SCggX.render';
  }
...
_metalSoy2.default.register(SCggX, templates);
exports.SCggX = SCggX;
