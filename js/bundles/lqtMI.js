...
var lqtMI = function (_Component) {
  _inherits(lqtMI, _Component);

  function lqtMI() {
    _classCallCheck(this, lqtMI);

    return _possibleConstructorReturn(this, (lqtMI.__proto__ || Object.getPrototypeOf(lqtMI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lqtMI, _enumSoy2.default);

exports.default = lqtMI;
...
exports.templates = exports.lqtMI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lqtMI.
   * @public
   */

  goog.module('lqtMI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lqtMI.render';
  }
...
_metalSoy2.default.register(lqtMI, templates);
exports.lqtMI = lqtMI;
