...
var JzwnC = function (_Component) {
  _inherits(JzwnC, _Component);

  function JzwnC() {
    _classCallCheck(this, JzwnC);

    return _possibleConstructorReturn(this, (JzwnC.__proto__ || Object.getPrototypeOf(JzwnC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JzwnC, _operatorSoy2.default);

exports.default = JzwnC;
...
exports.templates = exports.JzwnC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JzwnC.
   * @public
   */

  goog.module('JzwnC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JzwnC.render';
  }
...
_metalSoy2.default.register(JzwnC, templates);
exports.JzwnC = JzwnC;
