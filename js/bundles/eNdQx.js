...
var _apexdocSoy = __webpack_require__(287);
...
var eNdQx = function (_Component) {
  _inherits(eNdQx, _Component);

  function eNdQx() {
    _classCallCheck(this, eNdQx);

    return _possibleConstructorReturn(this, (eNdQx.__proto__ || Object.getPrototypeOf(eNdQx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eNdQx, _apexdocSoy2.default);

exports.default = eNdQx;
...
exports.templates = exports.eNdQx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eNdQx.
   * @public
   */

  goog.module('eNdQx.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param469 = function param469() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eNdQx.render';
  }
...
_metalSoy2.default.register(eNdQx, templates);
exports.eNdQx = eNdQx;
