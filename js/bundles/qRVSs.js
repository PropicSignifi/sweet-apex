...
var qRVSs = function (_Component) {
  _inherits(qRVSs, _Component);

  function qRVSs() {
    _classCallCheck(this, qRVSs);

    return _possibleConstructorReturn(this, (qRVSs.__proto__ || Object.getPrototypeOf(qRVSs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qRVSs, _actionSoy2.default);

exports.default = qRVSs;
...
exports.templates = exports.qRVSs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qRVSs.
   * @public
   */

  goog.module('qRVSs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qRVSs.render';
  }
...
_metalSoy2.default.register(qRVSs, templates);
exports.qRVSs = qRVSs;
