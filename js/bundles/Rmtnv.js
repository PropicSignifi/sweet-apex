...
var Rmtnv = function (_Component) {
  _inherits(Rmtnv, _Component);

  function Rmtnv() {
    _classCallCheck(this, Rmtnv);

    return _possibleConstructorReturn(this, (Rmtnv.__proto__ || Object.getPrototypeOf(Rmtnv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rmtnv, _step_2Soy2.default);

exports.default = Rmtnv;
...
exports.templates = exports.Rmtnv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rmtnv.
   * @public
   */

  goog.module('Rmtnv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rmtnv.render';
  }
...
_metalSoy2.default.register(Rmtnv, templates);
exports.Rmtnv = Rmtnv;
