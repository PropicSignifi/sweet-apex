...
var tDDUl = function (_Component) {
  _inherits(tDDUl, _Component);

  function tDDUl() {
    _classCallCheck(this, tDDUl);

    return _possibleConstructorReturn(this, (tDDUl.__proto__ || Object.getPrototypeOf(tDDUl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tDDUl, _step_4Soy2.default);

exports.default = tDDUl;
...
exports.templates = exports.tDDUl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tDDUl.
   * @public
   */

  goog.module('tDDUl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tDDUl.render';
  }
...
_metalSoy2.default.register(tDDUl, templates);
exports.tDDUl = tDDUl;
