...
var anFqk = function (_Component) {
  _inherits(anFqk, _Component);

  function anFqk() {
    _classCallCheck(this, anFqk);

    return _possibleConstructorReturn(this, (anFqk.__proto__ || Object.getPrototypeOf(anFqk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(anFqk, _annotationSoy2.default);

exports.default = anFqk;
...
exports.templates = exports.anFqk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace anFqk.
   * @public
   */

  goog.module('anFqk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'anFqk.render';
  }
...
_metalSoy2.default.register(anFqk, templates);
exports.anFqk = anFqk;
