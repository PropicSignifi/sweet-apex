...
var wSrFt = function (_Component) {
  _inherits(wSrFt, _Component);

  function wSrFt() {
    _classCallCheck(this, wSrFt);

    return _possibleConstructorReturn(this, (wSrFt.__proto__ || Object.getPrototypeOf(wSrFt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wSrFt, _identitySoy2.default);

exports.default = wSrFt;
...
exports.templates = exports.wSrFt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wSrFt.
   * @public
   */

  goog.module('wSrFt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wSrFt.render';
  }
...
_metalSoy2.default.register(wSrFt, templates);
exports.wSrFt = wSrFt;
