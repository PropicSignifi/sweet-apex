...
var XrQlK = function (_Component) {
  _inherits(XrQlK, _Component);

  function XrQlK() {
    _classCallCheck(this, XrQlK);

    return _possibleConstructorReturn(this, (XrQlK.__proto__ || Object.getPrototypeOf(XrQlK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XrQlK, _indexSoy2.default);

exports.default = XrQlK;
...
exports.templates = exports.XrQlK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XrQlK.
   * @public
   */

  goog.module('XrQlK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XrQlK.render';
  }
...
_metalSoy2.default.register(XrQlK, templates);
exports.XrQlK = XrQlK;
