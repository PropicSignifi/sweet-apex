...
var wxEIP = function (_Component) {
  _inherits(wxEIP, _Component);

  function wxEIP() {
    _classCallCheck(this, wxEIP);

    return _possibleConstructorReturn(this, (wxEIP.__proto__ || Object.getPrototypeOf(wxEIP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wxEIP, _tagged_stringSoy2.default);

exports.default = wxEIP;
...
exports.templates = exports.wxEIP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wxEIP.
   * @public
   */

  goog.module('wxEIP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wxEIP.render';
  }
...
_metalSoy2.default.register(wxEIP, templates);
exports.wxEIP = wxEIP;
