...
var Rkznu = function (_Component) {
  _inherits(Rkznu, _Component);

  function Rkznu() {
    _classCallCheck(this, Rkznu);

    return _possibleConstructorReturn(this, (Rkznu.__proto__ || Object.getPrototypeOf(Rkznu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rkznu, _actionSoy2.default);

exports.default = Rkznu;
...
exports.templates = exports.Rkznu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rkznu.
   * @public
   */

  goog.module('Rkznu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rkznu.render';
  }
...
_metalSoy2.default.register(Rkznu, templates);
exports.Rkznu = Rkznu;
