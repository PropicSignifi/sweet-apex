...
var YLkQV = function (_Component) {
  _inherits(YLkQV, _Component);

  function YLkQV() {
    _classCallCheck(this, YLkQV);

    return _possibleConstructorReturn(this, (YLkQV.__proto__ || Object.getPrototypeOf(YLkQV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YLkQV, _step_4Soy2.default);

exports.default = YLkQV;
...
exports.templates = exports.YLkQV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YLkQV.
   * @public
   */

  goog.module('YLkQV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YLkQV.render';
  }
...
_metalSoy2.default.register(YLkQV, templates);
exports.YLkQV = YLkQV;
