...
var IMtIv = function (_Component) {
  _inherits(IMtIv, _Component);

  function IMtIv() {
    _classCallCheck(this, IMtIv);

    return _possibleConstructorReturn(this, (IMtIv.__proto__ || Object.getPrototypeOf(IMtIv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IMtIv, _featureSoy2.default);

exports.default = IMtIv;
...
exports.templates = exports.IMtIv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IMtIv.
   * @public
   */

  goog.module('IMtIv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IMtIv.render';
  }
...
_metalSoy2.default.register(IMtIv, templates);
exports.IMtIv = IMtIv;
