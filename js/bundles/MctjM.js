...
var MctjM = function (_Component) {
  _inherits(MctjM, _Component);

  function MctjM() {
    _classCallCheck(this, MctjM);

    return _possibleConstructorReturn(this, (MctjM.__proto__ || Object.getPrototypeOf(MctjM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MctjM, _step_3Soy2.default);

exports.default = MctjM;
...
exports.templates = exports.MctjM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MctjM.
   * @public
   */

  goog.module('MctjM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MctjM.render';
  }
...
_metalSoy2.default.register(MctjM, templates);
exports.MctjM = MctjM;
