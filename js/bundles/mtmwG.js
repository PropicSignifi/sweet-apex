...
var _step_2Soy = __webpack_require__(353);
...
var mtmwG = function (_Component) {
  _inherits(mtmwG, _Component);

  function mtmwG() {
    _classCallCheck(this, mtmwG);

    return _possibleConstructorReturn(this, (mtmwG.__proto__ || Object.getPrototypeOf(mtmwG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mtmwG, _step_2Soy2.default);

exports.default = mtmwG;
...
exports.templates = exports.mtmwG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mtmwG.
   * @public
   */

  goog.module('mtmwG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mtmwG.render';
  }
...
_metalSoy2.default.register(mtmwG, templates);
exports.mtmwG = mtmwG;
