...
var RMTRO = function (_Component) {
  _inherits(RMTRO, _Component);

  function RMTRO() {
    _classCallCheck(this, RMTRO);

    return _possibleConstructorReturn(this, (RMTRO.__proto__ || Object.getPrototypeOf(RMTRO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RMTRO, _testcaseSoy2.default);

exports.default = RMTRO;
...
exports.templates = exports.RMTRO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RMTRO.
   * @public
   */

  goog.module('RMTRO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RMTRO.render';
  }
...
_metalSoy2.default.register(RMTRO, templates);
exports.RMTRO = RMTRO;
