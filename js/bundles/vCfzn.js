...
var vCfzn = function (_Component) {
  _inherits(vCfzn, _Component);

  function vCfzn() {
    _classCallCheck(this, vCfzn);

    return _possibleConstructorReturn(this, (vCfzn.__proto__ || Object.getPrototypeOf(vCfzn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vCfzn, _apexdocSoy2.default);

exports.default = vCfzn;
...
exports.templates = exports.vCfzn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vCfzn.
   * @public
   */

  goog.module('vCfzn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vCfzn.render';
  }
...
_metalSoy2.default.register(vCfzn, templates);
exports.vCfzn = vCfzn;
