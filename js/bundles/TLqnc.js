...
var _enumSoy = __webpack_require__(303);
...
var TLqnc = function (_Component) {
  _inherits(TLqnc, _Component);

  function TLqnc() {
    _classCallCheck(this, TLqnc);

    return _possibleConstructorReturn(this, (TLqnc.__proto__ || Object.getPrototypeOf(TLqnc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TLqnc, _enumSoy2.default);

exports.default = TLqnc;
...
exports.templates = exports.TLqnc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TLqnc.
   * @public
   */

  goog.module('TLqnc.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param667 = function param667() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TLqnc.render';
  }
...
_metalSoy2.default.register(TLqnc, templates);
exports.TLqnc = TLqnc;
