...
var mOVly = function (_Component) {
  _inherits(mOVly, _Component);

  function mOVly() {
    _classCallCheck(this, mOVly);

    return _possibleConstructorReturn(this, (mOVly.__proto__ || Object.getPrototypeOf(mOVly)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mOVly, _identitySoy2.default);

exports.default = mOVly;
...
exports.templates = exports.mOVly = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mOVly.
   * @public
   */

  goog.module('mOVly.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mOVly.render';
  }
...
_metalSoy2.default.register(mOVly, templates);
exports.mOVly = mOVly;
