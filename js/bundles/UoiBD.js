...
var UoiBD = function (_Component) {
  _inherits(UoiBD, _Component);

  function UoiBD() {
    _classCallCheck(this, UoiBD);

    return _possibleConstructorReturn(this, (UoiBD.__proto__ || Object.getPrototypeOf(UoiBD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UoiBD, _rethrowSoy2.default);

exports.default = UoiBD;
...
exports.templates = exports.UoiBD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UoiBD.
   * @public
   */

  goog.module('UoiBD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UoiBD.render';
  }
...
_metalSoy2.default.register(UoiBD, templates);
exports.UoiBD = UoiBD;
