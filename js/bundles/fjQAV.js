...
var fjQAV = function (_Component) {
  _inherits(fjQAV, _Component);

  function fjQAV() {
    _classCallCheck(this, fjQAV);

    return _possibleConstructorReturn(this, (fjQAV.__proto__ || Object.getPrototypeOf(fjQAV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fjQAV, _configSoy2.default);

exports.default = fjQAV;
...
exports.templates = exports.fjQAV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fjQAV.
   * @public
   */

  goog.module('fjQAV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fjQAV.render';
  }
...
_metalSoy2.default.register(fjQAV, templates);
exports.fjQAV = fjQAV;
