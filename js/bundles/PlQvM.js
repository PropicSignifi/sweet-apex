...
var PlQvM = function (_Component) {
  _inherits(PlQvM, _Component);

  function PlQvM() {
    _classCallCheck(this, PlQvM);

    return _possibleConstructorReturn(this, (PlQvM.__proto__ || Object.getPrototypeOf(PlQvM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PlQvM, _apexdocSoy2.default);

exports.default = PlQvM;
...
exports.templates = exports.PlQvM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PlQvM.
   * @public
   */

  goog.module('PlQvM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PlQvM.render';
  }
...
_metalSoy2.default.register(PlQvM, templates);
exports.PlQvM = PlQvM;
