...
var vIMYM = function (_Component) {
  _inherits(vIMYM, _Component);

  function vIMYM() {
    _classCallCheck(this, vIMYM);

    return _possibleConstructorReturn(this, (vIMYM.__proto__ || Object.getPrototypeOf(vIMYM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vIMYM, _functionSoy2.default);

exports.default = vIMYM;
...
exports.templates = exports.vIMYM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vIMYM.
   * @public
   */

  goog.module('vIMYM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vIMYM.render';
  }
...
_metalSoy2.default.register(vIMYM, templates);
exports.vIMYM = vIMYM;
