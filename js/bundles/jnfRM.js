...
var jnfRM = function (_Component) {
  _inherits(jnfRM, _Component);

  function jnfRM() {
    _classCallCheck(this, jnfRM);

    return _possibleConstructorReturn(this, (jnfRM.__proto__ || Object.getPrototypeOf(jnfRM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jnfRM, _lambdaSoy2.default);

exports.default = jnfRM;
...
exports.templates = exports.jnfRM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jnfRM.
   * @public
   */

  goog.module('jnfRM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jnfRM.render';
  }
...
_metalSoy2.default.register(jnfRM, templates);
exports.jnfRM = jnfRM;
