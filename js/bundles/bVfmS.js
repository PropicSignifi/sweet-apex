...
var bVfmS = function (_Component) {
  _inherits(bVfmS, _Component);

  function bVfmS() {
    _classCallCheck(this, bVfmS);

    return _possibleConstructorReturn(this, (bVfmS.__proto__ || Object.getPrototypeOf(bVfmS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bVfmS, _indexSoy2.default);

exports.default = bVfmS;
...
exports.templates = exports.bVfmS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bVfmS.
   * @public
   */

  goog.module('bVfmS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bVfmS.render';
  }
...
_metalSoy2.default.register(bVfmS, templates);
exports.bVfmS = bVfmS;
