...
var _annotationSoy = __webpack_require__(299);
...
var XORoO = function (_Component) {
  _inherits(XORoO, _Component);

  function XORoO() {
    _classCallCheck(this, XORoO);

    return _possibleConstructorReturn(this, (XORoO.__proto__ || Object.getPrototypeOf(XORoO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XORoO, _annotationSoy2.default);

exports.default = XORoO;
...
exports.templates = exports.XORoO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XORoO.
   * @public
   */

  goog.module('XORoO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XORoO.render';
  }
...
_metalSoy2.default.register(XORoO, templates);
exports.XORoO = XORoO;
