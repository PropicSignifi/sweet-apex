...
var _featureSoy = __webpack_require__(291);
...
var ISkEL = function (_Component) {
  _inherits(ISkEL, _Component);

  function ISkEL() {
    _classCallCheck(this, ISkEL);

    return _possibleConstructorReturn(this, (ISkEL.__proto__ || Object.getPrototypeOf(ISkEL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ISkEL, _featureSoy2.default);

exports.default = ISkEL;
...
exports.templates = exports.ISkEL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ISkEL.
   * @public
   */

  goog.module('ISkEL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ISkEL.render';
  }
...
_metalSoy2.default.register(ISkEL, templates);
exports.ISkEL = ISkEL;
