...
var cBITv = function (_Component) {
  _inherits(cBITv, _Component);

  function cBITv() {
    _classCallCheck(this, cBITv);

    return _possibleConstructorReturn(this, (cBITv.__proto__ || Object.getPrototypeOf(cBITv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cBITv, _lambdaSoy2.default);

exports.default = cBITv;
...
exports.templates = exports.cBITv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cBITv.
   * @public
   */

  goog.module('cBITv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cBITv.render';
  }
...
_metalSoy2.default.register(cBITv, templates);
exports.cBITv = cBITv;
