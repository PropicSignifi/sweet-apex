...
var PTdDs = function (_Component) {
  _inherits(PTdDs, _Component);

  function PTdDs() {
    _classCallCheck(this, PTdDs);

    return _possibleConstructorReturn(this, (PTdDs.__proto__ || Object.getPrototypeOf(PTdDs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PTdDs, _array_creationSoy2.default);

exports.default = PTdDs;
...
exports.templates = exports.PTdDs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PTdDs.
   * @public
   */

  goog.module('PTdDs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PTdDs.render';
  }
...
_metalSoy2.default.register(PTdDs, templates);
exports.PTdDs = PTdDs;
