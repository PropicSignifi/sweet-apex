...
var MzdNg = function (_Component) {
  _inherits(MzdNg, _Component);

  function MzdNg() {
    _classCallCheck(this, MzdNg);

    return _possibleConstructorReturn(this, (MzdNg.__proto__ || Object.getPrototypeOf(MzdNg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MzdNg, _fileSoy2.default);

exports.default = MzdNg;
...
exports.templates = exports.MzdNg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MzdNg.
   * @public
   */

  goog.module('MzdNg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MzdNg.render';
  }
...
_metalSoy2.default.register(MzdNg, templates);
exports.MzdNg = MzdNg;
