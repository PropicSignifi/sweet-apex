...
var tPaQQ = function (_Component) {
  _inherits(tPaQQ, _Component);

  function tPaQQ() {
    _classCallCheck(this, tPaQQ);

    return _possibleConstructorReturn(this, (tPaQQ.__proto__ || Object.getPrototypeOf(tPaQQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tPaQQ, _operatorSoy2.default);

exports.default = tPaQQ;
...
exports.templates = exports.tPaQQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tPaQQ.
   * @public
   */

  goog.module('tPaQQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tPaQQ.render';
  }
...
_metalSoy2.default.register(tPaQQ, templates);
exports.tPaQQ = tPaQQ;
