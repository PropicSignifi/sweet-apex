...
var WRgQA = function (_Component) {
  _inherits(WRgQA, _Component);

  function WRgQA() {
    _classCallCheck(this, WRgQA);

    return _possibleConstructorReturn(this, (WRgQA.__proto__ || Object.getPrototypeOf(WRgQA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WRgQA, _operatorSoy2.default);

exports.default = WRgQA;
...
exports.templates = exports.WRgQA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WRgQA.
   * @public
   */

  goog.module('WRgQA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WRgQA.render';
  }
...
_metalSoy2.default.register(WRgQA, templates);
exports.WRgQA = WRgQA;
