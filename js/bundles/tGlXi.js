...
var tGlXi = function (_Component) {
  _inherits(tGlXi, _Component);

  function tGlXi() {
    _classCallCheck(this, tGlXi);

    return _possibleConstructorReturn(this, (tGlXi.__proto__ || Object.getPrototypeOf(tGlXi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tGlXi, _fileSoy2.default);

exports.default = tGlXi;
...
exports.templates = exports.tGlXi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tGlXi.
   * @public
   */

  goog.module('tGlXi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tGlXi.render';
  }
...
_metalSoy2.default.register(tGlXi, templates);
exports.tGlXi = tGlXi;
