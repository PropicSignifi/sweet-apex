...
var cilMR = function (_Component) {
  _inherits(cilMR, _Component);

  function cilMR() {
    _classCallCheck(this, cilMR);

    return _possibleConstructorReturn(this, (cilMR.__proto__ || Object.getPrototypeOf(cilMR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cilMR, _actionSoy2.default);

exports.default = cilMR;
...
exports.templates = exports.cilMR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cilMR.
   * @public
   */

  goog.module('cilMR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cilMR.render';
  }
...
_metalSoy2.default.register(cilMR, templates);
exports.cilMR = cilMR;
