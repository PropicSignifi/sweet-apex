...
var aOloN = function (_Component) {
  _inherits(aOloN, _Component);

  function aOloN() {
    _classCallCheck(this, aOloN);

    return _possibleConstructorReturn(this, (aOloN.__proto__ || Object.getPrototypeOf(aOloN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aOloN, _castSoy2.default);

exports.default = aOloN;
...
exports.templates = exports.aOloN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aOloN.
   * @public
   */

  goog.module('aOloN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aOloN.render';
  }
...
_metalSoy2.default.register(aOloN, templates);
exports.aOloN = aOloN;
