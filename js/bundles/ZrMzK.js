...
var ZrMzK = function (_Component) {
  _inherits(ZrMzK, _Component);

  function ZrMzK() {
    _classCallCheck(this, ZrMzK);

    return _possibleConstructorReturn(this, (ZrMzK.__proto__ || Object.getPrototypeOf(ZrMzK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZrMzK, _aspectSoy2.default);

exports.default = ZrMzK;
...
exports.templates = exports.ZrMzK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZrMzK.
   * @public
   */

  goog.module('ZrMzK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZrMzK.render';
  }
...
_metalSoy2.default.register(ZrMzK, templates);
exports.ZrMzK = ZrMzK;
