...
var pfoBR = function (_Component) {
  _inherits(pfoBR, _Component);

  function pfoBR() {
    _classCallCheck(this, pfoBR);

    return _possibleConstructorReturn(this, (pfoBR.__proto__ || Object.getPrototypeOf(pfoBR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pfoBR, _templateSoy2.default);

exports.default = pfoBR;
...
exports.templates = exports.pfoBR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pfoBR.
   * @public
   */

  goog.module('pfoBR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pfoBR.render';
  }
...
_metalSoy2.default.register(pfoBR, templates);
exports.pfoBR = pfoBR;
