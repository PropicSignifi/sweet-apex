...
var gDJHZ = function (_Component) {
  _inherits(gDJHZ, _Component);

  function gDJHZ() {
    _classCallCheck(this, gDJHZ);

    return _possibleConstructorReturn(this, (gDJHZ.__proto__ || Object.getPrototypeOf(gDJHZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gDJHZ, _transpilationSoy2.default);

exports.default = gDJHZ;
...
exports.templates = exports.gDJHZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gDJHZ.
   * @public
   */

  goog.module('gDJHZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gDJHZ.render';
  }
...
_metalSoy2.default.register(gDJHZ, templates);
exports.gDJHZ = gDJHZ;
