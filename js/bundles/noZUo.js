...
var _templateSoy = __webpack_require__(329);
...
var noZUo = function (_Component) {
  _inherits(noZUo, _Component);

  function noZUo() {
    _classCallCheck(this, noZUo);

    return _possibleConstructorReturn(this, (noZUo.__proto__ || Object.getPrototypeOf(noZUo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(noZUo, _templateSoy2.default);

exports.default = noZUo;
...
exports.templates = exports.noZUo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace noZUo.
   * @public
   */

  goog.module('noZUo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'noZUo.render';
  }
...
_metalSoy2.default.register(noZUo, templates);
exports.noZUo = noZUo;
