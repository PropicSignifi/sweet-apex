...
var Emlsn = function (_Component) {
  _inherits(Emlsn, _Component);

  function Emlsn() {
    _classCallCheck(this, Emlsn);

    return _possibleConstructorReturn(this, (Emlsn.__proto__ || Object.getPrototypeOf(Emlsn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Emlsn, _default_valueSoy2.default);

exports.default = Emlsn;
...
exports.templates = exports.Emlsn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Emlsn.
   * @public
   */

  goog.module('Emlsn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Emlsn.render';
  }
...
_metalSoy2.default.register(Emlsn, templates);
exports.Emlsn = Emlsn;
