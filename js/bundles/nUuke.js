...
var nUuke = function (_Component) {
  _inherits(nUuke, _Component);

  function nUuke() {
    _classCallCheck(this, nUuke);

    return _possibleConstructorReturn(this, (nUuke.__proto__ || Object.getPrototypeOf(nUuke)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nUuke, _step_1Soy2.default);

exports.default = nUuke;
...
exports.templates = exports.nUuke = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nUuke.
   * @public
   */

  goog.module('nUuke.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nUuke.render';
  }
...
_metalSoy2.default.register(nUuke, templates);
exports.nUuke = nUuke;
