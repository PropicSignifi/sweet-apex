...
var qBNhN = function (_Component) {
  _inherits(qBNhN, _Component);

  function qBNhN() {
    _classCallCheck(this, qBNhN);

    return _possibleConstructorReturn(this, (qBNhN.__proto__ || Object.getPrototypeOf(qBNhN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qBNhN, _featureSoy2.default);

exports.default = qBNhN;
...
exports.templates = exports.qBNhN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qBNhN.
   * @public
   */

  goog.module('qBNhN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qBNhN.render';
  }
...
_metalSoy2.default.register(qBNhN, templates);
exports.qBNhN = qBNhN;
