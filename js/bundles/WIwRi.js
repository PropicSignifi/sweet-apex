...
var WIwRi = function (_Component) {
  _inherits(WIwRi, _Component);

  function WIwRi() {
    _classCallCheck(this, WIwRi);

    return _possibleConstructorReturn(this, (WIwRi.__proto__ || Object.getPrototypeOf(WIwRi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WIwRi, _array_creationSoy2.default);

exports.default = WIwRi;
...
exports.templates = exports.WIwRi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WIwRi.
   * @public
   */

  goog.module('WIwRi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WIwRi.render';
  }
...
_metalSoy2.default.register(WIwRi, templates);
exports.WIwRi = WIwRi;
