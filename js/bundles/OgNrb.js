...
var OgNrb = function (_Component) {
  _inherits(OgNrb, _Component);

  function OgNrb() {
    _classCallCheck(this, OgNrb);

    return _possibleConstructorReturn(this, (OgNrb.__proto__ || Object.getPrototypeOf(OgNrb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OgNrb, _apexdocSoy2.default);

exports.default = OgNrb;
...
exports.templates = exports.OgNrb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OgNrb.
   * @public
   */

  goog.module('OgNrb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OgNrb.render';
  }
...
_metalSoy2.default.register(OgNrb, templates);
exports.OgNrb = OgNrb;
