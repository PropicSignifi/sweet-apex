...
var yvEvE = function (_Component) {
  _inherits(yvEvE, _Component);

  function yvEvE() {
    _classCallCheck(this, yvEvE);

    return _possibleConstructorReturn(this, (yvEvE.__proto__ || Object.getPrototypeOf(yvEvE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yvEvE, _actionSoy2.default);

exports.default = yvEvE;
...
exports.templates = exports.yvEvE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yvEvE.
   * @public
   */

  goog.module('yvEvE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yvEvE.render';
  }
...
_metalSoy2.default.register(yvEvE, templates);
exports.yvEvE = yvEvE;
