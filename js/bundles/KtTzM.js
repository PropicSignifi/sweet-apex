...
var _templateSoy = __webpack_require__(327);
...
var KtTzM = function (_Component) {
  _inherits(KtTzM, _Component);

  function KtTzM() {
    _classCallCheck(this, KtTzM);

    return _possibleConstructorReturn(this, (KtTzM.__proto__ || Object.getPrototypeOf(KtTzM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KtTzM, _templateSoy2.default);

exports.default = KtTzM;
...
exports.templates = exports.KtTzM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KtTzM.
   * @public
   */

  goog.module('KtTzM.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param894 = function param894() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KtTzM.render';
  }
...
_metalSoy2.default.register(KtTzM, templates);
exports.KtTzM = KtTzM;
