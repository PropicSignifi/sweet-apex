...
var BSacH = function (_Component) {
  _inherits(BSacH, _Component);

  function BSacH() {
    _classCallCheck(this, BSacH);

    return _possibleConstructorReturn(this, (BSacH.__proto__ || Object.getPrototypeOf(BSacH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BSacH, _apexdocSoy2.default);

exports.default = BSacH;
...
exports.templates = exports.BSacH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BSacH.
   * @public
   */

  goog.module('BSacH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BSacH.render';
  }
...
_metalSoy2.default.register(BSacH, templates);
exports.BSacH = BSacH;
