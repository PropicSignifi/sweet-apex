...
var bwAMD = function (_Component) {
  _inherits(bwAMD, _Component);

  function bwAMD() {
    _classCallCheck(this, bwAMD);

    return _possibleConstructorReturn(this, (bwAMD.__proto__ || Object.getPrototypeOf(bwAMD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bwAMD, _fileSoy2.default);

exports.default = bwAMD;
...
exports.templates = exports.bwAMD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bwAMD.
   * @public
   */

  goog.module('bwAMD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bwAMD.render';
  }
...
_metalSoy2.default.register(bwAMD, templates);
exports.bwAMD = bwAMD;
