...
var kQGtG = function (_Component) {
  _inherits(kQGtG, _Component);

  function kQGtG() {
    _classCallCheck(this, kQGtG);

    return _possibleConstructorReturn(this, (kQGtG.__proto__ || Object.getPrototypeOf(kQGtG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kQGtG, _rethrowSoy2.default);

exports.default = kQGtG;
...
exports.templates = exports.kQGtG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kQGtG.
   * @public
   */

  goog.module('kQGtG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kQGtG.render';
  }
...
_metalSoy2.default.register(kQGtG, templates);
exports.kQGtG = kQGtG;
