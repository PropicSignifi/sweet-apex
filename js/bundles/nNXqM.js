...
var nNXqM = function (_Component) {
  _inherits(nNXqM, _Component);

  function nNXqM() {
    _classCallCheck(this, nNXqM);

    return _possibleConstructorReturn(this, (nNXqM.__proto__ || Object.getPrototypeOf(nNXqM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nNXqM, _tagged_stringSoy2.default);

exports.default = nNXqM;
...
exports.templates = exports.nNXqM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nNXqM.
   * @public
   */

  goog.module('nNXqM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nNXqM.render';
  }
...
_metalSoy2.default.register(nNXqM, templates);
exports.nNXqM = nNXqM;
