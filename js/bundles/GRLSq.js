...
var GRLSq = function (_Component) {
  _inherits(GRLSq, _Component);

  function GRLSq() {
    _classCallCheck(this, GRLSq);

    return _possibleConstructorReturn(this, (GRLSq.__proto__ || Object.getPrototypeOf(GRLSq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GRLSq, _indexSoy2.default);

exports.default = GRLSq;
...
exports.templates = exports.GRLSq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GRLSq.
   * @public
   */

  goog.module('GRLSq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GRLSq.render';
  }
...
_metalSoy2.default.register(GRLSq, templates);
exports.GRLSq = GRLSq;
