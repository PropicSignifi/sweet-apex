...
var WdCXN = function (_Component) {
  _inherits(WdCXN, _Component);

  function WdCXN() {
    _classCallCheck(this, WdCXN);

    return _possibleConstructorReturn(this, (WdCXN.__proto__ || Object.getPrototypeOf(WdCXN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WdCXN, _aspectSoy2.default);

exports.default = WdCXN;
...
exports.templates = exports.WdCXN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WdCXN.
   * @public
   */

  goog.module('WdCXN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WdCXN.render';
  }
...
_metalSoy2.default.register(WdCXN, templates);
exports.WdCXN = WdCXN;
