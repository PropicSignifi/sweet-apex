...
var JAIRT = function (_Component) {
  _inherits(JAIRT, _Component);

  function JAIRT() {
    _classCallCheck(this, JAIRT);

    return _possibleConstructorReturn(this, (JAIRT.__proto__ || Object.getPrototypeOf(JAIRT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JAIRT, _indexSoy2.default);

exports.default = JAIRT;
...
exports.templates = exports.JAIRT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JAIRT.
   * @public
   */

  goog.module('JAIRT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JAIRT.render';
  }
...
_metalSoy2.default.register(JAIRT, templates);
exports.JAIRT = JAIRT;
