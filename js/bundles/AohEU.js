...
var AohEU = function (_Component) {
  _inherits(AohEU, _Component);

  function AohEU() {
    _classCallCheck(this, AohEU);

    return _possibleConstructorReturn(this, (AohEU.__proto__ || Object.getPrototypeOf(AohEU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AohEU, _commandSoy2.default);

exports.default = AohEU;
...
exports.templates = exports.AohEU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AohEU.
   * @public
   */

  goog.module('AohEU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AohEU.render';
  }
...
_metalSoy2.default.register(AohEU, templates);
exports.AohEU = AohEU;
