...
var nLbKv = function (_Component) {
  _inherits(nLbKv, _Component);

  function nLbKv() {
    _classCallCheck(this, nLbKv);

    return _possibleConstructorReturn(this, (nLbKv.__proto__ || Object.getPrototypeOf(nLbKv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nLbKv, _array_creationSoy2.default);

exports.default = nLbKv;
...
exports.templates = exports.nLbKv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nLbKv.
   * @public
   */

  goog.module('nLbKv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nLbKv.render';
  }
...
_metalSoy2.default.register(nLbKv, templates);
exports.nLbKv = nLbKv;
