...
var tSNxA = function (_Component) {
  _inherits(tSNxA, _Component);

  function tSNxA() {
    _classCallCheck(this, tSNxA);

    return _possibleConstructorReturn(this, (tSNxA.__proto__ || Object.getPrototypeOf(tSNxA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tSNxA, _constructor_annotationSoy2.default);

exports.default = tSNxA;
...
exports.templates = exports.tSNxA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tSNxA.
   * @public
   */

  goog.module('tSNxA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tSNxA.render';
  }
...
_metalSoy2.default.register(tSNxA, templates);
exports.tSNxA = tSNxA;
