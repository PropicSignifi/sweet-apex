...
var bmFao = function (_Component) {
  _inherits(bmFao, _Component);

  function bmFao() {
    _classCallCheck(this, bmFao);

    return _possibleConstructorReturn(this, (bmFao.__proto__ || Object.getPrototypeOf(bmFao)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bmFao, _indexSoy2.default);

exports.default = bmFao;
...
exports.templates = exports.bmFao = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bmFao.
   * @public
   */

  goog.module('bmFao.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bmFao.render';
  }
...
_metalSoy2.default.register(bmFao, templates);
exports.bmFao = bmFao;
