...
var ZGoHP = function (_Component) {
  _inherits(ZGoHP, _Component);

  function ZGoHP() {
    _classCallCheck(this, ZGoHP);

    return _possibleConstructorReturn(this, (ZGoHP.__proto__ || Object.getPrototypeOf(ZGoHP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZGoHP, _grammarSoy2.default);

exports.default = ZGoHP;
...
exports.templates = exports.ZGoHP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZGoHP.
   * @public
   */

  goog.module('ZGoHP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZGoHP.render';
  }
...
_metalSoy2.default.register(ZGoHP, templates);
exports.ZGoHP = ZGoHP;
