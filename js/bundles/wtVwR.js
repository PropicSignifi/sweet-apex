...
var wtVwR = function (_Component) {
  _inherits(wtVwR, _Component);

  function wtVwR() {
    _classCallCheck(this, wtVwR);

    return _possibleConstructorReturn(this, (wtVwR.__proto__ || Object.getPrototypeOf(wtVwR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wtVwR, _configSoy2.default);

exports.default = wtVwR;
...
exports.templates = exports.wtVwR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wtVwR.
   * @public
   */

  goog.module('wtVwR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wtVwR.render';
  }
...
_metalSoy2.default.register(wtVwR, templates);
exports.wtVwR = wtVwR;
