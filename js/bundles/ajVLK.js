...
var ajVLK = function (_Component) {
  _inherits(ajVLK, _Component);

  function ajVLK() {
    _classCallCheck(this, ajVLK);

    return _possibleConstructorReturn(this, (ajVLK.__proto__ || Object.getPrototypeOf(ajVLK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ajVLK, _indexSoy2.default);

exports.default = ajVLK;
...
exports.templates = exports.ajVLK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ajVLK.
   * @public
   */

  goog.module('ajVLK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ajVLK.render';
  }
...
_metalSoy2.default.register(ajVLK, templates);
exports.ajVLK = ajVLK;
