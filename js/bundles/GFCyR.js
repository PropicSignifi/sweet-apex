...
var GFCyR = function (_Component) {
  _inherits(GFCyR, _Component);

  function GFCyR() {
    _classCallCheck(this, GFCyR);

    return _possibleConstructorReturn(this, (GFCyR.__proto__ || Object.getPrototypeOf(GFCyR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GFCyR, _nullableSoy2.default);

exports.default = GFCyR;
...
exports.templates = exports.GFCyR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GFCyR.
   * @public
   */

  goog.module('GFCyR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GFCyR.render';
  }
...
_metalSoy2.default.register(GFCyR, templates);
exports.GFCyR = GFCyR;
