...
var SJyGB = function (_Component) {
  _inherits(SJyGB, _Component);

  function SJyGB() {
    _classCallCheck(this, SJyGB);

    return _possibleConstructorReturn(this, (SJyGB.__proto__ || Object.getPrototypeOf(SJyGB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SJyGB, _commandSoy2.default);

exports.default = SJyGB;
...
exports.templates = exports.SJyGB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SJyGB.
   * @public
   */

  goog.module('SJyGB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SJyGB.render';
  }
...
_metalSoy2.default.register(SJyGB, templates);
exports.SJyGB = SJyGB;
