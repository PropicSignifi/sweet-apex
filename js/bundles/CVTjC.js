...
var CVTjC = function (_Component) {
  _inherits(CVTjC, _Component);

  function CVTjC() {
    _classCallCheck(this, CVTjC);

    return _possibleConstructorReturn(this, (CVTjC.__proto__ || Object.getPrototypeOf(CVTjC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CVTjC, _actionSoy2.default);

exports.default = CVTjC;
...
exports.templates = exports.CVTjC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CVTjC.
   * @public
   */

  goog.module('CVTjC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CVTjC.render';
  }
...
_metalSoy2.default.register(CVTjC, templates);
exports.CVTjC = CVTjC;
