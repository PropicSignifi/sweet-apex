...
var cVZSa = function (_Component) {
  _inherits(cVZSa, _Component);

  function cVZSa() {
    _classCallCheck(this, cVZSa);

    return _possibleConstructorReturn(this, (cVZSa.__proto__ || Object.getPrototypeOf(cVZSa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cVZSa, _lambdaSoy2.default);

exports.default = cVZSa;
...
exports.templates = exports.cVZSa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cVZSa.
   * @public
   */

  goog.module('cVZSa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cVZSa.render';
  }
...
_metalSoy2.default.register(cVZSa, templates);
exports.cVZSa = cVZSa;
