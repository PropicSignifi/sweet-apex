...
var ZrTZg = function (_Component) {
  _inherits(ZrTZg, _Component);

  function ZrTZg() {
    _classCallCheck(this, ZrTZg);

    return _possibleConstructorReturn(this, (ZrTZg.__proto__ || Object.getPrototypeOf(ZrTZg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZrTZg, _modSoy2.default);

exports.default = ZrTZg;
...
exports.templates = exports.ZrTZg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZrTZg.
   * @public
   */

  goog.module('ZrTZg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZrTZg.render';
  }
...
_metalSoy2.default.register(ZrTZg, templates);
exports.ZrTZg = ZrTZg;
