...
var VIzrw = function (_Component) {
  _inherits(VIzrw, _Component);

  function VIzrw() {
    _classCallCheck(this, VIzrw);

    return _possibleConstructorReturn(this, (VIzrw.__proto__ || Object.getPrototypeOf(VIzrw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VIzrw, _functionSoy2.default);

exports.default = VIzrw;
...
exports.templates = exports.VIzrw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VIzrw.
   * @public
   */

  goog.module('VIzrw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VIzrw.render';
  }
...
_metalSoy2.default.register(VIzrw, templates);
exports.VIzrw = VIzrw;
