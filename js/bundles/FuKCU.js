...
var FuKCU = function (_Component) {
  _inherits(FuKCU, _Component);

  function FuKCU() {
    _classCallCheck(this, FuKCU);

    return _possibleConstructorReturn(this, (FuKCU.__proto__ || Object.getPrototypeOf(FuKCU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FuKCU, _indexSoy2.default);

exports.default = FuKCU;
...
exports.templates = exports.FuKCU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FuKCU.
   * @public
   */

  goog.module('FuKCU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FuKCU.render';
  }
...
_metalSoy2.default.register(FuKCU, templates);
exports.FuKCU = FuKCU;
