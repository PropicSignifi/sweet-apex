...
var BVoJY = function (_Component) {
  _inherits(BVoJY, _Component);

  function BVoJY() {
    _classCallCheck(this, BVoJY);

    return _possibleConstructorReturn(this, (BVoJY.__proto__ || Object.getPrototypeOf(BVoJY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BVoJY, _configSoy2.default);

exports.default = BVoJY;
...
exports.templates = exports.BVoJY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BVoJY.
   * @public
   */

  goog.module('BVoJY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BVoJY.render';
  }
...
_metalSoy2.default.register(BVoJY, templates);
exports.BVoJY = BVoJY;
