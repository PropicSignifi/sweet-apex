...
var _step_2Soy = __webpack_require__(339);
...
var TSYOm = function (_Component) {
  _inherits(TSYOm, _Component);

  function TSYOm() {
    _classCallCheck(this, TSYOm);

    return _possibleConstructorReturn(this, (TSYOm.__proto__ || Object.getPrototypeOf(TSYOm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TSYOm, _step_2Soy2.default);

exports.default = TSYOm;
...
exports.templates = exports.TSYOm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TSYOm.
   * @public
   */

  goog.module('TSYOm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TSYOm.render';
  }
...
_metalSoy2.default.register(TSYOm, templates);
exports.TSYOm = TSYOm;
