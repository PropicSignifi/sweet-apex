...
var AxcMP = function (_Component) {
  _inherits(AxcMP, _Component);

  function AxcMP() {
    _classCallCheck(this, AxcMP);

    return _possibleConstructorReturn(this, (AxcMP.__proto__ || Object.getPrototypeOf(AxcMP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AxcMP, _enumSoy2.default);

exports.default = AxcMP;
...
exports.templates = exports.AxcMP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AxcMP.
   * @public
   */

  goog.module('AxcMP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AxcMP.render';
  }
...
_metalSoy2.default.register(AxcMP, templates);
exports.AxcMP = AxcMP;
