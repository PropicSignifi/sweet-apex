...
var Dkhfx = function (_Component) {
  _inherits(Dkhfx, _Component);

  function Dkhfx() {
    _classCallCheck(this, Dkhfx);

    return _possibleConstructorReturn(this, (Dkhfx.__proto__ || Object.getPrototypeOf(Dkhfx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Dkhfx, _configSoy2.default);

exports.default = Dkhfx;
...
exports.templates = exports.Dkhfx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Dkhfx.
   * @public
   */

  goog.module('Dkhfx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Dkhfx.render';
  }
...
_metalSoy2.default.register(Dkhfx, templates);
exports.Dkhfx = Dkhfx;
