...
var bUMyy = function (_Component) {
  _inherits(bUMyy, _Component);

  function bUMyy() {
    _classCallCheck(this, bUMyy);

    return _possibleConstructorReturn(this, (bUMyy.__proto__ || Object.getPrototypeOf(bUMyy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bUMyy, _step_2Soy2.default);

exports.default = bUMyy;
...
exports.templates = exports.bUMyy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bUMyy.
   * @public
   */

  goog.module('bUMyy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bUMyy.render';
  }
...
_metalSoy2.default.register(bUMyy, templates);
exports.bUMyy = bUMyy;
