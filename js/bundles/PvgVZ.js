...
var PvgVZ = function (_Component) {
  _inherits(PvgVZ, _Component);

  function PvgVZ() {
    _classCallCheck(this, PvgVZ);

    return _possibleConstructorReturn(this, (PvgVZ.__proto__ || Object.getPrototypeOf(PvgVZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PvgVZ, _annotationSoy2.default);

exports.default = PvgVZ;
...
exports.templates = exports.PvgVZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PvgVZ.
   * @public
   */

  goog.module('PvgVZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PvgVZ.render';
  }
...
_metalSoy2.default.register(PvgVZ, templates);
exports.PvgVZ = PvgVZ;
