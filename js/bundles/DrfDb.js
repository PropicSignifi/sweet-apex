...
var _functionSoy = __webpack_require__(315);
...
var DrfDb = function (_Component) {
  _inherits(DrfDb, _Component);

  function DrfDb() {
    _classCallCheck(this, DrfDb);

    return _possibleConstructorReturn(this, (DrfDb.__proto__ || Object.getPrototypeOf(DrfDb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DrfDb, _functionSoy2.default);

exports.default = DrfDb;
...
exports.templates = exports.DrfDb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DrfDb.
   * @public
   */

  goog.module('DrfDb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DrfDb.render';
  }
...
_metalSoy2.default.register(DrfDb, templates);
exports.DrfDb = DrfDb;
