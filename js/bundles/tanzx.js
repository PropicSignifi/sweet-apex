...
var tanzx = function (_Component) {
  _inherits(tanzx, _Component);

  function tanzx() {
    _classCallCheck(this, tanzx);

    return _possibleConstructorReturn(this, (tanzx.__proto__ || Object.getPrototypeOf(tanzx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tanzx, _fileSoy2.default);

exports.default = tanzx;
...
exports.templates = exports.tanzx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tanzx.
   * @public
   */

  goog.module('tanzx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tanzx.render';
  }
...
_metalSoy2.default.register(tanzx, templates);
exports.tanzx = tanzx;
