...
var AikCn = function (_Component) {
  _inherits(AikCn, _Component);

  function AikCn() {
    _classCallCheck(this, AikCn);

    return _possibleConstructorReturn(this, (AikCn.__proto__ || Object.getPrototypeOf(AikCn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AikCn, _castSoy2.default);

exports.default = AikCn;
...
exports.templates = exports.AikCn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AikCn.
   * @public
   */

  goog.module('AikCn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AikCn.render';
  }
...
_metalSoy2.default.register(AikCn, templates);
exports.AikCn = AikCn;
