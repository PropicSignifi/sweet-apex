...
var acAgR = function (_Component) {
  _inherits(acAgR, _Component);

  function acAgR() {
    _classCallCheck(this, acAgR);

    return _possibleConstructorReturn(this, (acAgR.__proto__ || Object.getPrototypeOf(acAgR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(acAgR, _default_valueSoy2.default);

exports.default = acAgR;
...
exports.templates = exports.acAgR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace acAgR.
   * @public
   */

  goog.module('acAgR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'acAgR.render';
  }
...
_metalSoy2.default.register(acAgR, templates);
exports.acAgR = acAgR;
