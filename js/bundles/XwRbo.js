...
var XwRbo = function (_Component) {
  _inherits(XwRbo, _Component);

  function XwRbo() {
    _classCallCheck(this, XwRbo);

    return _possibleConstructorReturn(this, (XwRbo.__proto__ || Object.getPrototypeOf(XwRbo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XwRbo, _indexSoy2.default);

exports.default = XwRbo;
...
exports.templates = exports.XwRbo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XwRbo.
   * @public
   */

  goog.module('XwRbo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XwRbo.render';
  }
...
_metalSoy2.default.register(XwRbo, templates);
exports.XwRbo = XwRbo;
