...
var CyEJf = function (_Component) {
  _inherits(CyEJf, _Component);

  function CyEJf() {
    _classCallCheck(this, CyEJf);

    return _possibleConstructorReturn(this, (CyEJf.__proto__ || Object.getPrototypeOf(CyEJf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CyEJf, _lambdaSoy2.default);

exports.default = CyEJf;
...
exports.templates = exports.CyEJf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CyEJf.
   * @public
   */

  goog.module('CyEJf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CyEJf.render';
  }
...
_metalSoy2.default.register(CyEJf, templates);
exports.CyEJf = CyEJf;
