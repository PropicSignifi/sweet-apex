...
var quByK = function (_Component) {
  _inherits(quByK, _Component);

  function quByK() {
    _classCallCheck(this, quByK);

    return _possibleConstructorReturn(this, (quByK.__proto__ || Object.getPrototypeOf(quByK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(quByK, _aspectSoy2.default);

exports.default = quByK;
...
exports.templates = exports.quByK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace quByK.
   * @public
   */

  goog.module('quByK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'quByK.render';
  }
...
_metalSoy2.default.register(quByK, templates);
exports.quByK = quByK;
