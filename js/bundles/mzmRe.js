...
var mzmRe = function (_Component) {
  _inherits(mzmRe, _Component);

  function mzmRe() {
    _classCallCheck(this, mzmRe);

    return _possibleConstructorReturn(this, (mzmRe.__proto__ || Object.getPrototypeOf(mzmRe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mzmRe, _injectSoy2.default);

exports.default = mzmRe;
...
exports.templates = exports.mzmRe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mzmRe.
   * @public
   */

  goog.module('mzmRe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mzmRe.render';
  }
...
_metalSoy2.default.register(mzmRe, templates);
exports.mzmRe = mzmRe;
