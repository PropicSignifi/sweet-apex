...
var wNuvp = function (_Component) {
  _inherits(wNuvp, _Component);

  function wNuvp() {
    _classCallCheck(this, wNuvp);

    return _possibleConstructorReturn(this, (wNuvp.__proto__ || Object.getPrototypeOf(wNuvp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wNuvp, _apexdocSoy2.default);

exports.default = wNuvp;
...
exports.templates = exports.wNuvp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wNuvp.
   * @public
   */

  goog.module('wNuvp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wNuvp.render';
  }
...
_metalSoy2.default.register(wNuvp, templates);
exports.wNuvp = wNuvp;
