...
var DvFCr = function (_Component) {
  _inherits(DvFCr, _Component);

  function DvFCr() {
    _classCallCheck(this, DvFCr);

    return _possibleConstructorReturn(this, (DvFCr.__proto__ || Object.getPrototypeOf(DvFCr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DvFCr, _scriptSoy2.default);

exports.default = DvFCr;
...
exports.templates = exports.DvFCr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DvFCr.
   * @public
   */

  goog.module('DvFCr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DvFCr.render';
  }
...
_metalSoy2.default.register(DvFCr, templates);
exports.DvFCr = DvFCr;
