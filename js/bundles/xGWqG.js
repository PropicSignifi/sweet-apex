...
var xGWqG = function (_Component) {
  _inherits(xGWqG, _Component);

  function xGWqG() {
    _classCallCheck(this, xGWqG);

    return _possibleConstructorReturn(this, (xGWqG.__proto__ || Object.getPrototypeOf(xGWqG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xGWqG, _constructor_annotationSoy2.default);

exports.default = xGWqG;
...
exports.templates = exports.xGWqG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xGWqG.
   * @public
   */

  goog.module('xGWqG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xGWqG.render';
  }
...
_metalSoy2.default.register(xGWqG, templates);
exports.xGWqG = xGWqG;
