...
var KpAHA = function (_Component) {
  _inherits(KpAHA, _Component);

  function KpAHA() {
    _classCallCheck(this, KpAHA);

    return _possibleConstructorReturn(this, (KpAHA.__proto__ || Object.getPrototypeOf(KpAHA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KpAHA, _commandSoy2.default);

exports.default = KpAHA;
...
exports.templates = exports.KpAHA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KpAHA.
   * @public
   */

  goog.module('KpAHA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KpAHA.render';
  }
...
_metalSoy2.default.register(KpAHA, templates);
exports.KpAHA = KpAHA;
