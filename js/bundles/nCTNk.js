...
var nCTNk = function (_Component) {
  _inherits(nCTNk, _Component);

  function nCTNk() {
    _classCallCheck(this, nCTNk);

    return _possibleConstructorReturn(this, (nCTNk.__proto__ || Object.getPrototypeOf(nCTNk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nCTNk, _injectSoy2.default);

exports.default = nCTNk;
...
exports.templates = exports.nCTNk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nCTNk.
   * @public
   */

  goog.module('nCTNk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nCTNk.render';
  }
...
_metalSoy2.default.register(nCTNk, templates);
exports.nCTNk = nCTNk;
