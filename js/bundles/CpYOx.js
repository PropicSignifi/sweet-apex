...
var CpYOx = function (_Component) {
  _inherits(CpYOx, _Component);

  function CpYOx() {
    _classCallCheck(this, CpYOx);

    return _possibleConstructorReturn(this, (CpYOx.__proto__ || Object.getPrototypeOf(CpYOx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CpYOx, _lambdaSoy2.default);

exports.default = CpYOx;
...
exports.templates = exports.CpYOx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CpYOx.
   * @public
   */

  goog.module('CpYOx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CpYOx.render';
  }
...
_metalSoy2.default.register(CpYOx, templates);
exports.CpYOx = CpYOx;
