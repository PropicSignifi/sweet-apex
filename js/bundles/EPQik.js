...
var EPQik = function (_Component) {
  _inherits(EPQik, _Component);

  function EPQik() {
    _classCallCheck(this, EPQik);

    return _possibleConstructorReturn(this, (EPQik.__proto__ || Object.getPrototypeOf(EPQik)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EPQik, _identitySoy2.default);

exports.default = EPQik;
...
exports.templates = exports.EPQik = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EPQik.
   * @public
   */

  goog.module('EPQik.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EPQik.render';
  }
...
_metalSoy2.default.register(EPQik, templates);
exports.EPQik = EPQik;
