...
var yFiOL = function (_Component) {
  _inherits(yFiOL, _Component);

  function yFiOL() {
    _classCallCheck(this, yFiOL);

    return _possibleConstructorReturn(this, (yFiOL.__proto__ || Object.getPrototypeOf(yFiOL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yFiOL, _identitySoy2.default);

exports.default = yFiOL;
...
exports.templates = exports.yFiOL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yFiOL.
   * @public
   */

  goog.module('yFiOL.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param637 = function param637() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param637 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yFiOL.render';
  }
...
_metalSoy2.default.register(yFiOL, templates);
exports.yFiOL = yFiOL;
