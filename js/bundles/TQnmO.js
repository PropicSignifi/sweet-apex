...
var TQnmO = function (_Component) {
  _inherits(TQnmO, _Component);

  function TQnmO() {
    _classCallCheck(this, TQnmO);

    return _possibleConstructorReturn(this, (TQnmO.__proto__ || Object.getPrototypeOf(TQnmO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TQnmO, _map_accessSoy2.default);

exports.default = TQnmO;
...
exports.templates = exports.TQnmO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TQnmO.
   * @public
   */

  goog.module('TQnmO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TQnmO.render';
  }
...
_metalSoy2.default.register(TQnmO, templates);
exports.TQnmO = TQnmO;
