...
var QByGL = function (_Component) {
  _inherits(QByGL, _Component);

  function QByGL() {
    _classCallCheck(this, QByGL);

    return _possibleConstructorReturn(this, (QByGL.__proto__ || Object.getPrototypeOf(QByGL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QByGL, _enumSoy2.default);

exports.default = QByGL;
...
exports.templates = exports.QByGL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QByGL.
   * @public
   */

  goog.module('QByGL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QByGL.render';
  }
...
_metalSoy2.default.register(QByGL, templates);
exports.QByGL = QByGL;
