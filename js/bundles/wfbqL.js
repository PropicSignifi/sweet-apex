...
var wfbqL = function (_Component) {
  _inherits(wfbqL, _Component);

  function wfbqL() {
    _classCallCheck(this, wfbqL);

    return _possibleConstructorReturn(this, (wfbqL.__proto__ || Object.getPrototypeOf(wfbqL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wfbqL, _enumSoy2.default);

exports.default = wfbqL;
...
exports.templates = exports.wfbqL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wfbqL.
   * @public
   */

  goog.module('wfbqL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wfbqL.render';
  }
...
_metalSoy2.default.register(wfbqL, templates);
exports.wfbqL = wfbqL;
