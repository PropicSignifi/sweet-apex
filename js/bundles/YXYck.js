...
var YXYck = function (_Component) {
  _inherits(YXYck, _Component);

  function YXYck() {
    _classCallCheck(this, YXYck);

    return _possibleConstructorReturn(this, (YXYck.__proto__ || Object.getPrototypeOf(YXYck)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YXYck, _actionSoy2.default);

exports.default = YXYck;
...
exports.templates = exports.YXYck = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YXYck.
   * @public
   */

  goog.module('YXYck.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YXYck.render';
  }
...
_metalSoy2.default.register(YXYck, templates);
exports.YXYck = YXYck;
