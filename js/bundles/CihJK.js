...
var CihJK = function (_Component) {
  _inherits(CihJK, _Component);

  function CihJK() {
    _classCallCheck(this, CihJK);

    return _possibleConstructorReturn(this, (CihJK.__proto__ || Object.getPrototypeOf(CihJK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CihJK, _array_creationSoy2.default);

exports.default = CihJK;
...
exports.templates = exports.CihJK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CihJK.
   * @public
   */

  goog.module('CihJK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CihJK.render';
  }
...
_metalSoy2.default.register(CihJK, templates);
exports.CihJK = CihJK;
