...
var KGqtS = function (_Component) {
  _inherits(KGqtS, _Component);

  function KGqtS() {
    _classCallCheck(this, KGqtS);

    return _possibleConstructorReturn(this, (KGqtS.__proto__ || Object.getPrototypeOf(KGqtS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KGqtS, _scriptSoy2.default);

exports.default = KGqtS;
...
exports.templates = exports.KGqtS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KGqtS.
   * @public
   */

  goog.module('KGqtS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KGqtS.render';
  }
...
_metalSoy2.default.register(KGqtS, templates);
exports.KGqtS = KGqtS;
