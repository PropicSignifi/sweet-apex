...
var nsnwc = function (_Component) {
  _inherits(nsnwc, _Component);

  function nsnwc() {
    _classCallCheck(this, nsnwc);

    return _possibleConstructorReturn(this, (nsnwc.__proto__ || Object.getPrototypeOf(nsnwc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nsnwc, _injectSoy2.default);

exports.default = nsnwc;
...
exports.templates = exports.nsnwc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nsnwc.
   * @public
   */

  goog.module('nsnwc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nsnwc.render';
  }
...
_metalSoy2.default.register(nsnwc, templates);
exports.nsnwc = nsnwc;
