...
var Wadpa = function (_Component) {
  _inherits(Wadpa, _Component);

  function Wadpa() {
    _classCallCheck(this, Wadpa);

    return _possibleConstructorReturn(this, (Wadpa.__proto__ || Object.getPrototypeOf(Wadpa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Wadpa, _template_stringSoy2.default);

exports.default = Wadpa;
...
exports.templates = exports.Wadpa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Wadpa.
   * @public
   */

  goog.module('Wadpa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Wadpa.render';
  }
...
_metalSoy2.default.register(Wadpa, templates);
exports.Wadpa = Wadpa;
