...
var LBjIm = function (_Component) {
  _inherits(LBjIm, _Component);

  function LBjIm() {
    _classCallCheck(this, LBjIm);

    return _possibleConstructorReturn(this, (LBjIm.__proto__ || Object.getPrototypeOf(LBjIm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LBjIm, _enumSoy2.default);

exports.default = LBjIm;
...
exports.templates = exports.LBjIm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LBjIm.
   * @public
   */

  goog.module('LBjIm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LBjIm.render';
  }
...
_metalSoy2.default.register(LBjIm, templates);
exports.LBjIm = LBjIm;
