...
var vAeqe = function (_Component) {
  _inherits(vAeqe, _Component);

  function vAeqe() {
    _classCallCheck(this, vAeqe);

    return _possibleConstructorReturn(this, (vAeqe.__proto__ || Object.getPrototypeOf(vAeqe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vAeqe, _templateSoy2.default);

exports.default = vAeqe;
...
exports.templates = exports.vAeqe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vAeqe.
   * @public
   */

  goog.module('vAeqe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vAeqe.render';
  }
...
_metalSoy2.default.register(vAeqe, templates);
exports.vAeqe = vAeqe;
