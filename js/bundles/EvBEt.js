...
var EvBEt = function (_Component) {
  _inherits(EvBEt, _Component);

  function EvBEt() {
    _classCallCheck(this, EvBEt);

    return _possibleConstructorReturn(this, (EvBEt.__proto__ || Object.getPrototypeOf(EvBEt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EvBEt, _identitySoy2.default);

exports.default = EvBEt;
...
exports.templates = exports.EvBEt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EvBEt.
   * @public
   */

  goog.module('EvBEt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EvBEt.render';
  }
...
_metalSoy2.default.register(EvBEt, templates);
exports.EvBEt = EvBEt;
