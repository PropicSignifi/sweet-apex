...
var wtVwv = function (_Component) {
  _inherits(wtVwv, _Component);

  function wtVwv() {
    _classCallCheck(this, wtVwv);

    return _possibleConstructorReturn(this, (wtVwv.__proto__ || Object.getPrototypeOf(wtVwv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wtVwv, _grammarSoy2.default);

exports.default = wtVwv;
...
exports.templates = exports.wtVwv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wtVwv.
   * @public
   */

  goog.module('wtVwv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wtVwv.render';
  }
...
_metalSoy2.default.register(wtVwv, templates);
exports.wtVwv = wtVwv;
