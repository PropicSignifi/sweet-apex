...
var yXiaE = function (_Component) {
  _inherits(yXiaE, _Component);

  function yXiaE() {
    _classCallCheck(this, yXiaE);

    return _possibleConstructorReturn(this, (yXiaE.__proto__ || Object.getPrototypeOf(yXiaE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yXiaE, _aspectSoy2.default);

exports.default = yXiaE;
...
exports.templates = exports.yXiaE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yXiaE.
   * @public
   */

  goog.module('yXiaE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yXiaE.render';
  }
...
_metalSoy2.default.register(yXiaE, templates);
exports.yXiaE = yXiaE;
