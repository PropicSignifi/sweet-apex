...
var BOZPr = function (_Component) {
  _inherits(BOZPr, _Component);

  function BOZPr() {
    _classCallCheck(this, BOZPr);

    return _possibleConstructorReturn(this, (BOZPr.__proto__ || Object.getPrototypeOf(BOZPr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BOZPr, _grammarSoy2.default);

exports.default = BOZPr;
...
exports.templates = exports.BOZPr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BOZPr.
   * @public
   */

  goog.module('BOZPr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BOZPr.render';
  }
...
_metalSoy2.default.register(BOZPr, templates);
exports.BOZPr = BOZPr;
