...
var BKKed = function (_Component) {
  _inherits(BKKed, _Component);

  function BKKed() {
    _classCallCheck(this, BKKed);

    return _possibleConstructorReturn(this, (BKKed.__proto__ || Object.getPrototypeOf(BKKed)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BKKed, _functionSoy2.default);

exports.default = BKKed;
...
exports.templates = exports.BKKed = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BKKed.
   * @public
   */

  goog.module('BKKed.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BKKed.render';
  }
...
_metalSoy2.default.register(BKKed, templates);
exports.BKKed = BKKed;
