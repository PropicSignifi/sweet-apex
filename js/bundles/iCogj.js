...
var iCogj = function (_Component) {
  _inherits(iCogj, _Component);

  function iCogj() {
    _classCallCheck(this, iCogj);

    return _possibleConstructorReturn(this, (iCogj.__proto__ || Object.getPrototypeOf(iCogj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iCogj, _map_accessSoy2.default);

exports.default = iCogj;
...
exports.templates = exports.iCogj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iCogj.
   * @public
   */

  goog.module('iCogj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iCogj.render';
  }
...
_metalSoy2.default.register(iCogj, templates);
exports.iCogj = iCogj;
