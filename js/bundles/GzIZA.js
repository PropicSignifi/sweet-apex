...
var GzIZA = function (_Component) {
  _inherits(GzIZA, _Component);

  function GzIZA() {
    _classCallCheck(this, GzIZA);

    return _possibleConstructorReturn(this, (GzIZA.__proto__ || Object.getPrototypeOf(GzIZA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GzIZA, _commandSoy2.default);

exports.default = GzIZA;
...
exports.templates = exports.GzIZA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GzIZA.
   * @public
   */

  goog.module('GzIZA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GzIZA.render';
  }
...
_metalSoy2.default.register(GzIZA, templates);
exports.GzIZA = GzIZA;
