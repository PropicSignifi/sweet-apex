...
var Ndwyf = function (_Component) {
  _inherits(Ndwyf, _Component);

  function Ndwyf() {
    _classCallCheck(this, Ndwyf);

    return _possibleConstructorReturn(this, (Ndwyf.__proto__ || Object.getPrototypeOf(Ndwyf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Ndwyf, _scriptSoy2.default);

exports.default = Ndwyf;
...
exports.templates = exports.Ndwyf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Ndwyf.
   * @public
   */

  goog.module('Ndwyf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Ndwyf.render';
  }
...
_metalSoy2.default.register(Ndwyf, templates);
exports.Ndwyf = Ndwyf;
