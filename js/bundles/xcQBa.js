...
var xcQBa = function (_Component) {
  _inherits(xcQBa, _Component);

  function xcQBa() {
    _classCallCheck(this, xcQBa);

    return _possibleConstructorReturn(this, (xcQBa.__proto__ || Object.getPrototypeOf(xcQBa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xcQBa, _featureSoy2.default);

exports.default = xcQBa;
...
exports.templates = exports.xcQBa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xcQBa.
   * @public
   */

  goog.module('xcQBa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xcQBa.render';
  }
...
_metalSoy2.default.register(xcQBa, templates);
exports.xcQBa = xcQBa;
