...
var YxAqh = function (_Component) {
  _inherits(YxAqh, _Component);

  function YxAqh() {
    _classCallCheck(this, YxAqh);

    return _possibleConstructorReturn(this, (YxAqh.__proto__ || Object.getPrototypeOf(YxAqh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YxAqh, _commandSoy2.default);

exports.default = YxAqh;
...
exports.templates = exports.YxAqh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YxAqh.
   * @public
   */

  goog.module('YxAqh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YxAqh.render';
  }
...
_metalSoy2.default.register(YxAqh, templates);
exports.YxAqh = YxAqh;
