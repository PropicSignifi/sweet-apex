...
var _reflectSoy = __webpack_require__(329);
...
var icHHI = function (_Component) {
  _inherits(icHHI, _Component);

  function icHHI() {
    _classCallCheck(this, icHHI);

    return _possibleConstructorReturn(this, (icHHI.__proto__ || Object.getPrototypeOf(icHHI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(icHHI, _reflectSoy2.default);

exports.default = icHHI;
...
exports.templates = exports.icHHI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace icHHI.
   * @public
   */

  goog.module('icHHI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'icHHI.render';
  }
...
_metalSoy2.default.register(icHHI, templates);
exports.icHHI = icHHI;
