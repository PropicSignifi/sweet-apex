...
var iEPFR = function (_Component) {
  _inherits(iEPFR, _Component);

  function iEPFR() {
    _classCallCheck(this, iEPFR);

    return _possibleConstructorReturn(this, (iEPFR.__proto__ || Object.getPrototypeOf(iEPFR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iEPFR, _grammarSoy2.default);

exports.default = iEPFR;
...
exports.templates = exports.iEPFR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iEPFR.
   * @public
   */

  goog.module('iEPFR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iEPFR.render';
  }
...
_metalSoy2.default.register(iEPFR, templates);
exports.iEPFR = iEPFR;
