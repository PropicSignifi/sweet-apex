...
var HytsZ = function (_Component) {
  _inherits(HytsZ, _Component);

  function HytsZ() {
    _classCallCheck(this, HytsZ);

    return _possibleConstructorReturn(this, (HytsZ.__proto__ || Object.getPrototypeOf(HytsZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HytsZ, _template_stringSoy2.default);

exports.default = HytsZ;
...
exports.templates = exports.HytsZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HytsZ.
   * @public
   */

  goog.module('HytsZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HytsZ.render';
  }
...
_metalSoy2.default.register(HytsZ, templates);
exports.HytsZ = HytsZ;
