...
var _aspectSoy = __webpack_require__(303);
...
var gRqIx = function (_Component) {
  _inherits(gRqIx, _Component);

  function gRqIx() {
    _classCallCheck(this, gRqIx);

    return _possibleConstructorReturn(this, (gRqIx.__proto__ || Object.getPrototypeOf(gRqIx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gRqIx, _aspectSoy2.default);

exports.default = gRqIx;
...
exports.templates = exports.gRqIx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gRqIx.
   * @public
   */

  goog.module('gRqIx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gRqIx.render';
  }
...
_metalSoy2.default.register(gRqIx, templates);
exports.gRqIx = gRqIx;
