...
var AUwoN = function (_Component) {
  _inherits(AUwoN, _Component);

  function AUwoN() {
    _classCallCheck(this, AUwoN);

    return _possibleConstructorReturn(this, (AUwoN.__proto__ || Object.getPrototypeOf(AUwoN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AUwoN, _functionSoy2.default);

exports.default = AUwoN;
...
exports.templates = exports.AUwoN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AUwoN.
   * @public
   */

  goog.module('AUwoN.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param616 = function param616() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AUwoN.render';
  }
...
_metalSoy2.default.register(AUwoN, templates);
exports.AUwoN = AUwoN;
