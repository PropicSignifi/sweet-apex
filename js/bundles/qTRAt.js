...
var qTRAt = function (_Component) {
  _inherits(qTRAt, _Component);

  function qTRAt() {
    _classCallCheck(this, qTRAt);

    return _possibleConstructorReturn(this, (qTRAt.__proto__ || Object.getPrototypeOf(qTRAt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qTRAt, _transpilationSoy2.default);

exports.default = qTRAt;
...
exports.templates = exports.qTRAt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qTRAt.
   * @public
   */

  goog.module('qTRAt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qTRAt.render';
  }
...
_metalSoy2.default.register(qTRAt, templates);
exports.qTRAt = qTRAt;
