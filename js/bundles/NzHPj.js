...
var NzHPj = function (_Component) {
  _inherits(NzHPj, _Component);

  function NzHPj() {
    _classCallCheck(this, NzHPj);

    return _possibleConstructorReturn(this, (NzHPj.__proto__ || Object.getPrototypeOf(NzHPj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NzHPj, _templateSoy2.default);

exports.default = NzHPj;
...
exports.templates = exports.NzHPj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NzHPj.
   * @public
   */

  goog.module('NzHPj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NzHPj.render';
  }
...
_metalSoy2.default.register(NzHPj, templates);
exports.NzHPj = NzHPj;
