...
var GRNuE = function (_Component) {
  _inherits(GRNuE, _Component);

  function GRNuE() {
    _classCallCheck(this, GRNuE);

    return _possibleConstructorReturn(this, (GRNuE.__proto__ || Object.getPrototypeOf(GRNuE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GRNuE, _commandSoy2.default);

exports.default = GRNuE;
...
exports.templates = exports.GRNuE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GRNuE.
   * @public
   */

  goog.module('GRNuE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GRNuE.render';
  }
...
_metalSoy2.default.register(GRNuE, templates);
exports.GRNuE = GRNuE;
