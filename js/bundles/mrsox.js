...
var mrsox = function (_Component) {
  _inherits(mrsox, _Component);

  function mrsox() {
    _classCallCheck(this, mrsox);

    return _possibleConstructorReturn(this, (mrsox.__proto__ || Object.getPrototypeOf(mrsox)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mrsox, _grammarSoy2.default);

exports.default = mrsox;
...
exports.templates = exports.mrsox = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mrsox.
   * @public
   */

  goog.module('mrsox.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mrsox.render';
  }
...
_metalSoy2.default.register(mrsox, templates);
exports.mrsox = mrsox;
