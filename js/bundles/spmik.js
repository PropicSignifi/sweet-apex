...
var spmik = function (_Component) {
  _inherits(spmik, _Component);

  function spmik() {
    _classCallCheck(this, spmik);

    return _possibleConstructorReturn(this, (spmik.__proto__ || Object.getPrototypeOf(spmik)).apply(this, arguments));
  }
...
_metalSoy2.default.register(spmik, _operatorSoy2.default);

exports.default = spmik;
...
exports.templates = exports.spmik = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace spmik.
   * @public
   */

  goog.module('spmik.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'spmik.render';
  }
...
_metalSoy2.default.register(spmik, templates);
exports.spmik = spmik;
