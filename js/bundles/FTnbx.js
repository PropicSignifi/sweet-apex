...
var FTnbx = function (_Component) {
  _inherits(FTnbx, _Component);

  function FTnbx() {
    _classCallCheck(this, FTnbx);

    return _possibleConstructorReturn(this, (FTnbx.__proto__ || Object.getPrototypeOf(FTnbx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FTnbx, _identitySoy2.default);

exports.default = FTnbx;
...
exports.templates = exports.FTnbx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FTnbx.
   * @public
   */

  goog.module('FTnbx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FTnbx.render';
  }
...
_metalSoy2.default.register(FTnbx, templates);
exports.FTnbx = FTnbx;
