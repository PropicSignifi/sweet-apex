...
var jvYLu = function (_Component) {
  _inherits(jvYLu, _Component);

  function jvYLu() {
    _classCallCheck(this, jvYLu);

    return _possibleConstructorReturn(this, (jvYLu.__proto__ || Object.getPrototypeOf(jvYLu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jvYLu, _rethrowSoy2.default);

exports.default = jvYLu;
...
exports.templates = exports.jvYLu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jvYLu.
   * @public
   */

  goog.module('jvYLu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jvYLu.render';
  }
...
_metalSoy2.default.register(jvYLu, templates);
exports.jvYLu = jvYLu;
