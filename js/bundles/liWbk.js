...
var liWbk = function (_Component) {
  _inherits(liWbk, _Component);

  function liWbk() {
    _classCallCheck(this, liWbk);

    return _possibleConstructorReturn(this, (liWbk.__proto__ || Object.getPrototypeOf(liWbk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(liWbk, _annotationSoy2.default);

exports.default = liWbk;
...
exports.templates = exports.liWbk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace liWbk.
   * @public
   */

  goog.module('liWbk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'liWbk.render';
  }
...
_metalSoy2.default.register(liWbk, templates);
exports.liWbk = liWbk;
