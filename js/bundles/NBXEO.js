...
var NBXEO = function (_Component) {
  _inherits(NBXEO, _Component);

  function NBXEO() {
    _classCallCheck(this, NBXEO);

    return _possibleConstructorReturn(this, (NBXEO.__proto__ || Object.getPrototypeOf(NBXEO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NBXEO, _step_4Soy2.default);

exports.default = NBXEO;
...
exports.templates = exports.NBXEO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NBXEO.
   * @public
   */

  goog.module('NBXEO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NBXEO.render';
  }
...
_metalSoy2.default.register(NBXEO, templates);
exports.NBXEO = NBXEO;
