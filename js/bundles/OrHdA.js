...
var _testcaseSoy = __webpack_require__(295);
...
var OrHdA = function (_Component) {
  _inherits(OrHdA, _Component);

  function OrHdA() {
    _classCallCheck(this, OrHdA);

    return _possibleConstructorReturn(this, (OrHdA.__proto__ || Object.getPrototypeOf(OrHdA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OrHdA, _testcaseSoy2.default);

exports.default = OrHdA;
...
exports.templates = exports.OrHdA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OrHdA.
   * @public
   */

  goog.module('OrHdA.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param432 = function param432() {
      ...
      ie_close('p');
      $templateAlias2({ code: 'node transpile.js resource/ build/ mod -c', mode: 'bash' }, null, opt_ijData);
      ie_close('article');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OrHdA.render';
  }
...
_metalSoy2.default.register(OrHdA, templates);
exports.OrHdA = OrHdA;
