...
var CYnbc = function (_Component) {
  _inherits(CYnbc, _Component);

  function CYnbc() {
    _classCallCheck(this, CYnbc);

    return _possibleConstructorReturn(this, (CYnbc.__proto__ || Object.getPrototypeOf(CYnbc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CYnbc, _grammarSoy2.default);

exports.default = CYnbc;
...
exports.templates = exports.CYnbc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CYnbc.
   * @public
   */

  goog.module('CYnbc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CYnbc.render';
  }
...
_metalSoy2.default.register(CYnbc, templates);
exports.CYnbc = CYnbc;
