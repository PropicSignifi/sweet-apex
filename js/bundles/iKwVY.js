...
var _tagged_stringSoy = __webpack_require__(347);
...
var iKwVY = function (_Component) {
  _inherits(iKwVY, _Component);

  function iKwVY() {
    _classCallCheck(this, iKwVY);

    return _possibleConstructorReturn(this, (iKwVY.__proto__ || Object.getPrototypeOf(iKwVY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iKwVY, _tagged_stringSoy2.default);

exports.default = iKwVY;
...
exports.templates = exports.iKwVY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iKwVY.
   * @public
   */

  goog.module('iKwVY.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1139 = function param1139() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1139 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iKwVY.render';
  }
...
_metalSoy2.default.register(iKwVY, templates);
exports.iKwVY = iKwVY;
