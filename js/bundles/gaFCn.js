...
var gaFCn = function (_Component) {
  _inherits(gaFCn, _Component);

  function gaFCn() {
    _classCallCheck(this, gaFCn);

    return _possibleConstructorReturn(this, (gaFCn.__proto__ || Object.getPrototypeOf(gaFCn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gaFCn, _indexSoy2.default);

exports.default = gaFCn;
...
exports.templates = exports.gaFCn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gaFCn.
   * @public
   */

  goog.module('gaFCn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gaFCn.render';
  }
...
_metalSoy2.default.register(gaFCn, templates);
exports.gaFCn = gaFCn;
