...
var edPWh = function (_Component) {
  _inherits(edPWh, _Component);

  function edPWh() {
    _classCallCheck(this, edPWh);

    return _possibleConstructorReturn(this, (edPWh.__proto__ || Object.getPrototypeOf(edPWh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(edPWh, _aspectSoy2.default);

exports.default = edPWh;
...
exports.templates = exports.edPWh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace edPWh.
   * @public
   */

  goog.module('edPWh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'edPWh.render';
  }
...
_metalSoy2.default.register(edPWh, templates);
exports.edPWh = edPWh;
