...
var uLbgd = function (_Component) {
  _inherits(uLbgd, _Component);

  function uLbgd() {
    _classCallCheck(this, uLbgd);

    return _possibleConstructorReturn(this, (uLbgd.__proto__ || Object.getPrototypeOf(uLbgd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uLbgd, _functionSoy2.default);

exports.default = uLbgd;
...
exports.templates = exports.uLbgd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uLbgd.
   * @public
   */

  goog.module('uLbgd.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param709 = function param709() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uLbgd.render';
  }
...
_metalSoy2.default.register(uLbgd, templates);
exports.uLbgd = uLbgd;
