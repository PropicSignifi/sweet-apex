...
var vuNoJ = function (_Component) {
  _inherits(vuNoJ, _Component);

  function vuNoJ() {
    _classCallCheck(this, vuNoJ);

    return _possibleConstructorReturn(this, (vuNoJ.__proto__ || Object.getPrototypeOf(vuNoJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vuNoJ, _apexdocSoy2.default);

exports.default = vuNoJ;
...
exports.templates = exports.vuNoJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vuNoJ.
   * @public
   */

  goog.module('vuNoJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vuNoJ.render';
  }
...
_metalSoy2.default.register(vuNoJ, templates);
exports.vuNoJ = vuNoJ;
