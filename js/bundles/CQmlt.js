...
var CQmlt = function (_Component) {
  _inherits(CQmlt, _Component);

  function CQmlt() {
    _classCallCheck(this, CQmlt);

    return _possibleConstructorReturn(this, (CQmlt.__proto__ || Object.getPrototypeOf(CQmlt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CQmlt, _tagged_stringSoy2.default);

exports.default = CQmlt;
...
exports.templates = exports.CQmlt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CQmlt.
   * @public
   */

  goog.module('CQmlt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CQmlt.render';
  }
...
_metalSoy2.default.register(CQmlt, templates);
exports.CQmlt = CQmlt;
