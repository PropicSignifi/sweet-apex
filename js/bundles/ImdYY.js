...
var ImdYY = function (_Component) {
  _inherits(ImdYY, _Component);

  function ImdYY() {
    _classCallCheck(this, ImdYY);

    return _possibleConstructorReturn(this, (ImdYY.__proto__ || Object.getPrototypeOf(ImdYY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ImdYY, _castSoy2.default);

exports.default = ImdYY;
...
exports.templates = exports.ImdYY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ImdYY.
   * @public
   */

  goog.module('ImdYY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ImdYY.render';
  }
...
_metalSoy2.default.register(ImdYY, templates);
exports.ImdYY = ImdYY;
