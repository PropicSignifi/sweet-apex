...
var dOrLK = function (_Component) {
  _inherits(dOrLK, _Component);

  function dOrLK() {
    _classCallCheck(this, dOrLK);

    return _possibleConstructorReturn(this, (dOrLK.__proto__ || Object.getPrototypeOf(dOrLK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dOrLK, _indexSoy2.default);

exports.default = dOrLK;
...
exports.templates = exports.dOrLK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dOrLK.
   * @public
   */

  goog.module('dOrLK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dOrLK.render';
  }
...
_metalSoy2.default.register(dOrLK, templates);
exports.dOrLK = dOrLK;
