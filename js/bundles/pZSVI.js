...
var pZSVI = function (_Component) {
  _inherits(pZSVI, _Component);

  function pZSVI() {
    _classCallCheck(this, pZSVI);

    return _possibleConstructorReturn(this, (pZSVI.__proto__ || Object.getPrototypeOf(pZSVI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pZSVI, _grammarSoy2.default);

exports.default = pZSVI;
...
exports.templates = exports.pZSVI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pZSVI.
   * @public
   */

  goog.module('pZSVI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pZSVI.render';
  }
...
_metalSoy2.default.register(pZSVI, templates);
exports.pZSVI = pZSVI;
