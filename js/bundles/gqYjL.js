...
var _aspectSoy = __webpack_require__(291);
...
var gqYjL = function (_Component) {
  _inherits(gqYjL, _Component);

  function gqYjL() {
    _classCallCheck(this, gqYjL);

    return _possibleConstructorReturn(this, (gqYjL.__proto__ || Object.getPrototypeOf(gqYjL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gqYjL, _aspectSoy2.default);

exports.default = gqYjL;
...
exports.templates = exports.gqYjL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gqYjL.
   * @public
   */

  goog.module('gqYjL.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param516 = function param516() {
      ...
      ie_close('p');
      ie_open('p');
      itext('The first argument will be the target object invoking this method, or the target class if it is a static method.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gqYjL.render';
  }
...
_metalSoy2.default.register(gqYjL, templates);
exports.gqYjL = gqYjL;
