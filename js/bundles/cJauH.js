...
var cJauH = function (_Component) {
  _inherits(cJauH, _Component);

  function cJauH() {
    _classCallCheck(this, cJauH);

    return _possibleConstructorReturn(this, (cJauH.__proto__ || Object.getPrototypeOf(cJauH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cJauH, _enumSoy2.default);

exports.default = cJauH;
...
exports.templates = exports.cJauH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cJauH.
   * @public
   */

  goog.module('cJauH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cJauH.render';
  }
...
_metalSoy2.default.register(cJauH, templates);
exports.cJauH = cJauH;
