...
var OVviI = function (_Component) {
  _inherits(OVviI, _Component);

  function OVviI() {
    _classCallCheck(this, OVviI);

    return _possibleConstructorReturn(this, (OVviI.__proto__ || Object.getPrototypeOf(OVviI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OVviI, _rethrowSoy2.default);

exports.default = OVviI;
...
exports.templates = exports.OVviI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OVviI.
   * @public
   */

  goog.module('OVviI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OVviI.render';
  }
...
_metalSoy2.default.register(OVviI, templates);
exports.OVviI = OVviI;
