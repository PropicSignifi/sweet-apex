...
var uBnqA = function (_Component) {
  _inherits(uBnqA, _Component);

  function uBnqA() {
    _classCallCheck(this, uBnqA);

    return _possibleConstructorReturn(this, (uBnqA.__proto__ || Object.getPrototypeOf(uBnqA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uBnqA, _indexSoy2.default);

exports.default = uBnqA;
...
exports.templates = exports.uBnqA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uBnqA.
   * @public
   */

  goog.module('uBnqA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uBnqA.render';
  }
...
_metalSoy2.default.register(uBnqA, templates);
exports.uBnqA = uBnqA;
