...
var lVZjl = function (_Component) {
  _inherits(lVZjl, _Component);

  function lVZjl() {
    _classCallCheck(this, lVZjl);

    return _possibleConstructorReturn(this, (lVZjl.__proto__ || Object.getPrototypeOf(lVZjl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lVZjl, _step_5Soy2.default);

exports.default = lVZjl;
...
exports.templates = exports.lVZjl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lVZjl.
   * @public
   */

  goog.module('lVZjl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lVZjl.render';
  }
...
_metalSoy2.default.register(lVZjl, templates);
exports.lVZjl = lVZjl;
