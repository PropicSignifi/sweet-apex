...
var rewvq = function (_Component) {
  _inherits(rewvq, _Component);

  function rewvq() {
    _classCallCheck(this, rewvq);

    return _possibleConstructorReturn(this, (rewvq.__proto__ || Object.getPrototypeOf(rewvq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rewvq, _apexdocSoy2.default);

exports.default = rewvq;
...
exports.templates = exports.rewvq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rewvq.
   * @public
   */

  goog.module('rewvq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rewvq.render';
  }
...
_metalSoy2.default.register(rewvq, templates);
exports.rewvq = rewvq;
