...
var zRBPv = function (_Component) {
  _inherits(zRBPv, _Component);

  function zRBPv() {
    _classCallCheck(this, zRBPv);

    return _possibleConstructorReturn(this, (zRBPv.__proto__ || Object.getPrototypeOf(zRBPv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zRBPv, _featureSoy2.default);

exports.default = zRBPv;
...
exports.templates = exports.zRBPv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zRBPv.
   * @public
   */

  goog.module('zRBPv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zRBPv.render';
  }
...
_metalSoy2.default.register(zRBPv, templates);
exports.zRBPv = zRBPv;
