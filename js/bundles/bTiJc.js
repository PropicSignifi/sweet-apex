...
var bTiJc = function (_Component) {
  _inherits(bTiJc, _Component);

  function bTiJc() {
    _classCallCheck(this, bTiJc);

    return _possibleConstructorReturn(this, (bTiJc.__proto__ || Object.getPrototypeOf(bTiJc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bTiJc, _fileSoy2.default);

exports.default = bTiJc;
...
exports.templates = exports.bTiJc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bTiJc.
   * @public
   */

  goog.module('bTiJc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bTiJc.render';
  }
...
_metalSoy2.default.register(bTiJc, templates);
exports.bTiJc = bTiJc;
