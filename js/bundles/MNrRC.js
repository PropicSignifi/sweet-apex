...
var MNrRC = function (_Component) {
  _inherits(MNrRC, _Component);

  function MNrRC() {
    _classCallCheck(this, MNrRC);

    return _possibleConstructorReturn(this, (MNrRC.__proto__ || Object.getPrototypeOf(MNrRC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MNrRC, _nullableSoy2.default);

exports.default = MNrRC;
...
exports.templates = exports.MNrRC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MNrRC.
   * @public
   */

  goog.module('MNrRC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MNrRC.render';
  }
...
_metalSoy2.default.register(MNrRC, templates);
exports.MNrRC = MNrRC;
