...
var pxECs = function (_Component) {
  _inherits(pxECs, _Component);

  function pxECs() {
    _classCallCheck(this, pxECs);

    return _possibleConstructorReturn(this, (pxECs.__proto__ || Object.getPrototypeOf(pxECs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pxECs, _operatorSoy2.default);

exports.default = pxECs;
...
exports.templates = exports.pxECs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pxECs.
   * @public
   */

  goog.module('pxECs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pxECs.render';
  }
...
_metalSoy2.default.register(pxECs, templates);
exports.pxECs = pxECs;
