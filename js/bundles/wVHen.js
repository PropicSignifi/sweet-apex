...
var wVHen = function (_Component) {
  _inherits(wVHen, _Component);

  function wVHen() {
    _classCallCheck(this, wVHen);

    return _possibleConstructorReturn(this, (wVHen.__proto__ || Object.getPrototypeOf(wVHen)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wVHen, _featureSoy2.default);

exports.default = wVHen;
...
exports.templates = exports.wVHen = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wVHen.
   * @public
   */

  goog.module('wVHen.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wVHen.render';
  }
...
_metalSoy2.default.register(wVHen, templates);
exports.wVHen = wVHen;
