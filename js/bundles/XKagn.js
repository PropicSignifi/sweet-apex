...
var XKagn = function (_Component) {
  _inherits(XKagn, _Component);

  function XKagn() {
    _classCallCheck(this, XKagn);

    return _possibleConstructorReturn(this, (XKagn.__proto__ || Object.getPrototypeOf(XKagn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XKagn, _apexdocSoy2.default);

exports.default = XKagn;
...
exports.templates = exports.XKagn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XKagn.
   * @public
   */

  goog.module('XKagn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XKagn.render';
  }
...
_metalSoy2.default.register(XKagn, templates);
exports.XKagn = XKagn;
