...
var qRThQ = function (_Component) {
  _inherits(qRThQ, _Component);

  function qRThQ() {
    _classCallCheck(this, qRThQ);

    return _possibleConstructorReturn(this, (qRThQ.__proto__ || Object.getPrototypeOf(qRThQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qRThQ, _injectSoy2.default);

exports.default = qRThQ;
...
exports.templates = exports.qRThQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qRThQ.
   * @public
   */

  goog.module('qRThQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qRThQ.render';
  }
...
_metalSoy2.default.register(qRThQ, templates);
exports.qRThQ = qRThQ;
