...
var TaGVS = function (_Component) {
  _inherits(TaGVS, _Component);

  function TaGVS() {
    _classCallCheck(this, TaGVS);

    return _possibleConstructorReturn(this, (TaGVS.__proto__ || Object.getPrototypeOf(TaGVS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TaGVS, _indexSoy2.default);

exports.default = TaGVS;
...
exports.templates = exports.TaGVS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TaGVS.
   * @public
   */

  goog.module('TaGVS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TaGVS.render';
  }
...
_metalSoy2.default.register(TaGVS, templates);
exports.TaGVS = TaGVS;
