...
var tSjXC = function (_Component) {
  _inherits(tSjXC, _Component);

  function tSjXC() {
    _classCallCheck(this, tSjXC);

    return _possibleConstructorReturn(this, (tSjXC.__proto__ || Object.getPrototypeOf(tSjXC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tSjXC, _testcaseSoy2.default);

exports.default = tSjXC;
...
exports.templates = exports.tSjXC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tSjXC.
   * @public
   */

  goog.module('tSjXC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tSjXC.render';
  }
...
_metalSoy2.default.register(tSjXC, templates);
exports.tSjXC = tSjXC;
