...
var LIYXD = function (_Component) {
  _inherits(LIYXD, _Component);

  function LIYXD() {
    _classCallCheck(this, LIYXD);

    return _possibleConstructorReturn(this, (LIYXD.__proto__ || Object.getPrototypeOf(LIYXD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LIYXD, _testcaseSoy2.default);

exports.default = LIYXD;
...
exports.templates = exports.LIYXD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LIYXD.
   * @public
   */

  goog.module('LIYXD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LIYXD.render';
  }
...
_metalSoy2.default.register(LIYXD, templates);
exports.LIYXD = LIYXD;
