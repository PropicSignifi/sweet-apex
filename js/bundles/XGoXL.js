...
var XGoXL = function (_Component) {
  _inherits(XGoXL, _Component);

  function XGoXL() {
    _classCallCheck(this, XGoXL);

    return _possibleConstructorReturn(this, (XGoXL.__proto__ || Object.getPrototypeOf(XGoXL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XGoXL, _apexdocSoy2.default);

exports.default = XGoXL;
...
exports.templates = exports.XGoXL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XGoXL.
   * @public
   */

  goog.module('XGoXL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XGoXL.render';
  }
...
_metalSoy2.default.register(XGoXL, templates);
exports.XGoXL = XGoXL;
