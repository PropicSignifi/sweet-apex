...
var TMVZx = function (_Component) {
  _inherits(TMVZx, _Component);

  function TMVZx() {
    _classCallCheck(this, TMVZx);

    return _possibleConstructorReturn(this, (TMVZx.__proto__ || Object.getPrototypeOf(TMVZx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TMVZx, _indexSoy2.default);

exports.default = TMVZx;
...
exports.templates = exports.TMVZx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TMVZx.
   * @public
   */

  goog.module('TMVZx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TMVZx.render';
  }
...
_metalSoy2.default.register(TMVZx, templates);
exports.TMVZx = TMVZx;
