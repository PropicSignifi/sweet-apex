...
var obDRc = function (_Component) {
  _inherits(obDRc, _Component);

  function obDRc() {
    _classCallCheck(this, obDRc);

    return _possibleConstructorReturn(this, (obDRc.__proto__ || Object.getPrototypeOf(obDRc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(obDRc, _lambdaSoy2.default);

exports.default = obDRc;
...
exports.templates = exports.obDRc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace obDRc.
   * @public
   */

  goog.module('obDRc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'obDRc.render';
  }
...
_metalSoy2.default.register(obDRc, templates);
exports.obDRc = obDRc;
