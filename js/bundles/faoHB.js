...
var faoHB = function (_Component) {
  _inherits(faoHB, _Component);

  function faoHB() {
    _classCallCheck(this, faoHB);

    return _possibleConstructorReturn(this, (faoHB.__proto__ || Object.getPrototypeOf(faoHB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(faoHB, _enumSoy2.default);

exports.default = faoHB;
...
exports.templates = exports.faoHB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace faoHB.
   * @public
   */

  goog.module('faoHB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'faoHB.render';
  }
...
_metalSoy2.default.register(faoHB, templates);
exports.faoHB = faoHB;
