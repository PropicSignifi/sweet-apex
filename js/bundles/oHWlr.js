...
var _templateSoy = __webpack_require__(345);
...
var oHWlr = function (_Component) {
  _inherits(oHWlr, _Component);

  function oHWlr() {
    _classCallCheck(this, oHWlr);

    return _possibleConstructorReturn(this, (oHWlr.__proto__ || Object.getPrototypeOf(oHWlr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oHWlr, _templateSoy2.default);

exports.default = oHWlr;
...
exports.templates = exports.oHWlr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oHWlr.
   * @public
   */

  goog.module('oHWlr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oHWlr.render';
  }
...
_metalSoy2.default.register(oHWlr, templates);
exports.oHWlr = oHWlr;
