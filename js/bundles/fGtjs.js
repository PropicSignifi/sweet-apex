...
var fGtjs = function (_Component) {
  _inherits(fGtjs, _Component);

  function fGtjs() {
    _classCallCheck(this, fGtjs);

    return _possibleConstructorReturn(this, (fGtjs.__proto__ || Object.getPrototypeOf(fGtjs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fGtjs, _reflectSoy2.default);

exports.default = fGtjs;
...
exports.templates = exports.fGtjs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fGtjs.
   * @public
   */

  goog.module('fGtjs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fGtjs.render';
  }
...
_metalSoy2.default.register(fGtjs, templates);
exports.fGtjs = fGtjs;
