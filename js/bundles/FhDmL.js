...
var FhDmL = function (_Component) {
  _inherits(FhDmL, _Component);

  function FhDmL() {
    _classCallCheck(this, FhDmL);

    return _possibleConstructorReturn(this, (FhDmL.__proto__ || Object.getPrototypeOf(FhDmL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FhDmL, _varSoy2.default);

exports.default = FhDmL;
...
exports.templates = exports.FhDmL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FhDmL.
   * @public
   */

  goog.module('FhDmL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FhDmL.render';
  }
...
_metalSoy2.default.register(FhDmL, templates);
exports.FhDmL = FhDmL;
