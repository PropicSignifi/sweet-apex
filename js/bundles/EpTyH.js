...
var EpTyH = function (_Component) {
  _inherits(EpTyH, _Component);

  function EpTyH() {
    _classCallCheck(this, EpTyH);

    return _possibleConstructorReturn(this, (EpTyH.__proto__ || Object.getPrototypeOf(EpTyH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EpTyH, _fileSoy2.default);

exports.default = EpTyH;
...
exports.templates = exports.EpTyH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EpTyH.
   * @public
   */

  goog.module('EpTyH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EpTyH.render';
  }
...
_metalSoy2.default.register(EpTyH, templates);
exports.EpTyH = EpTyH;
