...
var _map_accessSoy = __webpack_require__(317);
...
var ougmU = function (_Component) {
  _inherits(ougmU, _Component);

  function ougmU() {
    _classCallCheck(this, ougmU);

    return _possibleConstructorReturn(this, (ougmU.__proto__ || Object.getPrototypeOf(ougmU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ougmU, _map_accessSoy2.default);

exports.default = ougmU;
...
exports.templates = exports.ougmU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ougmU.
   * @public
   */

  goog.module('ougmU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ougmU.render';
  }
...
_metalSoy2.default.register(ougmU, templates);
exports.ougmU = ougmU;
