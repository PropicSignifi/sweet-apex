...
var IFIsN = function (_Component) {
  _inherits(IFIsN, _Component);

  function IFIsN() {
    _classCallCheck(this, IFIsN);

    return _possibleConstructorReturn(this, (IFIsN.__proto__ || Object.getPrototypeOf(IFIsN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IFIsN, _step_3Soy2.default);

exports.default = IFIsN;
...
exports.templates = exports.IFIsN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IFIsN.
   * @public
   */

  goog.module('IFIsN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IFIsN.render';
  }
...
_metalSoy2.default.register(IFIsN, templates);
exports.IFIsN = IFIsN;
