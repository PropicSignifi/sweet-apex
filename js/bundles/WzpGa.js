...
var WzpGa = function (_Component) {
  _inherits(WzpGa, _Component);

  function WzpGa() {
    _classCallCheck(this, WzpGa);

    return _possibleConstructorReturn(this, (WzpGa.__proto__ || Object.getPrototypeOf(WzpGa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WzpGa, _transpilationSoy2.default);

exports.default = WzpGa;
...
exports.templates = exports.WzpGa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WzpGa.
   * @public
   */

  goog.module('WzpGa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WzpGa.render';
  }
...
_metalSoy2.default.register(WzpGa, templates);
exports.WzpGa = WzpGa;
