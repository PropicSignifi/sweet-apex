...
var gDYUv = function (_Component) {
  _inherits(gDYUv, _Component);

  function gDYUv() {
    _classCallCheck(this, gDYUv);

    return _possibleConstructorReturn(this, (gDYUv.__proto__ || Object.getPrototypeOf(gDYUv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gDYUv, _indexSoy2.default);

exports.default = gDYUv;
...
exports.templates = exports.gDYUv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gDYUv.
   * @public
   */

  goog.module('gDYUv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gDYUv.render';
  }
...
_metalSoy2.default.register(gDYUv, templates);
exports.gDYUv = gDYUv;
