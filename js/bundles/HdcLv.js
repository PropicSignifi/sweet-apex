...
var HdcLv = function (_Component) {
  _inherits(HdcLv, _Component);

  function HdcLv() {
    _classCallCheck(this, HdcLv);

    return _possibleConstructorReturn(this, (HdcLv.__proto__ || Object.getPrototypeOf(HdcLv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HdcLv, _configSoy2.default);

exports.default = HdcLv;
...
exports.templates = exports.HdcLv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HdcLv.
   * @public
   */

  goog.module('HdcLv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HdcLv.render';
  }
...
_metalSoy2.default.register(HdcLv, templates);
exports.HdcLv = HdcLv;
