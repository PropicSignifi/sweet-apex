...
var _operatorSoy = __webpack_require__(331);
...
var iMIme = function (_Component) {
  _inherits(iMIme, _Component);

  function iMIme() {
    _classCallCheck(this, iMIme);

    return _possibleConstructorReturn(this, (iMIme.__proto__ || Object.getPrototypeOf(iMIme)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iMIme, _operatorSoy2.default);

exports.default = iMIme;
...
exports.templates = exports.iMIme = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iMIme.
   * @public
   */

  goog.module('iMIme.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iMIme.render';
  }
...
_metalSoy2.default.register(iMIme, templates);
exports.iMIme = iMIme;
