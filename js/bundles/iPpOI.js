...
var iPpOI = function (_Component) {
  _inherits(iPpOI, _Component);

  function iPpOI() {
    _classCallCheck(this, iPpOI);

    return _possibleConstructorReturn(this, (iPpOI.__proto__ || Object.getPrototypeOf(iPpOI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iPpOI, _indexSoy2.default);

exports.default = iPpOI;
...
exports.templates = exports.iPpOI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iPpOI.
   * @public
   */

  goog.module('iPpOI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param663 = function param663() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iPpOI.render';
  }
...
_metalSoy2.default.register(iPpOI, templates);
exports.iPpOI = iPpOI;
