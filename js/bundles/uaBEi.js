...
var uaBEi = function (_Component) {
  _inherits(uaBEi, _Component);

  function uaBEi() {
    _classCallCheck(this, uaBEi);

    return _possibleConstructorReturn(this, (uaBEi.__proto__ || Object.getPrototypeOf(uaBEi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uaBEi, _identitySoy2.default);

exports.default = uaBEi;
...
exports.templates = exports.uaBEi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uaBEi.
   * @public
   */

  goog.module('uaBEi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uaBEi.render';
  }
...
_metalSoy2.default.register(uaBEi, templates);
exports.uaBEi = uaBEi;
