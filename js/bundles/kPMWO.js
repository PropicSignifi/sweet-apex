...
var kPMWO = function (_Component) {
  _inherits(kPMWO, _Component);

  function kPMWO() {
    _classCallCheck(this, kPMWO);

    return _possibleConstructorReturn(this, (kPMWO.__proto__ || Object.getPrototypeOf(kPMWO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kPMWO, _featureSoy2.default);

exports.default = kPMWO;
...
exports.templates = exports.kPMWO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kPMWO.
   * @public
   */

  goog.module('kPMWO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kPMWO.render';
  }
...
_metalSoy2.default.register(kPMWO, templates);
exports.kPMWO = kPMWO;
