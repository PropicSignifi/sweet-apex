...
var qSYiC = function (_Component) {
  _inherits(qSYiC, _Component);

  function qSYiC() {
    _classCallCheck(this, qSYiC);

    return _possibleConstructorReturn(this, (qSYiC.__proto__ || Object.getPrototypeOf(qSYiC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qSYiC, _transpilationSoy2.default);

exports.default = qSYiC;
...
exports.templates = exports.qSYiC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qSYiC.
   * @public
   */

  goog.module('qSYiC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qSYiC.render';
  }
...
_metalSoy2.default.register(qSYiC, templates);
exports.qSYiC = qSYiC;
