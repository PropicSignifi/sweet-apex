...
var KHrzl = function (_Component) {
  _inherits(KHrzl, _Component);

  function KHrzl() {
    _classCallCheck(this, KHrzl);

    return _possibleConstructorReturn(this, (KHrzl.__proto__ || Object.getPrototypeOf(KHrzl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KHrzl, _scriptSoy2.default);

exports.default = KHrzl;
...
exports.templates = exports.KHrzl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KHrzl.
   * @public
   */

  goog.module('KHrzl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KHrzl.render';
  }
...
_metalSoy2.default.register(KHrzl, templates);
exports.KHrzl = KHrzl;
