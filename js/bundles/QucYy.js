...
var QucYy = function (_Component) {
  _inherits(QucYy, _Component);

  function QucYy() {
    _classCallCheck(this, QucYy);

    return _possibleConstructorReturn(this, (QucYy.__proto__ || Object.getPrototypeOf(QucYy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QucYy, _castSoy2.default);

exports.default = QucYy;
...
exports.templates = exports.QucYy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QucYy.
   * @public
   */

  goog.module('QucYy.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param583 = function param583() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param583 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QucYy.render';
  }
...
_metalSoy2.default.register(QucYy, templates);
exports.QucYy = QucYy;
