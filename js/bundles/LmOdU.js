...
var LmOdU = function (_Component) {
  _inherits(LmOdU, _Component);

  function LmOdU() {
    _classCallCheck(this, LmOdU);

    return _possibleConstructorReturn(this, (LmOdU.__proto__ || Object.getPrototypeOf(LmOdU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LmOdU, _template_stringSoy2.default);

exports.default = LmOdU;
...
exports.templates = exports.LmOdU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LmOdU.
   * @public
   */

  goog.module('LmOdU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LmOdU.render';
  }
...
_metalSoy2.default.register(LmOdU, templates);
exports.LmOdU = LmOdU;
