...
var ADSMa = function (_Component) {
  _inherits(ADSMa, _Component);

  function ADSMa() {
    _classCallCheck(this, ADSMa);

    return _possibleConstructorReturn(this, (ADSMa.__proto__ || Object.getPrototypeOf(ADSMa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ADSMa, _commandSoy2.default);

exports.default = ADSMa;
...
exports.templates = exports.ADSMa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ADSMa.
   * @public
   */

  goog.module('ADSMa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ADSMa.render';
  }
...
_metalSoy2.default.register(ADSMa, templates);
exports.ADSMa = ADSMa;
