...
var sxmxN = function (_Component) {
  _inherits(sxmxN, _Component);

  function sxmxN() {
    _classCallCheck(this, sxmxN);

    return _possibleConstructorReturn(this, (sxmxN.__proto__ || Object.getPrototypeOf(sxmxN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sxmxN, _array_creationSoy2.default);

exports.default = sxmxN;
...
exports.templates = exports.sxmxN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sxmxN.
   * @public
   */

  goog.module('sxmxN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sxmxN.render';
  }
...
_metalSoy2.default.register(sxmxN, templates);
exports.sxmxN = sxmxN;
