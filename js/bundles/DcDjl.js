...
var DcDjl = function (_Component) {
  _inherits(DcDjl, _Component);

  function DcDjl() {
    _classCallCheck(this, DcDjl);

    return _possibleConstructorReturn(this, (DcDjl.__proto__ || Object.getPrototypeOf(DcDjl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DcDjl, _aspectSoy2.default);

exports.default = DcDjl;
...
exports.templates = exports.DcDjl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DcDjl.
   * @public
   */

  goog.module('DcDjl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DcDjl.render';
  }
...
_metalSoy2.default.register(DcDjl, templates);
exports.DcDjl = DcDjl;
