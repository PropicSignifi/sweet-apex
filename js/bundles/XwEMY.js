...
var XwEMY = function (_Component) {
  _inherits(XwEMY, _Component);

  function XwEMY() {
    _classCallCheck(this, XwEMY);

    return _possibleConstructorReturn(this, (XwEMY.__proto__ || Object.getPrototypeOf(XwEMY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XwEMY, _actionSoy2.default);

exports.default = XwEMY;
...
exports.templates = exports.XwEMY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XwEMY.
   * @public
   */

  goog.module('XwEMY.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param448 = function param448() {
      ...
      itext('@action');
      ie_close('code');
      itext(' can only be used on public static methods with ');
      ie_open('code');
      itext('@AuraEnabled');
      ie_close('code');
      itext('.');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XwEMY.render';
  }
...
_metalSoy2.default.register(XwEMY, templates);
exports.XwEMY = XwEMY;
