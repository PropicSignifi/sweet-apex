...
var PSKon = function (_Component) {
  _inherits(PSKon, _Component);

  function PSKon() {
    _classCallCheck(this, PSKon);

    return _possibleConstructorReturn(this, (PSKon.__proto__ || Object.getPrototypeOf(PSKon)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PSKon, _transpilationSoy2.default);

exports.default = PSKon;
...
exports.templates = exports.PSKon = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PSKon.
   * @public
   */

  goog.module('PSKon.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PSKon.render';
  }
...
_metalSoy2.default.register(PSKon, templates);
exports.PSKon = PSKon;
