...
var Rgmjc = function (_Component) {
  _inherits(Rgmjc, _Component);

  function Rgmjc() {
    _classCallCheck(this, Rgmjc);

    return _possibleConstructorReturn(this, (Rgmjc.__proto__ || Object.getPrototypeOf(Rgmjc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rgmjc, _commandSoy2.default);

exports.default = Rgmjc;
...
exports.templates = exports.Rgmjc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rgmjc.
   * @public
   */

  goog.module('Rgmjc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rgmjc.render';
  }
...
_metalSoy2.default.register(Rgmjc, templates);
exports.Rgmjc = Rgmjc;
