...
var fclpY = function (_Component) {
  _inherits(fclpY, _Component);

  function fclpY() {
    _classCallCheck(this, fclpY);

    return _possibleConstructorReturn(this, (fclpY.__proto__ || Object.getPrototypeOf(fclpY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fclpY, _castSoy2.default);

exports.default = fclpY;
...
exports.templates = exports.fclpY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fclpY.
   * @public
   */

  goog.module('fclpY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fclpY.render';
  }
...
_metalSoy2.default.register(fclpY, templates);
exports.fclpY = fclpY;
