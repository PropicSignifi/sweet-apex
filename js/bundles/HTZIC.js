...
var HTZIC = function (_Component) {
  _inherits(HTZIC, _Component);

  function HTZIC() {
    _classCallCheck(this, HTZIC);

    return _possibleConstructorReturn(this, (HTZIC.__proto__ || Object.getPrototypeOf(HTZIC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HTZIC, _lambdaSoy2.default);

exports.default = HTZIC;
...
exports.templates = exports.HTZIC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HTZIC.
   * @public
   */

  goog.module('HTZIC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HTZIC.render';
  }
...
_metalSoy2.default.register(HTZIC, templates);
exports.HTZIC = HTZIC;
