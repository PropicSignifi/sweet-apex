...
var wXTbW = function (_Component) {
  _inherits(wXTbW, _Component);

  function wXTbW() {
    _classCallCheck(this, wXTbW);

    return _possibleConstructorReturn(this, (wXTbW.__proto__ || Object.getPrototypeOf(wXTbW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wXTbW, _step_4Soy2.default);

exports.default = wXTbW;
...
exports.templates = exports.wXTbW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wXTbW.
   * @public
   */

  goog.module('wXTbW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wXTbW.render';
  }
...
_metalSoy2.default.register(wXTbW, templates);
exports.wXTbW = wXTbW;
