...
var RoKMx = function (_Component) {
  _inherits(RoKMx, _Component);

  function RoKMx() {
    _classCallCheck(this, RoKMx);

    return _possibleConstructorReturn(this, (RoKMx.__proto__ || Object.getPrototypeOf(RoKMx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RoKMx, _castSoy2.default);

exports.default = RoKMx;
...
exports.templates = exports.RoKMx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RoKMx.
   * @public
   */

  goog.module('RoKMx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RoKMx.render';
  }
...
_metalSoy2.default.register(RoKMx, templates);
exports.RoKMx = RoKMx;
