...
var onAKr = function (_Component) {
  _inherits(onAKr, _Component);

  function onAKr() {
    _classCallCheck(this, onAKr);

    return _possibleConstructorReturn(this, (onAKr.__proto__ || Object.getPrototypeOf(onAKr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(onAKr, _lambdaSoy2.default);

exports.default = onAKr;
...
exports.templates = exports.onAKr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace onAKr.
   * @public
   */

  goog.module('onAKr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'onAKr.render';
  }
...
_metalSoy2.default.register(onAKr, templates);
exports.onAKr = onAKr;
