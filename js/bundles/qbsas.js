...
var qbsas = function (_Component) {
  _inherits(qbsas, _Component);

  function qbsas() {
    _classCallCheck(this, qbsas);

    return _possibleConstructorReturn(this, (qbsas.__proto__ || Object.getPrototypeOf(qbsas)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qbsas, _operatorSoy2.default);

exports.default = qbsas;
...
exports.templates = exports.qbsas = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qbsas.
   * @public
   */

  goog.module('qbsas.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qbsas.render';
  }
...
_metalSoy2.default.register(qbsas, templates);
exports.qbsas = qbsas;
