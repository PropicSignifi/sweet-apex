...
var DdSVt = function (_Component) {
  _inherits(DdSVt, _Component);

  function DdSVt() {
    _classCallCheck(this, DdSVt);

    return _possibleConstructorReturn(this, (DdSVt.__proto__ || Object.getPrototypeOf(DdSVt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DdSVt, _indexSoy2.default);

exports.default = DdSVt;
...
exports.templates = exports.DdSVt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DdSVt.
   * @public
   */

  goog.module('DdSVt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DdSVt.render';
  }
...
_metalSoy2.default.register(DdSVt, templates);
exports.DdSVt = DdSVt;
