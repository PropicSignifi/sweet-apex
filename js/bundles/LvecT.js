...
var LvecT = function (_Component) {
  _inherits(LvecT, _Component);

  function LvecT() {
    _classCallCheck(this, LvecT);

    return _possibleConstructorReturn(this, (LvecT.__proto__ || Object.getPrototypeOf(LvecT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LvecT, _functionSoy2.default);

exports.default = LvecT;
...
exports.templates = exports.LvecT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LvecT.
   * @public
   */

  goog.module('LvecT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LvecT.render';
  }
...
_metalSoy2.default.register(LvecT, templates);
exports.LvecT = LvecT;
