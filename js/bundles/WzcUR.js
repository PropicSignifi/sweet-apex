...
var WzcUR = function (_Component) {
  _inherits(WzcUR, _Component);

  function WzcUR() {
    _classCallCheck(this, WzcUR);

    return _possibleConstructorReturn(this, (WzcUR.__proto__ || Object.getPrototypeOf(WzcUR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WzcUR, _injectSoy2.default);

exports.default = WzcUR;
...
exports.templates = exports.WzcUR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WzcUR.
   * @public
   */

  goog.module('WzcUR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WzcUR.render';
  }
...
_metalSoy2.default.register(WzcUR, templates);
exports.WzcUR = WzcUR;
