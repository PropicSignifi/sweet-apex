...
var jEnLG = function (_Component) {
  _inherits(jEnLG, _Component);

  function jEnLG() {
    _classCallCheck(this, jEnLG);

    return _possibleConstructorReturn(this, (jEnLG.__proto__ || Object.getPrototypeOf(jEnLG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jEnLG, _annotationSoy2.default);

exports.default = jEnLG;
...
exports.templates = exports.jEnLG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jEnLG.
   * @public
   */

  goog.module('jEnLG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jEnLG.render';
  }
...
_metalSoy2.default.register(jEnLG, templates);
exports.jEnLG = jEnLG;
