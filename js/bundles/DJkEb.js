...
var DJkEb = function (_Component) {
  _inherits(DJkEb, _Component);

  function DJkEb() {
    _classCallCheck(this, DJkEb);

    return _possibleConstructorReturn(this, (DJkEb.__proto__ || Object.getPrototypeOf(DJkEb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DJkEb, _indexSoy2.default);

exports.default = DJkEb;
...
exports.templates = exports.DJkEb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DJkEb.
   * @public
   */

  goog.module('DJkEb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DJkEb.render';
  }
...
_metalSoy2.default.register(DJkEb, templates);
exports.DJkEb = DJkEb;
