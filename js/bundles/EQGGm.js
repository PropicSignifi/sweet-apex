...
var EQGGm = function (_Component) {
  _inherits(EQGGm, _Component);

  function EQGGm() {
    _classCallCheck(this, EQGGm);

    return _possibleConstructorReturn(this, (EQGGm.__proto__ || Object.getPrototypeOf(EQGGm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EQGGm, _annotationSoy2.default);

exports.default = EQGGm;
...
exports.templates = exports.EQGGm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EQGGm.
   * @public
   */

  goog.module('EQGGm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EQGGm.render';
  }
...
_metalSoy2.default.register(EQGGm, templates);
exports.EQGGm = EQGGm;
