...
var bFFPU = function (_Component) {
  _inherits(bFFPU, _Component);

  function bFFPU() {
    _classCallCheck(this, bFFPU);

    return _possibleConstructorReturn(this, (bFFPU.__proto__ || Object.getPrototypeOf(bFFPU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bFFPU, _functionSoy2.default);

exports.default = bFFPU;
...
exports.templates = exports.bFFPU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bFFPU.
   * @public
   */

  goog.module('bFFPU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bFFPU.render';
  }
...
_metalSoy2.default.register(bFFPU, templates);
exports.bFFPU = bFFPU;
