...
var _apexdocSoy = __webpack_require__(301);
...
var AMNLH = function (_Component) {
  _inherits(AMNLH, _Component);

  function AMNLH() {
    _classCallCheck(this, AMNLH);

    return _possibleConstructorReturn(this, (AMNLH.__proto__ || Object.getPrototypeOf(AMNLH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AMNLH, _apexdocSoy2.default);

exports.default = AMNLH;
...
exports.templates = exports.AMNLH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AMNLH.
   * @public
   */

  goog.module('AMNLH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AMNLH.render';
  }
...
_metalSoy2.default.register(AMNLH, templates);
exports.AMNLH = AMNLH;
