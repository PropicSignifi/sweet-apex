...
var _reflectSoy = __webpack_require__(327);
...
var JNUHC = function (_Component) {
  _inherits(JNUHC, _Component);

  function JNUHC() {
    _classCallCheck(this, JNUHC);

    return _possibleConstructorReturn(this, (JNUHC.__proto__ || Object.getPrototypeOf(JNUHC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JNUHC, _reflectSoy2.default);

exports.default = JNUHC;
...
exports.templates = exports.JNUHC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JNUHC.
   * @public
   */

  goog.module('JNUHC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JNUHC.render';
  }
...
_metalSoy2.default.register(JNUHC, templates);
exports.JNUHC = JNUHC;
