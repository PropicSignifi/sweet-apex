...
var KpANI = function (_Component) {
  _inherits(KpANI, _Component);

  function KpANI() {
    _classCallCheck(this, KpANI);

    return _possibleConstructorReturn(this, (KpANI.__proto__ || Object.getPrototypeOf(KpANI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KpANI, _apexdocSoy2.default);

exports.default = KpANI;
...
exports.templates = exports.KpANI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KpANI.
   * @public
   */

  goog.module('KpANI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KpANI.render';
  }
...
_metalSoy2.default.register(KpANI, templates);
exports.KpANI = KpANI;
