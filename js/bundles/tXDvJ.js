...
var tXDvJ = function (_Component) {
  _inherits(tXDvJ, _Component);

  function tXDvJ() {
    _classCallCheck(this, tXDvJ);

    return _possibleConstructorReturn(this, (tXDvJ.__proto__ || Object.getPrototypeOf(tXDvJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tXDvJ, _injectSoy2.default);

exports.default = tXDvJ;
...
exports.templates = exports.tXDvJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tXDvJ.
   * @public
   */

  goog.module('tXDvJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tXDvJ.render';
  }
...
_metalSoy2.default.register(tXDvJ, templates);
exports.tXDvJ = tXDvJ;
