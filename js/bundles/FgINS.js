...
var FgINS = function (_Component) {
  _inherits(FgINS, _Component);

  function FgINS() {
    _classCallCheck(this, FgINS);

    return _possibleConstructorReturn(this, (FgINS.__proto__ || Object.getPrototypeOf(FgINS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FgINS, _functionSoy2.default);

exports.default = FgINS;
...
exports.templates = exports.FgINS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FgINS.
   * @public
   */

  goog.module('FgINS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FgINS.render';
  }
...
_metalSoy2.default.register(FgINS, templates);
exports.FgINS = FgINS;
