...
var QQWil = function (_Component) {
  _inherits(QQWil, _Component);

  function QQWil() {
    _classCallCheck(this, QQWil);

    return _possibleConstructorReturn(this, (QQWil.__proto__ || Object.getPrototypeOf(QQWil)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QQWil, _annotationSoy2.default);

exports.default = QQWil;
...
exports.templates = exports.QQWil = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QQWil.
   * @public
   */

  goog.module('QQWil.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QQWil.render';
  }
...
_metalSoy2.default.register(QQWil, templates);
exports.QQWil = QQWil;
