...
var SXCmc = function (_Component) {
  _inherits(SXCmc, _Component);

  function SXCmc() {
    _classCallCheck(this, SXCmc);

    return _possibleConstructorReturn(this, (SXCmc.__proto__ || Object.getPrototypeOf(SXCmc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SXCmc, _castSoy2.default);

exports.default = SXCmc;
...
exports.templates = exports.SXCmc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SXCmc.
   * @public
   */

  goog.module('SXCmc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SXCmc.render';
  }
...
_metalSoy2.default.register(SXCmc, templates);
exports.SXCmc = SXCmc;
