...
var nqnyI = function (_Component) {
  _inherits(nqnyI, _Component);

  function nqnyI() {
    _classCallCheck(this, nqnyI);

    return _possibleConstructorReturn(this, (nqnyI.__proto__ || Object.getPrototypeOf(nqnyI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nqnyI, _array_creationSoy2.default);

exports.default = nqnyI;
...
exports.templates = exports.nqnyI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nqnyI.
   * @public
   */

  goog.module('nqnyI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nqnyI.render';
  }
...
_metalSoy2.default.register(nqnyI, templates);
exports.nqnyI = nqnyI;
