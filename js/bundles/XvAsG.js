...
var XvAsG = function (_Component) {
  _inherits(XvAsG, _Component);

  function XvAsG() {
    _classCallCheck(this, XvAsG);

    return _possibleConstructorReturn(this, (XvAsG.__proto__ || Object.getPrototypeOf(XvAsG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XvAsG, _lambdaSoy2.default);

exports.default = XvAsG;
...
exports.templates = exports.XvAsG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XvAsG.
   * @public
   */

  goog.module('XvAsG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XvAsG.render';
  }
...
_metalSoy2.default.register(XvAsG, templates);
exports.XvAsG = XvAsG;
