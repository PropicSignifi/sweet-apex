...
var ZAQhZ = function (_Component) {
  _inherits(ZAQhZ, _Component);

  function ZAQhZ() {
    _classCallCheck(this, ZAQhZ);

    return _possibleConstructorReturn(this, (ZAQhZ.__proto__ || Object.getPrototypeOf(ZAQhZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZAQhZ, _reflectSoy2.default);

exports.default = ZAQhZ;
...
exports.templates = exports.ZAQhZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZAQhZ.
   * @public
   */

  goog.module('ZAQhZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZAQhZ.render';
  }
...
_metalSoy2.default.register(ZAQhZ, templates);
exports.ZAQhZ = ZAQhZ;
