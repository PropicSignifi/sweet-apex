...
var _step_2Soy = __webpack_require__(349);
...
var feKho = function (_Component) {
  _inherits(feKho, _Component);

  function feKho() {
    _classCallCheck(this, feKho);

    return _possibleConstructorReturn(this, (feKho.__proto__ || Object.getPrototypeOf(feKho)).apply(this, arguments));
  }
...
_metalSoy2.default.register(feKho, _step_2Soy2.default);

exports.default = feKho;
...
exports.templates = exports.feKho = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace feKho.
   * @public
   */

  goog.module('feKho.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'feKho.render';
  }
...
_metalSoy2.default.register(feKho, templates);
exports.feKho = feKho;
