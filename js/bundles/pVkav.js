...
var pVkav = function (_Component) {
  _inherits(pVkav, _Component);

  function pVkav() {
    _classCallCheck(this, pVkav);

    return _possibleConstructorReturn(this, (pVkav.__proto__ || Object.getPrototypeOf(pVkav)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pVkav, _aspectSoy2.default);

exports.default = pVkav;
...
exports.templates = exports.pVkav = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pVkav.
   * @public
   */

  goog.module('pVkav.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pVkav.render';
  }
...
_metalSoy2.default.register(pVkav, templates);
exports.pVkav = pVkav;
