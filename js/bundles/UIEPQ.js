...
var UIEPQ = function (_Component) {
  _inherits(UIEPQ, _Component);

  function UIEPQ() {
    _classCallCheck(this, UIEPQ);

    return _possibleConstructorReturn(this, (UIEPQ.__proto__ || Object.getPrototypeOf(UIEPQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UIEPQ, _castSoy2.default);

exports.default = UIEPQ;
...
exports.templates = exports.UIEPQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UIEPQ.
   * @public
   */

  goog.module('UIEPQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UIEPQ.render';
  }
...
_metalSoy2.default.register(UIEPQ, templates);
exports.UIEPQ = UIEPQ;
