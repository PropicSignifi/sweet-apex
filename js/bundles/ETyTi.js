...
var ETyTi = function (_Component) {
  _inherits(ETyTi, _Component);

  function ETyTi() {
    _classCallCheck(this, ETyTi);

    return _possibleConstructorReturn(this, (ETyTi.__proto__ || Object.getPrototypeOf(ETyTi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ETyTi, _destructureSoy2.default);

exports.default = ETyTi;
...
exports.templates = exports.ETyTi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ETyTi.
   * @public
   */

  goog.module('ETyTi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ETyTi.render';
  }
...
_metalSoy2.default.register(ETyTi, templates);
exports.ETyTi = ETyTi;
