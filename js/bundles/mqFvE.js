...
var mqFvE = function (_Component) {
  _inherits(mqFvE, _Component);

  function mqFvE() {
    _classCallCheck(this, mqFvE);

    return _possibleConstructorReturn(this, (mqFvE.__proto__ || Object.getPrototypeOf(mqFvE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mqFvE, _array_creationSoy2.default);

exports.default = mqFvE;
...
exports.templates = exports.mqFvE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mqFvE.
   * @public
   */

  goog.module('mqFvE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mqFvE.render';
  }
...
_metalSoy2.default.register(mqFvE, templates);
exports.mqFvE = mqFvE;
