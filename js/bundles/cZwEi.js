...
var cZwEi = function (_Component) {
  _inherits(cZwEi, _Component);

  function cZwEi() {
    _classCallCheck(this, cZwEi);

    return _possibleConstructorReturn(this, (cZwEi.__proto__ || Object.getPrototypeOf(cZwEi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cZwEi, _configSoy2.default);

exports.default = cZwEi;
...
exports.templates = exports.cZwEi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cZwEi.
   * @public
   */

  goog.module('cZwEi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cZwEi.render';
  }
...
_metalSoy2.default.register(cZwEi, templates);
exports.cZwEi = cZwEi;
