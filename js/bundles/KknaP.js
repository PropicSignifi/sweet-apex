...
var KknaP = function (_Component) {
  _inherits(KknaP, _Component);

  function KknaP() {
    _classCallCheck(this, KknaP);

    return _possibleConstructorReturn(this, (KknaP.__proto__ || Object.getPrototypeOf(KknaP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KknaP, _injectSoy2.default);

exports.default = KknaP;
...
exports.templates = exports.KknaP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KknaP.
   * @public
   */

  goog.module('KknaP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KknaP.render';
  }
...
_metalSoy2.default.register(KknaP, templates);
exports.KknaP = KknaP;
