...
var _patchSoy = __webpack_require__(335);
...
var utLAs = function (_Component) {
  _inherits(utLAs, _Component);

  function utLAs() {
    _classCallCheck(this, utLAs);

    return _possibleConstructorReturn(this, (utLAs.__proto__ || Object.getPrototypeOf(utLAs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(utLAs, _patchSoy2.default);

exports.default = utLAs;
...
exports.templates = exports.utLAs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace utLAs.
   * @public
   */

  goog.module('utLAs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'utLAs.render';
  }
...
_metalSoy2.default.register(utLAs, templates);
exports.utLAs = utLAs;
