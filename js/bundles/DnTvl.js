...
var DnTvl = function (_Component) {
  _inherits(DnTvl, _Component);

  function DnTvl() {
    _classCallCheck(this, DnTvl);

    return _possibleConstructorReturn(this, (DnTvl.__proto__ || Object.getPrototypeOf(DnTvl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DnTvl, _grammarSoy2.default);

exports.default = DnTvl;
...
exports.templates = exports.DnTvl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DnTvl.
   * @public
   */

  goog.module('DnTvl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DnTvl.render';
  }
...
_metalSoy2.default.register(DnTvl, templates);
exports.DnTvl = DnTvl;
