...
var NHtqP = function (_Component) {
  _inherits(NHtqP, _Component);

  function NHtqP() {
    _classCallCheck(this, NHtqP);

    return _possibleConstructorReturn(this, (NHtqP.__proto__ || Object.getPrototypeOf(NHtqP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NHtqP, _rethrowSoy2.default);

exports.default = NHtqP;
...
exports.templates = exports.NHtqP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NHtqP.
   * @public
   */

  goog.module('NHtqP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NHtqP.render';
  }
...
_metalSoy2.default.register(NHtqP, templates);
exports.NHtqP = NHtqP;
