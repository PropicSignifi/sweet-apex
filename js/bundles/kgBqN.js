...
var kgBqN = function (_Component) {
  _inherits(kgBqN, _Component);

  function kgBqN() {
    _classCallCheck(this, kgBqN);

    return _possibleConstructorReturn(this, (kgBqN.__proto__ || Object.getPrototypeOf(kgBqN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kgBqN, _indexSoy2.default);

exports.default = kgBqN;
...
exports.templates = exports.kgBqN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kgBqN.
   * @public
   */

  goog.module('kgBqN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kgBqN.render';
  }
...
_metalSoy2.default.register(kgBqN, templates);
exports.kgBqN = kgBqN;
