...
var UlErM = function (_Component) {
  _inherits(UlErM, _Component);

  function UlErM() {
    _classCallCheck(this, UlErM);

    return _possibleConstructorReturn(this, (UlErM.__proto__ || Object.getPrototypeOf(UlErM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UlErM, _indexSoy2.default);

exports.default = UlErM;
...
exports.templates = exports.UlErM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UlErM.
   * @public
   */

  goog.module('UlErM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UlErM.render';
  }
...
_metalSoy2.default.register(UlErM, templates);
exports.UlErM = UlErM;
