...
var uLFNn = function (_Component) {
  _inherits(uLFNn, _Component);

  function uLFNn() {
    _classCallCheck(this, uLFNn);

    return _possibleConstructorReturn(this, (uLFNn.__proto__ || Object.getPrototypeOf(uLFNn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uLFNn, _apexdocSoy2.default);

exports.default = uLFNn;
...
exports.templates = exports.uLFNn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uLFNn.
   * @public
   */

  goog.module('uLFNn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uLFNn.render';
  }
...
_metalSoy2.default.register(uLFNn, templates);
exports.uLFNn = uLFNn;
