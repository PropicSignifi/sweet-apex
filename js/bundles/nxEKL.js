...
var nxEKL = function (_Component) {
  _inherits(nxEKL, _Component);

  function nxEKL() {
    _classCallCheck(this, nxEKL);

    return _possibleConstructorReturn(this, (nxEKL.__proto__ || Object.getPrototypeOf(nxEKL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nxEKL, _castSoy2.default);

exports.default = nxEKL;
...
exports.templates = exports.nxEKL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nxEKL.
   * @public
   */

  goog.module('nxEKL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nxEKL.render';
  }
...
_metalSoy2.default.register(nxEKL, templates);
exports.nxEKL = nxEKL;
