...
var vaMUk = function (_Component) {
  _inherits(vaMUk, _Component);

  function vaMUk() {
    _classCallCheck(this, vaMUk);

    return _possibleConstructorReturn(this, (vaMUk.__proto__ || Object.getPrototypeOf(vaMUk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vaMUk, _indexSoy2.default);

exports.default = vaMUk;
...
exports.templates = exports.vaMUk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vaMUk.
   * @public
   */

  goog.module('vaMUk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vaMUk.render';
  }
...
_metalSoy2.default.register(vaMUk, templates);
exports.vaMUk = vaMUk;
