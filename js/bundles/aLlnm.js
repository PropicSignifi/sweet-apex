...
var aLlnm = function (_Component) {
  _inherits(aLlnm, _Component);

  function aLlnm() {
    _classCallCheck(this, aLlnm);

    return _possibleConstructorReturn(this, (aLlnm.__proto__ || Object.getPrototypeOf(aLlnm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aLlnm, _reflectSoy2.default);

exports.default = aLlnm;
...
exports.templates = exports.aLlnm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aLlnm.
   * @public
   */

  goog.module('aLlnm.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param977 = function param977() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param977 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aLlnm.render';
  }
...
_metalSoy2.default.register(aLlnm, templates);
exports.aLlnm = aLlnm;
