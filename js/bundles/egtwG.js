...
var egtwG = function (_Component) {
  _inherits(egtwG, _Component);

  function egtwG() {
    _classCallCheck(this, egtwG);

    return _possibleConstructorReturn(this, (egtwG.__proto__ || Object.getPrototypeOf(egtwG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(egtwG, _configSoy2.default);

exports.default = egtwG;
...
exports.templates = exports.egtwG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace egtwG.
   * @public
   */

  goog.module('egtwG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'egtwG.render';
  }
...
_metalSoy2.default.register(egtwG, templates);
exports.egtwG = egtwG;
