...
var ubjeC = function (_Component) {
  _inherits(ubjeC, _Component);

  function ubjeC() {
    _classCallCheck(this, ubjeC);

    return _possibleConstructorReturn(this, (ubjeC.__proto__ || Object.getPrototypeOf(ubjeC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ubjeC, _nullableSoy2.default);

exports.default = ubjeC;
...
exports.templates = exports.ubjeC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ubjeC.
   * @public
   */

  goog.module('ubjeC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ubjeC.render';
  }
...
_metalSoy2.default.register(ubjeC, templates);
exports.ubjeC = ubjeC;
