...
var fKFlC = function (_Component) {
  _inherits(fKFlC, _Component);

  function fKFlC() {
    _classCallCheck(this, fKFlC);

    return _possibleConstructorReturn(this, (fKFlC.__proto__ || Object.getPrototypeOf(fKFlC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fKFlC, _enumSoy2.default);

exports.default = fKFlC;
...
exports.templates = exports.fKFlC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fKFlC.
   * @public
   */

  goog.module('fKFlC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fKFlC.render';
  }
...
_metalSoy2.default.register(fKFlC, templates);
exports.fKFlC = fKFlC;
