...
var ngApf = function (_Component) {
  _inherits(ngApf, _Component);

  function ngApf() {
    _classCallCheck(this, ngApf);

    return _possibleConstructorReturn(this, (ngApf.__proto__ || Object.getPrototypeOf(ngApf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ngApf, _annotationSoy2.default);

exports.default = ngApf;
...
exports.templates = exports.ngApf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ngApf.
   * @public
   */

  goog.module('ngApf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ngApf.render';
  }
...
_metalSoy2.default.register(ngApf, templates);
exports.ngApf = ngApf;
