...
var orVWg = function (_Component) {
  _inherits(orVWg, _Component);

  function orVWg() {
    _classCallCheck(this, orVWg);

    return _possibleConstructorReturn(this, (orVWg.__proto__ || Object.getPrototypeOf(orVWg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(orVWg, _functionSoy2.default);

exports.default = orVWg;
...
exports.templates = exports.orVWg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace orVWg.
   * @public
   */

  goog.module('orVWg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'orVWg.render';
  }
...
_metalSoy2.default.register(orVWg, templates);
exports.orVWg = orVWg;
