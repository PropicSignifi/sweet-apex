...
var zazro = function (_Component) {
  _inherits(zazro, _Component);

  function zazro() {
    _classCallCheck(this, zazro);

    return _possibleConstructorReturn(this, (zazro.__proto__ || Object.getPrototypeOf(zazro)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zazro, _indexSoy2.default);

exports.default = zazro;
...
exports.templates = exports.zazro = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zazro.
   * @public
   */

  goog.module('zazro.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zazro.render';
  }
...
_metalSoy2.default.register(zazro, templates);
exports.zazro = zazro;
