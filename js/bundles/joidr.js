...
var joidr = function (_Component) {
  _inherits(joidr, _Component);

  function joidr() {
    _classCallCheck(this, joidr);

    return _possibleConstructorReturn(this, (joidr.__proto__ || Object.getPrototypeOf(joidr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(joidr, _actionSoy2.default);

exports.default = joidr;
...
exports.templates = exports.joidr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace joidr.
   * @public
   */

  goog.module('joidr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'joidr.render';
  }
...
_metalSoy2.default.register(joidr, templates);
exports.joidr = joidr;
