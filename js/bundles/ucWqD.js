...
var ucWqD = function (_Component) {
  _inherits(ucWqD, _Component);

  function ucWqD() {
    _classCallCheck(this, ucWqD);

    return _possibleConstructorReturn(this, (ucWqD.__proto__ || Object.getPrototypeOf(ucWqD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ucWqD, _enumSoy2.default);

exports.default = ucWqD;
...
exports.templates = exports.ucWqD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ucWqD.
   * @public
   */

  goog.module('ucWqD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ucWqD.render';
  }
...
_metalSoy2.default.register(ucWqD, templates);
exports.ucWqD = ucWqD;
