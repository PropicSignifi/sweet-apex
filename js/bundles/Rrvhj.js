...
var Rrvhj = function (_Component) {
  _inherits(Rrvhj, _Component);

  function Rrvhj() {
    _classCallCheck(this, Rrvhj);

    return _possibleConstructorReturn(this, (Rrvhj.__proto__ || Object.getPrototypeOf(Rrvhj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rrvhj, _transpilationSoy2.default);

exports.default = Rrvhj;
...
exports.templates = exports.Rrvhj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rrvhj.
   * @public
   */

  goog.module('Rrvhj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rrvhj.render';
  }
...
_metalSoy2.default.register(Rrvhj, templates);
exports.Rrvhj = Rrvhj;
