...
var _transpilationSoy = __webpack_require__(289);
...
var NTZZW = function (_Component) {
  _inherits(NTZZW, _Component);

  function NTZZW() {
    _classCallCheck(this, NTZZW);

    return _possibleConstructorReturn(this, (NTZZW.__proto__ || Object.getPrototypeOf(NTZZW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NTZZW, _transpilationSoy2.default);

exports.default = NTZZW;
...
exports.templates = exports.NTZZW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NTZZW.
   * @public
   */

  goog.module('NTZZW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NTZZW.render';
  }
...
_metalSoy2.default.register(NTZZW, templates);
exports.NTZZW = NTZZW;
