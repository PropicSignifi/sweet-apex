...
var yaMsn = function (_Component) {
  _inherits(yaMsn, _Component);

  function yaMsn() {
    _classCallCheck(this, yaMsn);

    return _possibleConstructorReturn(this, (yaMsn.__proto__ || Object.getPrototypeOf(yaMsn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yaMsn, _constructor_annotationSoy2.default);

exports.default = yaMsn;
...
exports.templates = exports.yaMsn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yaMsn.
   * @public
   */

  goog.module('yaMsn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yaMsn.render';
  }
...
_metalSoy2.default.register(yaMsn, templates);
exports.yaMsn = yaMsn;
