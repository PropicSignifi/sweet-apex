...
var _scriptSoy = __webpack_require__(341);
...
var pHdMD = function (_Component) {
  _inherits(pHdMD, _Component);

  function pHdMD() {
    _classCallCheck(this, pHdMD);

    return _possibleConstructorReturn(this, (pHdMD.__proto__ || Object.getPrototypeOf(pHdMD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pHdMD, _scriptSoy2.default);

exports.default = pHdMD;
...
exports.templates = exports.pHdMD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pHdMD.
   * @public
   */

  goog.module('pHdMD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pHdMD.render';
  }
...
_metalSoy2.default.register(pHdMD, templates);
exports.pHdMD = pHdMD;
