...
var nwnUD = function (_Component) {
  _inherits(nwnUD, _Component);

  function nwnUD() {
    _classCallCheck(this, nwnUD);

    return _possibleConstructorReturn(this, (nwnUD.__proto__ || Object.getPrototypeOf(nwnUD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nwnUD, _injectSoy2.default);

exports.default = nwnUD;
...
exports.templates = exports.nwnUD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nwnUD.
   * @public
   */

  goog.module('nwnUD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nwnUD.render';
  }
...
_metalSoy2.default.register(nwnUD, templates);
exports.nwnUD = nwnUD;
