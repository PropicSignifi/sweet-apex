...
var rIpar = function (_Component) {
  _inherits(rIpar, _Component);

  function rIpar() {
    _classCallCheck(this, rIpar);

    return _possibleConstructorReturn(this, (rIpar.__proto__ || Object.getPrototypeOf(rIpar)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rIpar, _actionSoy2.default);

exports.default = rIpar;
...
exports.templates = exports.rIpar = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rIpar.
   * @public
   */

  goog.module('rIpar.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rIpar.render';
  }
...
_metalSoy2.default.register(rIpar, templates);
exports.rIpar = rIpar;
