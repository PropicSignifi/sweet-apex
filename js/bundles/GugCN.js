...
var GugCN = function (_Component) {
  _inherits(GugCN, _Component);

  function GugCN() {
    _classCallCheck(this, GugCN);

    return _possibleConstructorReturn(this, (GugCN.__proto__ || Object.getPrototypeOf(GugCN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GugCN, _testcaseSoy2.default);

exports.default = GugCN;
...
exports.templates = exports.GugCN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GugCN.
   * @public
   */

  goog.module('GugCN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GugCN.render';
  }
...
_metalSoy2.default.register(GugCN, templates);
exports.GugCN = GugCN;
