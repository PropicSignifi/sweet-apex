...
var YcyDd = function (_Component) {
  _inherits(YcyDd, _Component);

  function YcyDd() {
    _classCallCheck(this, YcyDd);

    return _possibleConstructorReturn(this, (YcyDd.__proto__ || Object.getPrototypeOf(YcyDd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YcyDd, _identitySoy2.default);

exports.default = YcyDd;
...
exports.templates = exports.YcyDd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YcyDd.
   * @public
   */

  goog.module('YcyDd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YcyDd.render';
  }
...
_metalSoy2.default.register(YcyDd, templates);
exports.YcyDd = YcyDd;
