...
var QFcdt = function (_Component) {
  _inherits(QFcdt, _Component);

  function QFcdt() {
    _classCallCheck(this, QFcdt);

    return _possibleConstructorReturn(this, (QFcdt.__proto__ || Object.getPrototypeOf(QFcdt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QFcdt, _actionSoy2.default);

exports.default = QFcdt;
...
exports.templates = exports.QFcdt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QFcdt.
   * @public
   */

  goog.module('QFcdt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QFcdt.render';
  }
...
_metalSoy2.default.register(QFcdt, templates);
exports.QFcdt = QFcdt;
