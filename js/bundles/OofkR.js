...
var _lambdaSoy = __webpack_require__(321);
...
var OofkR = function (_Component) {
  _inherits(OofkR, _Component);

  function OofkR() {
    _classCallCheck(this, OofkR);

    return _possibleConstructorReturn(this, (OofkR.__proto__ || Object.getPrototypeOf(OofkR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OofkR, _lambdaSoy2.default);

exports.default = OofkR;
...
exports.templates = exports.OofkR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OofkR.
   * @public
   */

  goog.module('OofkR.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param705 = function param705() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param705 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OofkR.render';
  }
...
_metalSoy2.default.register(OofkR, templates);
exports.OofkR = OofkR;
