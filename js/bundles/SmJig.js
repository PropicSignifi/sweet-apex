...
var _templateSoy = __webpack_require__(337);
...
var SmJig = function (_Component) {
  _inherits(SmJig, _Component);

  function SmJig() {
    _classCallCheck(this, SmJig);

    return _possibleConstructorReturn(this, (SmJig.__proto__ || Object.getPrototypeOf(SmJig)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SmJig, _templateSoy2.default);

exports.default = SmJig;
...
exports.templates = exports.SmJig = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SmJig.
   * @public
   */

  goog.module('SmJig.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SmJig.render';
  }
...
_metalSoy2.default.register(SmJig, templates);
exports.SmJig = SmJig;
