...
var GHecw = function (_Component) {
  _inherits(GHecw, _Component);

  function GHecw() {
    _classCallCheck(this, GHecw);

    return _possibleConstructorReturn(this, (GHecw.__proto__ || Object.getPrototypeOf(GHecw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GHecw, _featureSoy2.default);

exports.default = GHecw;
...
exports.templates = exports.GHecw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GHecw.
   * @public
   */

  goog.module('GHecw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GHecw.render';
  }
...
_metalSoy2.default.register(GHecw, templates);
exports.GHecw = GHecw;
