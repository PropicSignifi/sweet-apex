...
var dvFvi = function (_Component) {
  _inherits(dvFvi, _Component);

  function dvFvi() {
    _classCallCheck(this, dvFvi);

    return _possibleConstructorReturn(this, (dvFvi.__proto__ || Object.getPrototypeOf(dvFvi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dvFvi, _aspectSoy2.default);

exports.default = dvFvi;
...
exports.templates = exports.dvFvi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dvFvi.
   * @public
   */

  goog.module('dvFvi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dvFvi.render';
  }
...
_metalSoy2.default.register(dvFvi, templates);
exports.dvFvi = dvFvi;
