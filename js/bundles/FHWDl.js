...
var FHWDl = function (_Component) {
  _inherits(FHWDl, _Component);

  function FHWDl() {
    _classCallCheck(this, FHWDl);

    return _possibleConstructorReturn(this, (FHWDl.__proto__ || Object.getPrototypeOf(FHWDl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FHWDl, _aspectSoy2.default);

exports.default = FHWDl;
...
exports.templates = exports.FHWDl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FHWDl.
   * @public
   */

  goog.module('FHWDl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FHWDl.render';
  }
...
_metalSoy2.default.register(FHWDl, templates);
exports.FHWDl = FHWDl;
