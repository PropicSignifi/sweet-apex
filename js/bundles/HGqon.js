...
var HGqon = function (_Component) {
  _inherits(HGqon, _Component);

  function HGqon() {
    _classCallCheck(this, HGqon);

    return _possibleConstructorReturn(this, (HGqon.__proto__ || Object.getPrototypeOf(HGqon)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HGqon, _castSoy2.default);

exports.default = HGqon;
...
exports.templates = exports.HGqon = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HGqon.
   * @public
   */

  goog.module('HGqon.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HGqon.render';
  }
...
_metalSoy2.default.register(HGqon, templates);
exports.HGqon = HGqon;
