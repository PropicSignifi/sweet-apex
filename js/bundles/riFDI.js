...
var _identitySoy = __webpack_require__(309);
...
var riFDI = function (_Component) {
  _inherits(riFDI, _Component);

  function riFDI() {
    _classCallCheck(this, riFDI);

    return _possibleConstructorReturn(this, (riFDI.__proto__ || Object.getPrototypeOf(riFDI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(riFDI, _identitySoy2.default);

exports.default = riFDI;
...
exports.templates = exports.riFDI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace riFDI.
   * @public
   */

  goog.module('riFDI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param725 = function param725() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'riFDI.render';
  }
...
_metalSoy2.default.register(riFDI, templates);
exports.riFDI = riFDI;
