...
var xRAru = function (_Component) {
  _inherits(xRAru, _Component);

  function xRAru() {
    _classCallCheck(this, xRAru);

    return _possibleConstructorReturn(this, (xRAru.__proto__ || Object.getPrototypeOf(xRAru)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xRAru, _identitySoy2.default);

exports.default = xRAru;
...
exports.templates = exports.xRAru = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xRAru.
   * @public
   */

  goog.module('xRAru.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xRAru.render';
  }
...
_metalSoy2.default.register(xRAru, templates);
exports.xRAru = xRAru;
