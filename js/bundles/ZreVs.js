...
var ZreVs = function (_Component) {
  _inherits(ZreVs, _Component);

  function ZreVs() {
    _classCallCheck(this, ZreVs);

    return _possibleConstructorReturn(this, (ZreVs.__proto__ || Object.getPrototypeOf(ZreVs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZreVs, _aspectSoy2.default);

exports.default = ZreVs;
...
exports.templates = exports.ZreVs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZreVs.
   * @public
   */

  goog.module('ZreVs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZreVs.render';
  }
...
_metalSoy2.default.register(ZreVs, templates);
exports.ZreVs = ZreVs;
