...
var QNGrf = function (_Component) {
  _inherits(QNGrf, _Component);

  function QNGrf() {
    _classCallCheck(this, QNGrf);

    return _possibleConstructorReturn(this, (QNGrf.__proto__ || Object.getPrototypeOf(QNGrf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QNGrf, _templateSoy2.default);

exports.default = QNGrf;
...
exports.templates = exports.QNGrf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QNGrf.
   * @public
   */

  goog.module('QNGrf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QNGrf.render';
  }
...
_metalSoy2.default.register(QNGrf, templates);
exports.QNGrf = QNGrf;
