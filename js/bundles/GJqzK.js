...
var GJqzK = function (_Component) {
  _inherits(GJqzK, _Component);

  function GJqzK() {
    _classCallCheck(this, GJqzK);

    return _possibleConstructorReturn(this, (GJqzK.__proto__ || Object.getPrototypeOf(GJqzK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GJqzK, _configSoy2.default);

exports.default = GJqzK;
...
exports.templates = exports.GJqzK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GJqzK.
   * @public
   */

  goog.module('GJqzK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GJqzK.render';
  }
...
_metalSoy2.default.register(GJqzK, templates);
exports.GJqzK = GJqzK;
