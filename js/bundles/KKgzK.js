...
var KKgzK = function (_Component) {
  _inherits(KKgzK, _Component);

  function KKgzK() {
    _classCallCheck(this, KKgzK);

    return _possibleConstructorReturn(this, (KKgzK.__proto__ || Object.getPrototypeOf(KKgzK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KKgzK, _annotationSoy2.default);

exports.default = KKgzK;
...
exports.templates = exports.KKgzK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KKgzK.
   * @public
   */

  goog.module('KKgzK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KKgzK.render';
  }
...
_metalSoy2.default.register(KKgzK, templates);
exports.KKgzK = KKgzK;
