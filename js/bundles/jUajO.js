...
var jUajO = function (_Component) {
  _inherits(jUajO, _Component);

  function jUajO() {
    _classCallCheck(this, jUajO);

    return _possibleConstructorReturn(this, (jUajO.__proto__ || Object.getPrototypeOf(jUajO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jUajO, _fileSoy2.default);

exports.default = jUajO;
...
exports.templates = exports.jUajO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jUajO.
   * @public
   */

  goog.module('jUajO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jUajO.render';
  }
...
_metalSoy2.default.register(jUajO, templates);
exports.jUajO = jUajO;
