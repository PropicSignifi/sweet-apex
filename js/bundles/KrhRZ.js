...
var KrhRZ = function (_Component) {
  _inherits(KrhRZ, _Component);

  function KrhRZ() {
    _classCallCheck(this, KrhRZ);

    return _possibleConstructorReturn(this, (KrhRZ.__proto__ || Object.getPrototypeOf(KrhRZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KrhRZ, _transpilationSoy2.default);

exports.default = KrhRZ;
...
exports.templates = exports.KrhRZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KrhRZ.
   * @public
   */

  goog.module('KrhRZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KrhRZ.render';
  }
...
_metalSoy2.default.register(KrhRZ, templates);
exports.KrhRZ = KrhRZ;
