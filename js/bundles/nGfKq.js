...
var nGfKq = function (_Component) {
  _inherits(nGfKq, _Component);

  function nGfKq() {
    _classCallCheck(this, nGfKq);

    return _possibleConstructorReturn(this, (nGfKq.__proto__ || Object.getPrototypeOf(nGfKq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nGfKq, _featureSoy2.default);

exports.default = nGfKq;
...
exports.templates = exports.nGfKq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nGfKq.
   * @public
   */

  goog.module('nGfKq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nGfKq.render';
  }
...
_metalSoy2.default.register(nGfKq, templates);
exports.nGfKq = nGfKq;
