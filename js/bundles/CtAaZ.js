...
var CtAaZ = function (_Component) {
  _inherits(CtAaZ, _Component);

  function CtAaZ() {
    _classCallCheck(this, CtAaZ);

    return _possibleConstructorReturn(this, (CtAaZ.__proto__ || Object.getPrototypeOf(CtAaZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CtAaZ, _apexdocSoy2.default);

exports.default = CtAaZ;
...
exports.templates = exports.CtAaZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CtAaZ.
   * @public
   */

  goog.module('CtAaZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CtAaZ.render';
  }
...
_metalSoy2.default.register(CtAaZ, templates);
exports.CtAaZ = CtAaZ;
