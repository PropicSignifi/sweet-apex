...
var Bcypr = function (_Component) {
  _inherits(Bcypr, _Component);

  function Bcypr() {
    _classCallCheck(this, Bcypr);

    return _possibleConstructorReturn(this, (Bcypr.__proto__ || Object.getPrototypeOf(Bcypr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Bcypr, _lambdaSoy2.default);

exports.default = Bcypr;
...
exports.templates = exports.Bcypr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Bcypr.
   * @public
   */

  goog.module('Bcypr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Bcypr.render';
  }
...
_metalSoy2.default.register(Bcypr, templates);
exports.Bcypr = Bcypr;
