...
var pGWoq = function (_Component) {
  _inherits(pGWoq, _Component);

  function pGWoq() {
    _classCallCheck(this, pGWoq);

    return _possibleConstructorReturn(this, (pGWoq.__proto__ || Object.getPrototypeOf(pGWoq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pGWoq, _array_creationSoy2.default);

exports.default = pGWoq;
...
exports.templates = exports.pGWoq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pGWoq.
   * @public
   */

  goog.module('pGWoq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pGWoq.render';
  }
...
_metalSoy2.default.register(pGWoq, templates);
exports.pGWoq = pGWoq;
