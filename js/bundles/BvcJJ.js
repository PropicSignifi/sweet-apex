...
var _nullableSoy = __webpack_require__(331);
...
var BvcJJ = function (_Component) {
  _inherits(BvcJJ, _Component);

  function BvcJJ() {
    _classCallCheck(this, BvcJJ);

    return _possibleConstructorReturn(this, (BvcJJ.__proto__ || Object.getPrototypeOf(BvcJJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BvcJJ, _nullableSoy2.default);

exports.default = BvcJJ;
...
exports.templates = exports.BvcJJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BvcJJ.
   * @public
   */

  goog.module('BvcJJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BvcJJ.render';
  }
...
_metalSoy2.default.register(BvcJJ, templates);
exports.BvcJJ = BvcJJ;
