...
var _templateSoy = __webpack_require__(349);
...
var jFdRY = function (_Component) {
  _inherits(jFdRY, _Component);

  function jFdRY() {
    _classCallCheck(this, jFdRY);

    return _possibleConstructorReturn(this, (jFdRY.__proto__ || Object.getPrototypeOf(jFdRY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jFdRY, _templateSoy2.default);

exports.default = jFdRY;
...
exports.templates = exports.jFdRY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jFdRY.
   * @public
   */

  goog.module('jFdRY.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1160 = function param1160() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1160 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jFdRY.render';
  }
...
_metalSoy2.default.register(jFdRY, templates);
exports.jFdRY = jFdRY;
