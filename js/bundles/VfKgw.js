...
var VfKgw = function (_Component) {
  _inherits(VfKgw, _Component);

  function VfKgw() {
    _classCallCheck(this, VfKgw);

    return _possibleConstructorReturn(this, (VfKgw.__proto__ || Object.getPrototypeOf(VfKgw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VfKgw, _transpilationSoy2.default);

exports.default = VfKgw;
...
exports.templates = exports.VfKgw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VfKgw.
   * @public
   */

  goog.module('VfKgw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VfKgw.render';
  }
...
_metalSoy2.default.register(VfKgw, templates);
exports.VfKgw = VfKgw;
