...
var Gydhg = function (_Component) {
  _inherits(Gydhg, _Component);

  function Gydhg() {
    _classCallCheck(this, Gydhg);

    return _possibleConstructorReturn(this, (Gydhg.__proto__ || Object.getPrototypeOf(Gydhg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Gydhg, _indexSoy2.default);

exports.default = Gydhg;
...
exports.templates = exports.Gydhg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Gydhg.
   * @public
   */

  goog.module('Gydhg.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param793 = function param793() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Gydhg.render';
  }
...
_metalSoy2.default.register(Gydhg, templates);
exports.Gydhg = Gydhg;
