...
var MXQaP = function (_Component) {
  _inherits(MXQaP, _Component);

  function MXQaP() {
    _classCallCheck(this, MXQaP);

    return _possibleConstructorReturn(this, (MXQaP.__proto__ || Object.getPrototypeOf(MXQaP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MXQaP, _indexSoy2.default);

exports.default = MXQaP;
...
exports.templates = exports.MXQaP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MXQaP.
   * @public
   */

  goog.module('MXQaP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MXQaP.render';
  }
...
_metalSoy2.default.register(MXQaP, templates);
exports.MXQaP = MXQaP;
