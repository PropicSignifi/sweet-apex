...
var NFbvC = function (_Component) {
  _inherits(NFbvC, _Component);

  function NFbvC() {
    _classCallCheck(this, NFbvC);

    return _possibleConstructorReturn(this, (NFbvC.__proto__ || Object.getPrototypeOf(NFbvC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NFbvC, _indexSoy2.default);

exports.default = NFbvC;
...
exports.templates = exports.NFbvC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NFbvC.
   * @public
   */

  goog.module('NFbvC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NFbvC.render';
  }
...
_metalSoy2.default.register(NFbvC, templates);
exports.NFbvC = NFbvC;
