...
var LpfQY = function (_Component) {
  _inherits(LpfQY, _Component);

  function LpfQY() {
    _classCallCheck(this, LpfQY);

    return _possibleConstructorReturn(this, (LpfQY.__proto__ || Object.getPrototypeOf(LpfQY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LpfQY, _modSoy2.default);

exports.default = LpfQY;
...
exports.templates = exports.LpfQY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LpfQY.
   * @public
   */

  goog.module('LpfQY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LpfQY.render';
  }
...
_metalSoy2.default.register(LpfQY, templates);
exports.LpfQY = LpfQY;
