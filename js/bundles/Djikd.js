...
var Djikd = function (_Component) {
  _inherits(Djikd, _Component);

  function Djikd() {
    _classCallCheck(this, Djikd);

    return _possibleConstructorReturn(this, (Djikd.__proto__ || Object.getPrototypeOf(Djikd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Djikd, _destructureSoy2.default);

exports.default = Djikd;
...
exports.templates = exports.Djikd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Djikd.
   * @public
   */

  goog.module('Djikd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Djikd.render';
  }
...
_metalSoy2.default.register(Djikd, templates);
exports.Djikd = Djikd;
