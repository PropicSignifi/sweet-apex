...
var hgAjD = function (_Component) {
  _inherits(hgAjD, _Component);

  function hgAjD() {
    _classCallCheck(this, hgAjD);

    return _possibleConstructorReturn(this, (hgAjD.__proto__ || Object.getPrototypeOf(hgAjD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hgAjD, _aspectSoy2.default);

exports.default = hgAjD;
...
exports.templates = exports.hgAjD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hgAjD.
   * @public
   */

  goog.module('hgAjD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hgAjD.render';
  }
...
_metalSoy2.default.register(hgAjD, templates);
exports.hgAjD = hgAjD;
