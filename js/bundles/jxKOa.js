...
var jxKOa = function (_Component) {
  _inherits(jxKOa, _Component);

  function jxKOa() {
    _classCallCheck(this, jxKOa);

    return _possibleConstructorReturn(this, (jxKOa.__proto__ || Object.getPrototypeOf(jxKOa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jxKOa, _enumSoy2.default);

exports.default = jxKOa;
...
exports.templates = exports.jxKOa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jxKOa.
   * @public
   */

  goog.module('jxKOa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jxKOa.render';
  }
...
_metalSoy2.default.register(jxKOa, templates);
exports.jxKOa = jxKOa;
