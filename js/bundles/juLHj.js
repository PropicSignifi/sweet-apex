...
var juLHj = function (_Component) {
  _inherits(juLHj, _Component);

  function juLHj() {
    _classCallCheck(this, juLHj);

    return _possibleConstructorReturn(this, (juLHj.__proto__ || Object.getPrototypeOf(juLHj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(juLHj, _configSoy2.default);

exports.default = juLHj;
...
exports.templates = exports.juLHj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace juLHj.
   * @public
   */

  goog.module('juLHj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'juLHj.render';
  }
...
_metalSoy2.default.register(juLHj, templates);
exports.juLHj = juLHj;
