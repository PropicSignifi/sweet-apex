...
var _step_3Soy = __webpack_require__(339);
...
var TluVG = function (_Component) {
  _inherits(TluVG, _Component);

  function TluVG() {
    _classCallCheck(this, TluVG);

    return _possibleConstructorReturn(this, (TluVG.__proto__ || Object.getPrototypeOf(TluVG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TluVG, _step_3Soy2.default);

exports.default = TluVG;
...
exports.templates = exports.TluVG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TluVG.
   * @public
   */

  goog.module('TluVG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TluVG.render';
  }
...
_metalSoy2.default.register(TluVG, templates);
exports.TluVG = TluVG;
