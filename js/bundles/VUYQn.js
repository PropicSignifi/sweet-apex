...
var VUYQn = function (_Component) {
  _inherits(VUYQn, _Component);

  function VUYQn() {
    _classCallCheck(this, VUYQn);

    return _possibleConstructorReturn(this, (VUYQn.__proto__ || Object.getPrototypeOf(VUYQn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VUYQn, _operatorSoy2.default);

exports.default = VUYQn;
...
exports.templates = exports.VUYQn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VUYQn.
   * @public
   */

  goog.module('VUYQn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VUYQn.render';
  }
...
_metalSoy2.default.register(VUYQn, templates);
exports.VUYQn = VUYQn;
