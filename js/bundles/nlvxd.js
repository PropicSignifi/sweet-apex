...
var nlvxd = function (_Component) {
  _inherits(nlvxd, _Component);

  function nlvxd() {
    _classCallCheck(this, nlvxd);

    return _possibleConstructorReturn(this, (nlvxd.__proto__ || Object.getPrototypeOf(nlvxd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nlvxd, _indexSoy2.default);

exports.default = nlvxd;
...
exports.templates = exports.nlvxd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nlvxd.
   * @public
   */

  goog.module('nlvxd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nlvxd.render';
  }
...
_metalSoy2.default.register(nlvxd, templates);
exports.nlvxd = nlvxd;
