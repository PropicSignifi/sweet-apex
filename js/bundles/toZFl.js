...
var toZFl = function (_Component) {
  _inherits(toZFl, _Component);

  function toZFl() {
    _classCallCheck(this, toZFl);

    return _possibleConstructorReturn(this, (toZFl.__proto__ || Object.getPrototypeOf(toZFl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(toZFl, _indexSoy2.default);

exports.default = toZFl;
...
exports.templates = exports.toZFl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace toZFl.
   * @public
   */

  goog.module('toZFl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'toZFl.render';
  }
...
_metalSoy2.default.register(toZFl, templates);
exports.toZFl = toZFl;
