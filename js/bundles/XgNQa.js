...
var XgNQa = function (_Component) {
  _inherits(XgNQa, _Component);

  function XgNQa() {
    _classCallCheck(this, XgNQa);

    return _possibleConstructorReturn(this, (XgNQa.__proto__ || Object.getPrototypeOf(XgNQa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XgNQa, _fileSoy2.default);

exports.default = XgNQa;
...
exports.templates = exports.XgNQa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XgNQa.
   * @public
   */

  goog.module('XgNQa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XgNQa.render';
  }
...
_metalSoy2.default.register(XgNQa, templates);
exports.XgNQa = XgNQa;
