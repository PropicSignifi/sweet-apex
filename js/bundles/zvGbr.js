...
var zvGbr = function (_Component) {
  _inherits(zvGbr, _Component);

  function zvGbr() {
    _classCallCheck(this, zvGbr);

    return _possibleConstructorReturn(this, (zvGbr.__proto__ || Object.getPrototypeOf(zvGbr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zvGbr, _reflectSoy2.default);

exports.default = zvGbr;
...
exports.templates = exports.zvGbr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zvGbr.
   * @public
   */

  goog.module('zvGbr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zvGbr.render';
  }
...
_metalSoy2.default.register(zvGbr, templates);
exports.zvGbr = zvGbr;
