...
var BfEkz = function (_Component) {
  _inherits(BfEkz, _Component);

  function BfEkz() {
    _classCallCheck(this, BfEkz);

    return _possibleConstructorReturn(this, (BfEkz.__proto__ || Object.getPrototypeOf(BfEkz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BfEkz, _apexdocSoy2.default);

exports.default = BfEkz;
...
exports.templates = exports.BfEkz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BfEkz.
   * @public
   */

  goog.module('BfEkz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BfEkz.render';
  }
...
_metalSoy2.default.register(BfEkz, templates);
exports.BfEkz = BfEkz;
