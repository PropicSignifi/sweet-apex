...
var cLxFB = function (_Component) {
  _inherits(cLxFB, _Component);

  function cLxFB() {
    _classCallCheck(this, cLxFB);

    return _possibleConstructorReturn(this, (cLxFB.__proto__ || Object.getPrototypeOf(cLxFB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cLxFB, _indexSoy2.default);

exports.default = cLxFB;
...
exports.templates = exports.cLxFB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cLxFB.
   * @public
   */

  goog.module('cLxFB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cLxFB.render';
  }
...
_metalSoy2.default.register(cLxFB, templates);
exports.cLxFB = cLxFB;
