...
var OcNJJ = function (_Component) {
  _inherits(OcNJJ, _Component);

  function OcNJJ() {
    _classCallCheck(this, OcNJJ);

    return _possibleConstructorReturn(this, (OcNJJ.__proto__ || Object.getPrototypeOf(OcNJJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OcNJJ, _fileSoy2.default);

exports.default = OcNJJ;
...
exports.templates = exports.OcNJJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OcNJJ.
   * @public
   */

  goog.module('OcNJJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OcNJJ.render';
  }
...
_metalSoy2.default.register(OcNJJ, templates);
exports.OcNJJ = OcNJJ;
