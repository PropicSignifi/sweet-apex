...
var wGscd = function (_Component) {
  _inherits(wGscd, _Component);

  function wGscd() {
    _classCallCheck(this, wGscd);

    return _possibleConstructorReturn(this, (wGscd.__proto__ || Object.getPrototypeOf(wGscd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wGscd, _annotationSoy2.default);

exports.default = wGscd;
...
exports.templates = exports.wGscd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wGscd.
   * @public
   */

  goog.module('wGscd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wGscd.render';
  }
...
_metalSoy2.default.register(wGscd, templates);
exports.wGscd = wGscd;
