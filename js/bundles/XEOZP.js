...
var XEOZP = function (_Component) {
  _inherits(XEOZP, _Component);

  function XEOZP() {
    _classCallCheck(this, XEOZP);

    return _possibleConstructorReturn(this, (XEOZP.__proto__ || Object.getPrototypeOf(XEOZP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XEOZP, _step_2Soy2.default);

exports.default = XEOZP;
...
exports.templates = exports.XEOZP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XEOZP.
   * @public
   */

  goog.module('XEOZP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XEOZP.render';
  }
...
_metalSoy2.default.register(XEOZP, templates);
exports.XEOZP = XEOZP;
