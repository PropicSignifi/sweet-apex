...
var pumbb = function (_Component) {
  _inherits(pumbb, _Component);

  function pumbb() {
    _classCallCheck(this, pumbb);

    return _possibleConstructorReturn(this, (pumbb.__proto__ || Object.getPrototypeOf(pumbb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pumbb, _step_2Soy2.default);

exports.default = pumbb;
...
exports.templates = exports.pumbb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pumbb.
   * @public
   */

  goog.module('pumbb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pumbb.render';
  }
...
_metalSoy2.default.register(pumbb, templates);
exports.pumbb = pumbb;
