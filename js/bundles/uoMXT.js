...
var uoMXT = function (_Component) {
  _inherits(uoMXT, _Component);

  function uoMXT() {
    _classCallCheck(this, uoMXT);

    return _possibleConstructorReturn(this, (uoMXT.__proto__ || Object.getPrototypeOf(uoMXT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uoMXT, _modSoy2.default);

exports.default = uoMXT;
...
exports.templates = exports.uoMXT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uoMXT.
   * @public
   */

  goog.module('uoMXT.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param742 = function param742() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uoMXT.render';
  }
...
_metalSoy2.default.register(uoMXT, templates);
exports.uoMXT = uoMXT;
