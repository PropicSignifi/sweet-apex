...
var _castSoy = __webpack_require__(293);
...
var zFrIz = function (_Component) {
  _inherits(zFrIz, _Component);

  function zFrIz() {
    _classCallCheck(this, zFrIz);

    return _possibleConstructorReturn(this, (zFrIz.__proto__ || Object.getPrototypeOf(zFrIz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zFrIz, _castSoy2.default);

exports.default = zFrIz;
...
exports.templates = exports.zFrIz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zFrIz.
   * @public
   */

  goog.module('zFrIz.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param532 = function param532() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zFrIz.render';
  }
...
_metalSoy2.default.register(zFrIz, templates);
exports.zFrIz = zFrIz;
