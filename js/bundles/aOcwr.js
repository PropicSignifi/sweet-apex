...
var aOcwr = function (_Component) {
  _inherits(aOcwr, _Component);

  function aOcwr() {
    _classCallCheck(this, aOcwr);

    return _possibleConstructorReturn(this, (aOcwr.__proto__ || Object.getPrototypeOf(aOcwr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aOcwr, _default_valueSoy2.default);

exports.default = aOcwr;
...
exports.templates = exports.aOcwr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aOcwr.
   * @public
   */

  goog.module('aOcwr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aOcwr.render';
  }
...
_metalSoy2.default.register(aOcwr, templates);
exports.aOcwr = aOcwr;
