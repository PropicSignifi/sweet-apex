...
var kaVmb = function (_Component) {
  _inherits(kaVmb, _Component);

  function kaVmb() {
    _classCallCheck(this, kaVmb);

    return _possibleConstructorReturn(this, (kaVmb.__proto__ || Object.getPrototypeOf(kaVmb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kaVmb, _step_5Soy2.default);

exports.default = kaVmb;
...
exports.templates = exports.kaVmb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kaVmb.
   * @public
   */

  goog.module('kaVmb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kaVmb.render';
  }
...
_metalSoy2.default.register(kaVmb, templates);
exports.kaVmb = kaVmb;
