...
var klbKY = function (_Component) {
  _inherits(klbKY, _Component);

  function klbKY() {
    _classCallCheck(this, klbKY);

    return _possibleConstructorReturn(this, (klbKY.__proto__ || Object.getPrototypeOf(klbKY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(klbKY, _functionSoy2.default);

exports.default = klbKY;
...
exports.templates = exports.klbKY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace klbKY.
   * @public
   */

  goog.module('klbKY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'klbKY.render';
  }
...
_metalSoy2.default.register(klbKY, templates);
exports.klbKY = klbKY;
