...
var TLzNG = function (_Component) {
  _inherits(TLzNG, _Component);

  function TLzNG() {
    _classCallCheck(this, TLzNG);

    return _possibleConstructorReturn(this, (TLzNG.__proto__ || Object.getPrototypeOf(TLzNG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TLzNG, _actionSoy2.default);

exports.default = TLzNG;
...
exports.templates = exports.TLzNG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TLzNG.
   * @public
   */

  goog.module('TLzNG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TLzNG.render';
  }
...
_metalSoy2.default.register(TLzNG, templates);
exports.TLzNG = TLzNG;
