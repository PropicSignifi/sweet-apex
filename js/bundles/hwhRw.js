...
var hwhRw = function (_Component) {
  _inherits(hwhRw, _Component);

  function hwhRw() {
    _classCallCheck(this, hwhRw);

    return _possibleConstructorReturn(this, (hwhRw.__proto__ || Object.getPrototypeOf(hwhRw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hwhRw, _default_valueSoy2.default);

exports.default = hwhRw;
...
exports.templates = exports.hwhRw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hwhRw.
   * @public
   */

  goog.module('hwhRw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hwhRw.render';
  }
...
_metalSoy2.default.register(hwhRw, templates);
exports.hwhRw = hwhRw;
