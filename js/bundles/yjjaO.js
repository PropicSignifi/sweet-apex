...
var _step_2Soy = __webpack_require__(357);
...
var yjjaO = function (_Component) {
  _inherits(yjjaO, _Component);

  function yjjaO() {
    _classCallCheck(this, yjjaO);

    return _possibleConstructorReturn(this, (yjjaO.__proto__ || Object.getPrototypeOf(yjjaO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yjjaO, _step_2Soy2.default);

exports.default = yjjaO;
...
exports.templates = exports.yjjaO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yjjaO.
   * @public
   */

  goog.module('yjjaO.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1233 = function param1233() {
      ie_open('h2');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yjjaO.render';
  }
...
_metalSoy2.default.register(yjjaO, templates);
exports.yjjaO = yjjaO;
