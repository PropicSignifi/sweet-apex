...
var ImyCp = function (_Component) {
  _inherits(ImyCp, _Component);

  function ImyCp() {
    _classCallCheck(this, ImyCp);

    return _possibleConstructorReturn(this, (ImyCp.__proto__ || Object.getPrototypeOf(ImyCp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ImyCp, _indexSoy2.default);

exports.default = ImyCp;
...
exports.templates = exports.ImyCp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ImyCp.
   * @public
   */

  goog.module('ImyCp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ImyCp.render';
  }
...
_metalSoy2.default.register(ImyCp, templates);
exports.ImyCp = ImyCp;
