...
var HtzDu = function (_Component) {
  _inherits(HtzDu, _Component);

  function HtzDu() {
    _classCallCheck(this, HtzDu);

    return _possibleConstructorReturn(this, (HtzDu.__proto__ || Object.getPrototypeOf(HtzDu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HtzDu, _injectSoy2.default);

exports.default = HtzDu;
...
exports.templates = exports.HtzDu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HtzDu.
   * @public
   */

  goog.module('HtzDu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HtzDu.render';
  }
...
_metalSoy2.default.register(HtzDu, templates);
exports.HtzDu = HtzDu;
