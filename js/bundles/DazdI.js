...
var DazdI = function (_Component) {
  _inherits(DazdI, _Component);

  function DazdI() {
    _classCallCheck(this, DazdI);

    return _possibleConstructorReturn(this, (DazdI.__proto__ || Object.getPrototypeOf(DazdI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DazdI, _testcaseSoy2.default);

exports.default = DazdI;
...
exports.templates = exports.DazdI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DazdI.
   * @public
   */

  goog.module('DazdI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DazdI.render';
  }
...
_metalSoy2.default.register(DazdI, templates);
exports.DazdI = DazdI;
