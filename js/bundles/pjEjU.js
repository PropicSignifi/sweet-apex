...
var _step_4Soy = __webpack_require__(343);
...
var pjEjU = function (_Component) {
  _inherits(pjEjU, _Component);

  function pjEjU() {
    _classCallCheck(this, pjEjU);

    return _possibleConstructorReturn(this, (pjEjU.__proto__ || Object.getPrototypeOf(pjEjU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pjEjU, _step_4Soy2.default);

exports.default = pjEjU;
...
exports.templates = exports.pjEjU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pjEjU.
   * @public
   */

  goog.module('pjEjU.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1056 = function param1056() {
      ie_open('h2');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pjEjU.render';
  }
...
_metalSoy2.default.register(pjEjU, templates);
exports.pjEjU = pjEjU;
