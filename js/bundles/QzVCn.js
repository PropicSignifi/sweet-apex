...
var QzVCn = function (_Component) {
  _inherits(QzVCn, _Component);

  function QzVCn() {
    _classCallCheck(this, QzVCn);

    return _possibleConstructorReturn(this, (QzVCn.__proto__ || Object.getPrototypeOf(QzVCn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QzVCn, _enumSoy2.default);

exports.default = QzVCn;
...
exports.templates = exports.QzVCn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QzVCn.
   * @public
   */

  goog.module('QzVCn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QzVCn.render';
  }
...
_metalSoy2.default.register(QzVCn, templates);
exports.QzVCn = QzVCn;
