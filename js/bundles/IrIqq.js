...
var IrIqq = function (_Component) {
  _inherits(IrIqq, _Component);

  function IrIqq() {
    _classCallCheck(this, IrIqq);

    return _possibleConstructorReturn(this, (IrIqq.__proto__ || Object.getPrototypeOf(IrIqq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IrIqq, _step_4Soy2.default);

exports.default = IrIqq;
...
exports.templates = exports.IrIqq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IrIqq.
   * @public
   */

  goog.module('IrIqq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IrIqq.render';
  }
...
_metalSoy2.default.register(IrIqq, templates);
exports.IrIqq = IrIqq;
