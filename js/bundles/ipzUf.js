...
var ipzUf = function (_Component) {
  _inherits(ipzUf, _Component);

  function ipzUf() {
    _classCallCheck(this, ipzUf);

    return _possibleConstructorReturn(this, (ipzUf.__proto__ || Object.getPrototypeOf(ipzUf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ipzUf, _commandSoy2.default);

exports.default = ipzUf;
...
exports.templates = exports.ipzUf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ipzUf.
   * @public
   */

  goog.module('ipzUf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ipzUf.render';
  }
...
_metalSoy2.default.register(ipzUf, templates);
exports.ipzUf = ipzUf;
