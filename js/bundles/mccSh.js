...
var mccSh = function (_Component) {
  _inherits(mccSh, _Component);

  function mccSh() {
    _classCallCheck(this, mccSh);

    return _possibleConstructorReturn(this, (mccSh.__proto__ || Object.getPrototypeOf(mccSh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mccSh, _actionSoy2.default);

exports.default = mccSh;
...
exports.templates = exports.mccSh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mccSh.
   * @public
   */

  goog.module('mccSh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mccSh.render';
  }
...
_metalSoy2.default.register(mccSh, templates);
exports.mccSh = mccSh;
