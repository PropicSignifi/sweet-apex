...
var AclsT = function (_Component) {
  _inherits(AclsT, _Component);

  function AclsT() {
    _classCallCheck(this, AclsT);

    return _possibleConstructorReturn(this, (AclsT.__proto__ || Object.getPrototypeOf(AclsT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AclsT, _indexSoy2.default);

exports.default = AclsT;
...
exports.templates = exports.AclsT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AclsT.
   * @public
   */

  goog.module('AclsT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AclsT.render';
  }
...
_metalSoy2.default.register(AclsT, templates);
exports.AclsT = AclsT;
