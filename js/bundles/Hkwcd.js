...
var Hkwcd = function (_Component) {
  _inherits(Hkwcd, _Component);

  function Hkwcd() {
    _classCallCheck(this, Hkwcd);

    return _possibleConstructorReturn(this, (Hkwcd.__proto__ || Object.getPrototypeOf(Hkwcd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Hkwcd, _functionSoy2.default);

exports.default = Hkwcd;
...
exports.templates = exports.Hkwcd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Hkwcd.
   * @public
   */

  goog.module('Hkwcd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Hkwcd.render';
  }
...
_metalSoy2.default.register(Hkwcd, templates);
exports.Hkwcd = Hkwcd;
