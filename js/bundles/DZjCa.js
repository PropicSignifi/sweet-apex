...
var DZjCa = function (_Component) {
  _inherits(DZjCa, _Component);

  function DZjCa() {
    _classCallCheck(this, DZjCa);

    return _possibleConstructorReturn(this, (DZjCa.__proto__ || Object.getPrototypeOf(DZjCa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DZjCa, _commandSoy2.default);

exports.default = DZjCa;
...
exports.templates = exports.DZjCa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DZjCa.
   * @public
   */

  goog.module('DZjCa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DZjCa.render';
  }
...
_metalSoy2.default.register(DZjCa, templates);
exports.DZjCa = DZjCa;
