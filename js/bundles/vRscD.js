...
var vRscD = function (_Component) {
  _inherits(vRscD, _Component);

  function vRscD() {
    _classCallCheck(this, vRscD);

    return _possibleConstructorReturn(this, (vRscD.__proto__ || Object.getPrototypeOf(vRscD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vRscD, _nullableSoy2.default);

exports.default = vRscD;
...
exports.templates = exports.vRscD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vRscD.
   * @public
   */

  goog.module('vRscD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vRscD.render';
  }
...
_metalSoy2.default.register(vRscD, templates);
exports.vRscD = vRscD;
