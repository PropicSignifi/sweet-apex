...
var _varSoy = __webpack_require__(341);
...
var PNRMe = function (_Component) {
  _inherits(PNRMe, _Component);

  function PNRMe() {
    _classCallCheck(this, PNRMe);

    return _possibleConstructorReturn(this, (PNRMe.__proto__ || Object.getPrototypeOf(PNRMe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PNRMe, _varSoy2.default);

exports.default = PNRMe;
...
exports.templates = exports.PNRMe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PNRMe.
   * @public
   */

  goog.module('PNRMe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PNRMe.render';
  }
...
_metalSoy2.default.register(PNRMe, templates);
exports.PNRMe = PNRMe;
