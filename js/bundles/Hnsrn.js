...
var Hnsrn = function (_Component) {
  _inherits(Hnsrn, _Component);

  function Hnsrn() {
    _classCallCheck(this, Hnsrn);

    return _possibleConstructorReturn(this, (Hnsrn.__proto__ || Object.getPrototypeOf(Hnsrn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Hnsrn, _lambdaSoy2.default);

exports.default = Hnsrn;
...
exports.templates = exports.Hnsrn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Hnsrn.
   * @public
   */

  goog.module('Hnsrn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Hnsrn.render';
  }
...
_metalSoy2.default.register(Hnsrn, templates);
exports.Hnsrn = Hnsrn;
