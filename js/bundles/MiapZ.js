...
var MiapZ = function (_Component) {
  _inherits(MiapZ, _Component);

  function MiapZ() {
    _classCallCheck(this, MiapZ);

    return _possibleConstructorReturn(this, (MiapZ.__proto__ || Object.getPrototypeOf(MiapZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MiapZ, _actionSoy2.default);

exports.default = MiapZ;
...
exports.templates = exports.MiapZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MiapZ.
   * @public
   */

  goog.module('MiapZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MiapZ.render';
  }
...
_metalSoy2.default.register(MiapZ, templates);
exports.MiapZ = MiapZ;
