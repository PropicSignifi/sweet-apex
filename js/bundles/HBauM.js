...
var HBauM = function (_Component) {
  _inherits(HBauM, _Component);

  function HBauM() {
    _classCallCheck(this, HBauM);

    return _possibleConstructorReturn(this, (HBauM.__proto__ || Object.getPrototypeOf(HBauM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HBauM, _constructor_annotationSoy2.default);

exports.default = HBauM;
...
exports.templates = exports.HBauM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HBauM.
   * @public
   */

  goog.module('HBauM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HBauM.render';
  }
...
_metalSoy2.default.register(HBauM, templates);
exports.HBauM = HBauM;
