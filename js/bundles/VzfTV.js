...
var VzfTV = function (_Component) {
  _inherits(VzfTV, _Component);

  function VzfTV() {
    _classCallCheck(this, VzfTV);

    return _possibleConstructorReturn(this, (VzfTV.__proto__ || Object.getPrototypeOf(VzfTV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VzfTV, _transpilationSoy2.default);

exports.default = VzfTV;
...
exports.templates = exports.VzfTV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VzfTV.
   * @public
   */

  goog.module('VzfTV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VzfTV.render';
  }
...
_metalSoy2.default.register(VzfTV, templates);
exports.VzfTV = VzfTV;
