...
var fckBs = function (_Component) {
  _inherits(fckBs, _Component);

  function fckBs() {
    _classCallCheck(this, fckBs);

    return _possibleConstructorReturn(this, (fckBs.__proto__ || Object.getPrototypeOf(fckBs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fckBs, _array_creationSoy2.default);

exports.default = fckBs;
...
exports.templates = exports.fckBs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fckBs.
   * @public
   */

  goog.module('fckBs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fckBs.render';
  }
...
_metalSoy2.default.register(fckBs, templates);
exports.fckBs = fckBs;
