...
var ZNlTG = function (_Component) {
  _inherits(ZNlTG, _Component);

  function ZNlTG() {
    _classCallCheck(this, ZNlTG);

    return _possibleConstructorReturn(this, (ZNlTG.__proto__ || Object.getPrototypeOf(ZNlTG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZNlTG, _indexSoy2.default);

exports.default = ZNlTG;
...
exports.templates = exports.ZNlTG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZNlTG.
   * @public
   */

  goog.module('ZNlTG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZNlTG.render';
  }
...
_metalSoy2.default.register(ZNlTG, templates);
exports.ZNlTG = ZNlTG;
