...
var pCOFC = function (_Component) {
  _inherits(pCOFC, _Component);

  function pCOFC() {
    _classCallCheck(this, pCOFC);

    return _possibleConstructorReturn(this, (pCOFC.__proto__ || Object.getPrototypeOf(pCOFC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pCOFC, _constructor_annotationSoy2.default);

exports.default = pCOFC;
...
exports.templates = exports.pCOFC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pCOFC.
   * @public
   */

  goog.module('pCOFC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pCOFC.render';
  }
...
_metalSoy2.default.register(pCOFC, templates);
exports.pCOFC = pCOFC;
