...
var MvakA = function (_Component) {
  _inherits(MvakA, _Component);

  function MvakA() {
    _classCallCheck(this, MvakA);

    return _possibleConstructorReturn(this, (MvakA.__proto__ || Object.getPrototypeOf(MvakA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MvakA, _step_3Soy2.default);

exports.default = MvakA;
...
exports.templates = exports.MvakA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MvakA.
   * @public
   */

  goog.module('MvakA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MvakA.render';
  }
...
_metalSoy2.default.register(MvakA, templates);
exports.MvakA = MvakA;
