...
var wvwKt = function (_Component) {
  _inherits(wvwKt, _Component);

  function wvwKt() {
    _classCallCheck(this, wvwKt);

    return _possibleConstructorReturn(this, (wvwKt.__proto__ || Object.getPrototypeOf(wvwKt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wvwKt, _indexSoy2.default);

exports.default = wvwKt;
...
exports.templates = exports.wvwKt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wvwKt.
   * @public
   */

  goog.module('wvwKt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wvwKt.render';
  }
...
_metalSoy2.default.register(wvwKt, templates);
exports.wvwKt = wvwKt;
