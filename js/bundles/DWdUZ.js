...
var DWdUZ = function (_Component) {
  _inherits(DWdUZ, _Component);

  function DWdUZ() {
    _classCallCheck(this, DWdUZ);

    return _possibleConstructorReturn(this, (DWdUZ.__proto__ || Object.getPrototypeOf(DWdUZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DWdUZ, _enumSoy2.default);

exports.default = DWdUZ;
...
exports.templates = exports.DWdUZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DWdUZ.
   * @public
   */

  goog.module('DWdUZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DWdUZ.render';
  }
...
_metalSoy2.default.register(DWdUZ, templates);
exports.DWdUZ = DWdUZ;
