...
var CaZAe = function (_Component) {
  _inherits(CaZAe, _Component);

  function CaZAe() {
    _classCallCheck(this, CaZAe);

    return _possibleConstructorReturn(this, (CaZAe.__proto__ || Object.getPrototypeOf(CaZAe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CaZAe, _default_valueSoy2.default);

exports.default = CaZAe;
...
exports.templates = exports.CaZAe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CaZAe.
   * @public
   */

  goog.module('CaZAe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CaZAe.render';
  }
...
_metalSoy2.default.register(CaZAe, templates);
exports.CaZAe = CaZAe;
