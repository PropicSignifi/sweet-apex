...
var wqqQa = function (_Component) {
  _inherits(wqqQa, _Component);

  function wqqQa() {
    _classCallCheck(this, wqqQa);

    return _possibleConstructorReturn(this, (wqqQa.__proto__ || Object.getPrototypeOf(wqqQa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wqqQa, _templateSoy2.default);

exports.default = wqqQa;
...
exports.templates = exports.wqqQa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wqqQa.
   * @public
   */

  goog.module('wqqQa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wqqQa.render';
  }
...
_metalSoy2.default.register(wqqQa, templates);
exports.wqqQa = wqqQa;
