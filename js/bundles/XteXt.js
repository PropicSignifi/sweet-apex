...
var XteXt = function (_Component) {
  _inherits(XteXt, _Component);

  function XteXt() {
    _classCallCheck(this, XteXt);

    return _possibleConstructorReturn(this, (XteXt.__proto__ || Object.getPrototypeOf(XteXt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XteXt, _indexSoy2.default);
...
exports.templates = exports.XteXt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XteXt.
   * @public
   */

  goog.module('XteXt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XteXt.render';
  }
...
_metalSoy2.default.register(XteXt, templates);
exports.XteXt = XteXt;
