...
var VZptl = function (_Component) {
  _inherits(VZptl, _Component);

  function VZptl() {
    _classCallCheck(this, VZptl);

    return _possibleConstructorReturn(this, (VZptl.__proto__ || Object.getPrototypeOf(VZptl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VZptl, _commandSoy2.default);

exports.default = VZptl;
...
exports.templates = exports.VZptl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VZptl.
   * @public
   */

  goog.module('VZptl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VZptl.render';
  }
...
_metalSoy2.default.register(VZptl, templates);
exports.VZptl = VZptl;
