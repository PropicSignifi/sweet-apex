...
var FPesD = function (_Component) {
  _inherits(FPesD, _Component);

  function FPesD() {
    _classCallCheck(this, FPesD);

    return _possibleConstructorReturn(this, (FPesD.__proto__ || Object.getPrototypeOf(FPesD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FPesD, _enumSoy2.default);

exports.default = FPesD;
...
exports.templates = exports.FPesD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FPesD.
   * @public
   */

  goog.module('FPesD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FPesD.render';
  }
...
_metalSoy2.default.register(FPesD, templates);
exports.FPesD = FPesD;
