...
var MVquS = function (_Component) {
  _inherits(MVquS, _Component);

  function MVquS() {
    _classCallCheck(this, MVquS);

    return _possibleConstructorReturn(this, (MVquS.__proto__ || Object.getPrototypeOf(MVquS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MVquS, _step_2Soy2.default);

exports.default = MVquS;
...
exports.templates = exports.MVquS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MVquS.
   * @public
   */

  goog.module('MVquS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MVquS.render';
  }
...
_metalSoy2.default.register(MVquS, templates);
exports.MVquS = MVquS;
