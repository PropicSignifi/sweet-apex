...
var jLVpz = function (_Component) {
  _inherits(jLVpz, _Component);

  function jLVpz() {
    _classCallCheck(this, jLVpz);

    return _possibleConstructorReturn(this, (jLVpz.__proto__ || Object.getPrototypeOf(jLVpz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jLVpz, _nullableSoy2.default);

exports.default = jLVpz;
...
exports.templates = exports.jLVpz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jLVpz.
   * @public
   */

  goog.module('jLVpz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jLVpz.render';
  }
...
_metalSoy2.default.register(jLVpz, templates);
exports.jLVpz = jLVpz;
