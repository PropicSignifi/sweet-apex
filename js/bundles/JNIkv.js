...
var JNIkv = function (_Component) {
  _inherits(JNIkv, _Component);

  function JNIkv() {
    _classCallCheck(this, JNIkv);

    return _possibleConstructorReturn(this, (JNIkv.__proto__ || Object.getPrototypeOf(JNIkv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JNIkv, _step_4Soy2.default);

exports.default = JNIkv;
...
exports.templates = exports.JNIkv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JNIkv.
   * @public
   */

  goog.module('JNIkv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JNIkv.render';
  }
...
_metalSoy2.default.register(JNIkv, templates);
exports.JNIkv = JNIkv;
