...
var oAMnT = function (_Component) {
  _inherits(oAMnT, _Component);

  function oAMnT() {
    _classCallCheck(this, oAMnT);

    return _possibleConstructorReturn(this, (oAMnT.__proto__ || Object.getPrototypeOf(oAMnT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oAMnT, _actionSoy2.default);

exports.default = oAMnT;
...
exports.templates = exports.oAMnT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oAMnT.
   * @public
   */

  goog.module('oAMnT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oAMnT.render';
  }
...
_metalSoy2.default.register(oAMnT, templates);
exports.oAMnT = oAMnT;
