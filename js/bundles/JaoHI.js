...
var _operatorSoy = __webpack_require__(327);
...
var JaoHI = function (_Component) {
  _inherits(JaoHI, _Component);

  function JaoHI() {
    _classCallCheck(this, JaoHI);

    return _possibleConstructorReturn(this, (JaoHI.__proto__ || Object.getPrototypeOf(JaoHI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JaoHI, _operatorSoy2.default);

exports.default = JaoHI;
...
exports.templates = exports.JaoHI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JaoHI.
   * @public
   */

  goog.module('JaoHI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JaoHI.render';
  }
...
_metalSoy2.default.register(JaoHI, templates);
exports.JaoHI = JaoHI;
