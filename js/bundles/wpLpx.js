...
var wpLpx = function (_Component) {
  _inherits(wpLpx, _Component);

  function wpLpx() {
    _classCallCheck(this, wpLpx);

    return _possibleConstructorReturn(this, (wpLpx.__proto__ || Object.getPrototypeOf(wpLpx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wpLpx, _destructureSoy2.default);

exports.default = wpLpx;
...
exports.templates = exports.wpLpx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wpLpx.
   * @public
   */

  goog.module('wpLpx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wpLpx.render';
  }
...
_metalSoy2.default.register(wpLpx, templates);
exports.wpLpx = wpLpx;
