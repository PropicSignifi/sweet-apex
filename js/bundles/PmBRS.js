...
var _injectSoy = __webpack_require__(311);
...
var PmBRS = function (_Component) {
  _inherits(PmBRS, _Component);

  function PmBRS() {
    _classCallCheck(this, PmBRS);

    return _possibleConstructorReturn(this, (PmBRS.__proto__ || Object.getPrototypeOf(PmBRS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PmBRS, _injectSoy2.default);

exports.default = PmBRS;
...
exports.templates = exports.PmBRS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PmBRS.
   * @public
   */

  goog.module('PmBRS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PmBRS.render';
  }
...
_metalSoy2.default.register(PmBRS, templates);
exports.PmBRS = PmBRS;
