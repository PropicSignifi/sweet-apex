...
var EGhhw = function (_Component) {
  _inherits(EGhhw, _Component);

  function EGhhw() {
    _classCallCheck(this, EGhhw);

    return _possibleConstructorReturn(this, (EGhhw.__proto__ || Object.getPrototypeOf(EGhhw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EGhhw, _operatorSoy2.default);

exports.default = EGhhw;
...
exports.templates = exports.EGhhw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EGhhw.
   * @public
   */

  goog.module('EGhhw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EGhhw.render';
  }
...
_metalSoy2.default.register(EGhhw, templates);
exports.EGhhw = EGhhw;
