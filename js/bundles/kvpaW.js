...
var _scriptSoy = __webpack_require__(343);
...
var kvpaW = function (_Component) {
  _inherits(kvpaW, _Component);

  function kvpaW() {
    _classCallCheck(this, kvpaW);

    return _possibleConstructorReturn(this, (kvpaW.__proto__ || Object.getPrototypeOf(kvpaW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kvpaW, _scriptSoy2.default);

exports.default = kvpaW;
...
exports.templates = exports.kvpaW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kvpaW.
   * @public
   */

  goog.module('kvpaW.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1092 = function param1092() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1092 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kvpaW.render';
  }
...
_metalSoy2.default.register(kvpaW, templates);
exports.kvpaW = kvpaW;
