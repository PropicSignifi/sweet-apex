...
var dFYKW = function (_Component) {
  _inherits(dFYKW, _Component);

  function dFYKW() {
    _classCallCheck(this, dFYKW);

    return _possibleConstructorReturn(this, (dFYKW.__proto__ || Object.getPrototypeOf(dFYKW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dFYKW, _array_creationSoy2.default);

exports.default = dFYKW;
...
exports.templates = exports.dFYKW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dFYKW.
   * @public
   */

  goog.module('dFYKW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dFYKW.render';
  }
...
_metalSoy2.default.register(dFYKW, templates);
exports.dFYKW = dFYKW;
