...
var TxMhF = function (_Component) {
  _inherits(TxMhF, _Component);

  function TxMhF() {
    _classCallCheck(this, TxMhF);

    return _possibleConstructorReturn(this, (TxMhF.__proto__ || Object.getPrototypeOf(TxMhF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TxMhF, _modSoy2.default);

exports.default = TxMhF;
...
exports.templates = exports.TxMhF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TxMhF.
   * @public
   */

  goog.module('TxMhF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TxMhF.render';
  }
...
_metalSoy2.default.register(TxMhF, templates);
exports.TxMhF = TxMhF;
