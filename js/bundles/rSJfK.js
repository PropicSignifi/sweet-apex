...
var rSJfK = function (_Component) {
  _inherits(rSJfK, _Component);

  function rSJfK() {
    _classCallCheck(this, rSJfK);

    return _possibleConstructorReturn(this, (rSJfK.__proto__ || Object.getPrototypeOf(rSJfK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rSJfK, _featureSoy2.default);

exports.default = rSJfK;
...
exports.templates = exports.rSJfK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rSJfK.
   * @public
   */

  goog.module('rSJfK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rSJfK.render';
  }
...
_metalSoy2.default.register(rSJfK, templates);
exports.rSJfK = rSJfK;
