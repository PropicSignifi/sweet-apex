...
var FnNBN = function (_Component) {
  _inherits(FnNBN, _Component);

  function FnNBN() {
    _classCallCheck(this, FnNBN);

    return _possibleConstructorReturn(this, (FnNBN.__proto__ || Object.getPrototypeOf(FnNBN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FnNBN, _array_creationSoy2.default);

exports.default = FnNBN;
...
exports.templates = exports.FnNBN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FnNBN.
   * @public
   */

  goog.module('FnNBN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FnNBN.render';
  }
...
_metalSoy2.default.register(FnNBN, templates);
exports.FnNBN = FnNBN;
