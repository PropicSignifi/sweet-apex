...
var Jnnfo = function (_Component) {
  _inherits(Jnnfo, _Component);

  function Jnnfo() {
    _classCallCheck(this, Jnnfo);

    return _possibleConstructorReturn(this, (Jnnfo.__proto__ || Object.getPrototypeOf(Jnnfo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Jnnfo, _array_creationSoy2.default);

exports.default = Jnnfo;
...
exports.templates = exports.Jnnfo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Jnnfo.
   * @public
   */

  goog.module('Jnnfo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Jnnfo.render';
  }
...
_metalSoy2.default.register(Jnnfo, templates);
exports.Jnnfo = Jnnfo;
