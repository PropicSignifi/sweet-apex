...
var yLofJ = function (_Component) {
  _inherits(yLofJ, _Component);

  function yLofJ() {
    _classCallCheck(this, yLofJ);

    return _possibleConstructorReturn(this, (yLofJ.__proto__ || Object.getPrototypeOf(yLofJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yLofJ, _actionSoy2.default);

exports.default = yLofJ;
...
exports.templates = exports.yLofJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yLofJ.
   * @public
   */

  goog.module('yLofJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yLofJ.render';
  }
...
_metalSoy2.default.register(yLofJ, templates);
exports.yLofJ = yLofJ;
