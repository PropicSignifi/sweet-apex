...
var DBHia = function (_Component) {
  _inherits(DBHia, _Component);

  function DBHia() {
    _classCallCheck(this, DBHia);

    return _possibleConstructorReturn(this, (DBHia.__proto__ || Object.getPrototypeOf(DBHia)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DBHia, _testcaseSoy2.default);

exports.default = DBHia;
...
exports.templates = exports.DBHia = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DBHia.
   * @public
   */

  goog.module('DBHia.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DBHia.render';
  }
...
_metalSoy2.default.register(DBHia, templates);
exports.DBHia = DBHia;
