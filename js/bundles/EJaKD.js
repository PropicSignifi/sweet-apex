...
var EJaKD = function (_Component) {
  _inherits(EJaKD, _Component);

  function EJaKD() {
    _classCallCheck(this, EJaKD);

    return _possibleConstructorReturn(this, (EJaKD.__proto__ || Object.getPrototypeOf(EJaKD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EJaKD, _scriptSoy2.default);

exports.default = EJaKD;
...
exports.templates = exports.EJaKD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EJaKD.
   * @public
   */

  goog.module('EJaKD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EJaKD.render';
  }
...
_metalSoy2.default.register(EJaKD, templates);
exports.EJaKD = EJaKD;
