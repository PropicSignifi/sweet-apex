...
var CwCuY = function (_Component) {
  _inherits(CwCuY, _Component);

  function CwCuY() {
    _classCallCheck(this, CwCuY);

    return _possibleConstructorReturn(this, (CwCuY.__proto__ || Object.getPrototypeOf(CwCuY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CwCuY, _identitySoy2.default);

exports.default = CwCuY;
...
exports.templates = exports.CwCuY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CwCuY.
   * @public
   */

  goog.module('CwCuY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CwCuY.render';
  }
...
_metalSoy2.default.register(CwCuY, templates);
exports.CwCuY = CwCuY;
