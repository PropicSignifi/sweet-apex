...
var TdfAk = function (_Component) {
  _inherits(TdfAk, _Component);

  function TdfAk() {
    _classCallCheck(this, TdfAk);

    return _possibleConstructorReturn(this, (TdfAk.__proto__ || Object.getPrototypeOf(TdfAk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TdfAk, _operatorSoy2.default);

exports.default = TdfAk;
...
exports.templates = exports.TdfAk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TdfAk.
   * @public
   */

  goog.module('TdfAk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TdfAk.render';
  }
...
_metalSoy2.default.register(TdfAk, templates);
exports.TdfAk = TdfAk;
