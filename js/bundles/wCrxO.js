...
var wCrxO = function (_Component) {
  _inherits(wCrxO, _Component);

  function wCrxO() {
    _classCallCheck(this, wCrxO);

    return _possibleConstructorReturn(this, (wCrxO.__proto__ || Object.getPrototypeOf(wCrxO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wCrxO, _operatorSoy2.default);

exports.default = wCrxO;
...
exports.templates = exports.wCrxO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wCrxO.
   * @public
   */

  goog.module('wCrxO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wCrxO.render';
  }
...
_metalSoy2.default.register(wCrxO, templates);
exports.wCrxO = wCrxO;
