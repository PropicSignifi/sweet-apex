...
var xEkTl = function (_Component) {
  _inherits(xEkTl, _Component);

  function xEkTl() {
    _classCallCheck(this, xEkTl);

    return _possibleConstructorReturn(this, (xEkTl.__proto__ || Object.getPrototypeOf(xEkTl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xEkTl, _configSoy2.default);

exports.default = xEkTl;
...
exports.templates = exports.xEkTl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xEkTl.
   * @public
   */

  goog.module('xEkTl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xEkTl.render';
  }
...
_metalSoy2.default.register(xEkTl, templates);
exports.xEkTl = xEkTl;
