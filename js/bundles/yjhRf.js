...
var yjhRf = function (_Component) {
  _inherits(yjhRf, _Component);

  function yjhRf() {
    _classCallCheck(this, yjhRf);

    return _possibleConstructorReturn(this, (yjhRf.__proto__ || Object.getPrototypeOf(yjhRf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yjhRf, _annotationSoy2.default);

exports.default = yjhRf;
...
exports.templates = exports.yjhRf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yjhRf.
   * @public
   */

  goog.module('yjhRf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yjhRf.render';
  }
...
_metalSoy2.default.register(yjhRf, templates);
exports.yjhRf = yjhRf;
