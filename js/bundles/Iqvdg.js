...
var Iqvdg = function (_Component) {
  _inherits(Iqvdg, _Component);

  function Iqvdg() {
    _classCallCheck(this, Iqvdg);

    return _possibleConstructorReturn(this, (Iqvdg.__proto__ || Object.getPrototypeOf(Iqvdg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Iqvdg, _indexSoy2.default);

exports.default = Iqvdg;
...
exports.templates = exports.Iqvdg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Iqvdg.
   * @public
   */

  goog.module('Iqvdg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Iqvdg.render';
  }
...
_metalSoy2.default.register(Iqvdg, templates);
exports.Iqvdg = Iqvdg;
