...
var ppAru = function (_Component) {
  _inherits(ppAru, _Component);

  function ppAru() {
    _classCallCheck(this, ppAru);

    return _possibleConstructorReturn(this, (ppAru.__proto__ || Object.getPrototypeOf(ppAru)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ppAru, _transpilationSoy2.default);

exports.default = ppAru;
...
exports.templates = exports.ppAru = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ppAru.
   * @public
   */

  goog.module('ppAru.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ppAru.render';
  }
...
_metalSoy2.default.register(ppAru, templates);
exports.ppAru = ppAru;
