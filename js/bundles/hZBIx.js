...
var hZBIx = function (_Component) {
  _inherits(hZBIx, _Component);

  function hZBIx() {
    _classCallCheck(this, hZBIx);

    return _possibleConstructorReturn(this, (hZBIx.__proto__ || Object.getPrototypeOf(hZBIx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hZBIx, _default_valueSoy2.default);

exports.default = hZBIx;
...
exports.templates = exports.hZBIx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hZBIx.
   * @public
   */

  goog.module('hZBIx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hZBIx.render';
  }
...
_metalSoy2.default.register(hZBIx, templates);
exports.hZBIx = hZBIx;
