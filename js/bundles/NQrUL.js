...
var NQrUL = function (_Component) {
  _inherits(NQrUL, _Component);

  function NQrUL() {
    _classCallCheck(this, NQrUL);

    return _possibleConstructorReturn(this, (NQrUL.__proto__ || Object.getPrototypeOf(NQrUL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NQrUL, _indexSoy2.default);

exports.default = NQrUL;
...
exports.templates = exports.NQrUL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NQrUL.
   * @public
   */

  goog.module('NQrUL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NQrUL.render';
  }
...
_metalSoy2.default.register(NQrUL, templates);
exports.NQrUL = NQrUL;
