...
var uMOsN = function (_Component) {
  _inherits(uMOsN, _Component);

  function uMOsN() {
    _classCallCheck(this, uMOsN);

    return _possibleConstructorReturn(this, (uMOsN.__proto__ || Object.getPrototypeOf(uMOsN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uMOsN, _fileSoy2.default);

exports.default = uMOsN;
...
exports.templates = exports.uMOsN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uMOsN.
   * @public
   */

  goog.module('uMOsN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uMOsN.render';
  }
...
_metalSoy2.default.register(uMOsN, templates);
exports.uMOsN = uMOsN;
