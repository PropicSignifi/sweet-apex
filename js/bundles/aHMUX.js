...
var aHMUX = function (_Component) {
  _inherits(aHMUX, _Component);

  function aHMUX() {
    _classCallCheck(this, aHMUX);

    return _possibleConstructorReturn(this, (aHMUX.__proto__ || Object.getPrototypeOf(aHMUX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aHMUX, _operatorSoy2.default);

exports.default = aHMUX;
...
exports.templates = exports.aHMUX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aHMUX.
   * @public
   */

  goog.module('aHMUX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aHMUX.render';
  }
...
_metalSoy2.default.register(aHMUX, templates);
exports.aHMUX = aHMUX;
