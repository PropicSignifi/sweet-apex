...
var asrTu = function (_Component) {
  _inherits(asrTu, _Component);

  function asrTu() {
    _classCallCheck(this, asrTu);

    return _possibleConstructorReturn(this, (asrTu.__proto__ || Object.getPrototypeOf(asrTu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(asrTu, _testcaseSoy2.default);

exports.default = asrTu;
...
exports.templates = exports.asrTu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace asrTu.
   * @public
   */

  goog.module('asrTu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'asrTu.render';
  }
...
_metalSoy2.default.register(asrTu, templates);
exports.asrTu = asrTu;
