...
var AmcCG = function (_Component) {
  _inherits(AmcCG, _Component);

  function AmcCG() {
    _classCallCheck(this, AmcCG);

    return _possibleConstructorReturn(this, (AmcCG.__proto__ || Object.getPrototypeOf(AmcCG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AmcCG, _actionSoy2.default);

exports.default = AmcCG;
...
exports.templates = exports.AmcCG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AmcCG.
   * @public
   */

  goog.module('AmcCG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AmcCG.render';
  }
...
_metalSoy2.default.register(AmcCG, templates);
exports.AmcCG = AmcCG;
