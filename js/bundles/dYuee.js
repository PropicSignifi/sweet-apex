...
var dYuee = function (_Component) {
  _inherits(dYuee, _Component);

  function dYuee() {
    _classCallCheck(this, dYuee);

    return _possibleConstructorReturn(this, (dYuee.__proto__ || Object.getPrototypeOf(dYuee)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dYuee, _enumSoy2.default);

exports.default = dYuee;
...
exports.templates = exports.dYuee = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dYuee.
   * @public
   */

  goog.module('dYuee.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dYuee.render';
  }
...
_metalSoy2.default.register(dYuee, templates);
exports.dYuee = dYuee;
