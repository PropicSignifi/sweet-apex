...
var FfpQj = function (_Component) {
  _inherits(FfpQj, _Component);

  function FfpQj() {
    _classCallCheck(this, FfpQj);

    return _possibleConstructorReturn(this, (FfpQj.__proto__ || Object.getPrototypeOf(FfpQj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FfpQj, _testcaseSoy2.default);

exports.default = FfpQj;
...
exports.templates = exports.FfpQj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FfpQj.
   * @public
   */

  goog.module('FfpQj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FfpQj.render';
  }
...
_metalSoy2.default.register(FfpQj, templates);
exports.FfpQj = FfpQj;
