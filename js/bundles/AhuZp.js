...
var AhuZp = function (_Component) {
  _inherits(AhuZp, _Component);

  function AhuZp() {
    _classCallCheck(this, AhuZp);

    return _possibleConstructorReturn(this, (AhuZp.__proto__ || Object.getPrototypeOf(AhuZp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AhuZp, _templateSoy2.default);

exports.default = AhuZp;
...
exports.templates = exports.AhuZp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AhuZp.
   * @public
   */

  goog.module('AhuZp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AhuZp.render';
  }
...
_metalSoy2.default.register(AhuZp, templates);
exports.AhuZp = AhuZp;
