...
var _lambdaSoy = __webpack_require__(309);
...
var EwuAn = function (_Component) {
  _inherits(EwuAn, _Component);

  function EwuAn() {
    _classCallCheck(this, EwuAn);

    return _possibleConstructorReturn(this, (EwuAn.__proto__ || Object.getPrototypeOf(EwuAn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EwuAn, _lambdaSoy2.default);

exports.default = EwuAn;
...
exports.templates = exports.EwuAn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EwuAn.
   * @public
   */

  goog.module('EwuAn.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param700 = function param700() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param700 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EwuAn.render';
  }
...
_metalSoy2.default.register(EwuAn, templates);
exports.EwuAn = EwuAn;
