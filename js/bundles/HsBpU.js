...
var HsBpU = function (_Component) {
  _inherits(HsBpU, _Component);

  function HsBpU() {
    _classCallCheck(this, HsBpU);

    return _possibleConstructorReturn(this, (HsBpU.__proto__ || Object.getPrototypeOf(HsBpU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HsBpU, _default_valueSoy2.default);

exports.default = HsBpU;
...
exports.templates = exports.HsBpU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HsBpU.
   * @public
   */

  goog.module('HsBpU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HsBpU.render';
  }
...
_metalSoy2.default.register(HsBpU, templates);
exports.HsBpU = HsBpU;
