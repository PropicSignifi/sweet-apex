...
var WVrRw = function (_Component) {
  _inherits(WVrRw, _Component);

  function WVrRw() {
    _classCallCheck(this, WVrRw);

    return _possibleConstructorReturn(this, (WVrRw.__proto__ || Object.getPrototypeOf(WVrRw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WVrRw, _indexSoy2.default);

exports.default = WVrRw;
...
exports.templates = exports.WVrRw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WVrRw.
   * @public
   */

  goog.module('WVrRw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WVrRw.render';
  }
...
_metalSoy2.default.register(WVrRw, templates);
exports.WVrRw = WVrRw;
