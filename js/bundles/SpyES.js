...
var SpyES = function (_Component) {
  _inherits(SpyES, _Component);

  function SpyES() {
    _classCallCheck(this, SpyES);

    return _possibleConstructorReturn(this, (SpyES.__proto__ || Object.getPrototypeOf(SpyES)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SpyES, _grammarSoy2.default);

exports.default = SpyES;
...
exports.templates = exports.SpyES = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SpyES.
   * @public
   */

  goog.module('SpyES.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SpyES.render';
  }
...
_metalSoy2.default.register(SpyES, templates);
exports.SpyES = SpyES;
