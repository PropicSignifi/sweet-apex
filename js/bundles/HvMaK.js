...
var HvMaK = function (_Component) {
  _inherits(HvMaK, _Component);

  function HvMaK() {
    _classCallCheck(this, HvMaK);

    return _possibleConstructorReturn(this, (HvMaK.__proto__ || Object.getPrototypeOf(HvMaK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HvMaK, _reflectSoy2.default);

exports.default = HvMaK;
...
exports.templates = exports.HvMaK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HvMaK.
   * @public
   */

  goog.module('HvMaK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HvMaK.render';
  }
...
_metalSoy2.default.register(HvMaK, templates);
exports.HvMaK = HvMaK;
