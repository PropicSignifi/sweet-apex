...
var MHDHM = function (_Component) {
  _inherits(MHDHM, _Component);

  function MHDHM() {
    _classCallCheck(this, MHDHM);

    return _possibleConstructorReturn(this, (MHDHM.__proto__ || Object.getPrototypeOf(MHDHM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MHDHM, _indexSoy2.default);

exports.default = MHDHM;
...
exports.templates = exports.MHDHM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MHDHM.
   * @public
   */

  goog.module('MHDHM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MHDHM.render';
  }
...
_metalSoy2.default.register(MHDHM, templates);
exports.MHDHM = MHDHM;
