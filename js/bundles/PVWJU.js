...
var _scriptSoy = __webpack_require__(339);
...
var PVWJU = function (_Component) {
  _inherits(PVWJU, _Component);

  function PVWJU() {
    _classCallCheck(this, PVWJU);

    return _possibleConstructorReturn(this, (PVWJU.__proto__ || Object.getPrototypeOf(PVWJU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PVWJU, _scriptSoy2.default);

exports.default = PVWJU;
...
exports.templates = exports.PVWJU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PVWJU.
   * @public
   */

  goog.module('PVWJU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PVWJU.render';
  }
...
_metalSoy2.default.register(PVWJU, templates);
exports.PVWJU = PVWJU;
