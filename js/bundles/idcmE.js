...
var _reflectSoy = __webpack_require__(331);
...
var idcmE = function (_Component) {
  _inherits(idcmE, _Component);

  function idcmE() {
    _classCallCheck(this, idcmE);

    return _possibleConstructorReturn(this, (idcmE.__proto__ || Object.getPrototypeOf(idcmE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(idcmE, _reflectSoy2.default);

exports.default = idcmE;
...
exports.templates = exports.idcmE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace idcmE.
   * @public
   */

  goog.module('idcmE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'idcmE.render';
  }
...
_metalSoy2.default.register(idcmE, templates);
exports.idcmE = idcmE;
