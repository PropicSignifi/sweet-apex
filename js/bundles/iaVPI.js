...
var _operatorSoy = __webpack_require__(333);
...
var iaVPI = function (_Component) {
  _inherits(iaVPI, _Component);

  function iaVPI() {
    _classCallCheck(this, iaVPI);

    return _possibleConstructorReturn(this, (iaVPI.__proto__ || Object.getPrototypeOf(iaVPI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iaVPI, _operatorSoy2.default);

exports.default = iaVPI;
...
exports.templates = exports.iaVPI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iaVPI.
   * @public
   */

  goog.module('iaVPI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iaVPI.render';
  }
...
_metalSoy2.default.register(iaVPI, templates);
exports.iaVPI = iaVPI;
