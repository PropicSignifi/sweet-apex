...
var hZkzq = function (_Component) {
  _inherits(hZkzq, _Component);

  function hZkzq() {
    _classCallCheck(this, hZkzq);

    return _possibleConstructorReturn(this, (hZkzq.__proto__ || Object.getPrototypeOf(hZkzq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hZkzq, _lambdaSoy2.default);

exports.default = hZkzq;
...
exports.templates = exports.hZkzq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hZkzq.
   * @public
   */

  goog.module('hZkzq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hZkzq.render';
  }
...
_metalSoy2.default.register(hZkzq, templates);
exports.hZkzq = hZkzq;
