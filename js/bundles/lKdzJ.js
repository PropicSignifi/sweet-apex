...
var lKdzJ = function (_Component) {
  _inherits(lKdzJ, _Component);

  function lKdzJ() {
    _classCallCheck(this, lKdzJ);

    return _possibleConstructorReturn(this, (lKdzJ.__proto__ || Object.getPrototypeOf(lKdzJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lKdzJ, _configSoy2.default);

exports.default = lKdzJ;
...
exports.templates = exports.lKdzJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lKdzJ.
   * @public
   */

  goog.module('lKdzJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lKdzJ.render';
  }
...
_metalSoy2.default.register(lKdzJ, templates);
exports.lKdzJ = lKdzJ;
