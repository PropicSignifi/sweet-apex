...
var jlyiP = function (_Component) {
  _inherits(jlyiP, _Component);

  function jlyiP() {
    _classCallCheck(this, jlyiP);

    return _possibleConstructorReturn(this, (jlyiP.__proto__ || Object.getPrototypeOf(jlyiP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jlyiP, _indexSoy2.default);

exports.default = jlyiP;
...
exports.templates = exports.jlyiP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jlyiP.
   * @public
   */

  goog.module('jlyiP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jlyiP.render';
  }
...
_metalSoy2.default.register(jlyiP, templates);
exports.jlyiP = jlyiP;
