...
var YyUQF = function (_Component) {
  _inherits(YyUQF, _Component);

  function YyUQF() {
    _classCallCheck(this, YyUQF);

    return _possibleConstructorReturn(this, (YyUQF.__proto__ || Object.getPrototypeOf(YyUQF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YyUQF, _templateSoy2.default);

exports.default = YyUQF;
...
exports.templates = exports.YyUQF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YyUQF.
   * @public
   */

  goog.module('YyUQF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YyUQF.render';
  }
...
_metalSoy2.default.register(YyUQF, templates);
exports.YyUQF = YyUQF;
