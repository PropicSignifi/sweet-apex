...
var LgRGT = function (_Component) {
  _inherits(LgRGT, _Component);

  function LgRGT() {
    _classCallCheck(this, LgRGT);

    return _possibleConstructorReturn(this, (LgRGT.__proto__ || Object.getPrototypeOf(LgRGT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LgRGT, _operatorSoy2.default);

exports.default = LgRGT;
...
exports.templates = exports.LgRGT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LgRGT.
   * @public
   */

  goog.module('LgRGT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LgRGT.render';
  }
...
_metalSoy2.default.register(LgRGT, templates);
exports.LgRGT = LgRGT;
