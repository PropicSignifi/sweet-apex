...
var oaddi = function (_Component) {
  _inherits(oaddi, _Component);

  function oaddi() {
    _classCallCheck(this, oaddi);

    return _possibleConstructorReturn(this, (oaddi.__proto__ || Object.getPrototypeOf(oaddi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oaddi, _commandSoy2.default);

exports.default = oaddi;
...
exports.templates = exports.oaddi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oaddi.
   * @public
   */

  goog.module('oaddi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oaddi.render';
  }
...
_metalSoy2.default.register(oaddi, templates);
exports.oaddi = oaddi;
