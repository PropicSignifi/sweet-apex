...
var sShCB = function (_Component) {
  _inherits(sShCB, _Component);

  function sShCB() {
    _classCallCheck(this, sShCB);

    return _possibleConstructorReturn(this, (sShCB.__proto__ || Object.getPrototypeOf(sShCB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sShCB, _transpilationSoy2.default);

exports.default = sShCB;
...
exports.templates = exports.sShCB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sShCB.
   * @public
   */

  goog.module('sShCB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sShCB.render';
  }
...
_metalSoy2.default.register(sShCB, templates);
exports.sShCB = sShCB;
