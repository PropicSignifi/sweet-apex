...
var atwIE = function (_Component) {
  _inherits(atwIE, _Component);

  function atwIE() {
    _classCallCheck(this, atwIE);

    return _possibleConstructorReturn(this, (atwIE.__proto__ || Object.getPrototypeOf(atwIE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(atwIE, _indexSoy2.default);

exports.default = atwIE;
...
exports.templates = exports.atwIE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace atwIE.
   * @public
   */

  goog.module('atwIE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'atwIE.render';
  }
...
_metalSoy2.default.register(atwIE, templates);
exports.atwIE = atwIE;
