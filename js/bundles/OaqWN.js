...
var OaqWN = function (_Component) {
  _inherits(OaqWN, _Component);

  function OaqWN() {
    _classCallCheck(this, OaqWN);

    return _possibleConstructorReturn(this, (OaqWN.__proto__ || Object.getPrototypeOf(OaqWN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OaqWN, _operatorSoy2.default);

exports.default = OaqWN;
...
exports.templates = exports.OaqWN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OaqWN.
   * @public
   */

  goog.module('OaqWN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OaqWN.render';
  }
...
_metalSoy2.default.register(OaqWN, templates);
exports.OaqWN = OaqWN;
