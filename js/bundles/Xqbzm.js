...
var Xqbzm = function (_Component) {
  _inherits(Xqbzm, _Component);

  function Xqbzm() {
    _classCallCheck(this, Xqbzm);

    return _possibleConstructorReturn(this, (Xqbzm.__proto__ || Object.getPrototypeOf(Xqbzm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Xqbzm, _tagged_stringSoy2.default);

exports.default = Xqbzm;
...
exports.templates = exports.Xqbzm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Xqbzm.
   * @public
   */

  goog.module('Xqbzm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Xqbzm.render';
  }
...
_metalSoy2.default.register(Xqbzm, templates);
exports.Xqbzm = Xqbzm;
