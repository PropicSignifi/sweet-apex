...
var tlNkw = function (_Component) {
  _inherits(tlNkw, _Component);

  function tlNkw() {
    _classCallCheck(this, tlNkw);

    return _possibleConstructorReturn(this, (tlNkw.__proto__ || Object.getPrototypeOf(tlNkw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tlNkw, _enumSoy2.default);

exports.default = tlNkw;
...
exports.templates = exports.tlNkw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tlNkw.
   * @public
   */

  goog.module('tlNkw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tlNkw.render';
  }
...
_metalSoy2.default.register(tlNkw, templates);
exports.tlNkw = tlNkw;
