...
var iZeDV = function (_Component) {
  _inherits(iZeDV, _Component);

  function iZeDV() {
    _classCallCheck(this, iZeDV);

    return _possibleConstructorReturn(this, (iZeDV.__proto__ || Object.getPrototypeOf(iZeDV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iZeDV, _featureSoy2.default);

exports.default = iZeDV;
...
exports.templates = exports.iZeDV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iZeDV.
   * @public
   */

  goog.module('iZeDV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iZeDV.render';
  }
...
_metalSoy2.default.register(iZeDV, templates);
exports.iZeDV = iZeDV;
