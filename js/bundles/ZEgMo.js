...
var ZEgMo = function (_Component) {
  _inherits(ZEgMo, _Component);

  function ZEgMo() {
    _classCallCheck(this, ZEgMo);

    return _possibleConstructorReturn(this, (ZEgMo.__proto__ || Object.getPrototypeOf(ZEgMo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZEgMo, _scriptSoy2.default);

exports.default = ZEgMo;
...
exports.templates = exports.ZEgMo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZEgMo.
   * @public
   */

  goog.module('ZEgMo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZEgMo.render';
  }
...
_metalSoy2.default.register(ZEgMo, templates);
exports.ZEgMo = ZEgMo;
