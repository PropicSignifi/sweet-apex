...
var ztGHf = function (_Component) {
  _inherits(ztGHf, _Component);

  function ztGHf() {
    _classCallCheck(this, ztGHf);

    return _possibleConstructorReturn(this, (ztGHf.__proto__ || Object.getPrototypeOf(ztGHf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ztGHf, _indexSoy2.default);

exports.default = ztGHf;
...
exports.templates = exports.ztGHf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ztGHf.
   * @public
   */

  goog.module('ztGHf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ztGHf.render';
  }
...
_metalSoy2.default.register(ztGHf, templates);
exports.ztGHf = ztGHf;
