...
var Gxuod = function (_Component) {
  _inherits(Gxuod, _Component);

  function Gxuod() {
    _classCallCheck(this, Gxuod);

    return _possibleConstructorReturn(this, (Gxuod.__proto__ || Object.getPrototypeOf(Gxuod)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Gxuod, _constructor_annotationSoy2.default);

exports.default = Gxuod;
...
exports.templates = exports.Gxuod = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Gxuod.
   * @public
   */

  goog.module('Gxuod.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Gxuod.render';
  }
...
_metalSoy2.default.register(Gxuod, templates);
exports.Gxuod = Gxuod;
