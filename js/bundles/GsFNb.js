...
var GsFNb = function (_Component) {
  _inherits(GsFNb, _Component);

  function GsFNb() {
    _classCallCheck(this, GsFNb);

    return _possibleConstructorReturn(this, (GsFNb.__proto__ || Object.getPrototypeOf(GsFNb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GsFNb, _apexdocSoy2.default);

exports.default = GsFNb;
...
exports.templates = exports.GsFNb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GsFNb.
   * @public
   */

  goog.module('GsFNb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GsFNb.render';
  }
...
_metalSoy2.default.register(GsFNb, templates);
exports.GsFNb = GsFNb;
