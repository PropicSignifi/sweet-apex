...
var LsIPZ = function (_Component) {
  _inherits(LsIPZ, _Component);

  function LsIPZ() {
    _classCallCheck(this, LsIPZ);

    return _possibleConstructorReturn(this, (LsIPZ.__proto__ || Object.getPrototypeOf(LsIPZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LsIPZ, _commandSoy2.default);

exports.default = LsIPZ;
...
exports.templates = exports.LsIPZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LsIPZ.
   * @public
   */

  goog.module('LsIPZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LsIPZ.render';
  }
...
_metalSoy2.default.register(LsIPZ, templates);
exports.LsIPZ = LsIPZ;
