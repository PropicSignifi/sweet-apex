...
var dAUnk = function (_Component) {
  _inherits(dAUnk, _Component);

  function dAUnk() {
    _classCallCheck(this, dAUnk);

    return _possibleConstructorReturn(this, (dAUnk.__proto__ || Object.getPrototypeOf(dAUnk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dAUnk, _enumSoy2.default);

exports.default = dAUnk;
...
exports.templates = exports.dAUnk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dAUnk.
   * @public
   */

  goog.module('dAUnk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dAUnk.render';
  }
...
_metalSoy2.default.register(dAUnk, templates);
exports.dAUnk = dAUnk;
