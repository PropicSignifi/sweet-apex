...
var khutM = function (_Component) {
  _inherits(khutM, _Component);

  function khutM() {
    _classCallCheck(this, khutM);

    return _possibleConstructorReturn(this, (khutM.__proto__ || Object.getPrototypeOf(khutM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(khutM, _fileSoy2.default);

exports.default = khutM;
...
exports.templates = exports.khutM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace khutM.
   * @public
   */

  goog.module('khutM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'khutM.render';
  }
...
_metalSoy2.default.register(khutM, templates);
exports.khutM = khutM;
