...
var wnfMD = function (_Component) {
  _inherits(wnfMD, _Component);

  function wnfMD() {
    _classCallCheck(this, wnfMD);

    return _possibleConstructorReturn(this, (wnfMD.__proto__ || Object.getPrototypeOf(wnfMD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wnfMD, _default_valueSoy2.default);

exports.default = wnfMD;
...
exports.templates = exports.wnfMD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wnfMD.
   * @public
   */

  goog.module('wnfMD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wnfMD.render';
  }
...
_metalSoy2.default.register(wnfMD, templates);
exports.wnfMD = wnfMD;
