...
var euYGq = function (_Component) {
  _inherits(euYGq, _Component);

  function euYGq() {
    _classCallCheck(this, euYGq);

    return _possibleConstructorReturn(this, (euYGq.__proto__ || Object.getPrototypeOf(euYGq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(euYGq, _indexSoy2.default);

exports.default = euYGq;
...
exports.templates = exports.euYGq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace euYGq.
   * @public
   */

  goog.module('euYGq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'euYGq.render';
  }
...
_metalSoy2.default.register(euYGq, templates);
exports.euYGq = euYGq;
