...
var qpvhy = function (_Component) {
  _inherits(qpvhy, _Component);

  function qpvhy() {
    _classCallCheck(this, qpvhy);

    return _possibleConstructorReturn(this, (qpvhy.__proto__ || Object.getPrototypeOf(qpvhy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qpvhy, _reflectSoy2.default);

exports.default = qpvhy;
...
exports.templates = exports.qpvhy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qpvhy.
   * @public
   */

  goog.module('qpvhy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qpvhy.render';
  }
...
_metalSoy2.default.register(qpvhy, templates);
exports.qpvhy = qpvhy;
