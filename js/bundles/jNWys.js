...
var jNWys = function (_Component) {
  _inherits(jNWys, _Component);

  function jNWys() {
    _classCallCheck(this, jNWys);

    return _possibleConstructorReturn(this, (jNWys.__proto__ || Object.getPrototypeOf(jNWys)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jNWys, _reflectSoy2.default);

exports.default = jNWys;
...
exports.templates = exports.jNWys = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jNWys.
   * @public
   */

  goog.module('jNWys.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jNWys.render';
  }
...
_metalSoy2.default.register(jNWys, templates);
exports.jNWys = jNWys;
