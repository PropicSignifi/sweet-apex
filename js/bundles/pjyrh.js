...
var pjyrh = function (_Component) {
  _inherits(pjyrh, _Component);

  function pjyrh() {
    _classCallCheck(this, pjyrh);

    return _possibleConstructorReturn(this, (pjyrh.__proto__ || Object.getPrototypeOf(pjyrh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pjyrh, _default_valueSoy2.default);

exports.default = pjyrh;
...
exports.templates = exports.pjyrh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pjyrh.
   * @public
   */

  goog.module('pjyrh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pjyrh.render';
  }
...
_metalSoy2.default.register(pjyrh, templates);
exports.pjyrh = pjyrh;
