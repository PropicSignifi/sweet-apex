...
var _reflectSoy = __webpack_require__(321);
...
var fOaRr = function (_Component) {
  _inherits(fOaRr, _Component);

  function fOaRr() {
    _classCallCheck(this, fOaRr);

    return _possibleConstructorReturn(this, (fOaRr.__proto__ || Object.getPrototypeOf(fOaRr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fOaRr, _reflectSoy2.default);

exports.default = fOaRr;
...
exports.templates = exports.fOaRr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fOaRr.
   * @public
   */

  goog.module('fOaRr.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param826 = function param826() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param826 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fOaRr.render';
  }
...
_metalSoy2.default.register(fOaRr, templates);
exports.fOaRr = fOaRr;
