...
var YGbcJ = function (_Component) {
  _inherits(YGbcJ, _Component);

  function YGbcJ() {
    _classCallCheck(this, YGbcJ);

    return _possibleConstructorReturn(this, (YGbcJ.__proto__ || Object.getPrototypeOf(YGbcJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YGbcJ, _castSoy2.default);

exports.default = YGbcJ;
...
exports.templates = exports.YGbcJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YGbcJ.
   * @public
   */

  goog.module('YGbcJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YGbcJ.render';
  }
...
_metalSoy2.default.register(YGbcJ, templates);
exports.YGbcJ = YGbcJ;
