...
var foQFy = function (_Component) {
  _inherits(foQFy, _Component);

  function foQFy() {
    _classCallCheck(this, foQFy);

    return _possibleConstructorReturn(this, (foQFy.__proto__ || Object.getPrototypeOf(foQFy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(foQFy, _reflectSoy2.default);

exports.default = foQFy;
...
exports.templates = exports.foQFy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace foQFy.
   * @public
   */

  goog.module('foQFy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'foQFy.render';
  }
...
_metalSoy2.default.register(foQFy, templates);
exports.foQFy = foQFy;
