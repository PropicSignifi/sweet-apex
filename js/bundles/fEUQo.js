...
var fEUQo = function (_Component) {
  _inherits(fEUQo, _Component);

  function fEUQo() {
    _classCallCheck(this, fEUQo);

    return _possibleConstructorReturn(this, (fEUQo.__proto__ || Object.getPrototypeOf(fEUQo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fEUQo, _indexSoy2.default);

exports.default = fEUQo;
...
exports.templates = exports.fEUQo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fEUQo.
   * @public
   */

  goog.module('fEUQo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fEUQo.render';
  }
...
_metalSoy2.default.register(fEUQo, templates);
exports.fEUQo = fEUQo;
