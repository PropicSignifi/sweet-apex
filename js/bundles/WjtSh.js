...
var WjtSh = function (_Component) {
  _inherits(WjtSh, _Component);

  function WjtSh() {
    _classCallCheck(this, WjtSh);

    return _possibleConstructorReturn(this, (WjtSh.__proto__ || Object.getPrototypeOf(WjtSh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WjtSh, _featureSoy2.default);

exports.default = WjtSh;
...
exports.templates = exports.WjtSh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WjtSh.
   * @public
   */

  goog.module('WjtSh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WjtSh.render';
  }
...
_metalSoy2.default.register(WjtSh, templates);
exports.WjtSh = WjtSh;
