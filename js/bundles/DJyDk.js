...
var DJyDk = function (_Component) {
  _inherits(DJyDk, _Component);

  function DJyDk() {
    _classCallCheck(this, DJyDk);

    return _possibleConstructorReturn(this, (DJyDk.__proto__ || Object.getPrototypeOf(DJyDk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DJyDk, _transpilationSoy2.default);

exports.default = DJyDk;
...
exports.templates = exports.DJyDk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DJyDk.
   * @public
   */

  goog.module('DJyDk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DJyDk.render';
  }
...
_metalSoy2.default.register(DJyDk, templates);
exports.DJyDk = DJyDk;
