...
var ZnLZz = function (_Component) {
  _inherits(ZnLZz, _Component);

  function ZnLZz() {
    _classCallCheck(this, ZnLZz);

    return _possibleConstructorReturn(this, (ZnLZz.__proto__ || Object.getPrototypeOf(ZnLZz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZnLZz, _castSoy2.default);

exports.default = ZnLZz;
...
exports.templates = exports.ZnLZz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZnLZz.
   * @public
   */

  goog.module('ZnLZz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZnLZz.render';
  }
...
_metalSoy2.default.register(ZnLZz, templates);
exports.ZnLZz = ZnLZz;
