...
var ZqDnB = function (_Component) {
  _inherits(ZqDnB, _Component);

  function ZqDnB() {
    _classCallCheck(this, ZqDnB);

    return _possibleConstructorReturn(this, (ZqDnB.__proto__ || Object.getPrototypeOf(ZqDnB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZqDnB, _grammarSoy2.default);

exports.default = ZqDnB;
...
exports.templates = exports.ZqDnB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZqDnB.
   * @public
   */

  goog.module('ZqDnB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZqDnB.render';
  }
...
_metalSoy2.default.register(ZqDnB, templates);
exports.ZqDnB = ZqDnB;
