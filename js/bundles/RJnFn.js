...
var RJnFn = function (_Component) {
  _inherits(RJnFn, _Component);

  function RJnFn() {
    _classCallCheck(this, RJnFn);

    return _possibleConstructorReturn(this, (RJnFn.__proto__ || Object.getPrototypeOf(RJnFn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RJnFn, _reflectSoy2.default);

exports.default = RJnFn;
...
exports.templates = exports.RJnFn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RJnFn.
   * @public
   */

  goog.module('RJnFn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RJnFn.render';
  }
...
_metalSoy2.default.register(RJnFn, templates);
exports.RJnFn = RJnFn;
