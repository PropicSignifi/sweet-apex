...
var miSxs = function (_Component) {
  _inherits(miSxs, _Component);

  function miSxs() {
    _classCallCheck(this, miSxs);

    return _possibleConstructorReturn(this, (miSxs.__proto__ || Object.getPrototypeOf(miSxs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(miSxs, _indexSoy2.default);

exports.default = miSxs;
...
exports.templates = exports.miSxs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace miSxs.
   * @public
   */

  goog.module('miSxs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'miSxs.render';
  }
...
_metalSoy2.default.register(miSxs, templates);
exports.miSxs = miSxs;
