...
var sKPMP = function (_Component) {
  _inherits(sKPMP, _Component);

  function sKPMP() {
    _classCallCheck(this, sKPMP);

    return _possibleConstructorReturn(this, (sKPMP.__proto__ || Object.getPrototypeOf(sKPMP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sKPMP, _templateSoy2.default);

exports.default = sKPMP;
...
exports.templates = exports.sKPMP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sKPMP.
   * @public
   */

  goog.module('sKPMP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sKPMP.render';
  }
...
_metalSoy2.default.register(sKPMP, templates);
exports.sKPMP = sKPMP;
