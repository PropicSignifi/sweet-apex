...
var wMfOC = function (_Component) {
  _inherits(wMfOC, _Component);

  function wMfOC() {
    _classCallCheck(this, wMfOC);

    return _possibleConstructorReturn(this, (wMfOC.__proto__ || Object.getPrototypeOf(wMfOC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wMfOC, _identitySoy2.default);

exports.default = wMfOC;
...
exports.templates = exports.wMfOC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wMfOC.
   * @public
   */

  goog.module('wMfOC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wMfOC.render';
  }
...
_metalSoy2.default.register(wMfOC, templates);
exports.wMfOC = wMfOC;
