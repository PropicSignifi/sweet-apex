...
var CZQtx = function (_Component) {
  _inherits(CZQtx, _Component);

  function CZQtx() {
    _classCallCheck(this, CZQtx);

    return _possibleConstructorReturn(this, (CZQtx.__proto__ || Object.getPrototypeOf(CZQtx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CZQtx, _configSoy2.default);

exports.default = CZQtx;
...
exports.templates = exports.CZQtx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CZQtx.
   * @public
   */

  goog.module('CZQtx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CZQtx.render';
  }
...
_metalSoy2.default.register(CZQtx, templates);
exports.CZQtx = CZQtx;
