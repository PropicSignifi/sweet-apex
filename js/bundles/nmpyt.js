...
var nmpyt = function (_Component) {
  _inherits(nmpyt, _Component);

  function nmpyt() {
    _classCallCheck(this, nmpyt);

    return _possibleConstructorReturn(this, (nmpyt.__proto__ || Object.getPrototypeOf(nmpyt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nmpyt, _tagged_stringSoy2.default);

exports.default = nmpyt;
...
exports.templates = exports.nmpyt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nmpyt.
   * @public
   */

  goog.module('nmpyt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nmpyt.render';
  }
...
_metalSoy2.default.register(nmpyt, templates);
exports.nmpyt = nmpyt;
