...
var bSwLR = function (_Component) {
  _inherits(bSwLR, _Component);

  function bSwLR() {
    _classCallCheck(this, bSwLR);

    return _possibleConstructorReturn(this, (bSwLR.__proto__ || Object.getPrototypeOf(bSwLR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bSwLR, _fileSoy2.default);

exports.default = bSwLR;
...
exports.templates = exports.bSwLR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bSwLR.
   * @public
   */

  goog.module('bSwLR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bSwLR.render';
  }
...
_metalSoy2.default.register(bSwLR, templates);
exports.bSwLR = bSwLR;
