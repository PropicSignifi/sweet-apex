...
var MXrif = function (_Component) {
  _inherits(MXrif, _Component);

  function MXrif() {
    _classCallCheck(this, MXrif);

    return _possibleConstructorReturn(this, (MXrif.__proto__ || Object.getPrototypeOf(MXrif)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MXrif, _annotationSoy2.default);

exports.default = MXrif;
...
exports.templates = exports.MXrif = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MXrif.
   * @public
   */

  goog.module('MXrif.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MXrif.render';
  }
...
_metalSoy2.default.register(MXrif, templates);
exports.MXrif = MXrif;
