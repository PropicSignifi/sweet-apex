...
var KwsqL = function (_Component) {
  _inherits(KwsqL, _Component);

  function KwsqL() {
    _classCallCheck(this, KwsqL);

    return _possibleConstructorReturn(this, (KwsqL.__proto__ || Object.getPrototypeOf(KwsqL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KwsqL, _array_creationSoy2.default);

exports.default = KwsqL;
...
exports.templates = exports.KwsqL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KwsqL.
   * @public
   */

  goog.module('KwsqL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KwsqL.render';
  }
...
_metalSoy2.default.register(KwsqL, templates);
exports.KwsqL = KwsqL;
