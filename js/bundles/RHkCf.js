...
var RHkCf = function (_Component) {
  _inherits(RHkCf, _Component);

  function RHkCf() {
    _classCallCheck(this, RHkCf);

    return _possibleConstructorReturn(this, (RHkCf.__proto__ || Object.getPrototypeOf(RHkCf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RHkCf, _lambdaSoy2.default);

exports.default = RHkCf;
...
exports.templates = exports.RHkCf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RHkCf.
   * @public
   */

  goog.module('RHkCf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RHkCf.render';
  }
...
_metalSoy2.default.register(RHkCf, templates);
exports.RHkCf = RHkCf;
