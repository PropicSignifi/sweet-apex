...
var _reflectSoy = __webpack_require__(337);
...
var GWhsq = function (_Component) {
  _inherits(GWhsq, _Component);

  function GWhsq() {
    _classCallCheck(this, GWhsq);

    return _possibleConstructorReturn(this, (GWhsq.__proto__ || Object.getPrototypeOf(GWhsq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GWhsq, _reflectSoy2.default);

exports.default = GWhsq;
...
exports.templates = exports.GWhsq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GWhsq.
   * @public
   */

  goog.module('GWhsq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GWhsq.render';
  }
...
_metalSoy2.default.register(GWhsq, templates);
exports.GWhsq = GWhsq;
