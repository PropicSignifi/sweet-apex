...
var _injectSoy = __webpack_require__(317);
...
var zgqxW = function (_Component) {
  _inherits(zgqxW, _Component);

  function zgqxW() {
    _classCallCheck(this, zgqxW);

    return _possibleConstructorReturn(this, (zgqxW.__proto__ || Object.getPrototypeOf(zgqxW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zgqxW, _injectSoy2.default);

exports.default = zgqxW;
...
exports.templates = exports.zgqxW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zgqxW.
   * @public
   */

  goog.module('zgqxW.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param804 = function param804() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param804 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zgqxW.render';
  }
...
_metalSoy2.default.register(zgqxW, templates);
exports.zgqxW = zgqxW;
