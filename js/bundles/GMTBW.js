...
var GMTBW = function (_Component) {
  _inherits(GMTBW, _Component);

  function GMTBW() {
    _classCallCheck(this, GMTBW);

    return _possibleConstructorReturn(this, (GMTBW.__proto__ || Object.getPrototypeOf(GMTBW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GMTBW, _tagged_stringSoy2.default);

exports.default = GMTBW;
...
exports.templates = exports.GMTBW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GMTBW.
   * @public
   */

  goog.module('GMTBW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GMTBW.render';
  }
...
_metalSoy2.default.register(GMTBW, templates);
exports.GMTBW = GMTBW;
