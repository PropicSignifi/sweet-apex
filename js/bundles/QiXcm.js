...
var QiXcm = function (_Component) {
  _inherits(QiXcm, _Component);

  function QiXcm() {
    _classCallCheck(this, QiXcm);

    return _possibleConstructorReturn(this, (QiXcm.__proto__ || Object.getPrototypeOf(QiXcm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QiXcm, _step_1Soy2.default);

exports.default = QiXcm;
...
exports.templates = exports.QiXcm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QiXcm.
   * @public
   */

  goog.module('QiXcm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QiXcm.render';
  }
...
_metalSoy2.default.register(QiXcm, templates);
exports.QiXcm = QiXcm;
