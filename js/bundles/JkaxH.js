...
var JkaxH = function (_Component) {
  _inherits(JkaxH, _Component);

  function JkaxH() {
    _classCallCheck(this, JkaxH);

    return _possibleConstructorReturn(this, (JkaxH.__proto__ || Object.getPrototypeOf(JkaxH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JkaxH, _aspectSoy2.default);

exports.default = JkaxH;
...
exports.templates = exports.JkaxH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JkaxH.
   * @public
   */

  goog.module('JkaxH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JkaxH.render';
  }
...
_metalSoy2.default.register(JkaxH, templates);
exports.JkaxH = JkaxH;
