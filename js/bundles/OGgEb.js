...
var OGgEb = function (_Component) {
  _inherits(OGgEb, _Component);

  function OGgEb() {
    _classCallCheck(this, OGgEb);

    return _possibleConstructorReturn(this, (OGgEb.__proto__ || Object.getPrototypeOf(OGgEb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OGgEb, _featureSoy2.default);

exports.default = OGgEb;
...
exports.templates = exports.OGgEb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OGgEb.
   * @public
   */

  goog.module('OGgEb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OGgEb.render';
  }
...
_metalSoy2.default.register(OGgEb, templates);
exports.OGgEb = OGgEb;
