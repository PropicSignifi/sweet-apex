...
var hJIwA = function (_Component) {
  _inherits(hJIwA, _Component);

  function hJIwA() {
    _classCallCheck(this, hJIwA);

    return _possibleConstructorReturn(this, (hJIwA.__proto__ || Object.getPrototypeOf(hJIwA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hJIwA, _reflectSoy2.default);

exports.default = hJIwA;
...
exports.templates = exports.hJIwA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hJIwA.
   * @public
   */

  goog.module('hJIwA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hJIwA.render';
  }
...
_metalSoy2.default.register(hJIwA, templates);
exports.hJIwA = hJIwA;
