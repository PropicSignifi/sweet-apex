...
var bUCDY = function (_Component) {
  _inherits(bUCDY, _Component);

  function bUCDY() {
    _classCallCheck(this, bUCDY);

    return _possibleConstructorReturn(this, (bUCDY.__proto__ || Object.getPrototypeOf(bUCDY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bUCDY, _grammarSoy2.default);

exports.default = bUCDY;
...
exports.templates = exports.bUCDY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bUCDY.
   * @public
   */

  goog.module('bUCDY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bUCDY.render';
  }
...
_metalSoy2.default.register(bUCDY, templates);
exports.bUCDY = bUCDY;
