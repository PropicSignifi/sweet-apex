...
var nwccM = function (_Component) {
  _inherits(nwccM, _Component);

  function nwccM() {
    _classCallCheck(this, nwccM);

    return _possibleConstructorReturn(this, (nwccM.__proto__ || Object.getPrototypeOf(nwccM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nwccM, _lambdaSoy2.default);

exports.default = nwccM;
...
exports.templates = exports.nwccM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nwccM.
   * @public
   */

  goog.module('nwccM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nwccM.render';
  }
...
_metalSoy2.default.register(nwccM, templates);
exports.nwccM = nwccM;
