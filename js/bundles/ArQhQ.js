...
var ArQhQ = function (_Component) {
  _inherits(ArQhQ, _Component);

  function ArQhQ() {
    _classCallCheck(this, ArQhQ);

    return _possibleConstructorReturn(this, (ArQhQ.__proto__ || Object.getPrototypeOf(ArQhQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ArQhQ, _apexdocSoy2.default);

exports.default = ArQhQ;
...
exports.templates = exports.ArQhQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ArQhQ.
   * @public
   */

  goog.module('ArQhQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ArQhQ.render';
  }
...
_metalSoy2.default.register(ArQhQ, templates);
exports.ArQhQ = ArQhQ;
