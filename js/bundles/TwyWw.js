...
var TwyWw = function (_Component) {
  _inherits(TwyWw, _Component);

  function TwyWw() {
    _classCallCheck(this, TwyWw);

    return _possibleConstructorReturn(this, (TwyWw.__proto__ || Object.getPrototypeOf(TwyWw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TwyWw, _template_stringSoy2.default);

exports.default = TwyWw;
...
exports.templates = exports.TwyWw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TwyWw.
   * @public
   */

  goog.module('TwyWw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TwyWw.render';
  }
...
_metalSoy2.default.register(TwyWw, templates);
exports.TwyWw = TwyWw;
