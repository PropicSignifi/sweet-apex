...
var lnaAQ = function (_Component) {
  _inherits(lnaAQ, _Component);

  function lnaAQ() {
    _classCallCheck(this, lnaAQ);

    return _possibleConstructorReturn(this, (lnaAQ.__proto__ || Object.getPrototypeOf(lnaAQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lnaAQ, _aspectSoy2.default);

exports.default = lnaAQ;
...
exports.templates = exports.lnaAQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lnaAQ.
   * @public
   */

  goog.module('lnaAQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lnaAQ.render';
  }
...
_metalSoy2.default.register(lnaAQ, templates);
exports.lnaAQ = lnaAQ;
