...
var nFXZy = function (_Component) {
  _inherits(nFXZy, _Component);

  function nFXZy() {
    _classCallCheck(this, nFXZy);

    return _possibleConstructorReturn(this, (nFXZy.__proto__ || Object.getPrototypeOf(nFXZy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nFXZy, _actionSoy2.default);

exports.default = nFXZy;
...
exports.templates = exports.nFXZy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nFXZy.
   * @public
   */

  goog.module('nFXZy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nFXZy.render';
  }
...
_metalSoy2.default.register(nFXZy, templates);
exports.nFXZy = nFXZy;
