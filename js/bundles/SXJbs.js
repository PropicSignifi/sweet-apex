...
var SXJbs = function (_Component) {
  _inherits(SXJbs, _Component);

  function SXJbs() {
    _classCallCheck(this, SXJbs);

    return _possibleConstructorReturn(this, (SXJbs.__proto__ || Object.getPrototypeOf(SXJbs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SXJbs, _templateSoy2.default);

exports.default = SXJbs;
...
exports.templates = exports.SXJbs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SXJbs.
   * @public
   */

  goog.module('SXJbs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SXJbs.render';
  }
...
_metalSoy2.default.register(SXJbs, templates);
exports.SXJbs = SXJbs;
