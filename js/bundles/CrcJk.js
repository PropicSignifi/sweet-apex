...
var _injectSoy = __webpack_require__(319);
...
var CrcJk = function (_Component) {
  _inherits(CrcJk, _Component);

  function CrcJk() {
    _classCallCheck(this, CrcJk);

    return _possibleConstructorReturn(this, (CrcJk.__proto__ || Object.getPrototypeOf(CrcJk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CrcJk, _injectSoy2.default);

exports.default = CrcJk;
...
exports.templates = exports.CrcJk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CrcJk.
   * @public
   */

  goog.module('CrcJk.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param674 = function param674() {
      ie_open('h6');
      ...
      ie_close('p');
      $templateAlias2({ code: 'Sweet.bind(Case.class, Account.class); // Bind Case.class to be created by Account.class', mode: 'javascript' }, null, opt_ijData);
      ie_open('p');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param674 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CrcJk.render';
  }
...
_metalSoy2.default.register(CrcJk, templates);
exports.CrcJk = CrcJk;
