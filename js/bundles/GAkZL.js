...
var GAkZL = function (_Component) {
  _inherits(GAkZL, _Component);

  function GAkZL() {
    _classCallCheck(this, GAkZL);

    return _possibleConstructorReturn(this, (GAkZL.__proto__ || Object.getPrototypeOf(GAkZL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GAkZL, _injectSoy2.default);

exports.default = GAkZL;
...
exports.templates = exports.GAkZL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GAkZL.
   * @public
   */

  goog.module('GAkZL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GAkZL.render';
  }
...
_metalSoy2.default.register(GAkZL, templates);
exports.GAkZL = GAkZL;
