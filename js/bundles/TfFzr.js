...
var _lambdaSoy = __webpack_require__(323);
...
var TfFzr = function (_Component) {
  _inherits(TfFzr, _Component);

  function TfFzr() {
    _classCallCheck(this, TfFzr);

    return _possibleConstructorReturn(this, (TfFzr.__proto__ || Object.getPrototypeOf(TfFzr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TfFzr, _lambdaSoy2.default);

exports.default = TfFzr;
...
exports.templates = exports.TfFzr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TfFzr.
   * @public
   */

  goog.module('TfFzr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TfFzr.render';
  }
...
_metalSoy2.default.register(TfFzr, templates);
exports.TfFzr = TfFzr;
