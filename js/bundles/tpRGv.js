...
var tpRGv = function (_Component) {
  _inherits(tpRGv, _Component);

  function tpRGv() {
    _classCallCheck(this, tpRGv);

    return _possibleConstructorReturn(this, (tpRGv.__proto__ || Object.getPrototypeOf(tpRGv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tpRGv, _identitySoy2.default);

exports.default = tpRGv;
...
exports.templates = exports.tpRGv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tpRGv.
   * @public
   */

  goog.module('tpRGv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tpRGv.render';
  }
...
_metalSoy2.default.register(tpRGv, templates);
exports.tpRGv = tpRGv;
