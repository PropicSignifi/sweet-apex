...
var HbuPm = function (_Component) {
  _inherits(HbuPm, _Component);

  function HbuPm() {
    _classCallCheck(this, HbuPm);

    return _possibleConstructorReturn(this, (HbuPm.__proto__ || Object.getPrototypeOf(HbuPm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HbuPm, _featureSoy2.default);

exports.default = HbuPm;
...
exports.templates = exports.HbuPm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HbuPm.
   * @public
   */

  goog.module('HbuPm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HbuPm.render';
  }
...
_metalSoy2.default.register(HbuPm, templates);
exports.HbuPm = HbuPm;
