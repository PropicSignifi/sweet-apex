...
var YuClv = function (_Component) {
  _inherits(YuClv, _Component);

  function YuClv() {
    _classCallCheck(this, YuClv);

    return _possibleConstructorReturn(this, (YuClv.__proto__ || Object.getPrototypeOf(YuClv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YuClv, _castSoy2.default);

exports.default = YuClv;
...
exports.templates = exports.YuClv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YuClv.
   * @public
   */

  goog.module('YuClv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YuClv.render';
  }
...
_metalSoy2.default.register(YuClv, templates);
exports.YuClv = YuClv;
