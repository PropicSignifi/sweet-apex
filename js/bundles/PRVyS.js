...
var PRVyS = function (_Component) {
  _inherits(PRVyS, _Component);

  function PRVyS() {
    _classCallCheck(this, PRVyS);

    return _possibleConstructorReturn(this, (PRVyS.__proto__ || Object.getPrototypeOf(PRVyS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PRVyS, _actionSoy2.default);

exports.default = PRVyS;
...
exports.templates = exports.PRVyS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PRVyS.
   * @public
   */

  goog.module('PRVyS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PRVyS.render';
  }
...
_metalSoy2.default.register(PRVyS, templates);
exports.PRVyS = PRVyS;
