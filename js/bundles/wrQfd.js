...
var wrQfd = function (_Component) {
  _inherits(wrQfd, _Component);

  function wrQfd() {
    _classCallCheck(this, wrQfd);

    return _possibleConstructorReturn(this, (wrQfd.__proto__ || Object.getPrototypeOf(wrQfd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wrQfd, _injectSoy2.default);

exports.default = wrQfd;
...
exports.templates = exports.wrQfd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wrQfd.
   * @public
   */

  goog.module('wrQfd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wrQfd.render';
  }
...
_metalSoy2.default.register(wrQfd, templates);
exports.wrQfd = wrQfd;
