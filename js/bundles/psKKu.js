...
var psKKu = function (_Component) {
  _inherits(psKKu, _Component);

  function psKKu() {
    _classCallCheck(this, psKKu);

    return _possibleConstructorReturn(this, (psKKu.__proto__ || Object.getPrototypeOf(psKKu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(psKKu, _configSoy2.default);

exports.default = psKKu;
...
exports.templates = exports.psKKu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace psKKu.
   * @public
   */

  goog.module('psKKu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'psKKu.render';
  }
...
_metalSoy2.default.register(psKKu, templates);
exports.psKKu = psKKu;
