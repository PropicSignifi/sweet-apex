...
var _templateSoy = __webpack_require__(331);
...
var WjEOf = function (_Component) {
  _inherits(WjEOf, _Component);

  function WjEOf() {
    _classCallCheck(this, WjEOf);

    return _possibleConstructorReturn(this, (WjEOf.__proto__ || Object.getPrototypeOf(WjEOf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WjEOf, _templateSoy2.default);

exports.default = WjEOf;
...
exports.templates = exports.WjEOf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WjEOf.
   * @public
   */

  goog.module('WjEOf.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param946 = function param946() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WjEOf.render';
  }
...
_metalSoy2.default.register(WjEOf, templates);
exports.WjEOf = WjEOf;
