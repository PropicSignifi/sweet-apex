...
var iGvJL = function (_Component) {
  _inherits(iGvJL, _Component);

  function iGvJL() {
    _classCallCheck(this, iGvJL);

    return _possibleConstructorReturn(this, (iGvJL.__proto__ || Object.getPrototypeOf(iGvJL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iGvJL, _indexSoy2.default);

exports.default = iGvJL;
...
exports.templates = exports.iGvJL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iGvJL.
   * @public
   */

  goog.module('iGvJL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iGvJL.render';
  }
...
_metalSoy2.default.register(iGvJL, templates);
exports.iGvJL = iGvJL;
