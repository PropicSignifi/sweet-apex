...
var URahS = function (_Component) {
  _inherits(URahS, _Component);

  function URahS() {
    _classCallCheck(this, URahS);

    return _possibleConstructorReturn(this, (URahS.__proto__ || Object.getPrototypeOf(URahS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(URahS, _indexSoy2.default);

exports.default = URahS;
...
exports.templates = exports.URahS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace URahS.
   * @public
   */

  goog.module('URahS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'URahS.render';
  }
...
_metalSoy2.default.register(URahS, templates);
exports.URahS = URahS;
