...
var qXMBO = function (_Component) {
  _inherits(qXMBO, _Component);

  function qXMBO() {
    _classCallCheck(this, qXMBO);

    return _possibleConstructorReturn(this, (qXMBO.__proto__ || Object.getPrototypeOf(qXMBO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qXMBO, _commandSoy2.default);

exports.default = qXMBO;
...
exports.templates = exports.qXMBO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qXMBO.
   * @public
   */

  goog.module('qXMBO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qXMBO.render';
  }
...
_metalSoy2.default.register(qXMBO, templates);
exports.qXMBO = qXMBO;
