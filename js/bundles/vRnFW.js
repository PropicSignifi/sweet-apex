...
var vRnFW = function (_Component) {
  _inherits(vRnFW, _Component);

  function vRnFW() {
    _classCallCheck(this, vRnFW);

    return _possibleConstructorReturn(this, (vRnFW.__proto__ || Object.getPrototypeOf(vRnFW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vRnFW, _indexSoy2.default);

exports.default = vRnFW;
...
exports.templates = exports.vRnFW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vRnFW.
   * @public
   */

  goog.module('vRnFW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vRnFW.render';
  }
...
_metalSoy2.default.register(vRnFW, templates);
exports.vRnFW = vRnFW;
