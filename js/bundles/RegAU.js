...
var RegAU = function (_Component) {
  _inherits(RegAU, _Component);

  function RegAU() {
    _classCallCheck(this, RegAU);

    return _possibleConstructorReturn(this, (RegAU.__proto__ || Object.getPrototypeOf(RegAU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RegAU, _aspectSoy2.default);

exports.default = RegAU;
...
exports.templates = exports.RegAU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RegAU.
   * @public
   */

  goog.module('RegAU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RegAU.render';
  }
...
_metalSoy2.default.register(RegAU, templates);
exports.RegAU = RegAU;
