...
var IKhmD = function (_Component) {
  _inherits(IKhmD, _Component);

  function IKhmD() {
    _classCallCheck(this, IKhmD);

    return _possibleConstructorReturn(this, (IKhmD.__proto__ || Object.getPrototypeOf(IKhmD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IKhmD, _indexSoy2.default);

exports.default = IKhmD;
...
exports.templates = exports.IKhmD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IKhmD.
   * @public
   */

  goog.module('IKhmD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IKhmD.render';
  }
...
_metalSoy2.default.register(IKhmD, templates);
exports.IKhmD = IKhmD;
