...
var FkLMc = function (_Component) {
  _inherits(FkLMc, _Component);

  function FkLMc() {
    _classCallCheck(this, FkLMc);

    return _possibleConstructorReturn(this, (FkLMc.__proto__ || Object.getPrototypeOf(FkLMc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FkLMc, _indexSoy2.default);

exports.default = FkLMc;
...
exports.templates = exports.FkLMc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FkLMc.
   * @public
   */

  goog.module('FkLMc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FkLMc.render';
  }
...
_metalSoy2.default.register(FkLMc, templates);
exports.FkLMc = FkLMc;
