...
var fpQwT = function (_Component) {
  _inherits(fpQwT, _Component);

  function fpQwT() {
    _classCallCheck(this, fpQwT);

    return _possibleConstructorReturn(this, (fpQwT.__proto__ || Object.getPrototypeOf(fpQwT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fpQwT, _scriptSoy2.default);

exports.default = fpQwT;
...
exports.templates = exports.fpQwT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fpQwT.
   * @public
   */

  goog.module('fpQwT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fpQwT.render';
  }
...
_metalSoy2.default.register(fpQwT, templates);
exports.fpQwT = fpQwT;
