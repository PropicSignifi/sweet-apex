...
var iJvkJ = function (_Component) {
  _inherits(iJvkJ, _Component);

  function iJvkJ() {
    _classCallCheck(this, iJvkJ);

    return _possibleConstructorReturn(this, (iJvkJ.__proto__ || Object.getPrototypeOf(iJvkJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iJvkJ, _default_valueSoy2.default);

exports.default = iJvkJ;
...
exports.templates = exports.iJvkJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iJvkJ.
   * @public
   */

  goog.module('iJvkJ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param625 = function param625() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param625 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iJvkJ.render';
  }
...
_metalSoy2.default.register(iJvkJ, templates);
exports.iJvkJ = iJvkJ;
