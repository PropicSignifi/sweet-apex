...
var XBvQA = function (_Component) {
  _inherits(XBvQA, _Component);

  function XBvQA() {
    _classCallCheck(this, XBvQA);

    return _possibleConstructorReturn(this, (XBvQA.__proto__ || Object.getPrototypeOf(XBvQA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XBvQA, _nullableSoy2.default);

exports.default = XBvQA;
...
exports.templates = exports.XBvQA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XBvQA.
   * @public
   */

  goog.module('XBvQA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XBvQA.render';
  }
...
_metalSoy2.default.register(XBvQA, templates);
exports.XBvQA = XBvQA;
