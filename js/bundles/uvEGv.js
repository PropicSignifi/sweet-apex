...
var uvEGv = function (_Component) {
  _inherits(uvEGv, _Component);

  function uvEGv() {
    _classCallCheck(this, uvEGv);

    return _possibleConstructorReturn(this, (uvEGv.__proto__ || Object.getPrototypeOf(uvEGv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uvEGv, _array_creationSoy2.default);

exports.default = uvEGv;
...
exports.templates = exports.uvEGv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uvEGv.
   * @public
   */

  goog.module('uvEGv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uvEGv.render';
  }
...
_metalSoy2.default.register(uvEGv, templates);
exports.uvEGv = uvEGv;
