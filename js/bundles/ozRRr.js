...
var ozRRr = function (_Component) {
  _inherits(ozRRr, _Component);

  function ozRRr() {
    _classCallCheck(this, ozRRr);

    return _possibleConstructorReturn(this, (ozRRr.__proto__ || Object.getPrototypeOf(ozRRr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ozRRr, _array_creationSoy2.default);

exports.default = ozRRr;
...
exports.templates = exports.ozRRr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ozRRr.
   * @public
   */

  goog.module('ozRRr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ozRRr.render';
  }
...
_metalSoy2.default.register(ozRRr, templates);
exports.ozRRr = ozRRr;
