...
var nHRge = function (_Component) {
  _inherits(nHRge, _Component);

  function nHRge() {
    _classCallCheck(this, nHRge);

    return _possibleConstructorReturn(this, (nHRge.__proto__ || Object.getPrototypeOf(nHRge)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nHRge, _step_2Soy2.default);

exports.default = nHRge;
...
exports.templates = exports.nHRge = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nHRge.
   * @public
   */

  goog.module('nHRge.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nHRge.render';
  }
...
_metalSoy2.default.register(nHRge, templates);
exports.nHRge = nHRge;
