...
var _lambdaSoy = __webpack_require__(317);
...
var HmtOM = function (_Component) {
  _inherits(HmtOM, _Component);

  function HmtOM() {
    _classCallCheck(this, HmtOM);

    return _possibleConstructorReturn(this, (HmtOM.__proto__ || Object.getPrototypeOf(HmtOM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HmtOM, _lambdaSoy2.default);

exports.default = HmtOM;
...
exports.templates = exports.HmtOM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HmtOM.
   * @public
   */

  goog.module('HmtOM.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param814 = function param814() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param814 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HmtOM.render';
  }
...
_metalSoy2.default.register(HmtOM, templates);
exports.HmtOM = HmtOM;
