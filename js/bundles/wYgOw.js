...
var _grammarSoy = __webpack_require__(285);
...
var wYgOw = function (_Component) {
  _inherits(wYgOw, _Component);

  function wYgOw() {
    _classCallCheck(this, wYgOw);

    return _possibleConstructorReturn(this, (wYgOw.__proto__ || Object.getPrototypeOf(wYgOw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wYgOw, _grammarSoy2.default);

exports.default = wYgOw;
...
exports.templates = exports.wYgOw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wYgOw.
   * @public
   */

  goog.module('wYgOw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wYgOw.render';
  }
...
_metalSoy2.default.register(wYgOw, templates);
exports.wYgOw = wYgOw;
