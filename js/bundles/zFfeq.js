...
var zFfeq = function (_Component) {
  _inherits(zFfeq, _Component);

  function zFfeq() {
    _classCallCheck(this, zFfeq);

    return _possibleConstructorReturn(this, (zFfeq.__proto__ || Object.getPrototypeOf(zFfeq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zFfeq, _transpilationSoy2.default);

exports.default = zFfeq;
...
exports.templates = exports.zFfeq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zFfeq.
   * @public
   */

  goog.module('zFfeq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zFfeq.render';
  }
...
_metalSoy2.default.register(zFfeq, templates);
exports.zFfeq = zFfeq;
