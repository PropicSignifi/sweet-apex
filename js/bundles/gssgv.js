...
var _configSoy = __webpack_require__(277);
...
var gssgv = function (_Component) {
  _inherits(gssgv, _Component);

  function gssgv() {
    _classCallCheck(this, gssgv);

    return _possibleConstructorReturn(this, (gssgv.__proto__ || Object.getPrototypeOf(gssgv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gssgv, _configSoy2.default);

exports.default = gssgv;
...
exports.templates = exports.gssgv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gssgv.
   * @public
   */

  goog.module('gssgv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gssgv.render';
  }
...
_metalSoy2.default.register(gssgv, templates);
exports.gssgv = gssgv;
