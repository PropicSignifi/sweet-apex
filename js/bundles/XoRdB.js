...
var XoRdB = function (_Component) {
  _inherits(XoRdB, _Component);

  function XoRdB() {
    _classCallCheck(this, XoRdB);

    return _possibleConstructorReturn(this, (XoRdB.__proto__ || Object.getPrototypeOf(XoRdB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XoRdB, _array_creationSoy2.default);

exports.default = XoRdB;
...
exports.templates = exports.XoRdB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XoRdB.
   * @public
   */

  goog.module('XoRdB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XoRdB.render';
  }
...
_metalSoy2.default.register(XoRdB, templates);
exports.XoRdB = XoRdB;
