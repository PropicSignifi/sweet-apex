...
var ZePnj = function (_Component) {
  _inherits(ZePnj, _Component);

  function ZePnj() {
    _classCallCheck(this, ZePnj);

    return _possibleConstructorReturn(this, (ZePnj.__proto__ || Object.getPrototypeOf(ZePnj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZePnj, _identitySoy2.default);

exports.default = ZePnj;
...
exports.templates = exports.ZePnj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZePnj.
   * @public
   */

  goog.module('ZePnj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZePnj.render';
  }
...
_metalSoy2.default.register(ZePnj, templates);
exports.ZePnj = ZePnj;
