...
var rwFns = function (_Component) {
  _inherits(rwFns, _Component);

  function rwFns() {
    _classCallCheck(this, rwFns);

    return _possibleConstructorReturn(this, (rwFns.__proto__ || Object.getPrototypeOf(rwFns)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rwFns, _commandSoy2.default);

exports.default = rwFns;
...
exports.templates = exports.rwFns = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rwFns.
   * @public
   */

  goog.module('rwFns.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rwFns.render';
  }
...
_metalSoy2.default.register(rwFns, templates);
exports.rwFns = rwFns;
