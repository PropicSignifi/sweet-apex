...
var VSBro = function (_Component) {
  _inherits(VSBro, _Component);

  function VSBro() {
    _classCallCheck(this, VSBro);

    return _possibleConstructorReturn(this, (VSBro.__proto__ || Object.getPrototypeOf(VSBro)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VSBro, _injectSoy2.default);

exports.default = VSBro;
...
exports.templates = exports.VSBro = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VSBro.
   * @public
   */

  goog.module('VSBro.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VSBro.render';
  }
...
_metalSoy2.default.register(VSBro, templates);
exports.VSBro = VSBro;
