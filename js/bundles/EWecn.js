...
var _operatorSoy = __webpack_require__(325);
...
var EWecn = function (_Component) {
  _inherits(EWecn, _Component);

  function EWecn() {
    _classCallCheck(this, EWecn);

    return _possibleConstructorReturn(this, (EWecn.__proto__ || Object.getPrototypeOf(EWecn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EWecn, _operatorSoy2.default);

exports.default = EWecn;
...
exports.templates = exports.EWecn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EWecn.
   * @public
   */

  goog.module('EWecn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EWecn.render';
  }
...
_metalSoy2.default.register(EWecn, templates);
exports.EWecn = EWecn;
