...
var MUOpC = function (_Component) {
  _inherits(MUOpC, _Component);

  function MUOpC() {
    _classCallCheck(this, MUOpC);

    return _possibleConstructorReturn(this, (MUOpC.__proto__ || Object.getPrototypeOf(MUOpC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MUOpC, _indexSoy2.default);

exports.default = MUOpC;
...
exports.templates = exports.MUOpC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MUOpC.
   * @public
   */

  goog.module('MUOpC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MUOpC.render';
  }
...
_metalSoy2.default.register(MUOpC, templates);
exports.MUOpC = MUOpC;
