...
var acrSj = function (_Component) {
  _inherits(acrSj, _Component);

  function acrSj() {
    _classCallCheck(this, acrSj);

    return _possibleConstructorReturn(this, (acrSj.__proto__ || Object.getPrototypeOf(acrSj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(acrSj, _indexSoy2.default);

exports.default = acrSj;
...
exports.templates = exports.acrSj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace acrSj.
   * @public
   */

  goog.module('acrSj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'acrSj.render';
  }
...
_metalSoy2.default.register(acrSj, templates);
exports.acrSj = acrSj;
