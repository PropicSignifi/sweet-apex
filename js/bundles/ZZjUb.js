...
var ZZjUb = function (_Component) {
  _inherits(ZZjUb, _Component);

  function ZZjUb() {
    _classCallCheck(this, ZZjUb);

    return _possibleConstructorReturn(this, (ZZjUb.__proto__ || Object.getPrototypeOf(ZZjUb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZZjUb, _map_accessSoy2.default);

exports.default = ZZjUb;
...
exports.templates = exports.ZZjUb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZZjUb.
   * @public
   */

  goog.module('ZZjUb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZZjUb.render';
  }
...
_metalSoy2.default.register(ZZjUb, templates);
exports.ZZjUb = ZZjUb;
