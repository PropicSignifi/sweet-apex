...
var pBFOn = function (_Component) {
  _inherits(pBFOn, _Component);

  function pBFOn() {
    _classCallCheck(this, pBFOn);

    return _possibleConstructorReturn(this, (pBFOn.__proto__ || Object.getPrototypeOf(pBFOn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pBFOn, _aspectSoy2.default);

exports.default = pBFOn;
...
exports.templates = exports.pBFOn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pBFOn.
   * @public
   */

  goog.module('pBFOn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pBFOn.render';
  }
...
_metalSoy2.default.register(pBFOn, templates);
exports.pBFOn = pBFOn;
