...
var RyKvP = function (_Component) {
  _inherits(RyKvP, _Component);

  function RyKvP() {
    _classCallCheck(this, RyKvP);

    return _possibleConstructorReturn(this, (RyKvP.__proto__ || Object.getPrototypeOf(RyKvP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RyKvP, _array_creationSoy2.default);

exports.default = RyKvP;
...
exports.templates = exports.RyKvP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RyKvP.
   * @public
   */

  goog.module('RyKvP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RyKvP.render';
  }
...
_metalSoy2.default.register(RyKvP, templates);
exports.RyKvP = RyKvP;
