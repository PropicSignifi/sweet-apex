...
var bQDhp = function (_Component) {
  _inherits(bQDhp, _Component);

  function bQDhp() {
    _classCallCheck(this, bQDhp);

    return _possibleConstructorReturn(this, (bQDhp.__proto__ || Object.getPrototypeOf(bQDhp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bQDhp, _configSoy2.default);

exports.default = bQDhp;
...
exports.templates = exports.bQDhp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bQDhp.
   * @public
   */

  goog.module('bQDhp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bQDhp.render';
  }
...
_metalSoy2.default.register(bQDhp, templates);
exports.bQDhp = bQDhp;
