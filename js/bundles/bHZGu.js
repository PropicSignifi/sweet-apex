...
var bHZGu = function (_Component) {
  _inherits(bHZGu, _Component);

  function bHZGu() {
    _classCallCheck(this, bHZGu);

    return _possibleConstructorReturn(this, (bHZGu.__proto__ || Object.getPrototypeOf(bHZGu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bHZGu, _transpilationSoy2.default);

exports.default = bHZGu;
...
exports.templates = exports.bHZGu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bHZGu.
   * @public
   */

  goog.module('bHZGu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bHZGu.render';
  }
...
_metalSoy2.default.register(bHZGu, templates);
exports.bHZGu = bHZGu;
