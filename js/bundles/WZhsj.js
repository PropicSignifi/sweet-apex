...
var WZhsj = function (_Component) {
  _inherits(WZhsj, _Component);

  function WZhsj() {
    _classCallCheck(this, WZhsj);

    return _possibleConstructorReturn(this, (WZhsj.__proto__ || Object.getPrototypeOf(WZhsj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WZhsj, _configSoy2.default);

exports.default = WZhsj;
...
exports.templates = exports.WZhsj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WZhsj.
   * @public
   */

  goog.module('WZhsj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WZhsj.render';
  }
...
_metalSoy2.default.register(WZhsj, templates);
exports.WZhsj = WZhsj;
