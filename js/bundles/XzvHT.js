...
var XzvHT = function (_Component) {
  _inherits(XzvHT, _Component);

  function XzvHT() {
    _classCallCheck(this, XzvHT);

    return _possibleConstructorReturn(this, (XzvHT.__proto__ || Object.getPrototypeOf(XzvHT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XzvHT, _fileSoy2.default);

exports.default = XzvHT;
...
exports.templates = exports.XzvHT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XzvHT.
   * @public
   */

  goog.module('XzvHT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XzvHT.render';
  }
...
_metalSoy2.default.register(XzvHT, templates);
exports.XzvHT = XzvHT;
