...
var AbssM = function (_Component) {
  _inherits(AbssM, _Component);

  function AbssM() {
    _classCallCheck(this, AbssM);

    return _possibleConstructorReturn(this, (AbssM.__proto__ || Object.getPrototypeOf(AbssM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AbssM, _castSoy2.default);

exports.default = AbssM;
...
exports.templates = exports.AbssM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AbssM.
   * @public
   */

  goog.module('AbssM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AbssM.render';
  }
...
_metalSoy2.default.register(AbssM, templates);
exports.AbssM = AbssM;
