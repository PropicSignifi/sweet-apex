...
var SdOZp = function (_Component) {
  _inherits(SdOZp, _Component);

  function SdOZp() {
    _classCallCheck(this, SdOZp);

    return _possibleConstructorReturn(this, (SdOZp.__proto__ || Object.getPrototypeOf(SdOZp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SdOZp, _grammarSoy2.default);

exports.default = SdOZp;
...
exports.templates = exports.SdOZp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SdOZp.
   * @public
   */

  goog.module('SdOZp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SdOZp.render';
  }
...
_metalSoy2.default.register(SdOZp, templates);
exports.SdOZp = SdOZp;
