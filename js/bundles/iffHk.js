...
var iffHk = function (_Component) {
  _inherits(iffHk, _Component);

  function iffHk() {
    _classCallCheck(this, iffHk);

    return _possibleConstructorReturn(this, (iffHk.__proto__ || Object.getPrototypeOf(iffHk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iffHk, _step_2Soy2.default);

exports.default = iffHk;
...
exports.templates = exports.iffHk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iffHk.
   * @public
   */

  goog.module('iffHk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iffHk.render';
  }
...
_metalSoy2.default.register(iffHk, templates);
exports.iffHk = iffHk;
