...
var BCEQN = function (_Component) {
  _inherits(BCEQN, _Component);

  function BCEQN() {
    _classCallCheck(this, BCEQN);

    return _possibleConstructorReturn(this, (BCEQN.__proto__ || Object.getPrototypeOf(BCEQN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BCEQN, _templateSoy2.default);

exports.default = BCEQN;
...
exports.templates = exports.BCEQN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BCEQN.
   * @public
   */

  goog.module('BCEQN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BCEQN.render';
  }
...
_metalSoy2.default.register(BCEQN, templates);
exports.BCEQN = BCEQN;
