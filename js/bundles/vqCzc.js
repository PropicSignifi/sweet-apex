...
var vqCzc = function (_Component) {
  _inherits(vqCzc, _Component);

  function vqCzc() {
    _classCallCheck(this, vqCzc);

    return _possibleConstructorReturn(this, (vqCzc.__proto__ || Object.getPrototypeOf(vqCzc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vqCzc, _constructor_annotationSoy2.default);

exports.default = vqCzc;
...
exports.templates = exports.vqCzc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vqCzc.
   * @public
   */

  goog.module('vqCzc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vqCzc.render';
  }
...
_metalSoy2.default.register(vqCzc, templates);
exports.vqCzc = vqCzc;
