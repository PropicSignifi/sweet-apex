...
var EgafK = function (_Component) {
  _inherits(EgafK, _Component);

  function EgafK() {
    _classCallCheck(this, EgafK);

    return _possibleConstructorReturn(this, (EgafK.__proto__ || Object.getPrototypeOf(EgafK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EgafK, _default_valueSoy2.default);

exports.default = EgafK;
...
exports.templates = exports.EgafK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EgafK.
   * @public
   */

  goog.module('EgafK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EgafK.render';
  }
...
_metalSoy2.default.register(EgafK, templates);
exports.EgafK = EgafK;
