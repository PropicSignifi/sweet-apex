...
var JSfoU = function (_Component) {
  _inherits(JSfoU, _Component);

  function JSfoU() {
    _classCallCheck(this, JSfoU);

    return _possibleConstructorReturn(this, (JSfoU.__proto__ || Object.getPrototypeOf(JSfoU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JSfoU, _testcaseSoy2.default);

exports.default = JSfoU;
...
exports.templates = exports.JSfoU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JSfoU.
   * @public
   */

  goog.module('JSfoU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JSfoU.render';
  }
...
_metalSoy2.default.register(JSfoU, templates);
exports.JSfoU = JSfoU;
