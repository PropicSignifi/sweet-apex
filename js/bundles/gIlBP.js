...
var _fileSoy = __webpack_require__(299);
...
var gIlBP = function (_Component) {
  _inherits(gIlBP, _Component);

  function gIlBP() {
    _classCallCheck(this, gIlBP);

    return _possibleConstructorReturn(this, (gIlBP.__proto__ || Object.getPrototypeOf(gIlBP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gIlBP, _fileSoy2.default);

exports.default = gIlBP;
...
exports.templates = exports.gIlBP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gIlBP.
   * @public
   */

  goog.module('gIlBP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gIlBP.render';
  }
...
_metalSoy2.default.register(gIlBP, templates);
exports.gIlBP = gIlBP;
