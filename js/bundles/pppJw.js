...
var pppJw = function (_Component) {
  _inherits(pppJw, _Component);

  function pppJw() {
    _classCallCheck(this, pppJw);

    return _possibleConstructorReturn(this, (pppJw.__proto__ || Object.getPrototypeOf(pppJw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pppJw, _indexSoy2.default);

exports.default = pppJw;
...
exports.templates = exports.pppJw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pppJw.
   * @public
   */

  goog.module('pppJw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pppJw.render';
  }
...
_metalSoy2.default.register(pppJw, templates);
exports.pppJw = pppJw;
