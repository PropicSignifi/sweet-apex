...
var FuGtT = function (_Component) {
  _inherits(FuGtT, _Component);

  function FuGtT() {
    _classCallCheck(this, FuGtT);

    return _possibleConstructorReturn(this, (FuGtT.__proto__ || Object.getPrototypeOf(FuGtT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FuGtT, _reflectSoy2.default);

exports.default = FuGtT;
...
exports.templates = exports.FuGtT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FuGtT.
   * @public
   */

  goog.module('FuGtT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FuGtT.render';
  }
...
_metalSoy2.default.register(FuGtT, templates);
exports.FuGtT = FuGtT;
