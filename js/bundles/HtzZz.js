...
var _lambdaSoy = __webpack_require__(319);
...
var HtzZz = function (_Component) {
  _inherits(HtzZz, _Component);

  function HtzZz() {
    _classCallCheck(this, HtzZz);

    return _possibleConstructorReturn(this, (HtzZz.__proto__ || Object.getPrototypeOf(HtzZz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HtzZz, _lambdaSoy2.default);

exports.default = HtzZz;
...
exports.templates = exports.HtzZz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HtzZz.
   * @public
   */

  goog.module('HtzZz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HtzZz.render';
  }
...
_metalSoy2.default.register(HtzZz, templates);
exports.HtzZz = HtzZz;
