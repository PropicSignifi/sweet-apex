...
var ExGvE = function (_Component) {
  _inherits(ExGvE, _Component);

  function ExGvE() {
    _classCallCheck(this, ExGvE);

    return _possibleConstructorReturn(this, (ExGvE.__proto__ || Object.getPrototypeOf(ExGvE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ExGvE, _actionSoy2.default);

exports.default = ExGvE;
...
exports.templates = exports.ExGvE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ExGvE.
   * @public
   */

  goog.module('ExGvE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ExGvE.render';
  }
...
_metalSoy2.default.register(ExGvE, templates);
exports.ExGvE = ExGvE;
