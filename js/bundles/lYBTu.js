...
var lYBTu = function (_Component) {
  _inherits(lYBTu, _Component);

  function lYBTu() {
    _classCallCheck(this, lYBTu);

    return _possibleConstructorReturn(this, (lYBTu.__proto__ || Object.getPrototypeOf(lYBTu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lYBTu, _testcaseSoy2.default);

exports.default = lYBTu;
...
exports.templates = exports.lYBTu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lYBTu.
   * @public
   */

  goog.module('lYBTu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lYBTu.render';
  }
...
_metalSoy2.default.register(lYBTu, templates);
exports.lYBTu = lYBTu;
