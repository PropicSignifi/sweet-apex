...
var ijqga = function (_Component) {
  _inherits(ijqga, _Component);

  function ijqga() {
    _classCallCheck(this, ijqga);

    return _possibleConstructorReturn(this, (ijqga.__proto__ || Object.getPrototypeOf(ijqga)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ijqga, _configSoy2.default);

exports.default = ijqga;
...
exports.templates = exports.ijqga = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ijqga.
   * @public
   */

  goog.module('ijqga.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ijqga.render';
  }
...
_metalSoy2.default.register(ijqga, templates);
exports.ijqga = ijqga;
