...
var KzXAp = function (_Component) {
  _inherits(KzXAp, _Component);

  function KzXAp() {
    _classCallCheck(this, KzXAp);

    return _possibleConstructorReturn(this, (KzXAp.__proto__ || Object.getPrototypeOf(KzXAp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KzXAp, _featureSoy2.default);

exports.default = KzXAp;
...
exports.templates = exports.KzXAp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KzXAp.
   * @public
   */

  goog.module('KzXAp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KzXAp.render';
  }
...
_metalSoy2.default.register(KzXAp, templates);
exports.KzXAp = KzXAp;
