...
var XtajW = function (_Component) {
  _inherits(XtajW, _Component);

  function XtajW() {
    _classCallCheck(this, XtajW);

    return _possibleConstructorReturn(this, (XtajW.__proto__ || Object.getPrototypeOf(XtajW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XtajW, _templateSoy2.default);

exports.default = XtajW;
...
exports.templates = exports.XtajW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XtajW.
   * @public
   */

  goog.module('XtajW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XtajW.render';
  }
...
_metalSoy2.default.register(XtajW, templates);
exports.XtajW = XtajW;
