...
var qQKQG = function (_Component) {
  _inherits(qQKQG, _Component);

  function qQKQG() {
    _classCallCheck(this, qQKQG);

    return _possibleConstructorReturn(this, (qQKQG.__proto__ || Object.getPrototypeOf(qQKQG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qQKQG, _operatorSoy2.default);

exports.default = qQKQG;
...
exports.templates = exports.qQKQG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qQKQG.
   * @public
   */

  goog.module('qQKQG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qQKQG.render';
  }
...
_metalSoy2.default.register(qQKQG, templates);
exports.qQKQG = qQKQG;
