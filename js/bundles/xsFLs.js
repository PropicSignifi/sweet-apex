...
var xsFLs = function (_Component) {
  _inherits(xsFLs, _Component);

  function xsFLs() {
    _classCallCheck(this, xsFLs);

    return _possibleConstructorReturn(this, (xsFLs.__proto__ || Object.getPrototypeOf(xsFLs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xsFLs, _array_creationSoy2.default);

exports.default = xsFLs;
...
exports.templates = exports.xsFLs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xsFLs.
   * @public
   */

  goog.module('xsFLs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xsFLs.render';
  }
...
_metalSoy2.default.register(xsFLs, templates);
exports.xsFLs = xsFLs;
