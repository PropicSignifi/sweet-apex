...
var _map_accessSoy = __webpack_require__(319);
...
var SVhWk = function (_Component) {
  _inherits(SVhWk, _Component);

  function SVhWk() {
    _classCallCheck(this, SVhWk);

    return _possibleConstructorReturn(this, (SVhWk.__proto__ || Object.getPrototypeOf(SVhWk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SVhWk, _map_accessSoy2.default);

exports.default = SVhWk;
...
exports.templates = exports.SVhWk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SVhWk.
   * @public
   */

  goog.module('SVhWk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SVhWk.render';
  }
...
_metalSoy2.default.register(SVhWk, templates);
exports.SVhWk = SVhWk;
