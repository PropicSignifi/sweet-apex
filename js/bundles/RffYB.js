...
var RffYB = function (_Component) {
  _inherits(RffYB, _Component);

  function RffYB() {
    _classCallCheck(this, RffYB);

    return _possibleConstructorReturn(this, (RffYB.__proto__ || Object.getPrototypeOf(RffYB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RffYB, _varSoy2.default);

exports.default = RffYB;
...
exports.templates = exports.RffYB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RffYB.
   * @public
   */

  goog.module('RffYB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RffYB.render';
  }
...
_metalSoy2.default.register(RffYB, templates);
exports.RffYB = RffYB;
