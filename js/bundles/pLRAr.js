...
var pLRAr = function (_Component) {
  _inherits(pLRAr, _Component);

  function pLRAr() {
    _classCallCheck(this, pLRAr);

    return _possibleConstructorReturn(this, (pLRAr.__proto__ || Object.getPrototypeOf(pLRAr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pLRAr, _rethrowSoy2.default);

exports.default = pLRAr;
...
exports.templates = exports.pLRAr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pLRAr.
   * @public
   */

  goog.module('pLRAr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pLRAr.render';
  }
...
_metalSoy2.default.register(pLRAr, templates);
exports.pLRAr = pLRAr;
