...
var _step_1Soy = __webpack_require__(347);
...
var SyysX = function (_Component) {
  _inherits(SyysX, _Component);

  function SyysX() {
    _classCallCheck(this, SyysX);

    return _possibleConstructorReturn(this, (SyysX.__proto__ || Object.getPrototypeOf(SyysX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SyysX, _step_1Soy2.default);

exports.default = SyysX;
...
exports.templates = exports.SyysX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SyysX.
   * @public
   */

  goog.module('SyysX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SyysX.render';
  }
...
_metalSoy2.default.register(SyysX, templates);
exports.SyysX = SyysX;
