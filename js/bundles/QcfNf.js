...
var QcfNf = function (_Component) {
  _inherits(QcfNf, _Component);

  function QcfNf() {
    _classCallCheck(this, QcfNf);

    return _possibleConstructorReturn(this, (QcfNf.__proto__ || Object.getPrototypeOf(QcfNf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QcfNf, _testcaseSoy2.default);

exports.default = QcfNf;
...
exports.templates = exports.QcfNf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QcfNf.
   * @public
   */

  goog.module('QcfNf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QcfNf.render';
  }
...
_metalSoy2.default.register(QcfNf, templates);
exports.QcfNf = QcfNf;
