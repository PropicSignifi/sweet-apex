...
var _tagged_stringSoy = __webpack_require__(341);
...
var MaWyS = function (_Component) {
  _inherits(MaWyS, _Component);

  function MaWyS() {
    _classCallCheck(this, MaWyS);

    return _possibleConstructorReturn(this, (MaWyS.__proto__ || Object.getPrototypeOf(MaWyS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MaWyS, _tagged_stringSoy2.default);

exports.default = MaWyS;
...
exports.templates = exports.MaWyS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MaWyS.
   * @public
   */

  goog.module('MaWyS.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1071 = function param1071() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1071 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MaWyS.render';
  }
...
_metalSoy2.default.register(MaWyS, templates);
exports.MaWyS = MaWyS;
