...
var LvgWu = function (_Component) {
  _inherits(LvgWu, _Component);

  function LvgWu() {
    _classCallCheck(this, LvgWu);

    return _possibleConstructorReturn(this, (LvgWu.__proto__ || Object.getPrototypeOf(LvgWu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LvgWu, _enumSoy2.default);

exports.default = LvgWu;
...
exports.templates = exports.LvgWu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LvgWu.
   * @public
   */

  goog.module('LvgWu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LvgWu.render';
  }
...
_metalSoy2.default.register(LvgWu, templates);
exports.LvgWu = LvgWu;
