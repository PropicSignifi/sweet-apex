...
var yguPc = function (_Component) {
  _inherits(yguPc, _Component);

  function yguPc() {
    _classCallCheck(this, yguPc);

    return _possibleConstructorReturn(this, (yguPc.__proto__ || Object.getPrototypeOf(yguPc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yguPc, _array_creationSoy2.default);

exports.default = yguPc;
...
exports.templates = exports.yguPc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yguPc.
   * @public
   */

  goog.module('yguPc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yguPc.render';
  }
...
_metalSoy2.default.register(yguPc, templates);
exports.yguPc = yguPc;
