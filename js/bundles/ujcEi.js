...
var ujcEi = function (_Component) {
  _inherits(ujcEi, _Component);

  function ujcEi() {
    _classCallCheck(this, ujcEi);

    return _possibleConstructorReturn(this, (ujcEi.__proto__ || Object.getPrototypeOf(ujcEi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ujcEi, _configSoy2.default);

exports.default = ujcEi;
...
exports.templates = exports.ujcEi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ujcEi.
   * @public
   */

  goog.module('ujcEi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ujcEi.render';
  }
...
_metalSoy2.default.register(ujcEi, templates);
exports.ujcEi = ujcEi;
