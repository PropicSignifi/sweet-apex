...
var THbMf = function (_Component) {
  _inherits(THbMf, _Component);

  function THbMf() {
    _classCallCheck(this, THbMf);

    return _possibleConstructorReturn(this, (THbMf.__proto__ || Object.getPrototypeOf(THbMf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(THbMf, _rethrowSoy2.default);

exports.default = THbMf;
...
exports.templates = exports.THbMf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace THbMf.
   * @public
   */

  goog.module('THbMf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'THbMf.render';
  }
...
_metalSoy2.default.register(THbMf, templates);
exports.THbMf = THbMf;
