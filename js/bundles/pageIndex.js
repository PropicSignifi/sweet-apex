...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/sweet-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Sweet.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Why Sweet.apex?');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Have you ever dreamed of using custom annotations in Apex? Have you ever wondered if you could eliminate some Apex boilerplate codes? Sweet.apex is here to make your dreams come true, by providing some of the most amazing features right at your disposal.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Fascinating Features');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Sweet.apex offers some fascinating features you may have wanted for long.');
    ie_close('p');
    ie_close('section');
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Sweet.apex features can help you eliminate boilerplates and focus on real core codes.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Sweet.apex delivers all its features in a form of plugins, and you can add your own plugins.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'col-md-12 col-md-offset-2');
    ie_open('h3', null, null, 'class', 'about-title');
    itext('It\'s transforming your mind');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('It completely changes how you would develop Apex, bringing you to a new world.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Sweet.apex aims to provide features that solve your pain points, and new features are continuously coming.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/sweet-apex/images/highlight_1.png', 'alt', 'Feature Rich', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Sweet.apex eliminates boilerplates and makes your code more lightweight.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/sweet-apex/images/highlight_2.png', 'alt', 'Lightweight', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Sweet.apex is built on plugins and welcomes new features.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/sweet-apex/images/highlight_3.png', 'alt', 'Extensible', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
