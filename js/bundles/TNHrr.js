...
var TNHrr = function (_Component) {
  _inherits(TNHrr, _Component);

  function TNHrr() {
    _classCallCheck(this, TNHrr);

    return _possibleConstructorReturn(this, (TNHrr.__proto__ || Object.getPrototypeOf(TNHrr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TNHrr, _castSoy2.default);

exports.default = TNHrr;
...
exports.templates = exports.TNHrr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TNHrr.
   * @public
   */

  goog.module('TNHrr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TNHrr.render';
  }
...
_metalSoy2.default.register(TNHrr, templates);
exports.TNHrr = TNHrr;
