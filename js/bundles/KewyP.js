...
var KewyP = function (_Component) {
  _inherits(KewyP, _Component);

  function KewyP() {
    _classCallCheck(this, KewyP);

    return _possibleConstructorReturn(this, (KewyP.__proto__ || Object.getPrototypeOf(KewyP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KewyP, _indexSoy2.default);

exports.default = KewyP;
...
exports.templates = exports.KewyP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KewyP.
   * @public
   */

  goog.module('KewyP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KewyP.render';
  }
...
_metalSoy2.default.register(KewyP, templates);
exports.KewyP = KewyP;
