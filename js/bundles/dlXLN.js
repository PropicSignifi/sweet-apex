...
var _tagged_stringSoy = __webpack_require__(331);
...
var dlXLN = function (_Component) {
  _inherits(dlXLN, _Component);

  function dlXLN() {
    _classCallCheck(this, dlXLN);

    return _possibleConstructorReturn(this, (dlXLN.__proto__ || Object.getPrototypeOf(dlXLN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dlXLN, _tagged_stringSoy2.default);

exports.default = dlXLN;
...
exports.templates = exports.dlXLN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dlXLN.
   * @public
   */

  goog.module('dlXLN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dlXLN.render';
  }
...
_metalSoy2.default.register(dlXLN, templates);
exports.dlXLN = dlXLN;
