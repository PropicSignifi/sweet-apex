...
var hiiDA = function (_Component) {
  _inherits(hiiDA, _Component);

  function hiiDA() {
    _classCallCheck(this, hiiDA);

    return _possibleConstructorReturn(this, (hiiDA.__proto__ || Object.getPrototypeOf(hiiDA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hiiDA, _aspectSoy2.default);

exports.default = hiiDA;
...
exports.templates = exports.hiiDA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hiiDA.
   * @public
   */

  goog.module('hiiDA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hiiDA.render';
  }
...
_metalSoy2.default.register(hiiDA, templates);
exports.hiiDA = hiiDA;
