...
var FefCB = function (_Component) {
  _inherits(FefCB, _Component);

  function FefCB() {
    _classCallCheck(this, FefCB);

    return _possibleConstructorReturn(this, (FefCB.__proto__ || Object.getPrototypeOf(FefCB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FefCB, _operatorSoy2.default);

exports.default = FefCB;
...
exports.templates = exports.FefCB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FefCB.
   * @public
   */

  goog.module('FefCB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FefCB.render';
  }
...
_metalSoy2.default.register(FefCB, templates);
exports.FefCB = FefCB;
