...
var pRuEu = function (_Component) {
  _inherits(pRuEu, _Component);

  function pRuEu() {
    _classCallCheck(this, pRuEu);

    return _possibleConstructorReturn(this, (pRuEu.__proto__ || Object.getPrototypeOf(pRuEu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pRuEu, _injectSoy2.default);

exports.default = pRuEu;
...
exports.templates = exports.pRuEu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pRuEu.
   * @public
   */

  goog.module('pRuEu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pRuEu.render';
  }
...
_metalSoy2.default.register(pRuEu, templates);
exports.pRuEu = pRuEu;
