...
var RRhOa = function (_Component) {
  _inherits(RRhOa, _Component);

  function RRhOa() {
    _classCallCheck(this, RRhOa);

    return _possibleConstructorReturn(this, (RRhOa.__proto__ || Object.getPrototypeOf(RRhOa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RRhOa, _commandSoy2.default);

exports.default = RRhOa;
...
exports.templates = exports.RRhOa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RRhOa.
   * @public
   */

  goog.module('RRhOa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RRhOa.render';
  }
...
_metalSoy2.default.register(RRhOa, templates);
exports.RRhOa = RRhOa;
