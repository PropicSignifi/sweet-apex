...
var crepH = function (_Component) {
  _inherits(crepH, _Component);

  function crepH() {
    _classCallCheck(this, crepH);

    return _possibleConstructorReturn(this, (crepH.__proto__ || Object.getPrototypeOf(crepH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(crepH, _actionSoy2.default);

exports.default = crepH;
...
exports.templates = exports.crepH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace crepH.
   * @public
   */

  goog.module('crepH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'crepH.render';
  }
...
_metalSoy2.default.register(crepH, templates);
exports.crepH = crepH;
