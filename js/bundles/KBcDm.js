...
var KBcDm = function (_Component) {
  _inherits(KBcDm, _Component);

  function KBcDm() {
    _classCallCheck(this, KBcDm);

    return _possibleConstructorReturn(this, (KBcDm.__proto__ || Object.getPrototypeOf(KBcDm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KBcDm, _testcaseSoy2.default);

exports.default = KBcDm;
...
exports.templates = exports.KBcDm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KBcDm.
   * @public
   */

  goog.module('KBcDm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KBcDm.render';
  }
...
_metalSoy2.default.register(KBcDm, templates);
exports.KBcDm = KBcDm;
