...
var NqRtE = function (_Component) {
  _inherits(NqRtE, _Component);

  function NqRtE() {
    _classCallCheck(this, NqRtE);

    return _possibleConstructorReturn(this, (NqRtE.__proto__ || Object.getPrototypeOf(NqRtE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NqRtE, _featureSoy2.default);

exports.default = NqRtE;
...
exports.templates = exports.NqRtE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NqRtE.
   * @public
   */

  goog.module('NqRtE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NqRtE.render';
  }
...
_metalSoy2.default.register(NqRtE, templates);
exports.NqRtE = NqRtE;
