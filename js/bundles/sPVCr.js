...
var sPVCr = function (_Component) {
  _inherits(sPVCr, _Component);

  function sPVCr() {
    _classCallCheck(this, sPVCr);

    return _possibleConstructorReturn(this, (sPVCr.__proto__ || Object.getPrototypeOf(sPVCr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sPVCr, _constructor_annotationSoy2.default);

exports.default = sPVCr;
...
exports.templates = exports.sPVCr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sPVCr.
   * @public
   */

  goog.module('sPVCr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sPVCr.render';
  }
...
_metalSoy2.default.register(sPVCr, templates);
exports.sPVCr = sPVCr;
