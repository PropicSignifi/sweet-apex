...
var DyIrk = function (_Component) {
  _inherits(DyIrk, _Component);

  function DyIrk() {
    _classCallCheck(this, DyIrk);

    return _possibleConstructorReturn(this, (DyIrk.__proto__ || Object.getPrototypeOf(DyIrk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DyIrk, _apexdocSoy2.default);

exports.default = DyIrk;
...
exports.templates = exports.DyIrk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DyIrk.
   * @public
   */

  goog.module('DyIrk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DyIrk.render';
  }
...
_metalSoy2.default.register(DyIrk, templates);
exports.DyIrk = DyIrk;
