...
var nDcFR = function (_Component) {
  _inherits(nDcFR, _Component);

  function nDcFR() {
    _classCallCheck(this, nDcFR);

    return _possibleConstructorReturn(this, (nDcFR.__proto__ || Object.getPrototypeOf(nDcFR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nDcFR, _featureSoy2.default);

exports.default = nDcFR;
...
exports.templates = exports.nDcFR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nDcFR.
   * @public
   */

  goog.module('nDcFR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nDcFR.render';
  }
...
_metalSoy2.default.register(nDcFR, templates);
exports.nDcFR = nDcFR;
