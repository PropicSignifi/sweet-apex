...
var yDLua = function (_Component) {
  _inherits(yDLua, _Component);

  function yDLua() {
    _classCallCheck(this, yDLua);

    return _possibleConstructorReturn(this, (yDLua.__proto__ || Object.getPrototypeOf(yDLua)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yDLua, _transpilationSoy2.default);

exports.default = yDLua;
...
exports.templates = exports.yDLua = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yDLua.
   * @public
   */

  goog.module('yDLua.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yDLua.render';
  }
...
_metalSoy2.default.register(yDLua, templates);
exports.yDLua = yDLua;
