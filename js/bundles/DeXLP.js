...
var _step_3Soy = __webpack_require__(343);
...
var DeXLP = function (_Component) {
  _inherits(DeXLP, _Component);

  function DeXLP() {
    _classCallCheck(this, DeXLP);

    return _possibleConstructorReturn(this, (DeXLP.__proto__ || Object.getPrototypeOf(DeXLP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DeXLP, _step_3Soy2.default);

exports.default = DeXLP;
...
exports.templates = exports.DeXLP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DeXLP.
   * @public
   */

  goog.module('DeXLP.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1081 = function param1081() {
      ie_open('h2');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DeXLP.render';
  }
...
_metalSoy2.default.register(DeXLP, templates);
exports.DeXLP = DeXLP;
