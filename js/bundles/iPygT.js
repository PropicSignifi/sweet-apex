...
var iPygT = function (_Component) {
  _inherits(iPygT, _Component);

  function iPygT() {
    _classCallCheck(this, iPygT);

    return _possibleConstructorReturn(this, (iPygT.__proto__ || Object.getPrototypeOf(iPygT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iPygT, _indexSoy2.default);

exports.default = iPygT;
...
exports.templates = exports.iPygT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iPygT.
   * @public
   */

  goog.module('iPygT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iPygT.render';
  }
...
_metalSoy2.default.register(iPygT, templates);
exports.iPygT = iPygT;
