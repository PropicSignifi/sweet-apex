...
var QBJvC = function (_Component) {
  _inherits(QBJvC, _Component);

  function QBJvC() {
    _classCallCheck(this, QBJvC);

    return _possibleConstructorReturn(this, (QBJvC.__proto__ || Object.getPrototypeOf(QBJvC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QBJvC, _rethrowSoy2.default);

exports.default = QBJvC;
...
exports.templates = exports.QBJvC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QBJvC.
   * @public
   */

  goog.module('QBJvC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QBJvC.render';
  }
...
_metalSoy2.default.register(QBJvC, templates);
exports.QBJvC = QBJvC;
