...
var tWeQM = function (_Component) {
  _inherits(tWeQM, _Component);

  function tWeQM() {
    _classCallCheck(this, tWeQM);

    return _possibleConstructorReturn(this, (tWeQM.__proto__ || Object.getPrototypeOf(tWeQM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tWeQM, _operatorSoy2.default);

exports.default = tWeQM;
...
exports.templates = exports.tWeQM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tWeQM.
   * @public
   */

  goog.module('tWeQM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tWeQM.render';
  }
...
_metalSoy2.default.register(tWeQM, templates);
exports.tWeQM = tWeQM;
