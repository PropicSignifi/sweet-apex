...
var uiiwa = function (_Component) {
  _inherits(uiiwa, _Component);

  function uiiwa() {
    _classCallCheck(this, uiiwa);

    return _possibleConstructorReturn(this, (uiiwa.__proto__ || Object.getPrototypeOf(uiiwa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uiiwa, _identitySoy2.default);

exports.default = uiiwa;
...
exports.templates = exports.uiiwa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uiiwa.
   * @public
   */

  goog.module('uiiwa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uiiwa.render';
  }
...
_metalSoy2.default.register(uiiwa, templates);
exports.uiiwa = uiiwa;
