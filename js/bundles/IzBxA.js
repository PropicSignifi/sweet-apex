...
var IzBxA = function (_Component) {
  _inherits(IzBxA, _Component);

  function IzBxA() {
    _classCallCheck(this, IzBxA);

    return _possibleConstructorReturn(this, (IzBxA.__proto__ || Object.getPrototypeOf(IzBxA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IzBxA, _functionSoy2.default);

exports.default = IzBxA;
...
exports.templates = exports.IzBxA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IzBxA.
   * @public
   */

  goog.module('IzBxA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IzBxA.render';
  }
...
_metalSoy2.default.register(IzBxA, templates);
exports.IzBxA = IzBxA;
