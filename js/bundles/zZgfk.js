...
var zZgfk = function (_Component) {
  _inherits(zZgfk, _Component);

  function zZgfk() {
    _classCallCheck(this, zZgfk);

    return _possibleConstructorReturn(this, (zZgfk.__proto__ || Object.getPrototypeOf(zZgfk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zZgfk, _scriptSoy2.default);

exports.default = zZgfk;
...
exports.templates = exports.zZgfk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zZgfk.
   * @public
   */

  goog.module('zZgfk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zZgfk.render';
  }
...
_metalSoy2.default.register(zZgfk, templates);
exports.zZgfk = zZgfk;
