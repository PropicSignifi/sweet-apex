...
var _nullableSoy = __webpack_require__(323);
...
var VDYCF = function (_Component) {
  _inherits(VDYCF, _Component);

  function VDYCF() {
    _classCallCheck(this, VDYCF);

    return _possibleConstructorReturn(this, (VDYCF.__proto__ || Object.getPrototypeOf(VDYCF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VDYCF, _nullableSoy2.default);

exports.default = VDYCF;
...
exports.templates = exports.VDYCF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VDYCF.
   * @public
   */

  goog.module('VDYCF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VDYCF.render';
  }
...
_metalSoy2.default.register(VDYCF, templates);
exports.VDYCF = VDYCF;
