...
var NAKOK = function (_Component) {
  _inherits(NAKOK, _Component);

  function NAKOK() {
    _classCallCheck(this, NAKOK);

    return _possibleConstructorReturn(this, (NAKOK.__proto__ || Object.getPrototypeOf(NAKOK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NAKOK, _indexSoy2.default);

exports.default = NAKOK;
...
exports.templates = exports.NAKOK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NAKOK.
   * @public
   */

  goog.module('NAKOK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NAKOK.render';
  }
...
_metalSoy2.default.register(NAKOK, templates);
exports.NAKOK = NAKOK;
